...
namespace NEsper.Avro.IO
{
    public class GenericRecordToJsonConverter
    {
        ...
        private bool ValueMatchSchemaType(
            Schema schema,
            object value)
        {
            switch (schema.Tag) {
