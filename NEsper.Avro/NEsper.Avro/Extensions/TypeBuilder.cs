...
namespace NEsper.Avro.Extensions
{
    public class TypeBuilder
    {
        ...
        public static JObject Map(JToken valueType, params JProperty[] properties)
        {
            return new JObject(
        ...
        public static JObject RequiredBoolean(string name)
        {
            return Required(name, "boolean");
        }
        ...
        public static JObject OptionalBoolean(
            string name,
            JValue defaultValue = null)
        {
            return Optional(name, "boolean", defaultValue);
        }

        public static JObject OptionalBytes(
            string name,
            JValue defaultValue = null)
        {
            return Optional(name, "bytes", defaultValue);
        }
