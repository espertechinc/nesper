...
namespace com.espertech.esper.regressionlib.suite.epl.other
{
    public class EPLOtherPlanInKeywordQuery : IndexBackingTableInfo
    {
        ...
        private static void AssertSubqueryC0C1(RegressionEnvironment env, int c0, int? [] c1)
        {
        ...
        {
            return SupportQueryPlanBuilder.Start(3).AddIndexHashSingleNonUnique(1, "i1", "P10").SetIndexFullTableScan(2, "i2").SetLookupPlanInstruction(0, "S0", new[]{new LookupInstructionPlanForge(0, "S0", new[]{1}, new TableLookupPlanForge[]{plan}, null, new bool[3]), new LookupInstructionPlanForge(0, "S0", new[]{2}, new TableLookupPlanForge[]{new FullTableScanLookupPlanForge(1, 2, false, types, GetIndexKey("i2"))}, null, new bool[3])}).Get();
        }
        ...
        private static void TryAssertionMultiIdx(RegressionEnvironment env)
        {
            ...
            EPAssertionUtil.AssertPropsPerRowAnyOrder(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{21, 101}, new object[]{21, 102}, new object[]{21, 103}});
        ...
        private static void TryAssertionSingleIdx(RegressionEnvironment env)
        {
            ...
            EPAssertionUtil.AssertPropsPerRow(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{100, 20}, new object[]{101, 20}, new object[]{102, 20}});
            env.SendEventBean(new SupportBean_S1(21, "b", "a", "x", "c"));
            EPAssertionUtil.AssertPropsPerRowAnyOrder(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{100, 21}, new object[]{102, 21}});
            env.SendEventBean(new SupportBean_S1(22, "b", "a", "d", "c"));
            EPAssertionUtil.AssertPropsPerRowAnyOrder(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{100, 22}, new object[]{101, 22}, new object[]{102, 22}});
        ...
        internal class EPLOtherNotIn : RegressionExecution
        {
            ...
            {
                SupportQueryPlanIndexHook.Reset();
                var epl = INDEX_CALLBACK_HOOK + "select * from SupportBean_S0 as S0 unidirectional, SupportBean_S1#keepall as S1 " + "where P00 not in (P10, P11)";
                env.CompileDeploy(epl);
        ...
        internal class EPLOtherMultiIdxMultipleInAndMultirow : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                // assert join
                SupportQueryPlanIndexHook.Reset();
                var epl = "@Name('s0') " + INDEX_CALLBACK_HOOK + "select * from SupportBean_S0 as S0 unidirectional, SupportBean_S1#keepall as S1 " + "where P00 in (P10, P11) and P01 in (P12, P13)";
                ...
                var eplNamedWindow = "@Name('s0') " + INDEX_CALLBACK_HOOK + "on SupportBean_S0 as S0 select * from S1Window as S1 " + "where P00 in (P10, P11) and P01 in (P12, P13)";
                ...
                var eplTable = "@Name('s0') " + INDEX_CALLBACK_HOOK + "on SupportBean_S0 as S0 select * from S1Table as S1 " + "where P00 in (P10, P11) and P01 in (P12, P13)";
        ...
        internal class EPLOtherMultiIdxSubquery : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                var epl = "@Name('s0') " + INDEX_CALLBACK_HOOK + "select S0.Id as c0," + "(select * from SupportBean_S1#keepall as S1 " + "  where S0.P00 in (S1.P10, SupportBean_S1.P11) and S0.P01 in (S1.P12, SupportBean_S1.P13))" + ".selectFrom(a->SupportBean_S1.Id) as c1 " + "from SupportBean_S0 as S0";
                env.CompileDeploy(epl).AddListener("s0");
                ...
                var eplCoercion = INDEX_CALLBACK_HOOK + "select *," + "(select * from SupportBean_S0#keepall as S0 where sb.LongPrimitive in (Id)) from SupportBean as sb";
        ...
        internal class EPLOtherSingleIdxMultipleInAndMultirow : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                // assert join
                SupportQueryPlanIndexHook.Reset();
                var epl = "@Name('s0') " + INDEX_CALLBACK_HOOK + "select * from SupportBean_S0#keepall as S0, SupportBean_S1 as S1 unidirectional " + "where P00 in (P10, P11) and P01 in (P12, P13)";
                env.CompileDeploy(epl).AddListener("s0");
                ...
                var eplNamedWindow = "@Name('s0') " + INDEX_CALLBACK_HOOK + "on SupportBean_S1 as S1 select * from S0Window as S0 " + "where P00 in (P10, P11) and P01 in (P12, P13)";
                env.CompileDeploy(eplNamedWindow, path).AddListener("s0");
                var onExprNamedWindow = SupportQueryPlanIndexHook.AssertOnExprAndReset();
                ...
                var eplTable = "@Name('s0') " + INDEX_CALLBACK_HOOK + "on SupportBean_S1 as S1 select * from S0Table as S0 " + "where P00 in (P10, P11) and P01 in (P12, P13)";
                env.CompileDeploy(eplTable, path).AddListener("s0");
                var onExprTable = SupportQueryPlanIndexHook.AssertOnExprAndReset();
        ...
        internal class EPLOtherSingleIdxSubquery : RegressionExecution
        {
            ...
            {
                SupportQueryPlanIndexHook.Reset();
                var epl = "@Name('s0') " + INDEX_CALLBACK_HOOK + "select S1.Id as c0," + "(select * from SupportBean_S0#keepall as S0 " + "  where S0.P00 in (S1.P10, SupportBean_S1.P11) and S0.P01 in (S1.P12, SupportBean_S1.P13))" + ".selectFrom(a->SupportBean_S0.Id) as c1 " + " from SupportBean_S1 as S1";
                env.CompileDeploy(epl).AddListener("s0");
                var subquery = SupportQueryPlanIndexHook.AssertSubqueryAndReset();
                ...
                env.UndeployAll();
                // test coercion absence - types the same
                var eplCoercion = INDEX_CALLBACK_HOOK + "select *," + "(select * from SupportBean#keepall as sb where sb.LongPrimitive in (S0.Id)) from SupportBean_S0 as S0";
                env.CompileDeploy(eplCoercion);
                var subqueryCoercion = SupportQueryPlanIndexHook.AssertSubqueryAndReset();
                Assert.AreEqual(typeof(SubordFullTableScanLookupStrategyFactoryForge).Name, subqueryCoercion.TableLookupStrategy);
                env.UndeployAll();
        ...
        internal class EPLOtherSingleIdxConstants : RegressionExecution
        {
            ...
            {
                SupportQueryPlanIndexHook.Reset();
                var epl = "@Name('s0') " + INDEX_CALLBACK_HOOK + "select * from SupportBean_S0 as S0 unidirectional, SupportBean_S1#keepall as S1 " + "where P10 in ('a', 'b')";
                var fields = new[]{"S0.Id", "S1.Id"};
                env.CompileDeploy(epl).AddListener("s0");
                var items = SupportQueryPlanIndexHook.AssertJoinAndReset().IndexSpecs[1].Items;
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{2, 101}, new object[]{2, 102}});
                env.UndeployAll();
            }
        }
        ...
        internal class EPLOtherMultiIdxConstants : RegressionExecution
        {
            ...
            {
                SupportQueryPlanIndexHook.Reset();
                var epl = "@Name('s0') " + INDEX_CALLBACK_HOOK + "select * from SupportBean_S0 as S0 unidirectional, SupportBean_S1#keepall as S1 " + "where 'a' in (P10, P11)";
                var fields = new[]{"S0.Id", "S1.Id"};
                env.CompileDeploy(epl).AddListener("s0");
                var items = SupportQueryPlanIndexHook.AssertJoinAndReset().IndexSpecs[1].Items;
                Assert.AreEqual("[\"P10\"][\"P11\"]", SupportQueryPlanIndexHelper.GetIndexedExpressions(items));
        ...
        internal class EPLOtherQueryPlan3Stream : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                var planInMidx = new InKeywordTableLookupPlanMultiIdxForge(0, 1, false, types, GetIndexKeys("i1a", "i1b"), SupportExprNodeFactory.MakeIdentExprNode("P00"));
                TryAssertion(env, epl + " where P00 in (P10, P11)", SupportQueryPlanBuilder.Start(3).AddIndexHashSingleNonUnique(1, "i1a", "P10").AddIndexHashSingleNonUnique(1, "i1b", "P11").SetIndexFullTableScan(2, "i2").SetLookupPlanInstruction(0, "S0", new[]{new LookupInstructionPlanForge(0, "S0", new[]{1}, new TableLookupPlanForge[]{planInMidx}, null, new bool[3]), new LookupInstructionPlanForge(0, "S0", new[]{2}, new TableLookupPlanForge[]{new FullTableScanLookupPlanForge(1, 2, false, types, GetIndexKey("i2"))}, null, new bool[3])}).Get());
                var planInMidxMulitiSrc = new InKeywordTableLookupPlanMultiIdxForge(0, 1, false, types, GetIndexKeys("i1", "i2"), SupportExprNodeFactory.MakeIdentExprNode("P00"));
                TryAssertion(env, epl + " where P00 in (P10, P20)", SupportQueryPlanBuilder.Start(3).SetIndexFullTableScan(1, "i1").SetIndexFullTableScan(2, "i2").SetLookupPlanInstruction(0, "S0", new[]{new LookupInstructionPlanForge(0, "S0", new[]{1}, new TableLookupPlanForge[]{new FullTableScanLookupPlanForge(0, 1, false, types, GetIndexKey("i1"))}, null, new bool[3]), new LookupInstructionPlanForge(0, "S0", new[]{2}, new TableLookupPlanForge[]{new FullTableScanLookupPlanForge(1, 2, false, types, GetIndexKey("i2"))}, null, new bool[3])}).Get());
                // 3-stream join with in-singleindex directional
                var planInSidx = new InKeywordTableLookupPlanSingleIdxForge(0, 1, false, types, GetIndexKey("i1"), SupportExprNodeFactory.MakeIdentExprNodes("P00", "P01"));
                ...
                var planInSingleMultiSrc = new InKeywordTableLookupPlanSingleIdxForge(0, 1, false, types, GetIndexKey("i1"), SupportExprNodeFactory.MakeIdentExprNodes("P00"));
        ...
        internal class EPLOtherQueryPlan2Stream : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                var fullTableScan = SupportQueryPlanBuilder.Start(2).SetIndexFullTableScan(1, "a").SetLookupPlanInner(0, new FullTableScanLookupPlanForge(0, 1, false, types, GetIndexKey("a"))).Get();
                // 2-stream unidirectional joins
                TryAssertion(env, epl, fullTableScan);
                var planEquals = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P10").SetLookupPlanInner(0, new IndexedTableLookupPlanHashedOnlyForge(0, 1, false, types, GetIndexKey("a"), new[]{SupportExprNodeFactory.MakeKeyed("P00")}, null, null, null)).Get();
                TryAssertion(env, epl + "where P00 = P10", planEquals);
                TryAssertion(env, epl + "where P00 = P10 and P00 in (P11, P12, P13)", planEquals);
                var planInMultiInner = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P11").AddIndexHashSingleNonUnique(1, "b", "P12").SetLookupPlanInner(0, new InKeywordTableLookupPlanMultiIdxForge(0, 1, false, types, GetIndexKeys("a", "b"), SupportExprNodeFactory.MakeIdentExprNode("P00"))).Get();
                TryAssertion(env, epl + "where P00 in (P11, P12)", planInMultiInner);
                TryAssertion(env, epl + "where P00 = P11 or P00 = P12", planInMultiInner);
                var planInMultiOuter = SupportQueryPlanBuilder.Start(planInMultiInner).SetLookupPlanOuter(0, new InKeywordTableLookupPlanMultiIdxForge(0, 1, false, types, GetIndexKeys("a", "b"), SupportExprNodeFactory.MakeIdentExprNode("P00"))).Get();
                ...
                var planInMultiWConst = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P11").AddIndexHashSingleNonUnique(1, "b", "P12").SetLookupPlanInner(0, new InKeywordTableLookupPlanMultiIdxForge(0, 1, false, types, GetIndexKeys("a", "b"), SupportExprNodeFactory.MakeConstExprNode("A"))).Get();
                TryAssertion(env, epl + "where 'A' in (P11, P12)", planInMultiWConst);
                TryAssertion(env, epl + "where 'A' = P11 or 'A' = P12", planInMultiWConst);
                var planInMultiWAddConst = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P12").SetLookupPlanInner(0, new InKeywordTableLookupPlanMultiIdxForge(0, 1, false, types, GetIndexKeys("a"), SupportExprNodeFactory.MakeConstExprNode("A"))).Get();
                TryAssertion(env, epl + "where 'A' in ('B', P12)", planInMultiWAddConst);
                TryAssertion(env, epl + "where 'A' in ('B', 'C')", fullTableScan);
                var planInSingle = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P10").SetLookupPlanInner(0, new InKeywordTableLookupPlanSingleIdxForge(0, 1, false, types, GetIndexKey("a"), SupportExprNodeFactory.MakeIdentExprNodes("P00", "P01"))).Get();
                TryAssertion(env, epl + "where P10 in (P00, P01)", planInSingle);
                var planInSingleWConst = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P10").SetLookupPlanInner(0, new InKeywordTableLookupPlanSingleIdxForge(0, 1, false, types, GetIndexKey("a"), SupportExprNodeFactory.MakeConstAndIdentNode("A", "P01"))).Get();
                TryAssertion(env, epl + "where P10 in ('A', P01)", planInSingleWConst);
                var planInSingleJustConst = SupportQueryPlanBuilder.Start(2).AddIndexHashSingleNonUnique(1, "a", "P10").SetLookupPlanInner(0, new InKeywordTableLookupPlanSingleIdxForge(0, 1, false, types, GetIndexKey("a"), SupportExprNodeFactory.MakeConstAndConstNode("A", "B"))).Get();
