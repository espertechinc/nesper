...
namespace com.espertech.esper.regressionlib.suite.epl.join
{
    public class EPLOuterJoin2Stream
    {
        ...
        private static void CompareEvent(EventBean receivedEvent, int? idS0, string p00, int? idS1, string p10)
        {
        ...
        {
            var joinStatement = "@Name('s0') select irstream S0.Id, S0.P00, S1.Id, S1.P10 from " + "SupportBean_S0#length(3) as S0 " + outerJoinType + " outer join " + "SupportBean_S1#length(5) as S1" + " on S0.P00 = S1.P10";
        ...
        internal class EPLJoinFullOuterMultikeyWArrayPrimitive : RegressionExecution
        {
            ...
            {
                string epl = "@Name('s0') select * " + "from SupportEventWithIntArray#keepall one " + "full outer join " + "SupportEventWithManyArray#keepall two " + "on Array = IntOne";
        ...
        internal class EPLJoinRangeOuterJoin : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                var stmtOne = "@Name('s0') select sb.TheString as sbstr, sb.IntPrimitive as sbint, sbr.Key as sbrk, sbr.RangeStart as sbrs, sbr.RangeEnd as sbre " + "from SupportBean#keepall sb " + "full outer join " + "SupportBeanRange#keepall sbr " + "on TheString = Key " + "where IntPrimitive between RangeStart and RangeEnd " + "order by RangeStart asc, IntPrimitive asc";
                TryAssertion(env, stmtOne, milestone);
                var stmtTwo = "@Name('s0') select sb.TheString as sbstr, sb.IntPrimitive as sbint, sbr.Key as sbrk, sbr.RangeStart as sbrs, sbr.RangeEnd as sbre " + "from SupportBeanRange#keepall sbr " + "full outer join " + "SupportBean#keepall sb " + "on TheString = Key " + "where IntPrimitive between RangeStart and RangeEnd " + "order by RangeStart asc, IntPrimitive asc";
                TryAssertion(env, stmtTwo, milestone);
                var stmtThree = "@Name('s0') select sb.TheString as sbstr, sb.IntPrimitive as sbint, sbr.Key as sbrk, sbr.RangeStart as sbrs, sbr.RangeEnd as sbre " + "from SupportBeanRange#keepall sbr " + "full outer join " + "SupportBean#keepall sb " + "on TheString = Key " + "where IntPrimitive >= RangeStart and IntPrimitive <= RangeEnd " + "order by RangeStart asc, IntPrimitive asc";
                TryAssertion(env, stmtThree, milestone);
            }

            private static void TryAssertion(RegressionEnvironment env, string epl, AtomicLong milestone)
            {
                ...
                EPAssertionUtil.AssertPropsPerRow(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{"K1", 41, "K1", 39, 41}, new object[]{"K1", 41, "K1", 40, 42}, new object[]{"K1", 41, "K1", 41, 42}});
                env.SendEventBean(new SupportBeanRange("R2", "K1", 35, 42));
                EPAssertionUtil.AssertPropsPerRow(env.Listener("s0").GetAndResetLastNewData(), fields, new[]{new object[]{"K1", 40, "K1", 35, 42}, new object[]{"K1", 41, "K1", 35, 42}});
                env.UndeployAll();
            }
        }
        ...
        internal class EPLJoinFullOuterIteratorGroupBy : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                var epl = "@Name('s0') select TheString, IntPrimitive, Symbol, Volume " + "from SupportMarketDataBean#keepall " + "full outer join SupportBean#groupwin(TheString, IntPrimitive)#length(2) " + "on TheString = Symbol " + "group by TheString, IntPrimitive, Symbol " + "order by TheString, IntPrimitive, Symbol, Volume";
                ...
                */
                EPAssertionUtil.AssertPropsPerRow(events, new[]{"TheString", "IntPrimitive", "Symbol", "Volume"}, new[]{new object[]{null, null, "c3", 400L}, new object[]{"c0", 0, "c0", 200L}, new object[]{"c0", 1, "c0", 200L}, new object[]{"c0", 2, "c0", 200L}, new object[]{"c1", 0, null, null}, new object[]{"c1", 1, null, null}, new object[]{"c1", 2, null, null}, new object[]{"c2", 0, null, null}, new object[]{"c2", 1, null, null}, new object[]{"c2", 2, null, null}});
                env.UndeployAll();
            }
        }
        ...
        internal class EPLJoinFullOuterJoin : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{100, "0", null, null}, new object[]{null, null, 201, "1"}});
                // Send S1[2] and S0[2]
                SendEvent(EVENTS_S1[2], env);
                CompareEvent(env.Listener("s0").AssertOneGetNewAndReset(), null, null, 202, "2");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{100, "0", null, null}, new object[]{null, null, 201, "1"}, new object[]{null, null, 202, "2"}});
                SendEvent(EVENTS_S0[2], env);
                CompareEvent(env.Listener("s0").AssertOneGetNewAndReset(), 102, "2", 202, "2");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{100, "0", null, null}, new object[]{null, null, 201, "1"}, new object[]{102, "2", 202, "2"}});
                // Send S0[3] and S1[3]
                SendEvent(EVENTS_S0[3], env);
                CompareEvent(env.Listener("s0").AssertOneGetNewAndReset(), 103, "3", null, null);
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{100, "0", null, null}, new object[]{null, null, 201, "1"}, new object[]{102, "2", 202, "2"}, new object[]{103, "3", null, null}});
                SendEvent(EVENTS_S1[3], env);
                CompareEvent(env.Listener("s0").AssertOneGetNewAndReset(), 103, "3", 203, "3");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{100, "0", null, null}, new object[]{null, null, 201, "1"}, new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}});
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{null, null, 201, "1"}, new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}, new object[]{104, "4", null, null}});
                // Send S1[4]
                SendEvent(EVENTS_S1[4], env);
                CompareEvent(env.Listener("s0").AssertOneGetNewAndReset(), 104, "4", 204, "4");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{null, null, 201, "1"}, new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}, new object[]{104, "4", 204, "4"}});
                // Send S1[5]
                SendEvent(EVENTS_S1[5], env);
                CompareEvent(env.Listener("s0").AssertOneGetNewAndReset(), null, null, 205, "5");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{null, null, 201, "1"}, new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}, new object[]{104, "4", 204, "4"}, new object[]{null, null, 205, "5"}});
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}, new object[]{104, "4", 204, "4"}, new object[]{null, null, 205, "5"}, new object[]{null, null, 205, "5"}});
                env.UndeployAll();
            }
        }
        ...
        internal class EPLJoinMultiColumnLeftOM : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                var fromClause = FromClause.Create(FilterStream.Create(typeof(SupportBean_S0).Name, "S0").AddView("keepall"), FilterStream.Create(typeof(SupportBean_S1).Name, "S1").AddView("keepall"));
                fromClause.Add(OuterJoinQualifier.Create("S0.P00", OuterJoinType.LEFT, "S1.P10").Add("S1.P11", "S0.P01"));
                model.FromClause = fromClause;
                model = env.CopyMayFail(model);
                var stmtText = "select S0.Id, S0.P00, S0.P01, S1.Id, S1.P10, S1.P11 from SupportBean_S0#keepall as S0 left outer join SupportBean_S1#keepall as S1 on S0.P00 = S1.P10 and S1.P11 = S0.P01";
        ...
        internal class EPLJoinMultiColumnLeft : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                var epl = "@Name('s0') select S0.Id, S0.P00, S0.P01, S1.Id, S1.P10, S1.P11 from " + "SupportBean_S0#length(3) as S0 " + "left outer join " + "SupportBean_S1#length(5) as S1" + " on S0.P00 = S1.P10 and S0.P01 = S1.P11";
                env.CompileDeploy(epl).AddListener("s0");
                AssertMultiColumnLeft(env);
                env.UndeployAll();
            }
        ...
        internal class EPLJoinMultiColumnRight : RegressionExecution
        {
            ...
            {
                var fields = new[]{"S0.Id", " S0.P00", " S0.P01", " S1.Id", " S1.P10", " S1.P11"};
                var epl = "@Name('s0') select S0.Id, S0.P00, S0.P01, S1.Id, S1.P10, S1.P11 from " + "SupportBean_S0#length(3) as S0 " + "right outer join " + "SupportBean_S1#length(5) as S1" + " on S0.P00 = S1.P10 and S1.P11 = S0.P01";
                env.CompileDeploy(epl).AddListener("s0");
                env.SendEventBean(new SupportBean_S0(1, "A_1", "B_1"));
                Assert.IsFalse(env.Listener("s0").IsInvoked);
                env.SendEventBean(new SupportBean_S1(2, "A_1", "B_1"));
        ...
        internal class EPLJoinMultiColumnRightCoercion : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                var epl = "@Name('s0') select S0.TheString, S1.TheString from " + "SupportBean(TheString like 'S0%')#keepall as S0 " + "right outer join " + "SupportBean(TheString like 'S1%')#keepall as S1" + " on S0.IntPrimitive = S1.DoublePrimitive and S1.IntPrimitive = S0.DoublePrimitive";
                env.CompileDeploy(epl).AddListener("s0");
        ...
        internal class EPLJoinRightOuterJoin : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", 202, "2"}, new object[]{null, null, 203, "3"}});
                // Send some more S0 events
                SendEvent(EVENTS_S0[3], env);
                theEvent = env.Listener("s0").AssertOneGetNewAndReset();
                CompareEvent(theEvent, 103, "3", 203, "3");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}});
                // Send some more S0 events
                SendEvent(EVENTS_S0[4], env);
                Assert.IsFalse(env.Listener("s0").IsInvoked);
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", 202, "2"}, new object[]{103, "3", 203, "3"}});
                ...
                CompareEvent(theEvent, 102, "2", 202, "2");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{null, null, 202, "2"}, new object[]{103, "3", 203, "3"}});
                // Some more S1 events
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{null, null, 202, "2"}, new object[]{103, "3", 203, "3"}, new object[]{null, null, 206, "6"}, new object[]{null, null, 207, "7"}, new object[]{null, null, 208, "8"}});
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{103, "3", 203, "3"}, new object[]{null, null, 206, "6"}, new object[]{null, null, 207, "7"}, new object[]{null, null, 208, "8"}, new object[]{null, null, 209, "9"}});
                env.UndeployAll();
            }
        }
        ...
        internal class EPLJoinLeftOuterJoin : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", 202, "2"}, new object[]{105, "5", 205, "5"}});
                // Let S1[2] go out of the window (lenght 5), expected old join event
                SendEvent(EVENTS_S1[7], env);
                SendEvent(EVENTS_S1[8], env);
                theEvent = env.Listener("s0").AssertOneGetOldAndReset();
                CompareEvent(theEvent, 102, "2", 202, "2");
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", null, null}, new object[]{105, "5", 205, "5"}});
                // S0[9] should generate an outer join event
                SendEvent(EVENTS_S0[9], env);
                theEvent = env.Listener("s0").AssertOneGetNewAndReset();
                CompareEvent(theEvent, 109, "9", null, null);
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{102, "2", null, null}, new object[]{109, "9", null, null}, new object[]{105, "5", 205, "5"}});
                ...
                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.GetEnumerator("s0"), FIELDS, new[]{new object[]{110, "10", null, null}, new object[]{109, "9", null, null}, new object[]{105, "5", 205, "5"}});
                env.UndeployAll();
            }
        }
