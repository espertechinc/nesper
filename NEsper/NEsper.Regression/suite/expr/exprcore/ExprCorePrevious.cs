        ...
        internal class ExprCorePreviousPerGroupTwoCriteria : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                EPAssertionUtil.AssertProps(
                    env.Listener("s0").AssertOneGetNewAndReset(),
                    fields,
                    new object[] {"IBM", "F1", null, 10d, 1L, SplitDoubles("10d")});

                env.SendEventBean(new SupportMarketDataBean("IBM", 11, 0L, "F1"));
                EPAssertionUtil.AssertProps(
                    env.Listener("s0").AssertOneGetNewAndReset(),
                    fields,
                    new object[] {"IBM", "F1", 10d, 10d, 2L, SplitDoubles("11d,10d")});

                env.SendEventBean(new SupportMarketDataBean("MSFT", 100, 0L, "F2"));
                EPAssertionUtil.AssertProps(
                    env.Listener("s0").AssertOneGetNewAndReset(),
                    fields,
                    new object[] {"MSFT", "F2", null, 100d, 1L, SplitDoubles("100d")});

                env.SendEventBean(new SupportMarketDataBean("IBM", 12, 0L, "F2"));
                EPAssertionUtil.AssertProps(
                    env.Listener("s0").AssertOneGetNewAndReset(),
                    fields,
                    new object[] {"IBM", "F2", null, 12d, 1L, SplitDoubles("12d")});

                env.SendEventBean(new SupportMarketDataBean("IBM", 13, 0L, "F1"));
                EPAssertionUtil.AssertProps(
                    env.Listener("s0").AssertOneGetNewAndReset(),
                    fields,
                    new object[] {"IBM", "F1", 11d, 11d, 2L, SplitDoubles("13d,11d")});
                ...
                EPAssertionUtil.AssertProps(
                    env.Listener("s0").AssertOneGetNewAndReset(),
                    fields,
                    new object[] {"IBM", "F2", 12d, 12d, 2L, SplitDoubles("17d,12d")});
