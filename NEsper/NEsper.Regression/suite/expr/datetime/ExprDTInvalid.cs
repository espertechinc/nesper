...
namespace com.espertech.esper.regressionlib.suite.expr.datetime
{
    public class ExprDTInvalid : RegressionExecution
    {
        public void Run(RegressionEnvironment env)
        {
            ...
            // invalid incompatible params
            epl = "select DtoDate.set('invalid') from SupportDateTime";
            TryInvalidCompile(
                env,
                epl,
                "Failed to validate select-clause expression 'DtoDate.set(\"invalid\")': Parameters mismatch for date-time method 'set', the method requires an expression providing a string-type calendar field name and an expression providing an integer-type value");

            // invalid lambda parameter
            epl = "select DtoDate.set(x -> true) from SupportDateTime";
            TryInvalidCompile(
                env,
                epl,
                "Failed to validate select-clause expression 'DtoDate.set()': Parameters mismatch for date-time method 'set', the method requires an expression providing a string-type calendar field name and an expression providing an integer-type value");

            // invalid no parameter
            epl = "select DtoDate.set() from SupportDateTime";
            TryInvalidCompile(
                env,
                epl,
                "Failed to validate select-clause expression 'DtoDate.set()': Parameters mismatch for date-time method 'set', the method requires an expression providing a string-type calendar field name and an expression providing an integer-type value");
            ...
            epl = "select DtoDate.set(1) from SupportDateTime";
            TryInvalidCompile(
                env,
                epl,
                "Failed to validate select-clause expression 'DtoDate.set(1)': Parameters mismatch for date-time method 'set', the method requires an expression providing a string-type calendar field name and an expression providing an integer-type value");

            // invalid wrong parameter
            epl = "select DtoDate.between('a', 'b') from SupportDateTime";
            TryInvalidCompile(
                env,
                epl,
            ...
            TryInvalidCompile(
                env,
                epl,
                "Failed to validate select-clause expression 'DtoDate.format(ParseCaseSensitive(...(114 chars)': Date-time enumeration method 'format' invalid format, expected string-format or DateFormat but received java.time.format.DateTimeFormatter");
            ...
            epl = "select DtoDate.format(null) from SupportDateTime";
            TryInvalidCompile(
                env,
                epl,
