...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestTablePlugInAggregation
    {
        ...
        public void TestPlugInAggMethod_CSVLast3Strings()
        {
            ...
            _epService.EPAdministrator.CreateEPL("into table varagg select csvWords(TheString) as csv from SupportBean#length(3)");
        ...
        public class ReferenceCountLookupAccessor : AggregationAccessor
        {
            ...
            public object GetValue(AggregationState state, EvaluateParams evaluateParams)
            {
                ...
                var lookupKey = _exprEvaluator.Evaluate(evaluateParams);
