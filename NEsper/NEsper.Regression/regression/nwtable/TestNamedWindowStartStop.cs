...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestNamedWindowStartStop 
    {
        ...
        public void TestAddRemoveType()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("create window MyWindowEventType#keepall (a int, b string)", "stmtOne");
            ...
            // add back the type
            stmt = _epService.EPAdministrator.CreateEPL("create window MyWindowEventType#keepall (c int, d string)", "stmtOne");
            Assert.IsTrue(configOps.IsEventTypeExists("MyWindowEventType"));
            ...
            // add back the type
            stmt.Dispose();
            stmt = _epService.EPAdministrator.CreateEPL("create window MyWindowEventType#keepall (f int)", "stmtOne");
            Assert.IsTrue(configOps.IsEventTypeExists("MyWindowEventType"));
