...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestNamedWindowOM 
    {
        ...
        public void TestCompile()
        {
            ...
            var stmtTextCreate = "create window MyWindow#keepall as select TheString as key, LongBoxed as value from " + typeof(SupportBean).FullName;
            ...
            Assert.AreEqual("create window MyWindow#keepall as select TheString as key, LongBoxed as value from " + Name.Of<SupportBean>() + "", modelCreate.ToEPL());
            ...
            Assert.AreEqual("on " + Name.Of<SupportMarketDataBean>() + " as s0 delete from MyWindow as s1 where s0.symbol=s1.key", modelDelete.ToEPL());
        ...
        {
            var expected = "create window MyWindow#keepall as (a1 string, a2 double, a3 int)";
    
            // create window object model
            var model = new EPStatementObjectModel();
            var clause = CreateWindowClause.Create("MyWindow").AddView("keepall");
