...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestTableSelectStarPublicTypeVisibility
    {
        ...
        private void RunAssertionSubquerySelectWEnumMethod(object[] rowValues)
        {
            ...
            // TODO: Reconcile the event property type with the actual return value.  Seems we
            // are returning the actual underlying collection type properly, but the wrapper we
            // are building is wrong.  Or... versa-vice.
