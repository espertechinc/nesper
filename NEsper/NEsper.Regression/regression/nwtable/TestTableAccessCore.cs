...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestTableAccessCore
    {
        ...
        private void RunAssertionIntegerIndexedPropertyLookAlike(bool soda)
        {
            ...
            var eplInto = "into table varagg select window(*) as myevents from SupportBean#length(3) group by IntPrimitive";
        ...
        public void TestExprSelectClauseRenderingUnnamedCol()
        {
            ...
            var expectedAggType = new object[][]{
                    ...
                    new object[]{"varagg[p00].theEvents.window(*).take(1)", typeof(ICollection<SupportBean>)},
            };
        ...
        private void RunAssertionSubqueryWithExpressionHasTableAccess()
        {
            ...
            _epService.EPAdministrator.CreateEPL("create expression getMyValue{o => (select MyTableTwo[o.p00].intPrimitive from SupportBean_S1#lastevent)}");
        ...
        private void RunAssertionMultiStmtContributingDifferentAggs(bool grouped)
        {
            ...
            var eplBindOne = "into table varagg select sum(id) as s0sum, count(*) as s0cnt, window(*) as s0win from SupportBean_S0#length(2) " +
            ...
            var eplBindTwo = "into table varagg select sum(id) as s1sum, count(*) as s1cnt, window(*) as s1win from SupportBean_S1#length(2) " +
        ...
        public void TestSubquery()
        {
            ...
            _epService.EPAdministrator.CreateEPL("select (select subquery_var_agg[p00].total from SupportBean_S0#lastevent) as c0 " +
