    ...
    public class TestNamedWindowTypes 
    {
        ...
        public void TestEventTypeColumnDef()
        {
            EnumHelper.ForEach<EventRepresentationChoice>(
                rep => RunAssertionEventTypeColumnDef(rep));
        }
        ...
        public void RunAssertionEventTypeColumnDef(EventRepresentationChoice eventRepresentationEnum)
        {
            ...
            var stmt = _epService.EPAdministrator.CreateEPL(eventRepresentationEnum.GetAnnotationText() + " create window SchemaWindow#lastevent() as (s1 SchemaOne)");
            ...
            {
                _epService.EPRuntime.SendEvent(new Object[] { 10, 11 }, "SchemaOne");
            }
            ...
            {
                var theEvent = new GenericRecord(SupportAvroUtil.GetAvroSchema(_epService, "SchemaOne").AsRecordSchema());
                theEvent.Put("col1", 10);
                theEvent.Put("col2", 11);
                _epService.EPRuntime.SendEventAvro(theEvent, "SchemaOne");
            }
            else
            {
                Assert.Fail();
        ...
        private void RunAssertionMapTranspose(EventRepresentationChoice eventRepresentationEnum)
        {
            ...
            // create window
            var stmtTextCreate = eventRepresentationEnum.GetAnnotationText() + " create window MyWindow#keepall as select one, two from OuterType";
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall as select TheString as a, LongPrimitive as b, LongBoxed as c from " + typeof(SupportBean).FullName;
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall as select TheString, LongPrimitive, LongBoxed from " + typeof(SupportBean).FullName;
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall as select '' as TheString, 0L as LongPrimitive, 0L as LongBoxed from MyMap";
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        public void TestCreateTableArray()
        {
            ...
            _epService.EPAdministrator.CreateEPL("create window SecurityEvent#time(30 sec) (ipAddress string, userId String, secData SecurityData, historySecData SecurityData[])");
    
            // create window
            var stmtTextCreate = "create window MyWindow#keepall (myvalue string[])";
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall (stringValOne varchar, stringValTwo string, intVal int, longVal long)";
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
            ...
            var text = "create window MyWindowThree#keepall as (a string, b integer, c integer)";
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall select * from " + typeof(SupportBean_A).FullName;
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall as select * from " + typeof(SupportBeanBase).FullName;
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall as " + typeof(SupportBean_A).FullName;
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
        ...
        {
            // create window
            var stmtTextCreate = "create window MyWindow#keepall as select *, id as myid from " + typeof(SupportBean_A).FullName;
            var stmtCreate = _epService.EPAdministrator.CreateEPL(stmtTextCreate);
            stmtCreate.AddListener(_listenerWindow);
