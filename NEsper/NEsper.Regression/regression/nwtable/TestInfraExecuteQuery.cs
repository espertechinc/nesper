...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestInfraExecuteQuery : IndexBackingTableInfo
    {
        ...
        private void RunAssertion3StreamInnerJoin(EventRepresentationChoice eventRepresentationEnum, bool isNamedWindow)
        {
        ...
        private void RunAssertionDeleteContextPartitioned(bool isNamedWindow)
        {
            ...
            _epService.EPAdministrator.CreateEPL("context MyCtxCat create window CtxInfraCat#keepall as SupportBean");
