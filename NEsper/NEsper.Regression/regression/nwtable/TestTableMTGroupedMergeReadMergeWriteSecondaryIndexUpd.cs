...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestTableMTGroupedMergeReadMergeWriteSecondaryIndexUpd 
    {
        ...
        public void SetUp()
        {
            ...
            config.EngineDefaults.Execution.IsFairlock = true;
        ...
        private void TryMT(int numSeconds) 
        {
            ...
            // populate
            var eplInto = "into table vartotal select count(*) as thecnt from LocalGroupEvent#length(100) group by topgroup, subgroup";
