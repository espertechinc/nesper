...
namespace com.espertech.esper.regression.nwtable
{
	...
	public class TestNamedWindowOnUpdateWMultiDispatch 
	{
        ...
        private void RunAssertion(bool useDefault, bool? preserve, ConfigurationEngineDefaults.ThreadingConfig.Locking? locking)
        {
	        ...
	        if (!useDefault) {
	            config.EngineDefaults.Threading.IsNamedWindowConsumerDispatchPreserveOrder = preserve.GetValueOrDefault();
		    ...
		    var stmtWin = epService.EPAdministrator.CreateEPL("create window S2Win#time(25 hour)#firstunique(company) as S2");
