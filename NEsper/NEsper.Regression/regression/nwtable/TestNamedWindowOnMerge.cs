...
namespace com.espertech.esper.regression.nwtable
{
    ...
    public class TestNamedWindowOnMerge
    {
        ...
        public void TestMergeTriggeredByAnotherWindow() {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('A') create window A#unique(id) as (id int)");
            _epService.EPAdministrator.CreateEPL("@Name('B') create window B#unique(id) as (id int)");
            ...
            _epService.EPAdministrator.CreateEPL("create window W1#lastevent as SupportBean");
            _epService.EPAdministrator.CreateEPL("insert into W1 select * from SupportBean");
            _epService.EPAdministrator.CreateEPL("create window W2#lastevent as SupportBean");
        ...
        {
            EnumHelper.ForEach<EventRepresentationChoice>(rep => RunAssertionDocExample(rep));
        }
    
        public void RunAssertionDocExample(EventRepresentationChoice eventRepresentationEnum) {
        ...
        public void TestTypeReference() {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('cnw') create window MyWindow#keepall as WindowSchema");
        ...
        public void TestPropertyEval() {
            ...
            _epService.EPAdministrator.CreateEPL("create window MyWindow#keepall as (c1 string, c2 string)");
        ...
        public void TestPropertyInsertBean() {
            EPStatement stmtWindow = _epService.EPAdministrator.CreateEPL("create window MergeWindow#unique(TheString) as SupportBean");
        ...
        {
            EnumHelper.ForEach<EventRepresentationChoice>(rep => RunAssertionSubselect(rep));
        }
        ...
        private void RunAssertionSubselect(EventRepresentationChoice eventRepresentationEnum) {
            ...
            EPStatement namedWindowStmt = _epService.EPAdministrator.CreateEPL(eventRepresentationEnum.GetAnnotationText() + " create window MyWindow#lastevent as MySchema");
