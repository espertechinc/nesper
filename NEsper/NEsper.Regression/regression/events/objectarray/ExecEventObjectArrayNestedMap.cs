    ...
    public class ExecEventObjectArrayNestedMap : RegressionExecution {
        ...
        public override void Run(EPServiceProvider epService) {
            ...
            try {
                ...
                Assert.AreEqual("Event type named 'MyMapNestedObjectArray' has not been defined or is not a Map event type, the name 'MyMapNestedObjectArray' refers to a Java.lang.Object(Array) event type", ex.Message);
            }
        }
    }
} // end of namespace
