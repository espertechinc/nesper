...
namespace com.espertech.esper.regression.events
{
    ...
    public class TestObjectArrayEventNested 
    {
        ...
        public void TestInvalid()
        {
            ...
            {
                Assert.AreEqual("Event type named 'ABC' has already been declared with differing column name or type information: Type by name 'ABC' in property 'p0' expected " + Name.Of<int>() + " but receives " + Name.Of<long>(), ex.Message);
            }
        ...
        public void TestObjectArrayNested()
        {
            ...
            var stmt = epService.EPAdministrator.CreateEPL("select * from TypeRoot#lastevent");
