...
namespace com.espertech.esper.regression.events.map
{
    public class ExecEventMapObjectArrayInterUse : RegressionExecution {
        ...
        private void RunAssertionObjectArrayWithMap(EPServiceProvider epService) {
            ...
            epService.EPRuntime.SendEvent(new Object[]{"E1", Collections.SingletonMap("im", "IM1"), new Map[]{Collections.SingletonMap("im", "IM2")}, Collections.SingletonMap("om", "OM1")}, "OAType");
            ...
            epService.EPAdministrator.CreateEPL("insert into MapType(im) select p0 from OAType").AddListener(listener);
        ...
        private void RunAssertionMapWithObjectArray(EPServiceProvider epService) {
            ...
            epService.EPAdministrator.CreateEPL("insert into OAType select 'a' as p0, 1 as p1 from MapType").AddListener(listener);
            epService.EPRuntime.SendEvent(data, "MapType");
