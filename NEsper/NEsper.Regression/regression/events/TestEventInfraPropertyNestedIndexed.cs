...
namespace com.espertech.esper.regression.events
{
    ...
    [TestFixture]
	public class TestEventInfraPropertyNestedIndexed
    {
	    private static readonly string BEAN_TYPENAME = TypeHelper.MaskTypeName(typeof(InfraNestedIndexPropTop).FullName);
	    ...
	    private static readonly FunctionSendEvent4Int FMAP = (epService, lvl1, lvl2, lvl3, lvl4) => {
            DataMap l4 = Collections.SingletonDataMap("lvl4", lvl4);
            DataMap l3 = SupportEventInfra.TwoEntryMap("l4", new DataMap[] { l4 }, "lvl3", lvl3);
            DataMap l2 = SupportEventInfra.TwoEntryMap("l3", new DataMap[] { l3 }, "lvl2", lvl2);
            DataMap l1 = SupportEventInfra.TwoEntryMap("l2", new DataMap[] { l2 }, "lvl1", lvl1);
	        DataMap top = Collections.SingletonDataMap("l1", new DataMap[] {l1});
        ...
        public void SetUp()
        {
	        ...
	        _epService.EPAdministrator.Configuration.AddEventType(BEAN_TYPENAME, typeof(InfraNestedIndexPropTop));
	        AddMapEventType();
	        AddOAEventType();
	        AddAvroEventType();
	    ...
	    public void TestNested() {
            RunAssertion(BEAN_TYPENAME, FBEAN, typeof(InfraNestedIndexedPropLvl1), typeof(InfraNestedIndexedPropLvl1).Name);
            RunAssertion(SupportEventInfra.MAP_TYPENAME, FMAP, typeof(DataMap), SupportEventInfra.MAP_TYPENAME + "_1");
            ...
            RunAssertion(SupportEventInfra.AVRO_TYPENAME, FAVRO, typeof(GenericRecord), SupportEventInfra.AVRO_TYPENAME + "_1");
	    }
	    ...
	    private void RunAssertionBeanNav(string typename, FunctionSendEvent4Int send) {
	        ...
	        EPAssertionUtil.AssertProps(@event, "l1[0].lvl1,l1[0].l2[0].lvl2,l1[0].l2[0].l3[0].lvl3,l1[0].l2[0].l3[0].l4[0].lvl4".SplitCsv(), new object[] {1, 2, 3, 4});
	    ...
	    private void RunAssertionTypeValidProp(string typeName, FunctionSendEvent4Int send, Type nestedClass, string fragmentTypeName) {
	        ...
	        var expectedType = new object[][] { new object[] {"l1", arrayType, fragmentTypeName, true}};
	    ...
	    private void RunAssertionTypeInvalidProp(string typeName) {
            ...
            foreach (var prop in Collections.List("l2[0]", "l1[0].l3", "l1[0].lvl1.lvl1", "l1[0].l2.l4", "l1[0].l2[0].xx", "l1[0].l2[0].l3[0].lvl5"))
            {
