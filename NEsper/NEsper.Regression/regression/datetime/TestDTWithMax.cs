...
namespace com.espertech.esper.regression.datetime
{
    ...
    public class TestDTWithMax
    {
        ...
        public void TestInput() {
            ...
            EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), fields, SupportDateTime.GetArrayCoerced(expectedTime, "util", "long"));
        }
        ...
        public void TestFields() {
            ...
            String[] expected = {
                    "2002-05-30 09:00:00.999",
                    "2002-05-30 09:00:59.000",
                    "2002-05-30 09:59:00.000",
                    "2002-05-30 23:00:00.000",
                    "2002-05-31 09:00:00.000",
