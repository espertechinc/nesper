...
{
    [TestFixture]
	public class TestDTMicrosecondResolution
    {
	    ...
	    public void TestEventTime() {
	        ...
	        RunAssertionEventTime(_epServices.Get(TimeUnit.MILLISECONDS), time, time);
	        RunAssertionEventTime(_epServices.Get(TimeUnit.MICROSECONDS), time*1000, time*1000);
	    }
	    ...
	    public void TestLongProperty() {
	        ...
	        RunAssertionLongProperty(
                _epServices.Get(TimeUnit.MILLISECONDS), time, new SupportDateTime(time, null, null), select, fields,
	            new object[] {dtxMod.TimeInMillis, dtxMod, 5, 5, 5, dtxTime.DateTime, dtxTime, time-1});
	        RunAssertionLongProperty(
                _epServices.Get(TimeUnit.MICROSECONDS), time*1000, new SupportDateTime(time * 1000 + 123, null, null), select, fields,
