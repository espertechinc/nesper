...
namespace com.espertech.esper.regression.context
{
    ...
    public class TestContextLifecycle
    {
        ...
        public void TestNWOtherContextOnExpr()
        {
            ...
            EPStatement stmtNamedWindow = _epService.EPAdministrator.CreateEPL("context NineToFive create window MyWindow#keepall as SupportBean");
            try {
        ...
        public void TestInvalid()
        {
            ...
            try {
                _epService.EPAdministrator.CreateEPL("context SegmentedByAString Update istream ABCStream set IntPrimitive = (select id from SupportBean_S0#lastevent) where IntPrimitive < 0");
                Assert.Fail();
            }
            catch (EPStatementException ex) {
