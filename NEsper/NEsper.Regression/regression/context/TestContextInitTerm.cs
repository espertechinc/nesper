...
namespace com.espertech.esper.regression.context
{
	...
	public class TestContextInitTerm
    {
        ...
        {
            _epService.EPRuntime.SendEvent(new CurrentTimeEvent(5));
	    ...
	    public void TestScheduleFilterResources() {
	        ...
	        var stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#time(30)");
	        ...
	        _epService.EPAdministrator.CreateEPL("context EverySupportBean select * from SupportBean_S0#time(2 min) sb0");
	        Assert.AreEqual(0, _spi.SchedulingService.ScheduleHandleCount);
	        ...
	        SendTimeEvent("2002-05-01T08:01:00.000");
	        Assert.AreEqual(0, _spi.SchedulingService.ScheduleHandleCount);
	        Assert.AreEqual(1, filterServiceSPI.FilterCountApprox);
	    ...
	    public void TestFilterInitiatedStraightEquals() {
	        ...
	        SendTimeEvent("2002-05-01T08:01:30.000");
	    ...
	    public void TestOutputSnapshotWhenTerminated() {
	        ...
	        SendTimeEvent("2002-05-01T08:01:10.000");
	        _epService.EPRuntime.SendEvent(new SupportBean("E2", 2));

	        SendTimeEvent("2002-05-01T08:01:59.999");
	        _epService.EPRuntime.SendEvent(new SupportBean("E3", 3));
	        Assert.IsFalse(_listener.GetAndClearIsInvoked());

	        // terminate
	        SendTimeEvent("2002-05-01T08:02:00.000");
	        EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), fields, new object[]{1 + 2 + 3});

	        SendTimeEvent("2002-05-01T08:02:01.000");
	        _epService.EPRuntime.SendEvent(new SupportBean("E4", 4));
	        _epService.EPRuntime.SendEvent(new SupportBean("E5", 5));
	        _epService.EPRuntime.SendEvent(new SupportBean("E6", 6));
	        Assert.IsFalse(_listener.GetAndClearIsInvoked());
	        ...
	        // terminate
	        SendTimeEvent("2002-05-01T08:03:00.000");
	        ...
	        SendTimeEvent("2002-05-01T08:04:00.000");
	        ...
	        // terminate
	        SendTimeEvent("2002-05-01T08:05:00.000");
	        Assert.IsFalse(_listener.IsInvoked);
	    }
	    ...
	    public void TestOutputWhenExprWhenTerminatedCondition() {
	        ...
	        SendTimeEvent("2002-05-01T08:02:10.000");
	        _epService.EPRuntime.SendEvent(new SupportBean("E4", 4));
	        Assert.IsFalse(_listener.IsInvoked);
	    ...
	    public void TestOutputOnlyWhenSetAndWhenTerminatedSet() {
	        ...
	        SendTimeEvent("2002-05-01T08:02:00.000"); // terminate, new context partition
	        Assert.IsTrue(_listener.GetAndClearIsInvoked());
	    ...
	    public void TestCrontab() {
	        ...
	        SendTimeEvent("2002-05-01T08:02:59.999");
	    ...
	    public void TestNonOverlappingSubqueryAndInvalid()
	    {
	        ...
	        SendTimeEvent("2002-05-01T10:00:00.000");
        ...
        private void RunAssertionNoTerminationConditionOverlapping(bool soda)
        {
            SupportModelHelper.CreateByCompileOrParse(_epService, soda, "create context SupportBeanInstanceCtx as initiated by SupportBean as sb");
            EPStatement stmt = SupportModelHelper.CreateByCompileOrParse(_epService, soda, "context SupportBeanInstanceCtx " +
            ...
            stmt.AddListener(_listener);
            String[] fields = "id,sbint,starttime,endtime".SplitCsv();

            _epService.EPRuntime.SendEvent(new SupportBean("P1", 100));
            _epService.EPRuntime.SendEvent(new SupportBean("P2", 200));

            _epService.EPRuntime.SendEvent(new SupportBean_S0(10, "P2"));
            EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), fields, new Object[] { 10, 200, 5L, null });

            _epService.EPRuntime.SendEvent(new SupportBean_S0(20, "P1"));
            EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), fields, new Object[] { 20, 100, 5L, null });

            _epService.EPAdministrator.DestroyAllStatements();
        }

        private void RunAssertionNoTerminationConditionNonoverlapping(bool soda)
        {

            SupportModelHelper.CreateByCompileOrParse(_epService, soda, "create context SupportBeanInstanceCtx as start SupportBean as sb");
            EPStatement stmt = SupportModelHelper.CreateByCompileOrParse(_epService, soda, "context SupportBeanInstanceCtx " +
                                                                                           "select id, context.sb.intPrimitive as sbint, context.startTime as starttime, context.endTime as endtime from SupportBean_S0(p00=context.sb.theString)");
            stmt.AddListener(_listener);
            String[] fields = "id,sbint,starttime,endtime".SplitCsv();
        ...
        private void RunAssertionNoTerminationConditionNested(bool soda)
        {

            SupportModelHelper.CreateByCompileOrParse(_epService, soda, "create context MyCtx as " +
            ...
            stmt.AddListener(_listener);
            String[] fields = "theString,p00,p10".SplitCsv();
            ...
            _epService.EPRuntime.SendEvent(new SupportBean("E1", 10));
            EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), fields, new Object[] { "E1", "A", "B" });
