...
namespace com.espertech.esper.regression.context
{
    ...
    public class TestContextSelectionAndFireAndForget
    {
        ...
        public void TestInvalid() {
            ...
            _epService.EPAdministrator.CreateEPL("context SegmentedSB create window WinSB#keepall as SupportBean");
            _epService.EPAdministrator.CreateEPL("context SegmentedS0 create window WinS0#keepall as SupportBean_S0");
            _epService.EPAdministrator.CreateEPL("create window WinS1#keepall as SupportBean_S1");
            ...
            _epService.EPAdministrator.CreateEPL("context PartitionedByString create window MyWindowOne#keepall as SupportBean");
    
            _epService.EPAdministrator.CreateEPL("create context PartitionedByP00 partition by p00 from SupportBean_S0");
            _epService.EPAdministrator.CreateEPL("context PartitionedByP00 create window MyWindowTwo#keepall as SupportBean_S0");
        ...
        public void TestContextNamedWindowQuery()
        {
            ...
            _epService.EPAdministrator.CreateEPL("create context PartitionedByString partition by TheString from SupportBean");
            _epService.EPAdministrator.CreateEPL("context PartitionedByString create window MyWindow#keepall as SupportBean");
        ...
        public void TestNestedContextNamedWindowQuery()
        {
            ...
            _epService.EPAdministrator.CreateEPL("context NestedContext create window MyWindow#keepall as SupportBean");
            _epService.EPAdministrator.CreateEPL("insert into MyWindow select * from SupportBean");
