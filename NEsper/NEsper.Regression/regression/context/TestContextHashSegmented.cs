...
namespace com.espertech.esper.regression.context
{
    ...
    public class TestContextHashSegmented
    {
        ...
        {
            RunAssertionScoringUseCase(EventRepresentationChoice.AVRO);

            EnumHelper.ForEach<EventRepresentationChoice>(RunAssertionScoringUseCase);
        }
        ...
        public void TestContextPartitionSelection()
        {
            ...
            var stmt = _epService.EPAdministrator.CreateEPL("context MyCtx select context.id as c0, TheString as c1, Sum(IntPrimitive) as c2 from SupportBean#keepall group by TheString");
        ...
        public void TestHashSegmentedFilter() {
            ...
            var eplStmt = "context " + ctx + " " + "select context.name as c0, IntPrimitive as c1 from SupportBean#lastevent";
