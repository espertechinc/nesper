...
namespace com.espertech.esper.regression.context
{
	...
	public class TestContextInitTermWithDistinct
    {
        ...
        {
            _epService.EPAdministrator.CreateEPL("create context MyContext initiated by Distinct(theString) SupportBean as sb terminated after 24 hours");
            ...
            Assert.AreEqual(2, _listener.GetAndResetLastNewData().Length);
        ...
        {
            _epService.EPAdministrator.CreateEPL("create context MyContext initiated by Distinct(theString, intBoxed, intPrimitive) SupportBean as sb terminated after 100 hours");
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("context MyContext select Count(*) as cnt from SupportBean");
            stmt.AddListener(_listener);
