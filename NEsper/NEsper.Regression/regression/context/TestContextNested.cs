	...
	public class TestContextNested
    {
	    ...
	    public void TestNestedContextWithFilterUDF()
        {
	        ...
	        epService.EPAdministrator.Configuration.AddPlugInSingleRowFunction(
	                "customEnabled", typeof(TestContextNested).FullName, "CustomMatch", FilterOptimizableEnum.ENABLED);
	        epService.EPAdministrator.Configuration.AddPlugInSingleRowFunction(
                    "customDisabled", typeof(TestContextNested).FullName, "CustomMatch", FilterOptimizableEnum.DISABLED);
	    ...
	    public void TestIterator() {
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:00.000");
	        ...
	        {
	            new object[] { DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:00.000"), "E1", 1 }
	        };
            ...
            {
                new object[] { DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:00.000"), "E1", 1 },
                new object[] { DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:00.000"), "E1", 2 }
            };
	        EPAssertionUtil.AssertPropsPerRow(stmtUser.GetEnumerator(), fields, expected);
            EPAssertionUtil.AssertPropsPerRow(stmtUser.GetSafeEnumerator(), fields, expected);
	    ...
	    public void TestCategoryOverPatternInitiated() {
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:10.000");
	    ...
	    public void Test4ContextsNested() {
	        ...
	        var spi = (EPServiceProviderSPI) epService;
	        var filterSPI = (FilterServiceSPI) spi.FilterService;
	        SendTimeEvent(epService, "2002-05-01T07:00:00.000");
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:05.000");
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:10.000"); // terminate S2_2 leaf
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:15.000"); // terminate S0_2/S1_2/S2_3 and S0_2/S1_3/S2_3 leafs
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:30.000"); // terminate S1_2 branch
	        ...
	        SendTimeEvent(epService, "2002-05-01T10:00:00.000"); // terminate all

	        epService.EPRuntime.SendEvent(new SupportBean("E14", 14));
	        Assert.IsFalse(listener.IsInvoked);

	        SendTimeEvent(epService, "2002-05-02T08:00:00.000"); // start next day
	    ...
	    public void TestTemporalOverlapOverPartition() {
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:10.000"); // expires first context
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:15.000"); // expires second context
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:25.000"); // expires second context
	    ...
	    public void Test3ContextsTermporalOverCategoryOverPartition() {
	        ...
	        RunAssertion3Contexts(epService, listener, fields, "2002-05-01T09:00:00.000");

	        stmtCtx.Dispose();
            stmtUser.Dispose();

	        SendTimeEvent(epService, "2002-05-02T08:00:00.000");
	        ...
	        RunAssertion3Contexts(epService, listener, fields, "2002-05-02T09:00:00.000");
	    ...
	    public void TestTemporalFixedOverHash() {
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:00:00.000"); // start context
	        ...
	        SendTimeEvent(epService, "2002-05-01T09:00:00.000"); // terminate

	        epService.EPRuntime.SendEvent(new SupportBean("E2", 0));
	        Assert.IsFalse(listener.IsInvoked);

	        SendTimeEvent(epService, "2002-05-02T08:00:00.000"); // start context
	    ...
	    public void TestCategoryOverTemporalOverlapping() {
	        ...
	        SendTimeEvent(epService, "2002-05-01T08:11:00.000"); // terminates all
	    ...
	    public void TestFixedTemporalOverPartitioned() {
	        ...
	        SendTimeEvent(epService, "2002-05-01T09:00:00.000");
	        Assert.AreEqual(0, filterSPI.FilterCountApprox);
	    ...
	    public void TestContextProps() {
	        ...
	        var filterSPI = (FilterServiceSPI) spi.FilterService;
	        SendTimeEvent(epService, "2002-05-01T08:30:00.000");
            ...
            EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fields, new object[]{"EightToNine", DateTimeParser.ParseDefaultMSec("2002-05-01T08:30:00.000"),
