...
namespace com.espertech.esper.regression.context
{
	...
	public class TestContextInitTermTemporalFixed
    {
	    ...
	    public void TestContextPartitionSelection() {
	        ...
	        var stmt = _epService.EPAdministrator.CreateEPL("context MyCtx select context.id as c0, context.s0.p00 as c1, theString as c2, sum(intPrimitive) as c3 from SupportBean#keepall group by theString");
	    ...
	    public void TestFilterStartedFilterEndedCorrelatedOutputSnapshot() {
	        ...
	        var statement = _epService.EPAdministrator.CreateEPL("context EveryNowAndThen select context.s0.id as c1, context.s1.id as c2, sum(intPrimitive) as c3 " +
	                "from SupportBean#keepall output snapshot when terminated", listener);
	    ...
	    public void TestFilterStartedPatternEndedCorrelated() {
	        ...
	        var statement = _epService.EPAdministrator.CreateEPL("context EveryNowAndThen select context.s0.p00 as c1, sum(intPrimitive) as c2 " +
                    "from SupportBean#keepall", listener);
	        statement.AddListener(listener);
	    ...
	    public void TestStartAfterEndAfter() {
	        ...
	        SendTimeEvent("2002-05-01T08:00:05.000");

	        _epService.EPRuntime.SendEvent(new SupportBean("E2", 2));
	        EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fields, new object[]{DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:05.000"), DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:15.000"), 2});

	        SendTimeEvent("2002-05-01T08:00:14.999");

	        _epService.EPRuntime.SendEvent(new SupportBean("E3", 3));
	        EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fieldsShort, new object[]{5});

	        SendTimeEvent("2002-05-01T08:00:15.000");

	        _epService.EPRuntime.SendEvent(new SupportBean("E4", 4));
	        Assert.IsFalse(listener.IsInvoked);

	        SendTimeEvent("2002-05-01T08:00:20.000");

	        _epService.EPRuntime.SendEvent(new SupportBean("E5", 5));
	        EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fields, new object[]{DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:20.000"), DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:30.000"), 5});

	        SendTimeEvent("2002-05-01T08:00:30.000");
	    ...
	    public void TestPatternStartedPatternEnded() {
	        ...
	        SendTimeEvent("2002-05-01T08:00:01.000"); // 1 second passes
	        ...
	        SendTimeEvent("2002-05-01T08:00:03.000");
	    ...
	    public void TestContextCreateDestroy() {
	        ...
	        SendTimeEvent("2002-05-01T08:00:00.999");
	        _epService.EPRuntime.SendEvent(new SupportBean());
	        Assert.IsTrue(listener.GetAndClearIsInvoked());

	        SendTimeEvent("2002-05-01T08:00:01.000");
	        _epService.EPRuntime.SendEvent(new SupportBean());
	        Assert.IsFalse(listener.GetAndClearIsInvoked());

	        long start = DateTimeParser.ParseDefaultMSec("2002-05-01T08:00:01.999");
	        for (var i = 0; i < 10; i++) {
	            SendTimeEvent(start);
	    ...
	    public void TestPrevPriorAndAggregation() {
	        ...
	        var statement = (EPStatementSPI) _epService.EPAdministrator.CreateEPL("context NineToFive " +
                    ...
                    "from SupportBean#keepall as sb", listener);
	        statement.AddListener(listener);
	    ...
	    public void TestPatternWithTime() {
	        ...
	        SendTimeEvent("2002-05-01T09:00:10.000");
	        ...
	        SendTimeEvent("2002-05-02T09:00:10.000");
	        Assert.IsTrue(listener.IsInvoked);
	    }
	    ...
	    public void TestSubselect() {
	        ...
	        var listener = new SupportUpdateListener();
            var statement = (EPStatementSPI)_epService.EPAdministrator.CreateEPL("context NineToFive select theString, (select p00 from SupportBean_S0#lastevent) as col from SupportBean", listener);
	        statement.AddListener(listener);
	        ...
	        // now gone
	        SendTimeEvent("2002-05-02T17:00:00.000");
	        Assert.AreEqual(0, filterSPI.FilterCountApprox);   // from the context
	    ...
	    public void TestNWSameContextOnExpr() {
	        ...
	        var listener = new SupportUpdateListener();
            var stmt = _epService.EPAdministrator.CreateEPL("context NineToFive create window MyWindow#keepall as SupportBean", listener);
	    ...
	    public void TestNWFireAndForget() {
	        ...
	        // no started yet
	        _epService.EPAdministrator.CreateEPL("context NineToFive create window MyWindow#keepall as SupportBean");
	        _epService.EPAdministrator.CreateEPL("context NineToFive insert into MyWindow select * from SupportBean");
	        ...
	        _epService.EPRuntime.SendEvent(new SupportBean());
	        _epService.EPRuntime.SendEvent(new SupportBean());
	        SendTimeEvent("2002-05-02T09:10:00.000");
	        TryNWQuery(2);
	    }
	    ...
	    public void TestStartTurnedOff() {
	        ...
	        SendTimeAndAssert("2002-05-01T08:59:30.000", false, 1);
	        SendTimeAndAssert("2002-05-01T08:59:59.999", false, 1);
	        SendTimeAndAssert("2002-05-01T09:00:00.000", true, 1);
	        ...
	        SendTimeAndAssert("2002-05-01T16:59:59.000", true, 2);
	        SendTimeAndAssert("2002-05-01T17:00:00.000", false, 2);
	        ...
	        SendTimeAndAssert("2002-05-02T08:59:59.999", false, 3);
	        SendTimeAndAssert("2002-05-02T09:00:00.000", true, 3);
	        SendTimeAndAssert("2002-05-02T16:59:59.000", true, 3);
	        SendTimeAndAssert("2002-05-02T17:00:00.000", false, 3);
	        ...
	        // test SODA
	        SendTimeEvent("2002-05-03T16:59:59.000");
	    ...
	    public void TestStartTurnedOn() {
	        ...
	        SendTimeEvent("2002-05-01T09:15:00.000");
	        ...
	        SendTimeAndAssert("2002-05-01T09:16:00.000", true, 1);
	        SendTimeAndAssert("2002-05-01T16:59:59.000", true, 1);
	        SendTimeAndAssert("2002-05-01T17:00:00.000", false, 1);

            var stmtTwoListener = new SupportUpdateListener();
            var stmtTwo = _epService.EPAdministrator.CreateEPL("@Name('B') context NineToFive select * from SupportBean", stmtTwoListener);
	        stmtTwo.AddListener(stmtTwoListener);

	        SendTimeAndAssert("2002-05-02T08:59:59.999", false, 2);
	        SendTimeAndAssert("2002-05-02T09:15:00.000", true, 2);
	        SendTimeAndAssert("2002-05-02T16:59:59.000", true, 2);
	        SendTimeAndAssert("2002-05-02T17:00:00.000", false, 2);
