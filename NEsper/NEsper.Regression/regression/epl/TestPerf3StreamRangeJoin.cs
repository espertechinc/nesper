...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestPerf3StreamRangeJoin 
    {
        ...
        {
            _epService.EPAdministrator.CreateEPL("create window ST0#keepall as SupportBean_ST0");
            _epService.EPAdministrator.CreateEPL("@Name('I1') insert into ST0 select * from SupportBean_ST0");
            _epService.EPAdministrator.CreateEPL("create window ST1#keepall as SupportBean_ST1");
        ...
        public void TestPerf3StreamUnidirectionalKeyAndRange() {
            _epService.EPAdministrator.CreateEPL("create window SBR#keepall as SupportBeanRange");
