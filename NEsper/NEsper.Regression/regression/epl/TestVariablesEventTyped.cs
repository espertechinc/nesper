    ...
    public class TestVariablesEventTyped 
    {
        ...
        public void TestInvalid()
        {
            ...
            try {
                ...
                Assert.AreEqual("Variable 'vars0' of declared event type 'TypeS0' underlying type '" + Name.Of<SupportBean_S0>() + "' cannot be assigned a value of type '" + Name.Of<SupportBean_S1>() + "'", ex.Message);
            }
            
            TryInvalid(_epService, "on TypeS0 arrival set vars1 = arrival",
                       "Error starting statement: Error in variable assignment: Variable 'vars1' of declared event type '" + Name.Of<SupportBean_S1>() + "' underlying type '" + Name.Of<SupportBean_S1>() + "' cannot be assigned a value of type '" + Name.Of<SupportBean_S0>() + "' [on TypeS0 arrival set vars1 = arrival]");
    
            TryInvalid(_epService, "on TypeS0 arrival set vars0 = 1",
                       "Error starting statement: Error in variable assignment: Variable 'vars0' of declared event type 'TypeS0' underlying type '" + Name.Of<SupportBean_S0>() + "' cannot be assigned a value of type '" + Name.Of<int>() + "' [on TypeS0 arrival set vars0 = 1]");
        ...
        public void TestConfig()
        {
            ...
            config.AddVariable<NonSerializable>("myNonSerializable", nonSerializable);
            ...
            Assert.AreSame(nonSerializable, _epService.EPRuntime.GetVariableValue("myNonSerializable"));
