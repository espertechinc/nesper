...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestSubselectMulticolumn
    {
        ...
        public void TestInvalid()
        {
            ...
            epl = "select * from S0(p00 in (select TheString, string from SupportBean#lastevent as sb))";
            TryInvalid(epl, "Failed to validate subquery number 1 querying SupportBean: Subquery multi-column select is not allowed in this context. [select * from S0(p00 in (select TheString, string from SupportBean#lastevent as sb))]");
        }
