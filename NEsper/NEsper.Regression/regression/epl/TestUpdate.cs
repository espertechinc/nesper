...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestUpdate 
    {
        ...
        public void SetUp()
        {
            ...
            config.EngineDefaults.Execution.IsPrioritized = true;
        ...
        public void TestInvalid()
        {
            ...
            TryInvalid("update istream SupportBeanStream set IntPrimitive=LongPrimitive",
                       "Error starting statement: Invalid assignment of column 'LongPrimitive' of type '" + Name.Of<long>(false) + "' to event property 'IntPrimitive' typed as '" + Name.Of<int>(false) + "', column and parameter types mismatch [update istream SupportBeanStream set IntPrimitive=LongPrimitive]");
        ...
        {
            EnumHelper.ForEach<EventRepresentationChoice>(RunAssertionFieldsWithPriority);
        }
    
        private void RunAssertionFieldsWithPriority(EventRepresentationChoice eventRepresentationEnum)
        {
        ...
        public void TestNamedWindow()
        {
            ...
            _epService.EPAdministrator.CreateEPL("create window AWindow#keepall select * from MyMapType").Events += listenerWindow.Update;
        ...
        public void TestSubquery()
        {
            ...
            var stmtUpd = _epService.EPAdministrator.CreateEPL("update istream ABCStream set TheString = (select s0 from MyMapTypeSelect#lastevent) where IntPrimitive in (select w0 from MyMapTypeWhere#keepall)");
            _epService.EPAdministrator.CreateEPL("select * from ABCStream").Events += _listener.Update;
            ...
            stmtUpd.Dispose();
            stmtUpd = _epService.EPAdministrator.CreateEPL("update istream ABCStream set IntPrimitive = (select s1 from MyMapTypeSelect#keepall where s0 = ABCStream.TheString)");
            ...
            stmtUpd.Dispose();
            _epService.EPAdministrator.CreateEPL("update istream ABCStream as mystream set IntPrimitive = (select s1 from MyMapTypeSelect#keepall where s0 = mystream.TheString)");
