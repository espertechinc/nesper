...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestUnidirectionalStreamJoin
    {
        ...
        public void TestInvalid()
        {
            ...
            TryInvalid(
                text,
                "Error starting statement: The unidirectional keyword requires that no views are declared onto the stream");
        }

        private void TryInvalid(String text, String message)
        {
            SupportMessageAssertUtil.TryInvalid(_epService, text, message);
        }
