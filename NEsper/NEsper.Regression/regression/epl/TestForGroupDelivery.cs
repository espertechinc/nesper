...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestForGroupDelivery
    {
        ...
        public void TestSubscriberOnly()
        {
            ...
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString,IntPrimitive from SupportBean#time_batch(1) for discrete_delivery");
            ...
            stmt.Dispose();
            subscriber.Reset();
            stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString,IntPrimitive from SupportBean#time_batch(1) for Grouped_delivery(IntPrimitive)");
            stmt.Subscriber = subscriber;
        ...
        {
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#time_batch(1) for discrete_delivery");
