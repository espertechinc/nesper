...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestInsertIntoTransposeStream
    {
        ...
        public void SetUp()
        {
            ...
            _epService.EPAdministrator.Configuration.AddPlugInSingleRowFunction("generateAvro", GetType().FullName, "LocalGenerateAvro");
        ...
        public void TestTransposeMapAndObjectArray() {
            ...
            EnumHelper.ForEach<EventRepresentationChoice>(RunTransposeMapAndObjectArray);
        }
        ...
        public void TestTransposeSingleColumnInsert()
        {
            ...
            {
                Assert.AreEqual("Error starting statement: Expression-returned value of type '" + Name.Of<SupportBean>() + "' cannot be converted to target event type 'SupportBeanNumeric' with underlying type '" + Name.Of<SupportBeanNumeric>() + "' [insert into SupportBeanNumeric select Transpose(customOne('O', 10)) from SupportBean]", ex.Message);
            }
            ...
            {
                Assert.AreEqual("Error starting statement: Expression-returned value of type '" + Name.Of<SupportBean>() + "' cannot be converted to target event type 'SomeOtherStream' with underlying type '" + Name.Of<IDictionary<string, object>>() + "' [insert into SomeOtherStream select Transpose(customOne('O', 10)) from SupportBean]", ex.Message);
            }
        ...
        public static GenericRecord LocalGenerateAvro(String theString, int intPrimitive)
        {
            var schema = SchemaBuilder.Record("name", 
                TypeBuilder.RequiredString("p0"),
                TypeBuilder.RequiredInt("p1"));
            var record = new GenericRecord(schema);
            record.Put("p0", theString);
