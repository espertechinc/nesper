...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestCreateExpression 
    {
        ...
        public void TestInvalid()
        {
            ...
            _epService.EPAdministrator.CreateEPL("create expression int jscript:abc(p1, p2) [return p1*p2]");
            TryInvalid("create expression int jscript:abc(a, a) [return p1*p2]",
        ...
        {
            _epService.EPAdministrator.CreateEPL("create expression int jscript:abc(p1, p2) [return p1*p2*10;]");
            _epService.EPAdministrator.CreateEPL("create expression int jscript:abc(p1) [return p1*10;]");
        ...
        public void TestExpressionUse()
        {
            ...
            var eplJoin = "select JoinMultiplication(sb,s0) from SupportBean#lastevent as sb, SupportBean_S0#lastevent as s0";
        ...
        public void TestExprAndScriptLifecycleAndFilter()
        {
            ...
            // script assertion
            RunAssertionLifecycleAndFilter("create expression bool jscript:MyFilter(IntPrimitive) [return IntPrimitive==1]",
