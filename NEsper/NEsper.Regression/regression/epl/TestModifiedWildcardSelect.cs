...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestModifiedWildcardSelect
    {
        ...
        public void TestSingleOM()
        {
            ...
            model.FromClause = FromClause.Create(FilterStream.Create(eventName).AddView(View.Create("length", Expressions.Constant(5))));
        ...
        public void TestMapEvents()
        {
            ...
            String text = "select *, string||string as concat from mapEvent#length(5)";
