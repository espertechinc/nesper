...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestInsertIntoPopulateEventTypeColumn 
    {
        ...
        private void RunAssertionFragmentSingeColNamedWindow()
        {
            ...
            _epService.EPAdministrator.CreateEPL("create window MyEventWindow#lastevent (e AEvent)");
            _epService.EPAdministrator.CreateEPL("insert into MyEventWindow select (select * from AEvent#lastevent) as e from SupportBean(TheString = 'A')");
        ...
        private void RunAssertionEnumerationSubquerySingleMayFilter(String typeType, bool filter)
        {
            ...
            _epService.EPAdministrator
                .CreateEPL(string.Format("insert into EventOne select (select * from SupportBean_S0#length(2) {0}) as sb " + "from SupportBean", (filter ? "where id >= 100" : "")))
