...
{
    public class ExecOuterJoinChain4Stream : RegressionExecution {
        ...
        public override void Run(EPServiceProvider epService) {
            ...
            RunAssertionLeftOuterJoin_root_s1(epService);
            RunAssertionLeftOuterJoin_root_s2(epService);
            RunAssertionLeftOuterJoin_root_s3(epService);
        }
        ...
        private void RunAssertionLeftOuterJoin_root_s1(EPServiceProvider epService) {
            /// <summary>
            /// Query:
            /// s0
            /// -> s1
        ...
        private void RunAssertionLeftOuterJoin_root_s2(EPServiceProvider epService) {
            /// <summary>
            /// Query:
            /// s0
            /// -> s1
        ...
        private void RunAssertionLeftOuterJoin_root_s3(EPServiceProvider epService) {
            /// <summary>
            /// Query:
            /// s0
            /// -> s1
