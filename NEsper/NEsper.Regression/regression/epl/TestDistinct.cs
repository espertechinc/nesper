...
namespace com.espertech.esper.regression.epl
{
	...
	public class TestDistinct 
	{
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean where TheString in (select distinct id from SupportBean_A#keepall)");
	        stmt.AddListener(_listener);
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var statementText = "select distinct * from SupportBean#keepall";
	    ...
	    public void TestBeanEventWildcardPlusCols()
	    {
	        ...
	        var statementText = "select distinct *, IntBoxed%5 as val1, IntBoxed as val2 from SupportBean_N#keepall";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementText);
	        stmt.AddListener(_listener);
	    ...
	    public void TestMapEventWildcard()
	    {
	        ...
	        var statementText = "select distinct * from MyMapType#keepall";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var statementText = "select distinct TheString, IntPrimitive from SupportBean#keepall";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var statementText = "select distinct TheString, IntPrimitive from SupportBean#keepall output snapshot every 3 events order by TheString asc";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var statementText = "select distinct TheString, IntPrimitive from SupportBean#length_batch(3)";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementText);
	        stmt.AddListener(_listener);
	        ...
	        var epl = "insert into ABC select distinct TheString as c1, first(IntPrimitive) as c2 from SupportBean#time_batch(1 second)";
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var statementText = "select distinct TheString, IntPrimitive from SupportBean#length_batch(3) a, SupportBean_A#keepall b where a.TheString = b.id";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        var fields = new string[] {"TheString", "IntPrimitive"};
	        var statementText = "insert into MyStream select distinct TheString, IntPrimitive from SupportBean#length_batch(3)";
