...
namespace com.espertech.esper.regression.client
{
    ...
    public class TestAudit
    {
        ...
        public void TestAuditNamedWindowAndInsertInto()
        {
            ...
            var stmtNW =
                _epService.EPAdministrator.CreateEPL(
                    "@Name('create') @Audit create window WinOne#keepall as SupportBean");
            var stmtInsertNW =
                _epService.EPAdministrator.CreateEPL(
        ...
        public void TestAuditSchedule()
        {
            ...
            var stmtSchedule =
                _epService.EPAdministrator.CreateEPL(
                    "@Name('ABC') @Audit('schedule') select irstream * from SupportBean#time(1 sec)");
        ...
        public void TestAuditView()
        {
            ...
            var stmtView = _epService.EPAdministrator.CreateEPL(
                    "@Name('ABC') @Audit('view') select IntPrimitive from SupportBean#lastevent");
            ...
            var stmtGroupedView = _epService.EPAdministrator.CreateEPL(
                    "@Audit Select * From SupportBean#groupwin(TheString)#length(2)");
            ...
            var stmtGroupedWIntersectionView = _epService.EPAdministrator.CreateEPL(
                "@Audit Select * From SupportBean#groupwin(TheString)#length(2)#unique(IntPrimitive)");
        ...
        public void TestAuditAggregation()
        {
            // with aggregation
            _epService.EPAdministrator.CreateEPL(
                "@Audit @Name ('create') create window MyWindow#keepall as SupportBean");
            var eplWithAgg =
