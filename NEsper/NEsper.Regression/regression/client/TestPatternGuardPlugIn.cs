        ...
        public void TestInvalid()
        {
            ...
            catch (EPStatementException ex)
            {
                SupportMessageAssertUtil.AssertMessage(
                    ex, "Failed to resolve pattern guard '" + Name.Of<SupportBean>() + " where namespace:name(10)': Error invoking pattern object factory constructor for object 'name', no invocation access for Activator.CreateInstance [select * from pattern [every " + Name.Of<SupportBean>() + " where namespace:name(10)]]");
            }
        }
    }
}
