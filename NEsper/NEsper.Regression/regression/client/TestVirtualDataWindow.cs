...
namespace com.espertech.esper.regression.client
{
    ...
    public class TestVirtualDataWindow
    {
        ...
        public void TestJoinAndLifecyle()
        {
            ...
            var stmtJoinAll = _epService.EPAdministrator.CreateEPL("select * from MyVDW vdw, SupportBean_ST0#lastevent st0");
            ...
            var stmtJoinSingle = _epService.EPAdministrator.CreateEPL("select * from MyVDW vdw, SupportBean_ST0#lastevent st0 where vdw.TheString = st0.id");
            ...
            var stmtJoinMulti = _epService.EPAdministrator.CreateEPL("select vdw.TheString from MyVDW vdw, SupportBeanRange#lastevent st0 " +
        ...
        public void TestInvalid()
        {
            ...
            TryInvalid(epl, "Error starting statement: Virtual data window factory class " + Name.Of<TestVirtualDataWindow.InvalidTypeForTest>() + " does not implement the interface " + Name.Of<VirtualDataWindowFactory>() + " [create window ABC.invalid:invalid() as SupportBean]");
