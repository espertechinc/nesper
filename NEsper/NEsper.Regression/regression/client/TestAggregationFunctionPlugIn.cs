...
namespace com.espertech.esper.regression.client
{
	...
	public class TestAggregationFunctionPlugIn 
	{
	    ...
	    {
	        var text = "select irstream concatstring(TheString) as val from " + typeof(SupportBean).FullName + "#length(2)";
	    ...
	    public void TestDistinctAndStarParam()
	    {
	        ...
	        try {
	            _epService.EPAdministrator.CreateEPL("select concatstring(*) as val from SupportBean#lastevent, SupportBean unidirectional");
	        }
	    ...
	    public void TestInvalidUse()
	    {
	        ...
	        SupportMessageAssertUtil.TryInvalid(
	            _epService, "select * from " + Name.Of<SupportBean>() + " group by xxx(1)",
	        ...
	        SupportMessageAssertUtil.TryInvalid(
	            _epService, "select * from " + Name.Of<SupportBean>() + " group by yyy(1)",
    ...
    [Test]
	    ...
	    {
	        SupportMessageAssertUtil.TryInvalid(_epService, "select xxx(theString) from " + Name.Of<SupportBean>(),
