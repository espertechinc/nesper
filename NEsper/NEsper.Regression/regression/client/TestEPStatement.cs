...
namespace com.espertech.esper.regression.client
{
    ...
    public class TestEPStatement
    {
        ...
        public void TestListenerWithReplay()
        {
            ...
            EPStatementSPI stmt = (EPStatementSPI) _epService.EPAdministrator.CreateEPL("select * from SupportBean#length(2)");
            ...
            // test 1 event
            stmt = (EPStatementSPI) _epService.EPAdministrator.CreateEPL("select * from SupportBean#length(2)");
            _epService.EPRuntime.SendEvent(new SupportBean("E1", 1));
            stmt.AddEventHandlerWithReplay(_listener.Update);
            Assert.AreEqual("E1", _listener.AssertOneGetNewAndReset().Get("TheString"));
            stmt.Dispose();
