    ...
    public class TestInvalidSyntaxMsg 
    {
        ...
        public void TestInvalidSyntax()
        {
            TryCompile("insert into 7event select * from " + typeof(SupportBeanReservedKeyword).FullName,
                       "Incorrect syntax near '7' at line 1 column 12 [insert into 7event select * from " + Name.Of<SupportBeanReservedKeyword>() + "]");
    
            TryCompile("select foo, create from " + typeof(SupportBeanReservedKeyword).FullName,
                       "Incorrect syntax near 'create' (a reserved keyword) at line 1 column 12, please check the select clause [select foo, create from " + Name.Of<SupportBeanReservedKeyword>() + "]");
