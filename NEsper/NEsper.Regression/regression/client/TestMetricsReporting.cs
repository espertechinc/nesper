...
namespace com.espertech.esper.regression.client
{
    ...
    public class TestMetricsReporting
    {
        ...
        public void TestNamedWindowAndViewShare()
        {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('A') create window MyWindow#lastevent as select * from SupportBean");
            ...
            String appModuleTwo =
                "@Name('W') create window SupportBeanWindow#keepall as SupportBean;" +
                "" +
        ...
        public void TestEnabledDisableRuntime()
        {
            ...
            statements[2] = _epService.EPAdministrator.CreateEPL("select * from SupportBean(IntPrimitive=1)#keepall where MyMetricFunctions.TakeCpuTime(LongPrimitive)");
            SendEvent("E1", 1, CpuGoalOneNano);
        ...
        public void TestManual()
        {
            ...
            statements[2] = epService.EPAdministrator.CreateEPL("select * from SupportBean(IntPrimitive=1)#keepall where MyMetricFunctions.TakeCPUTime(LongPrimitive)", "cpuStmtOne");
