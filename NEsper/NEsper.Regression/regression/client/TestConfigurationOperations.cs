...
namespace com.espertech.esper.regression.client
{
    ...
    public class TestConfigurationOperations
    {
        ...
        public void TestAutoNamePackageAmbigous() {
            ...
            _configOps.AddEventTypeAutoName(typeof(com.espertech.esper.regression.client.SupportAmbigousEventType).Namespace);
            _configOps.AddEventTypeAutoName(typeof(com.espertech.esper.supportregression.bean.SupportAmbigousEventType).Namespace);

            SupportMessageAssertUtil.TryInvalid(
                _epService, "select * from SupportAmbigousEventType",
                "Failed to resolve event type: Failed to resolve name 'SupportAmbigousEventType', the class was ambigously found both in namespace 'com.espertech.esper.regression.client' and in namespace 'com.espertech.esper.supportregression.bean'");

            SupportMessageAssertUtil.TryInvalid(_epService, "select * from XXXX",
