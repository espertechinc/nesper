        ...
        public void TestClientAppAnnotationSimple()
        {
            ...
            var stmtText =
                    "@MyAnnotationSimple " +
                            ...
                            "@MyAnnotationValueEnum(SupportEnum=" + Name.Of<SupportEnum>(false) + ".ENUM_VALUE_3) " +
            ...
            var stmtTextFormatted = "@MyAnnotationSimple" + NEWLINE +
                    ...
                    "@MyAnnotationValueEnum(SupportEnum=" + Name.Of<SupportEnum>(false) + ".ENUM_VALUE_3)" + NEWLINE +
