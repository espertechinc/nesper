...
namespace com.espertech.esper.regression.resultset
{
	...
	public class TestGroupByEventPerRow 
	{
	    ...
	    public void TestCriteriaByDotMethod() {
	        _epService.EPAdministrator.Configuration.AddEventType<SupportBean>();
            var epl = "select sb.get_LongPrimitive() as c0, sum(IntPrimitive) as c1 from SupportBean#length_batch(2) as sb group by sb.get_TheString()";
	    ...
	    public void TestWildcard() {
	        ...
	        var epl = "select *, min(IntPrimitive) as minval from SupportBean#length(2) group by TheString";
	    ...
	    public void TestInsertInto()
	    {
	        ...
	        var stmt = " select Symbol as Symbol, avg(Price) as average, sum(Volume) as sumation from " + eventType + "#length(3000)";
