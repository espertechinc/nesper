...
namespace com.espertech.esper.regression.resultset
{
	...
	public class TestAccessAggFirstLastWindow
    {
	    ...
	    public void TestNoParamChainedAndProperty() {
	        ...
	        EPStatement stmt = _epService.EPAdministrator.CreateEPL("select first().property as val0, first().MyMethod() as val1, window() as val2 from ChainEvent#lastevent");
	    ...
	    public void TestWindowedUnGrouped()
	    {
	        ...
	        EPStatement stmtWNull = _epService.EPAdministrator.CreateEPL("select window(intBoxed).take(10) from SupportBean#length(2)");
