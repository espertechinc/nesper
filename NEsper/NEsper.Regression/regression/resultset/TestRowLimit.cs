...
namespace com.espertech.esper.regression.resultset
{
	...
	public class TestRowLimit
    {
	    ...
	    public void TestLimitOneWithOrderOptimization() {
	        ...
	        var eplWithBatchSingleKey = "select TheString from SupportBean#length_batch(10) order by TheString limit 1";
	        RunAssertionLimitOneSingleKeySortBatch(eplWithBatchSingleKey);

	        var eplWithBatchMultiKey = "select TheString, IntPrimitive from SupportBean#length_batch(5) order by TheString asc, IntPrimitive desc limit 1";
		...
		{
	        var statementString = "select irstream * from SupportBean#length_batch(3) limit 1";
	    ...
	    public void TestLengthOffsetVariable()
		{
	        ...
	        var statementString = "select * from SupportBean#length(5) output every 5 events limit myoffset, myrows";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementString);
		...
		{
	        var statementString = "select * from SupportBean#length(5) output every 5 events order by IntPrimitive limit 2 offset 2";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementString);
		...
		{
	        var statementString = "select TheString, sum(IntPrimitive) as mysum from SupportBean#length(5) group by TheString order by sum(IntPrimitive) limit 2";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementString);
		...
		{
	        SendTimer(1000);
	        var statementString = "select TheString, sum(IntPrimitive) as mysum from SupportBean#length(5) output every 10 seconds order by TheString desc limit 2";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementString);
		...
		{
	        SendTimer(1000);
	        var statementString = "select TheString, sum(IntPrimitive) as mysum from SupportBean#length(5) group by TheString output snapshot every 10 seconds order by sum(IntPrimitive) desc limit 2";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementString);
		...
		{
	        SendTimer(1000);
	        var statementString = "select TheString, sum(IntPrimitive) as mysum from SupportBean#length(5) group by TheString output snapshot every 10 seconds order by sum(IntPrimitive) desc limit -1 offset 1";
	        var stmt = _epService.EPAdministrator.CreateEPL(statementString);
