...
namespace com.espertech.esper.regression.resultset
{
	...
	public class TestGroupByTimeBatch 
	{
	    ...
	    {
	        SendTimer(0);
	        var stmtText = "select irstream sum(Price) as sumPrice from MarketData#time_batch(1 sec)";
	    ...
	    {
	        SendTimer(0);
	        var stmtText = "select irstream sum(Price) as sumPrice from MarketData#time_batch(1 sec) as S0, SupportBean#keepall as S1 where S0.Symbol = S1.TheString";
	        var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        SendTimer(0);
	        var stmtText = "select irstream Symbol, sum(Price) as sumPrice from MarketData#time_batch(1 sec)";
	        var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        SendTimer(0);
	        var stmtText = "select irstream Symbol, sum(Price) as sumPrice from MarketData#time_batch(1 sec) as S0, SupportBean#keepall as S1 where S0.Symbol = S1.TheString";
	        var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        SendTimer(0);
	        var stmtText = "select irstream Symbol, sum(Price) as sumPrice from MarketData#time_batch(1 sec) group by Symbol order by Symbol asc";
	        var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	        stmt.AddListener(_listener);
	    ...
	    {
	        SendTimer(0);
	        var stmtText = "select irstream Symbol, sum(Price) as sumPrice, Volume from MarketData#time_batch(1 sec) group by Symbol";
	        var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	        stmt.AddListener(_listener);
