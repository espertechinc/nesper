    ...
    public class ExecOutputLimitCrontabWhen : RegressionExecution {
        ...
        private void RunAssertionInvalid(EPServiceProvider epService) {
            ...
            TryInvalid(epService, "select * from MarketData output when true then set myvardummy = 'b'",
                    "Error starting statement: Error in the output rate limiting clause: Variable 'myvardummy' of declared type java.lang.int? cannot be assigned a value of type java.lang.string [select * from MarketData output when true then set myvardummy = 'b']");
