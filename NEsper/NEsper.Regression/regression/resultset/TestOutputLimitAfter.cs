...
namespace com.espertech.esper.regression.resultset
{
	...
	public class TestOutputLimitAfter 
    {
        ...
        [Test]
	     ...
	     {
	         var stmtText = "select TheString from SupportBean#keepall output after 3 events";
	         var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	         stmt.AddListener(_listener);
	         ...
	         model = _epService.EPAdministrator.CompileEPL("select TheString from SupportBean#keepall output after 3 events");
	         Assert.AreEqual("select TheString from SupportBean#keepall output after 3 events ", model.ToEPL());
	     }
        ...
        [Test]
	     ...
	     {
	         SendTimer(0);
	         var stmtText = "select TheString from SupportBean#keepall output after 20 seconds ";
	         var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	         stmt.AddListener(_listener);
        ...
        [Test]
	     public void TestSnapshotVariable()
	     {
	         ...
	         SendTimer(0);
	         var stmtText = "select TheString from SupportBean#keepall output after 20 seconds snapshot when myvar=1";
	         var stmt = _epService.EPAdministrator.CreateEPL(stmtText);
	         stmt.AddListener(_listener);
