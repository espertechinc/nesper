...
namespace com.espertech.esper.regression.resultset
{
	...
	public class TestAggregateWithRollupGroupingFuncs 
	{
	    ...
	    public void TestFAFCarEventAndGroupingFunc() {
	        ...
	        _epService.EPAdministrator.CreateEPL("create window CarWindow#keepall as CarEvent");
	    ...
	    public void TestGroupingFuncExpressionUse() {
	        ...
	        var eplTwo = "select prev(1, name) as c0, prior(1, name) as c1, name as c2, sum(count) as c3 from CarEvent#keepall ce group by rollup(name)";
