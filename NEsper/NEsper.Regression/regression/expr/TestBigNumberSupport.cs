...
namespace com.espertech.esper.regression.expr
{
	...
	public class TestBigNumberSupport 
	{
	    ...
	    public void TestJoin()
	    {
	        ...
	        var stmt = _epService.EPAdministrator.CreateEPL("select BigInt,DecimalOne from SupportBeanNumeric#keepall, SupportBean#keepall " +
	    ...
	    public void TestCastAndUDF()
	    {
	        ...
	        var stmt = _epService.EPAdministrator.CreateEPL(
                    ...
                    " SupportStaticMethodLib.MyDecimalFunc(cast(3d, decimal)) as v2 " +
                    " from SupportBeanNumeric");
	        stmt.AddListener(_listener);
