...
namespace com.espertech.esper.regression.expr
{
    ...
    public class TestCaseExpr
    {
        ...
        public void TestCaseSyntax1Sum_OM()
        {
            ...
            model.FromClause = FromClause.Create(FilterStream.Create(typeof(SupportMarketDataBean).FullName).AddView("length",
                Expressions.
                    Constant(10)));
        ...
        public void TestCaseSyntax2WithNull_OM()
        {
            ...
            model.SelectClause = SelectClause.Create().Add(Expressions.CaseSwitch("IntPrimitive")
                ...
                "p1");
            model.FromClause = FromClause.Create(FilterStream.Create(typeof(SupportBean).FullName).AddView("length",
