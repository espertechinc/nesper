...
namespace com.espertech.esper.regression.expr
{
    ...
    public class TestCastExpr 
    {
        ...
        private void RunAssertionDynamicDateFormat(String date, String format)
        {
            ...
            EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), "c0,c1,c2,c3".Split(','), new Object[] {
                expectedDate,
                expectedDto,
                expectedDtx,
                theLong
        ...
        private void RunAssertionDatetimeInvalid() {
            ...
            SupportMessageAssertUtil.TryInvalid(_epService, "select cast(theString, int, dateformat:'yyyyMMdd') from SupportBean",
                    "Error starting statement: Failed to validate select-clause expression 'cast(theString,int,dateformat:\"yyyy...(41 chars)': Use of the 'dateformat' named parameter requires a target type of long or datetime [select cast(theString, int, dateformat:'yyyyMMdd') from SupportBean]");
        }
        ...
        private void RunAssertionDatetimeTypes(bool soda)
        {
            ...
            EPAssertionUtil.AssertProps(_listener.AssertOneGetNewAndReset(), "c0,c1,c2,c3,c4,c5,c6,c8".Split(','), new Object[] {
                    dateYYMMdd, 
                    dateYYMMdd,
                    dateYYMMddDto,
                    dateYYMMddDtx,
