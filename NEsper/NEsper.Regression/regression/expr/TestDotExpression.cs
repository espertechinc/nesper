...
namespace com.espertech.esper.regression.expr
{
	...
	public class TestDotExpression 
	{
	    ...
	    public void TestDotExpressionEnumValue()
        {
	        ...
	        _epService.EPAdministrator.CreateEPL("select com.espertech.esper.supportregression.events.SampleEnumInEventsPackage.A from SupportBean");
	    }
	    ...
	    public void TestInvalid()
        {
	        ...
	        TryInvalid("select abc.noSuchMethod() from SupportBean abc",
	                "Error starting statement: Failed to validate select-clause expression 'abc.noSuchMethod()': Failed to solve 'noSuchMethod' to either a date-time or enumeration method, an event property or a method on the event underlying object: Failed to resolve method 'noSuchMethod': Could not find enumeration method, date-time method or instance method named 'noSuchMethod' in class '" + Name.Of<SupportBean>() + "' taking no parameters [select abc.noSuchMethod() from SupportBean abc]");
	        TryInvalid("select abc.GetChildOne(\"abc\", 10).noSuchMethod() from SupportChainTop abc",
	                "Error starting statement: Failed to validate select-clause expression 'abc.GetChildOne(\"abc\",10).noSuchMethod()': Failed to solve 'GetChildOne' to either a date-time or enumeration method, an event property or a method on the event underlying object: Failed to resolve method 'noSuchMethod': Could not find enumeration method, date-time method or instance method named 'noSuchMethod' in class '" + Name.Of<SupportChainChildOne>() + "' taking no parameters [select abc.GetChildOne(\"abc\", 10).noSuchMethod() from SupportChainTop abc]");
	    }
	    ...
	    public void TestNestedPropertyInstanceExpr()
        {
	        ...
	        _epService.EPAdministrator.CreateEPL("create window NodeWindow#unique(id) as Node");
	        _epService.EPAdministrator.CreateEPL("insert into NodeWindow select * from Node");

	        _epService.EPAdministrator.CreateEPL("create window NodeDataWindow#unique(nodeId) as NodeData");
	        ...
	        _epService.EPAdministrator.CreateEPL("create window NodeWithDataWindow#unique(node.id) as NodeWithData");
