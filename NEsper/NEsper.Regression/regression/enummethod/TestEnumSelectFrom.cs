...
namespace com.espertech.esper.regression.enummethod
{
    ...
    public class TestEnumSelectFrom  {
        ...
        public void TestNew() {
            ...
            LambdaAssertionUtil.AssertTypes(stmtFragment.EventType, "val0".Split(','), new Type[] { typeof(ICollection<IDictionary<string, object>>) });
        ...
        public void TestSelect() {
            ...
            LambdaAssertionUtil.AssertTypes(stmtLambda.EventType, fields, new [] { typeof(ICollection<int>), typeof(ICollection<int>) });
