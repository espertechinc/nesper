...
namespace com.espertech.esper.regression.enummethod
{
    ...
    public class TestEnumDataSources
    {
        ...
        public void TestTableRow()
        {
            ...
            _epService.EPAdministrator.CreateEPL("into table MyTableUnkeyed select window(*) as theWindow from SupportBean#time(30)");
            _epService.EPRuntime.SendEvent(new SupportBean("E1", 10));
            _epService.EPRuntime.SendEvent(new SupportBean("E2", 20));
        ...
        public void TestPrevWindowSorted()
        {
            ...
            {
                typeof(SupportBean_ST0[]), typeof(ICollection<SupportBean_ST0>)
            });
            ...
            LambdaAssertionUtil.AssertTypes(stmtScalar.EventType, fields, new Type[]{typeof(ICollection<string>)});
        ...
        {
            // test named window
            _epService.EPAdministrator.CreateEPL("create window MyWindow#keepall as SupportBean_ST0");
            ...
            const string eplNamedWindow = "select MyWindow.allOf(x => x.p00 < 5) as allOfX from SupportBean#keepall";
            ...
            const string eplNamedWindowCorrelated = "select MyWindow(key0 = sb.TheString).allOf(x => x.p00 < 5) as allOfX from SupportBean#keepall sb";
        ...
        public void TestSubselect()
        {
            ...
            const string eplSubselect = "select (select * from SupportBean_ST0#keepall).allOf(x => x.p00 < 5) as allOfX from SupportBean#keepall";
            ...
            const string eplSubselectScalar = "select (select id from SupportBean_ST0#keepall).allOf(x => x  like '%B%') as allOfX from SupportBean#keepall";
            ...
            const string eplSubselectScalarCorrelated = "select (select key0 from SupportBean_ST0#keepall st0 where st0.id = sb.TheString).allOf(x => x  like '%hello%') as allOfX from SupportBean#keepall sb";
            ...
            var eplSubselectMultivalue = "select (select id, p00 from SupportBean_ST0#keepall).take(10) as c0 from SupportBean";
