...
namespace com.espertech.esper.regression.enummethod
{
    ...
    public class TestEnumWhere  {
        ...
        public void TestWhereEvents() {
            ...
            LambdaAssertionUtil.AssertTypes(stmt.EventType, "val0,val1".Split(','), new Type[] { typeof(ICollection<SupportBean_ST0>), typeof(ICollection<SupportBean_ST0>) });
        ...
        public void TestWhereString() {
            ...
            LambdaAssertionUtil.AssertTypes(stmtFragment.EventType, fields, new Type[] { typeof(ICollection<string>), typeof(ICollection<string>) });
            ...
            stmtFragment.Events += _listener.Update;
            LambdaAssertionUtil.AssertTypes(stmtFragment.EventType, "val0".Split(','), new Type[] { typeof(ICollection<bool?>) });
