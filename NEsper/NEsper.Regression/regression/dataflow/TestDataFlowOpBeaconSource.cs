...
namespace com.espertech.esper.regression.dataflow
{
    ...
    public class TestDataFlowOpBeaconSource
    {
...
#if NOTE_SEEMS_INCORRECT
            foreach (EventRepresentationChoice rep in new EventRepresentationChoice[] { EventRepresentationChoice.AVRO })
            {
                RunAssertionFields(rep, true);
                RunAssertionFields(rep, false);
            }
        ...
        private void RunAssertionFields(EventRepresentationChoice representationEnum, bool eventbean)
        {
