...
namespace com.espertech.esper.regression.dataflow
{
    ...
    public class ExecDataflowOpBeaconSource : RegressionExecution
    {
        ...
        private void RunAssertionFields(EPServiceProvider epService, EventRepresentationChoice representationEnum, bool eventbean) {
            ...
            epService.EPAdministrator.CreateEPL("create " + representationEnum.GetOutputTypeCreateSchemaName() + " schema MyEvent(p0 string, p1 long, p2 double)");
            var stmtGraph = epService.EPAdministrator.CreateEPL("create dataflow MyDataFlowOne " +
                    "" +
        ...
        private void RunAssertionBeaconNoType(EPServiceProvider epService)
        {
            ...
            epService.EPAdministrator.CreateEPL("create dataflow MyDataFlowTwo " +
                    "BeaconSource -> BeaconStream {" +
                    "  iterations: 5" +
                    "}" +
                    "DefaultSupportCaptureOp(BeaconStream) {}");
            ...
            epService.EPAdministrator.CreateEPL("create dataflow MyDataFlowThree " +
                    "BeaconSource -> BeaconStream {" +
                    "  iterations: 2," +
                    "  initialDelay: 0.5" +
                    "}" +
            ...
            epService.EPAdministrator.CreateEPL("create dataflow MyDataFlowFour " +
                    "BeaconSource -> BeaconStream {" +
                    "  interval: 0.5" +
                    "}" +
                    "DefaultSupportCaptureOp(BeaconStream) {}");
            ...
            epService.EPAdministrator.CreateEPL("create dataflow MyDataFlowFive " +
