...
namespace com.espertech.esper.regression.multithread
{
	...
	public class TestMTStmtNamedWindowUniqueTwoWJoinConsumer
    {
	    ...
	    private void RunAssertion(bool useDefault, bool? preserve, ConfigurationEngineDefaults.ThreadingConfig.Locking? locking)
        {
	        ...
	        {
	            if (preserve != null)
	                config.EngineDefaults.Threading.IsNamedWindowConsumerDispatchPreserveOrder = preserve.Value;
	            if (locking != null)
	                config.EngineDefaults.Threading.NamedWindowConsumerDispatchLocking = locking.Value;
	        }
