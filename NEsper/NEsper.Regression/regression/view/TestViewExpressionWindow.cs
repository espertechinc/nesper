...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestViewExpressionWindow 
    {
        ...
        public void TestNewestEventOldestEvent()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr(newest_event.IntPrimitive = oldest_event.IntPrimitive)");
        ...
        {
            String[] fields = {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#expr(current_count <= 2)");
            stmt.Events += _listener.Update;
        ...
        public void TestTimeWindow()
        {
            ...
            String[] fields = {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr(oldest_timestamp > newest_timestamp - 2000)");
            stmt.Events += _listener.Update;
        ...
        public void TestDynamicTimeWindow()
        {
            ...
            String[] fields = {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr(newest_timestamp - oldest_timestamp < SIZE)");
            stmt.Events += _listener.Update;
        ...
        public void TestUDFBuiltin()
        {
            ...
            _epService.EPAdministrator.CreateEPL("select * from SupportBean#expr(udf(TheString, view_reference, expired_count))");
        ...
        public void TestInvalid()
        {
            TryInvalid("select * from SupportBean#expr(1)",
                       "Error starting statement: Error attaching view to event stream: Invalid return value for expiry expression, expected a bool return value but received " + Name.Clean<int>() + " [select * from SupportBean#expr(1)]");
        ...
        public void TestNamedWindowDelete()
        {
            ...
            String[] fields = {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("create window NW#expr(true) as SupportBean");
            stmt.Events += _listener.Update;
        ...
        {
            String[] fields = {"val0"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select Prev(1, TheString) as val0 from SupportBean#expr(true)");
            stmt.Events += _listener.Update;
