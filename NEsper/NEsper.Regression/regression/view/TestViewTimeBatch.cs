...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestViewTimeBatch 
    {
        ...
        public void TestMonthScoped()
        {
            ...
            epAdministrator.CreateEPL("select * from SupportBean#time_batch(1 month)").Events += _listener.Update;
        ...
        public void TestStartEagerForceUpdate()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#time_batch(1, \"START_EAGER,FORCE_UPDATE\")");
