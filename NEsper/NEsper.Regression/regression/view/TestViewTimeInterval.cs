...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestViewTimeInterval
    {
        ...
        public void TestExternallyTimedMonthScoped()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select rstream * from SupportBean#ext_timed(LongPrimitive, 1 month)");
            stmt.Events += _testListener.Update;

            SendExtTimeEvent(DateTimeParser.ParseDefaultMSec("2002-02-01T09:00:00.000"), "E1");
            SendExtTimeEvent(DateTimeParser.ParseDefaultMSec("2002-03-01T09:00:00.000") - 1, "E2");
            Assert.IsFalse(_testListener.IsInvoked);

            SendExtTimeEvent(DateTimeParser.ParseDefaultMSec("2002-03-01T09:00:00.000"), "E3");
        ...
        public void TestExternallyTimedBatchMonthScoped()
        {
            _testListener = new SupportUpdateListener();
            _epService.EPAdministrator.Configuration.AddEventType<SupportBeanTimestamp>();
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#ext_timed_batch(LongPrimitive, 1 month)");
            stmt.Events += _testListener.Update;
