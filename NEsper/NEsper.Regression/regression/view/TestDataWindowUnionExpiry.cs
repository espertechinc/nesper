    ...
    public class TestDataWindowUnionExpiry
    {
        ...
        public void TestBatchWindow()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(
                "select irstream TheString from SupportBean#length_batch(3)#unique(IntPrimitive) retain-union");
        ...
        public void TestFirstUniqueAndFirstLength()
        {
            ...
            String epl =
                "select irstream TheString, IntPrimitive from SupportBean#firstlength(3)#firstunique(TheString) retain-union";
        ...
        public void TestFirstUniqueAndLengthOnDelete()
        {
            ...
            EPStatement nwstmt = _epService.EPAdministrator.CreateEPL(
                "create window MyWindow#firstunique(TheString)#firstlength(3) retain-union as SupportBean");
        ...
        public void TestInvalid()
        {
            ...
            TryInvalid(text,
                       "Error starting statement: Error attaching view to parent view: Groupwin view for this merge view could not be found among parent views [select TheString from SupportBean#groupwin(TheString)#unique(TheString)#merge(IntPrimitive) retain-union]");
            ...
            TryInvalid(text,
                       "Error starting statement: Multiple groupwin views are not allowed in conjuntion with multiple data windows [select TheString from SupportBean#groupwin(TheString)#groupwin(IntPrimitive)#unique(TheString)#unique(IntPrimitive) retain-union]");
        }
        ...
        public void TestUnionAndDerivedValue()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(
                "select * from SupportBean#unique(IntPrimitive)#unique(IntBoxed)#uni(DoublePrimitive) retain-union");
        ...
        public void TestUnionGroupBy()
        {
            ...
            String text =
                "select irstream TheString from SupportBean#groupwin(IntPrimitive)#length(2)#unique(IntBoxed) retain-union";
        ...
        public void TestUnionPattern()
        {
            ...
            String text =
                "select irstream a.p00||b.p10 as string from pattern [every a=SupportBean_S0 -> b=SupportBean_S1]#unique(a.id)#unique(b.id) retain-union";
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(text);
        ...
        public void TestUnionSorted()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(
                "select irstream TheString from SupportBean#sort(2, IntPrimitive)#sort(2, IntBoxed) retain-union");
        ...
        public void TestUnionSubselect()
        {
            ...
            String text =
                "select * from SupportBean_S0 where p00 in (select TheString from SupportBean#length(2)#unique(IntPrimitive) retain-union)";
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(text);
        ...
        public void TestUnionThreeUnique()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(
                "select irstream TheString from SupportBean#unique(IntPrimitive)#unique(IntBoxed)#unique(DoublePrimitive) retain-union");
        ...
        public void TestUnionTimeWin()
        {
            ...
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(
                "select irstream TheString from SupportBean#unique(IntPrimitive)#time(10 sec) retain-union");
        ...
        public void TestUnionTimeWinNamedWindow()
        {
            ...
            EPStatement stmtWindow = _epService.EPAdministrator.CreateEPL(
                "create window MyWindow#time(10 sec)#unique(IntPrimitive) retain-union as select * from SupportBean");
        ...
        public void TestUnionTimeWinSODA()
        {
            ...
            SendTimer(0);
            String stmtText =
                "select irstream TheString from SupportBean#time(10 seconds)#unique(IntPrimitive) retain-union";
        ...
        public void TestUnionTwoUnique()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(
                "select irstream TheString from SupportBean#unique(IntPrimitive)#unique(IntBoxed) retain-union");
        ...
        public void TestValidLegacy()
        {
            Init(true);
            _epService.EPAdministrator.CreateEPL(
                "select TheString from SupportBean#unique(TheString)#unique(IntPrimitive)");
        }
    }
}
