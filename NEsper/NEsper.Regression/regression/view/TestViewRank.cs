...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestViewRank
    {
        ...
        public void TestMultiexpression() {
            String[] fields = "TheString,IntPrimitive,LongPrimitive,DoublePrimitive".Split(',');
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#rank(TheString, IntPrimitive, 3, LongPrimitive, DoublePrimitive)");
            stmt.Events += _listener.Update;
        ...
        public void TestRemoveStream() {
            String[] fields = "TheString,IntPrimitive,LongPrimitive".Split(',');
            EPStatement stmtCreate = _epService.EPAdministrator.CreateEPL("create window MyWindow#rank(TheString, 3, IntPrimitive asc) as SupportBean");
        ...
        {
            String[] fields = "TheString,IntPrimitive,LongPrimitive".Split(',');
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#rank(TheString, 4, IntPrimitive desc)");
            stmt.Events += _listener.Update;
