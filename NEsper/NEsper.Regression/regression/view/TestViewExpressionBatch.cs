...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestViewExpressionBatch 
    {
        ...
        public void TestNewestEventOldestEvent()
        {
            ...
            EPStatement stmtOne = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr_batch(newest_event.IntPrimitive != oldest_event.IntPrimitive, false)");
            ...
            // try with include-trigger-event
            EPStatement stmtTwo = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr_batch(newest_event.IntPrimitive != oldest_event.IntPrimitive, true)");
        ...
        {
            String[] fields = new String[] {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr_batch(current_count >= 3, true)");
        ...
        public void TestTimeBatch()
        {
            ...
            String[] fields = new String[] {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr_batch(newest_timestamp - oldest_timestamp > 2000)");
            stmt.Events += _listener.Update;
        ...
        public void TestVariableBatch()
        {
            ...
            String[] fields = new String[] {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr_batch(POST)");
            stmt.Events += _listener.Update;
        ...
        public void TestDynamicTimeBatch()
        {
            ...
            String[] fields = new String[] {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#expr_batch(newest_timestamp - oldest_timestamp > SIZE)");
            stmt.Events += _listener.Update;
        ...
        public void TestUDFBuiltin()
        {
            ...
            _epService.EPAdministrator.CreateEPL("select * from SupportBean#expr_batch(udf(TheString, view_reference, expired_count))");
        ...
        public void TestInvalid() {
            TryInvalid("select * from SupportBean#expr_batch(1)",
                       "Error starting statement: Error attaching view to event stream: Invalid return value for expiry expression, expected a bool return value but received " + Name.Clean<int>() + " [select * from SupportBean#expr_batch(1)]");
        ...
        public void TestNamedWindowDelete() {
            ...
            String[] fields = new String[] {"TheString"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("create window NW#expr_batch(current_count > 3) as SupportBean");
            stmt.Events += _listener.Update;
        ...
        public void TestPrev() {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select Prev(1, TheString) as val0 from SupportBean#expr_batch(current_count > 2)");
            stmt.Events += _listener.Update;
        ...
        public void TestEventPropBatch() {
            String[] fields = new String[] {"val0"};
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString as val0 from SupportBean#expr_batch(IntPrimitive > 0)");
            stmt.Events += _listener.Update;
        ...
        public void TestAggregation() {
            ...
            // Test un-grouped
            EPStatement stmtUngrouped = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#expr_batch(sum(IntPrimitive) > 100)");
            ...
            // Test grouped
            EPStatement stmtGrouped = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#groupwin(IntPrimitive)#expr_batch(sum(LongPrimitive) > 100)");
            ...
            // Test on-delete
            _epService.EPAdministrator.Configuration.AddEventType<SupportBean_A>();
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("create window NW#expr_batch(sum(IntPrimitive) >= 10) as SupportBean");
            stmt.Events += _listener.Update;
            _epService.EPAdministrator.CreateEPL("insert into NW select * from SupportBean");
