...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestDataWindowIntersectExpiry 
    {
        ...
        public void TestUniqueAndFirstLength()
        {
            ...
            var epl = "select irstream TheString, IntPrimitive from SupportBean#firstlength(3)#unique(TheString)";
        ...
        public void TestFirstUniqueAndFirstLength()
        {
            ...
            var epl = "select irstream TheString, IntPrimitive from SupportBean#firstunique(TheString)#firstlength(3)";
            var stmt = _epService.EPAdministrator.CreateEPL(epl);
            stmt.Events += _listener.Update;
        ...
        public void TestFirstUniqueAndLengthOnDelete()
        {
            ...
            var nwstmt = _epService.EPAdministrator.CreateEPL("create window MyWindow#firstunique(TheString)#firstlength(3) as SupportBean");
        ...
        public void TestBatchWindow()
        {
            ...
            // test window
            stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#length_batch(3)#unique(IntPrimitive) order by TheString asc");
            stmt.Events += _listener.Update;
            RunAssertionUniqueAndBatch(stmt);
            stmt.Dispose();
    
            stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#unique(IntPrimitive)#length_batch(3) order by TheString asc");
            stmt.Events += _listener.Update;
            RunAssertionUniqueAndBatch(stmt);
            stmt.Dispose();
    
            // test aggregation with window
            stmt = _epService.EPAdministrator.CreateEPL("select Count(*) as c0, Sum(IntPrimitive) as c1 from SupportBean#unique(TheString)#length_batch(3)");
            stmt.Events += _listener.Update;
            RunAssertionUniqueBatchAggreation();
            stmt.Dispose();
    
            stmt = _epService.EPAdministrator.CreateEPL("select Count(*) as c0, Sum(IntPrimitive) as c1 from SupportBean#length_batch(3)#unique(TheString)");
            stmt.Events += _listener.Update;
            RunAssertionUniqueBatchAggreation();
            stmt.Dispose();
    
            // test first-unique
            stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#firstunique(TheString)#length_batch(3)");
            stmt.Events += _listener.Update;
            RunAssertionLengthBatchAndFirstUnique();
            stmt.Dispose();
    
            stmt = _epService.EPAdministrator.CreateEPL("select irstream * from SupportBean#length_batch(3)#firstunique(TheString)");
            stmt.Events += _listener.Update;
            RunAssertionLengthBatchAndFirstUnique();
            stmt.Dispose();
            ...
            stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#unique(TheString)#time_batch(1)");
            stmt.Events += _listener.Update;
            RunAssertionTimeBatchAndUnique(0);
            stmt.Dispose();
    
            _epService.EPRuntime.SendEvent(new CurrentTimeEvent(100000));
            stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#time_batch(1)#unique(TheString)");
            stmt.Events += _listener.Update;
            RunAssertionTimeBatchAndUnique(100000);
            stmt.Dispose();
    
            try {
                stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#time_batch(1)#length_batch(10)");
                Assert.Fail();
            }
        ...
        public void TestIntersectAndDerivedValue()
        {
            ...
            var stmt = _epService.EPAdministrator.CreateEPL("select * from SupportBean#unique(IntPrimitive)#unique(IntBoxed)#uni(DoublePrimitive)");
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectGroupBy()
        {
            ...
            var text = "select irstream TheString from SupportBean#groupwin(IntPrimitive)#length(2)#unique(IntBoxed) retain-intersection";
            ...
            // another combination
            _epService.EPAdministrator.CreateEPL("select * from SupportBean#groupwin(TheString)#time(.0083 sec)#firstevent()");
        }
        ...
        public void TestIntersectSubselect()
        {
            ...
            var text = "select * from SupportBean_S0 where p00 in (select TheString from SupportBean#length(2)#unique(IntPrimitive) retain-intersection)";
            var stmt = _epService.EPAdministrator.CreateEPL(text);
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectThreeUnique()
        {
            ...
            var stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#unique(IntPrimitive)#unique(IntBoxed)#unique(DoublePrimitive) retain-intersection");
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectPattern()
        {
            ...
            var text = "select irstream a.p00||b.p10 as TheString from pattern [every a=SupportBean_S0 -> b=SupportBean_S1]#unique(a.id)#unique(b.id) retain-intersection";
            var stmt = _epService.EPAdministrator.CreateEPL(text);
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectTwoUnique()
        {
            ...
            var stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#unique(IntPrimitive)#unique(IntBoxed) retain-intersection");
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectTimeWin()
        {
            ...
            SendTimer(0);
            var stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#unique(IntPrimitive)#time(10 sec) retain-intersection");
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectTimeWinReversed()
        {
            ...
            SendTimer(0);
            var stmt = _epService.EPAdministrator.CreateEPL("select irstream TheString from SupportBean#time(10 sec)#unique(IntPrimitive) retain-intersection");
            stmt.Events += _listener.Update;
        ...
        public void TestIntersectTimeWinSODA()
        {
            ...
            SendTimer(0);
            var stmtText = "select irstream TheString from SupportBean#time(10 seconds)#unique(IntPrimitive) retain-intersection";
        ...
        public void TestIntersectTimeWinNamedWindow()
        {
            ...
            SendTimer(0);
            var stmtWindow = _epService.EPAdministrator.CreateEPL("create window MyWindow#time(10 sec)#unique(IntPrimitive) retain-intersection as select * from SupportBean");
            _epService.EPAdministrator.CreateEPL("insert into MyWindow select * from SupportBean");
        ...
        public void TestIntersectTimeWinNamedWindowDelete()
        {
            ...
            SendTimer(0);
            var stmt = _epService.EPAdministrator.CreateEPL("create window MyWindow#time(10 sec)#unique(IntPrimitive) retain-intersection as select * from SupportBean");
            _epService.EPAdministrator.CreateEPL("insert into MyWindow select * from SupportBean");
            _epService.EPAdministrator.CreateEPL("on SupportBean_S0 delete from MyWindow where IntBoxed = id");
            stmt.Events += _listener.Update;
