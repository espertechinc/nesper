...
namespace com.espertech.esper.regression.rowrecog
{
	...
	public class TestRowPatternMaxStatesEngineWide : SupportBeanConstants
	{
	    ...
	    private void InitService(long max, bool preventStart)
        {
	        ...
	        config.EngineDefaults.ConditionHandling.AddClass<SupportConditionHandlerFactory>();
	        config.EngineDefaults.MatchRecognize.MaxStates = max;
	        config.EngineDefaults.MatchRecognize.IsMaxStatesPreventStart = preventStart;
