...
namespace com.espertech.esper.regression.pattern
{
	...
	public class TestTimerScheduleObserver : SupportBeanConstants
	{
	    ...
	    private void RunAssertionNameParameters() {
            var names = "GetThe1980Calendar,GetThe1980Date,GetThe1980Long,GetTheSeconds".SplitCsv();
            foreach (var name in names)
            {
                _epService.EPAdministrator.Configuration.AddPlugInSingleRowFunction(name, GetType().FullName, name);
            }
