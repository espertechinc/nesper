...
namespace com.espertech.esper.common.client.dataflow.core
{
	...
	public interface EPDataFlowService {
	    ...
	    EPDataFlowInstance Instantiate(string deploymentId, string dataflowName) ;
	    ...
	    /// <returns>data flow instance</returns>
	    /// <throws>EPDataFlowInstantiationException when the instantiation failed</throws>
	    EPDataFlowInstance Instantiate(string deploymentId, string dataFlowName, EPDataFlowInstantiationOptions options) ;
	    ...
	    void SaveConfiguration(string dataflowConfigName, string deploymentId, string dataFlowName, EPDataFlowInstantiationOptions options) ;
