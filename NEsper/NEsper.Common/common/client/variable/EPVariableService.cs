...
namespace com.espertech.esper.common.client.variable
{
	...
	public interface EPVariableService {
	    ...
	    object GetVariableValue(string deploymentId, string variableName) ;
	    ...
	    /// <returns>current variable value</returns>
	    /// <throws>VariableNotFoundException if a variable by that name has not been declared</throws>
	    IDictionary<DeploymentIdNamePair, IList<ContextPartitionVariableState>> GetVariableValue(ISet<DeploymentIdNamePair> variableNames, ContextPartitionSelector contextPartitionSelector) ;
	    ...
	    /// <para />Note that the thread setting the variable value queues the changes, i.e. it does not itself
	    ...
	    /// <throws>VariableValueException    if the value does not match variable type or cannot be safely coercedto the variable type
	    /// </throws>
	    /// <throws>VariableNotFoundException if the variable name has not been declared</throws>
	    void SetVariableValue(string deploymentId, string variableName, object variableValue) ;
	    ...
	    /// <throws>VariableValueException    if any value does not match variable type or cannot be safely coercedto the variable type
	    /// </throws>
	    /// <throws>VariableNotFoundException if any of the variable names has not been declared</throws>
	    ...
	    /// </throws>
	    /// <throws>VariableNotFoundException if any of the variable names has not been declared</throws>
	    void SetVariableValue(IDictionary<DeploymentIdNamePair, object> variableValues, int agentInstanceId) ;
	}
} // end of namespace