...
namespace com.espertech.esper.common.client.hook.vdw
{
	...
	public class VirtualDataWindowForgeContext {
	    ...
	    public VirtualDataWindowForgeContext(EventType eventType, object[] parameters, ExprNode[] parameterExpressions, string namedWindowName, ViewForgeEnv viewForgeEnv, object customConfiguration) {
