...
namespace com.espertech.esper.common.client.util
{
	...
	public class NameAccessModifier
	{
	    ...
	    NameAccessModifier(bool isAccessModifier, bool privateOrTransient) {
	    ...
	    public static bool Visible(NameAccessModifier objectVisibility, string objectModuleName, string importModuleName) {
	    ...
	    private static bool CompareModuleName(string objectModuleName, string importModuleName) {
