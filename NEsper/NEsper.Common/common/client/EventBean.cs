...
namespace com.espertech.esper.common.client
{
    ...
    public interface EventBean
    {
        ...
        ///     <para>
        ///         Returns null if the property value is null. Throws an exception if the expression is not valid against the
        ///         event type.
        ///     </para>
        ///     <para>
        ///         The method takes a property name or property expression as a parameter. Property expressions may include
        ///         indexed properties via the syntax "name[index]", mapped properties via the syntax "name('key')", nested
        ///         properties via the syntax "outer.inner" or combinations thereof.
        ///     </para>
        /// </summary>
        ...
        ///         determined by <seealso cref="FragmentEventType" />. Use <seealso cref="EventPropertyDescriptor" />
        ///         to obtain a list of properties that return fragments from an event type.
        ///     </para>
        ///     <para>
        ...
        ///     name or expression of the property whose value is to be presented as an EventBean or
        ///     array of EventBean
        /// </param>
        /// <returns>
