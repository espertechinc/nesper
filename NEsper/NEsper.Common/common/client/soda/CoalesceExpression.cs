...
namespace com.espertech.esper.common.client.soda
{
	...
	public class CoalesceExpression : ExpressionBase {
	    ...
	    public CoalesceExpression(string propertyOne, string propertyTwo, params string[] moreProperties) {
	    ...
	    public CoalesceExpression(Expression exprOne, Expression exprTwo, params Expression[] moreExpressions) {
	        AddChild(exprOne);
	        AddChild(exprTwo);
	    ...
	    public override void ToPrecedenceFreeEPL(TextWriter writer) {
	        ToPrecedenceFreeEPL("coalesce", this.Children, writer);
	    }
	}
} // end of namespace