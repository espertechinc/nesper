...
namespace com.espertech.esper.common.client.configuration.common
{
	...
	public class ConfigurationCommon
	{
	    ...
	    /// <para />Each entrie's value must be either a Class or a Map&lt;String,Object&gt; to
	    /// define nested maps.
	    /// </summary>
	    ...
	    /// <para />Each entry in the type map is the property name and the fully-qualified
	    /// Java class name or primitive type name.
	    /// </summary>
	    /// <param name="eventTypeName">is the name for the event type</param>
	    /// <param name="typeMap">maps the name of each property in the Map event to the type(fully qualified classname) of its value in Map event instances.
	    /// </param>
	    ...
	    /// <para />Each entry in the type mapping must contain the String property name as the key value,
	    ...
	    public void AddEventType(string eventTypeName, IDictionary<string, object> typeMap, ConfigurationCommonEventTypeMap mapConfig) {
	        nestableMapNames.Put(eventTypeName, new LinkedHashMap<string, object>(typeMap));
	    ...
	    /// <para />Each Map event type may have any number of supertypes, each supertype must also be of a Map-type event.
	    /// </summary>
	    ...
	    public void AddMapSuperType(string mapeventTypeName, string mapSupertypeName) {
	        ...
	        ISet<string> superTypes = current.SuperTypes;
	    ...
	    /// <para />Each Object array event type may have any number of supertypes, each supertype must also be of a Object-array-type event.
	    /// </summary>
	    ...
	    /// <throws>ConfigurationException if the name is already in used for a different type</throws>
	    public void AddEventType(string eventTypeName, string[] propertyNames, object[] propertyTypes, ConfigurationCommonEventTypeObjectArray optionalConfiguration) {
	        LinkedHashMap<string, object> propertyTypesMap = EventTypeUtility.ValidateObjectArrayDef(propertyNames, propertyTypes);
	        nestableObjectArrayNames.Put(eventTypeName, propertyTypesMap);
	    ...
	    /// <param name="beanEventTypeDesc">descriptor containing property and mapping information for Legacy Java type events</param>
	    ...
	    /// <para />To import a single class offering a static method, simply supply the fully-qualified name of the class
	    /// and use the syntax {@code classname.methodname(...)}
	    /// <para />To import a whole package and use the {@code classname.methodname(...)} syntax, specify a package
	    ...
	    /// <para />Use #addImport(String) to import a package.
	    /// </summary>
	    ...
	    /// <param name="methodInvocationConfig">is the cache configuration</param>
	    public void AddMethodRef(Type clazz, ConfigurationCommonMethodRef methodInvocationConfig) {
	        this.methodInvocationReferences.Put(clazz.Name, methodInvocationConfig);
	    }
	    ...
	    /// <para />Use the runtime API to set variable values or EPL statements to change variable values.
	    /// </summary>
	    /// <param name="variableName">name of the variable to add</param>
	    /// <param name="type">the type name of the variable, must be a primitive or boxed Java-builtin scalar type or "object" for anyvalue or an event type name or a class name or fully-qualified class name.  Append "[]" for array.
	    /// </param>
	    /// <param name="initializationValue">is the first assigned value.For static initialization the value can be string-typed and will be parsed.
	    /// For static initialization the initialization value, if provided, must implement <seealso cref="java.io.Serializable" /> or <seealso cref="java.io.Externalizable" />.
	    /// </param>
	    /// <throws>ConfigurationException if the type and initialization value don't match or the variable nameis already in use
	    /// </throws>
	    ...
	    /// <param name="type">the type name of the variable, must be a primitive or boxed Java-builtin scalar type or "object" for anyvalue or an event type name or a class name or fully-qualified class name.  Append "[]" for array.
	    /// </param>
	    /// <param name="initializationValue">is the first assigned valueThe value can be string-typed and will be parsed.
	    /// For static initialization the initialization value, if provided, must implement <seealso cref="java.io.Serializable" /> or <seealso cref="java.io.Externalizable" />.
	    /// </param>
	    /// <throws>ConfigurationException if the type and initialization value don't match or the variable nameis already in use
	    /// </throws>
	    ...
	    /// <param name="type">the type name of the variable, must be a primitive or boxed Java-builtin scalar type or "object" for anyvalue or an event type name or a class name or fully-qualified class name.  Append "[]" for array.
	    /// </param>
	    /// <param name="initializationValue">is the first assigned valueFor static initialization the value can be string-typed and will be parsed.
	    /// For static initialization the initialization value, if provided, must implement <seealso cref="java.io.Serializable" /> or <seealso cref="java.io.Externalizable" />.
	    /// </param>
	    ...
	    public IDictionary<string, object> TransientConfiguration {
	        ...
	        set => this.transientConfiguration = value;
	    }
	    ...
	    /// <para />This setting allows an application to place all it's events into one or more Java packages
	    ...
	    /// <para />For example, in the statement "select * from MyEvent" the runtime attempts to load class "javaPackageName.MyEvent"
	    /// and if successful, uses that class as the event type.
	    /// </summary>
	    /// <param name="packageName">is the fully-qualified Java package name of the Java package that event classes reside in</param>
	    ...
	    /// and if successful, uses that class as the event type.
	    /// </summary>
	    /// <value>set of Java package names to look for events types when encountering a new event type name</value>
