...
namespace com.espertech.esper.common.client.configuration.common
{
	...
	public class ConfigurationCommonParser {
	    ...
	    public static void DoConfigure(ConfigurationCommon common, XmlElement commonElement) {
	    ...
	    private static void HandleEventTypeAutoNames(ConfigurationCommon configuration, XmlElement element) {
	        var name = GetRequiredAttribute(element, "package-name");
	        configuration.AddEventTypeAutoName(name);
	    }

	    private static void HandleExecution(ConfigurationCommon common, XmlElement parentElement) {
	    ...
	    private static void HandleTimeSource(ConfigurationCommon common, XmlElement element) {
	            ...
	            switch (subElement.Name) {
	                case "time-unit":
	                    ...
	                    try {
	                        ...
	                        throw new ConfigurationException("Value attribute for time-unit element invalid: " + t.Message, t);
	                    }
	    ...
	    private static void HandleLogging(ConfigurationCommon common, XmlElement element) {
	        var nodeEnumerator = DOMElementEnumerator.Create(element.ChildNodes);
	        while (nodeEnumerator.MoveNext()) {
	            var subElement = nodeEnumerator.Current;
	            switch (subElement.Name) {
	    ...
	    private static void HandleVariantStream(ConfigurationCommon configuration, XmlElement element) {
	    ...
	    private static void HandleDatabaseRefs(ConfigurationCommon configuration, XmlElement element) {
	    ...
	    private static void HandleVariable(ConfigurationCommon configuration, XmlElement element) {
	    ...
	    private static void HandleEventTypes(ConfigurationCommon configuration, XmlElement element) {
	        var name = GetRequiredAttribute(element, "name");
	    ...
	    private static void HandleEventTypeDef(string name, string optionalClassName, ConfigurationCommon configuration, XmlNode parentNode) {
	    ...
	    private static void HandleXMLDOM(string name, ConfigurationCommon configuration, XmlElement xmldomElement) {
	                ...
	                case "xpath-property":
	                    ...
	                    switch (propertyTypeInvariant) {
	                        ...
	                        case "NODESET":
	                            ...
	                            break;
	                        default:
	                            throw new ArgumentException("Invalid xpath property type for property '" +
	    ...
	    private static void HandleAvro(string name, ConfigurationCommon configuration, XmlElement element) {
	    ...
	    private static void HandleLegacy(string name, string className, ConfigurationCommon configuration, XmlElement xmldomElement) {
	    ...
	    private static void HandleMap(string name, ConfigurationCommon configuration, XmlElement eventTypeElement) {
	    ...
	    private static void HandleObjectArray(string name, ConfigurationCommon configuration, XmlElement eventTypeElement) {
	    ...
	    private static void HandleAutoImports(ConfigurationCommon configuration, XmlElement element) {
	        var name = GetRequiredAttribute(element, "import-name");
	        configuration.AddImport(name);
	    }

	    private static void HandleAutoImportAnnotations(ConfigurationCommon configuration, XmlElement element) {
	        var name = GetRequiredAttribute(element, "import-name");
	        configuration.AddAnnotationImport(name);
	    }

	    private static void HandleMethodReference(ConfigurationCommon configuration, XmlElement element) {
	    ...
	    private static void HandleEventMeta(ConfigurationCommon common, XmlElement parentElement) {
