...
namespace com.espertech.esper.common.@internal.schedule
{
    ...
    public static class ScheduleComputeHelper
    {
            ...
            long remainder)
        {
            ...
            return timeAbacus.DateTimeGet(dateTimeEx, remainder);
        }
        ...
        /// <returns></returns>
        private static bool CheckDayValidInMonth(
            TimeZoneInfo timeZone,
            int day,
            int month,
            int year)
        ...
        internal class DateCheckerLastSpecificDayWeek : DateChecker
        {
            ...
            internal DateCheckerLastSpecificDayWeek(
                int day,
                int? month)
            {
                if (day < 0 || day > 7) {
        ...
        internal class DateCheckerLastDayOfMonth : DateChecker
        {
            ...
            internal DateCheckerLastDayOfMonth(
                int? day,
                int? month)
            {
                if (day != null) {
        ...
        internal class DateCheckerLastWeekday : DateChecker
        {
            ...
            internal DateCheckerLastWeekday(
                int? day,
                int? month)
            {
                if (day != null) {
        ...
        internal class DateCheckerMonthWeekday : DateChecker
        {
            ...
            internal DateCheckerMonthWeekday(
                int? day,
                int? month)
            {
                if (day != null) {
            ...
            private static int ComputeNearestWeekdayDay(
                int day,
                DateTimeEx work)
            {
