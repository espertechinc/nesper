...
namespace com.espertech.esper.common.@internal.epl.output.view
{
	...
	public class OutputProcessViewConditionFactory : OutputProcessViewDirectDistinctOrAfterFactory {
	    ...
	    public OutputProcessViewConditionFactory(OutputProcessViewConditionSpec spec) : base(spec.PostProcessFactory, spec.IsDistinct, spec.AfterTimePeriod, spec.AfterConditionNumberOfEvents, spec.ResultEventType)
	        {
