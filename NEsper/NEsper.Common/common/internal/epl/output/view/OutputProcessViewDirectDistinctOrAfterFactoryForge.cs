...
namespace com.espertech.esper.common.@internal.epl.output.view
{
	...
	public class OutputProcessViewDirectDistinctOrAfterFactoryForge : OutputProcessViewFactoryForge {
	    ...
	    public OutputProcessViewDirectDistinctOrAfterFactoryForge(OutputStrategyPostProcessForge outputStrategyPostProcessForge, bool isDistinct, ExprTimePeriod afterTimePeriod, int? afterConditionNumberOfEvents, EventType resultEventType) {
	    ...
	    public void ProvideCodegen(CodegenMethod method, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
	        method.Block.MethodReturn(
	                NewInstance(typeof(OutputProcessViewDirectDistinctOrAfterFactory),
