...
namespace com.espertech.esper.common.@internal.epl.output.polled
{
	...
	public sealed class OutputConditionPolledCountFactory : OutputConditionPolledFactory {
	    ...
	    private VariableReader GetVariableReader(AgentInstanceContext agentInstanceContext) {
	        ...
	        return agentInstanceContext.VariableManagementService.GetReader(variable.DeploymentId, variable.MetaData.VariableName, agentInstanceContext.AgentInstanceId);
	    }
	}
} // end of namespace