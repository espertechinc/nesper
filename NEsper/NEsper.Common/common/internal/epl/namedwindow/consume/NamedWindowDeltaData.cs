...
namespace com.espertech.esper.common.@internal.epl.namedwindow.consume
{
    ...
    public class NamedWindowDeltaData
    {
        ...
        /// </summary>
        /// <param name="deltaOne">is the insert and remove stream events of a first result</param>
        /// <param name="deltaTwo">is the insert and remove stream events of a second result</param>
        public NamedWindowDeltaData(
