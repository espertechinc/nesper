...
namespace com.espertech.esper.common.@internal.epl.subselect
{
    public class SubSelectHelperForgePlanner
    {
        ...
        public static IDictionary<ExprSubselectNode, SubSelectFactoryForge> PlanSubSelect(
        ...
        private static SubSelectFactoryForge PlanSubSelectInternal(
            ...
            StatementCompileTimeServices services)
        {
            ...
            if (filterStreamSpec is FilterStreamSpecCompiled) {
                subselecteventTypeName = ((FilterStreamSpecCompiled) filterStreamSpec).FilterSpecCompiled
            ...
            if (subselectSpec.Raw.WhereClause != null) {
                IList<ExprAggregateNode> aggExprNodesFilter = new List<ExprAggregateNode>();
        ...
        private static Pair<EventTableFactoryFactoryForge, SubordTableLookupStrategyFactoryForge>
                ...
                StatementCompileTimeServices services)
        {
            ...
            if (queryPlanLogging && (QUERY_PLAN_LOG.IsInfoEnabled || hook != null)) {
                ...
                if (hook != null) {
                    var strategyName = result.Second.GetType().Name;
                    hook.Subquery(
