	...
	public class TimerScheduleSpecComputeFromExprForge : TimerScheduleSpecComputeForge {
	    ...
	    public CodegenExpression Make(CodegenMethodScope parent, CodegenClassScope classScope) {
	        ...
	        method.Block
	                ...
	                .ExprDotMethod(@Ref("compute"), "setDate", dateNode == null ? ConstantNull() : ExprNodeUtilityCodegen.CodegenEvaluator(dateNode.Forge, method, this.GetType(), classScope))
	                .ExprDotMethod(@Ref("compute"), "setRepetitions", repetitionsNode == null ? ConstantNull() : ExprNodeUtilityCodegen.CodegenEvaluator(repetitionsNode.Forge, method, this.GetType(), classScope));
	        if (periodNode != null) {
