...
namespace com.espertech.esper.common.@internal.epl.pattern.observer
{
	public class TimerScheduleSpecComputeISOStringForge : TimerScheduleSpecComputeForge {
	    ...
	    public CodegenExpression Make(CodegenMethodScope parent, CodegenClassScope classScope) {
	        ...
	        method.Block.MethodReturn(NewInstance(typeof(TimerScheduleSpecComputeISOString), ExprNodeUtilityCodegen.CodegenEvaluator(parameter.Forge, method, this.GetType(), classScope)));
