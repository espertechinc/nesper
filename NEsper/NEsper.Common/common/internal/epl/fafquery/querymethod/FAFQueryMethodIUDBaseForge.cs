...
namespace com.espertech.esper.common.@internal.epl.fafquery.querymethod
{
	...
	public abstract class FAFQueryMethodIUDBaseForge : FAFQueryMethodForge {
	    ...
	    protected abstract void InitExec(string aliasName, StatementSpecCompiled spec, StatementRawInfo statementRawInfo, StatementCompileTimeServices services) ;
	    ...
	    public FAFQueryMethodIUDBaseForge(StatementSpecCompiled spec, Compilable compilable, StatementRawInfo statementRawInfo, StatementCompileTimeServices services) {
	        ...
	        StreamTypeServiceImpl typeService = new StreamTypeServiceImpl(new EventType[]{eventType}, new string[]{aliasName}, new bool[]{true}, true, false);
	    ...
	    public void MakeMethod(CodegenMethod method, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
	        ...
	        method.Block
	                ...
	                .ExprDotMethod(queryMethod, "setAnnotations", annotations == null ? ConstantNull() : LocalMethod(MakeAnnotations(typeof(Attribute[]), annotations, method, classScope)))
	                ...
	                .ExprDotMethod(queryMethod, "setInternalEventRouteDest", ExprDotMethod(symbols.GetAddInitSvc(method), EPStatementInitServicesConstants.GETINTERNALEVENTROUTEDEST))
	                .ExprDotMethod(queryMethod, "setTableAccesses", ExprTableEvalStrategyUtil.CodegenInitMap(tableAccessForges, this.GetType(), method, symbols, classScope))
