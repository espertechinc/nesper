    ...
    public class FireAndForgetInstanceTable : FireAndForgetInstance
    {
        ...
        public override EventBean[] ProcessInsert(FAFQueryMethodIUDInsertInto insert)
        {
            TableEvalLockUtil.ObtainLockUnless(
                instance.TableLevelRWLock.WriteLock, instance.AgentInstanceContext.TableExprEvaluatorContext);
        ...
        public override EventBean[] ProcessDelete(FAFQueryMethodIUDDelete delete)
        {
            ...
            var found = SnapshotAndApplyFilter(
                delete.QueryGraph, delete.Annotations, delete.OptionalWhereClause, instance.AgentInstanceContext);
        ...
        public override EventBean[] ProcessUpdate(FAFQueryMethodIUDUpdate update)
        {
            ...
            var events = SnapshotAndApplyFilter(
                update.QueryGraph, update.Annotations, update.OptionalWhereClause, instance.AgentInstanceContext);
            ...
            if (events == null) {
                update.TableUpdateStrategy.UpdateTable(
                    instance.EventCollection, instance, eventsPerStream, instance.AgentInstanceContext);
            }
            else {
                update.TableUpdateStrategy.UpdateTable(
                    events, instance, eventsPerStream, instance.AgentInstanceContext);
            }
            ...
            AgentInstanceContext agentInstanceContext)
        {
            ...
            return FireAndForgetQueryExec.Snapshot(
                queryGraph, annotations, null,
                instance.IndexRepository, instance.Table.Name,
            ...
            AgentInstanceContext agentInstanceContext)
        {
            ...
            if (filterExpr != null) {
                ExprNodeUtilityEvaluate.ApplyFilterExpressionIterable(
                    sourceCollection.GetEnumerator(), filterExpr, agentInstanceContext, deque);
            }
            else {
                while (it.MoveNext()) {
