...
namespace com.espertech.esper.common.@internal.epl.index.advanced.index.quadtree
{
    ...
    {
        public AdvancedIndexConfigContextPartition ValidateConfigureFilterIndex(string indexName, string indexTypeName, ExprNode[] parameters, ExprValidationContext validationContext)
        {
        ...
        protected internal static void ValidateParameters(string indexTypeName, ExprNode[] parameters)
        {
        ...
        protected internal static AdvancedIndexConfigContextPartition ConfigureQuadTree(string indexName, ExprEvaluator[] parameters, ExprEvaluatorContext exprEvaluatorContext)
        {
