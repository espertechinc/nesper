...
namespace com.espertech.esper.common.@internal.epl.index.compile
{
	public class IndexCollectorCompileTime : IndexCollector {
	    ...
	    public IndexCollectorCompileTime(IDictionary<string, NamedWindowMetaData> moduleNamedWindows, IDictionary<string, TableMetaData> moduleTables, PathRegistry<string, NamedWindowMetaData> pathNamedWindows, PathRegistry<string, TableMetaData> pathTables) {
	    ...
	    public void RegisterIndex(IndexCompileTimeKey indexKey, IndexDetail indexDetail) {
	        ...
	        try {
	            indexMetadata.AddIndexExplicit(false, indexDetail.IndexMultiKey, indexKey.IndexName, indexKey.InfraModuleName, indexDetail.QueryPlanIndexItem, "");
