...
namespace com.espertech.esper.common.@internal.epl.join.exec.sorted
{
	public class SortedAccessStrategyRange : SortedAccessStrategyRangeBase , SortedAccessStrategy {
	    ...
	    public SortedAccessStrategyRange(bool isNWOnTrigger, int lookupStream, int numStreams, ExprEvaluator start, bool includeStart, ExprEvaluator end, bool includeEnd, bool allowRangeReversal) : base(isNWOnTrigger, lookupStream, numStreams, start, includeStart, end, includeEnd)
	        {
