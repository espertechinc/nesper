...
{
    public class CompositeAccessStrategyLE : CompositeAccessStrategyRelOpBase,
        CompositeAccessStrategy
    {
        public CompositeAccessStrategyLE(
            bool isNWOnTrigger,
            int lookupStream,
            int numStreams,
            ExprEvaluator key)
            ...
            CompositeIndexQueryResultPostProcessor postProcessor)
        {
            ...
            return CompositeIndexQueryRange.Handle(
                theEvent, index.Head(comparable, true), null, result, next, postProcessor);
        }
            ...
            CompositeIndexQueryResultPostProcessor postProcessor)
        {
            ...
            return CompositeIndexQueryRange.Handle(
                eventsPerStream, index.Head(comparable, true), null, result, next, postProcessor);
        }
    }
} // end of namespace