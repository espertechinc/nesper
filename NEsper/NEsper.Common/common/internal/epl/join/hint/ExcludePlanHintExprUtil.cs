...
namespace com.espertech.esper.common.@internal.epl.join.hint
{
	public class ExcludePlanHintExprUtil {
	    ...
	    internal readonly static ObjectArrayEventType OAEXPRESSIONTYPE;
	    ...
	    public static ExprForge ToExpression(string hint, StatementRawInfo rawInfo, StatementCompileTimeServices services) {
