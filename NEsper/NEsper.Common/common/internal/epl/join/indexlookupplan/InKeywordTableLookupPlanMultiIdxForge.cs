...
namespace com.espertech.esper.common.@internal.epl.join.indexlookupplan
{
	...
	public class InKeywordTableLookupPlanMultiIdxForge : TableLookupPlanForge {
	    ...
	    public InKeywordTableLookupPlanMultiIdxForge(int lookupStream, int indexedStream, bool indexedStreamIsVDW, EventType[] typesPerStream, TableLookupIndexReqKey[] indexNum, ExprNode keyExpr)
	    ...
	    public override ICollection<CodegenExpression> AdditionalParams(CodegenMethod method, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
