...
namespace com.espertech.esper.common.@internal.epl.join.assemble
{
    ...
    public class RootRequiredAssemblyNodeFactory : BaseAssemblyNodeFactory
    {
        ...
        public RootRequiredAssemblyNodeFactory(int streamNum, int numStreams) : base(streamNum, numStreams)
        {
        }
        ...
        {
            return NewInstance(typeof(RootRequiredAssemblyNodeFactory), Constant(streamNum), Constant(numStreams));
        }
    }
} // end of namespace