...
namespace com.espertech.esper.common.@internal.epl.table.strategy
{
    public class ExprTableEvalStrategyUtil
    {
        ...
        public static CodegenExpression CodegenInitMap(IDictionary<ExprTableAccessNode, ExprTableEvalStrategyFactoryForge> tableAccesses, Type generator, CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope)
        {
            CodegenMethod method = parent.MakeChild(typeof(IDictionary<object, object>), generator, classScope);
            method.Block
                    .DeclareVar(typeof(IDictionary<object, object>), "ta", NewInstance(typeof(LinkedHashMap<object, object>), Constant(tableAccesses.Count + 2)));
        ...
        protected internal static IDictionary<string, object> EvalMap(ObjectArrayBackedEventBean @event, AggregationRow row, IDictionary<string, TableMetadataColumn> items, EventBean[] eventsPerStream, bool isNewData, ExprEvaluatorContext exprEvaluatorContext)
        {
        ...
        protected internal static object[] EvalTypable(ObjectArrayBackedEventBean @event,
                                              AggregationRow row,
