...
{
    public class ExprTableEvalStrategyUngroupedTopLevel : ExprTableEvalStrategyUngroupedBase, ExprTableEvalStrategy
    {
        public ExprTableEvalStrategyUngroupedTopLevel(TableAndLockProviderUngrouped provider, ExprTableEvalStrategyFactory factory) : base(provider, factory)
        {
        }
