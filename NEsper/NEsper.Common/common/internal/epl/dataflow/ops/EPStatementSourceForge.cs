...
namespace com.espertech.esper.common.@internal.epl.dataflow.ops
{
	public class EPStatementSourceForge : DataFlowOperatorForge {
	    ...
	    [DataFlowOpParameter]
	    private IDictionary<string, object> statementFilter; // interface EPDataFlowEPStatementFilter

	    [DataFlowOpParameter]
	    private IDictionary<string, object> collector; // interface EPDataFlowIRStreamCollector
	    ...
	    public CodegenExpression Make(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
	        return new SAIFFInitializeBuilder(OP_PACKAGE_NAME + ".epstatementsource.EPStatementSourceFactory", this.GetType(), "stmtSrc", parent, symbols, classScope)
