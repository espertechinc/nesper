...
namespace com.espertech.esper.common.@internal.epl.dataflow.util
{
	public class OperatorMetadataDescriptor {
	    ...
	    public OperatorMetadataDescriptor(Type forgeClass, string operatorPrettyPrint, Attribute[] operatorAnnotations, int numOutputPorts, string operatorName) {
	    ...
	    public CodegenExpression Make(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
	        ...
	        method.Block
	                ...
	                .ExprDotMethod(@Ref("op"), "setOperatorAnnotations", operatorAnnotations == null ? ConstantNull() : LocalMethod(MakeAnnotations(typeof(Attribute[]), operatorAnnotations, method, classScope)))
