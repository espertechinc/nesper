...
namespace com.espertech.esper.common.@internal.epl.dataflow.filtersvcadapter
{
	public class DataFlowFilterServiceAdapterNonHA : DataFlowFilterServiceAdapter {
	    ...
	    public readonly static DataFlowFilterServiceAdapterNonHA INSTANCE = new DataFlowFilterServiceAdapterNonHA();

	    private readonly IDictionary<FilterHandleCallback, EPStatementHandleCallbackFilter> handlesPerOp = new Dictionary<FilterHandleCallback,  EPStatementHandleCallbackFilter>();
	    ...
	    public void AddFilterCallback(FilterHandleCallback filterHandleCallback, AgentInstanceContext agentInstanceContext, EventType eventType, FilterValueSetParam[][] @params, int filterCallbackId) {
	        EPStatementHandleCallbackFilter handle = new EPStatementHandleCallbackFilter(agentInstanceContext.EpStatementAgentInstanceHandle, filterHandleCallback);
