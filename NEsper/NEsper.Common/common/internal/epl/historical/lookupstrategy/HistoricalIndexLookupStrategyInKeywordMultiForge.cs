...
namespace com.espertech.esper.common.@internal.epl.historical.lookupstrategy
{
	public class HistoricalIndexLookupStrategyInKeywordMultiForge : HistoricalIndexLookupStrategyForge {
	    ...
	    public CodegenExpression Make(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
	        ...
	        method.Block
	                .DeclareVar(typeof(HistoricalIndexLookupStrategyInKeywordMulti), "strat", NewInstance(typeof(HistoricalIndexLookupStrategyInKeywordMulti)))
	                .ExprDotMethod(@Ref("strat"), "setLookupStream", Constant(lookupStream))
	                .ExprDotMethod(@Ref("strat"), "setEvaluator", ExprNodeUtilityCodegen.CodegenEvaluator(evaluator.Forge, method, this.GetType(), classScope))
