...
namespace com.espertech.esper.common.@internal.epl.expression.dot.propertydot
{
	public class PropertyDotNonLambdaIndexedForgeEval : ExprEvaluator {
	    ...
	    public static CodegenExpression Codegen(PropertyDotNonLambdaIndexedForge forge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        CodegenMethod methodNode = codegenMethodScope.MakeChild(forge.EvaluationType, typeof(PropertyDotNonLambdaIndexedForgeEval), codegenClassScope);
	        ...
	        methodNode.Block
	                ...
	                .DeclareVar(evaluationType, "key", forge.ParamForge.EvaluateCodegen(evaluationType, methodNode, exprSymbol, codegenClassScope))
	                .MethodReturn(forge.IndexedGetter.EventBeanGetIndexedCodegen(methodNode, codegenClassScope, @Ref("event"), @Ref("key")));
