	...
	public class ExprDotNodeForgeVariableEval {
	    public static CodegenExpression Codegen(ExprDotNodeForgeVariable forge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope classScope) {
	        ...
	        CodegenBlock block = methodNode.Block
	                ...
	                .Apply(InstrumentationCode.Instblock(classScope, "qExprDotChain", typeInformation, @Ref("result"), Constant(forge.ChainForge.Length)));
	        CodegenExpression chain = ExprDotNodeUtility.EvaluateChainCodegen(methodNode, exprSymbol, classScope, @Ref("result"), variableType, forge.ChainForge, forge.ResultWrapLambda);
