	...
	public class ExprDotNodeForgeStreamEvalMethod : ExprEvaluator {
	    ...
	    public static CodegenExpression Codegen(ExprDotNodeForgeStream forge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        ...
	        if (codegenClassScope.IsInstrumented) {
	            typeInformation = codegenClassScope.AddOrGetFieldSharable(new EPTypeCodegenSharable(EPTypeHelper.SingleValue(forge.EventType.UnderlyingType), codegenClassScope));
	        }
	        ...
	        CodegenExpression invoke = ExprDotNodeUtility.EvaluateChainCodegen(methodNode, exprSymbol, codegenClassScope, @Ref("inner"), eventUndType, forge.Evaluators, null);
	        if (evaluationType == typeof(void)) {
