...
namespace com.espertech.esper.common.@internal.epl.expression.ops
{
	...
	public class ExprRelationalOpNodeForge : ExprForgeInstrumentable {
	    ...
	    public CodegenExpression EvaluateCodegen(Type requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        return new InstrumentationBuilderExpr(this.GetType(), this, "ExprRelOp", requiredType, codegenMethodScope, exprSymbol, codegenClassScope).Qparam(Constant(parent.RelationalOpEnum.ExpressionText)).Build();
	    }
