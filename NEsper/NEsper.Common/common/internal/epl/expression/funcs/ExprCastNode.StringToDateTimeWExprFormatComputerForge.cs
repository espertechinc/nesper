...
namespace com.espertech.esper.common.@internal.epl.expression.funcs
{
    ...
    {
        public class StringToDateTimeWExprFormatComputerForge : StringWExprFormatComputerForge
        {
            public StringToDateTimeWExprFormatComputerForge(ExprForge dateFormatForge)
                : base(dateFormatForge)
            {
            }

            public override CasterParserComputer EvaluatorComputer =>
                new StringToDateTimeWExprFormatComputerEval(dateFormatForge.ExprEvaluator);
