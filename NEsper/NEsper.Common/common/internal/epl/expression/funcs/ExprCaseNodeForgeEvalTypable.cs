	...
	public class ExprCaseNodeForgeEvalTypable : ExprTypableReturnEval {
	    ...
	    public static CodegenExpression CodegenTypeableSingle(ExprCaseNodeForge forge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        ...
	        CodegenBlock block = methodNode.Block
	                .DeclareVar(typeof(IDictionary<object, object>), "map", Cast(typeof(IDictionary<object, object>), forge.EvaluateCodegen(typeof(IDictionary<object, object>), methodNode, exprSymbol, codegenClassScope)))
