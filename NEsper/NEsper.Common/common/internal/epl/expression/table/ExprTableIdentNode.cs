...
{
	public class ExprTableIdentNode : ExprNodeBase , ExprForgeInstrumentable {
	    ...
	    public CodegenExpression EvaluateCodegenUninstrumented(Type requiredType, CodegenMethodScope parent, ExprForgeCodegenSymbol symbols, CodegenClassScope codegenClassScope) {
	        CodegenMethod method = parent.MakeChild(requiredType, this.GetType(), codegenClassScope);
	        method.Block.DeclareVar(typeof(object), "result", StaticMethod(typeof(ExprTableIdentNode), "tableColumnAggValue", Constant(streamNum), Constant(columnNum),
	    ...
	    public CodegenExpression EvaluateCodegen(Type requiredType, CodegenMethodScope parent, ExprForgeCodegenSymbol symbols, CodegenClassScope codegenClassScope) {
	    ...
	    public static object TableColumnAggValue(int streamNum, int column, EventBean[] eventsPerStream, bool isNewData, ExprEvaluatorContext ctx) {
