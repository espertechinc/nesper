...
namespace com.espertech.esper.common.@internal.epl.expression.subquery
{
	...
	public class SubselectForgeNREqualsDefault : SubselectForgeNREqualsBase {
	    ...
	    public SubselectForgeNREqualsDefault(ExprSubselectNode subselect, ExprForge valueEval, ExprForge selectEval, bool resultWhenNoMatchingEvents, bool isNot, SimpleNumberCoercer coercer, ExprForge filterEval, bool isAll) : base(subselect, valueEval, selectEval, resultWhenNoMatchingEvents, isNot, coercer)
	        {
