    ...
    public class SubselectForgeNRExistsWGroupBy : SubselectForgeNR
    {
            ...
            CodegenClassScope classScope)
        {
            ...
            method.Block.ApplyTri(
                new SubselectForgeCodegenUtil.ReturnIfNoMatch(ConstantFalse(), ConstantFalse()), method, symbols);
            method.Block.MethodReturn(
                Not(
                    ExprDotMethodChain(aggService).Add("getGroupKeys", symbols.GetAddExprEvalCtx(method))
                        .Add("isEmpty")));
