...
{
    public class ExprEvalStreamInsertNamedWindow : ExprForge, ExprEvaluator, ExprNodeRenderable
    {
        private readonly int streamNum;
        private readonly EventType namedWindowAsType;
        private readonly Type returnType;

        public ExprEvalStreamInsertNamedWindow(int streamNum, EventType namedWindowAsType, Type returnType)
        {
        ...
        public CodegenExpression EvaluateCodegen(Type requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope)
        {
            ...
            CodegenExpressionField namedWindowType = codegenClassScope.AddFieldUnshared(true, typeof(EventType), EventTypeUtility.ResolveTypeCodegen(namedWindowAsType, EPStatementInitServicesConstants.REF));
            ...
            methodNode.Block
                    ...
                    .MethodReturn(ExprDotMethod(eventSvc, method, Cast(namedWindowAsType.UnderlyingType, ExprDotUnderlying(@Ref("event"))), namedWindowType));
