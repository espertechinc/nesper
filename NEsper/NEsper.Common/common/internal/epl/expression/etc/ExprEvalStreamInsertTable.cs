...
{
    public class ExprEvalStreamInsertTable : ExprForgeInstrumentable, ExprEvaluator, ExprNodeRenderable
    {
        private readonly int streamNum;
        private readonly TableMetaData tableMetadata;
        private readonly Type returnType;

        public ExprEvalStreamInsertTable(int streamNum, TableMetaData tableMetadata, Type returnType)
        {
        ...
        public CodegenExpression EvaluateCodegenUninstrumented(Type requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope)
        {
            ...
            return StaticMethod(typeof(ExprEvalStreamInsertTable), "convertToTableEvent", Constant(streamNum), eventToPublic, refEPS, refIsNewData, refExprEvalCtx);
        }
        ...
        {
            return new InstrumentationBuilderExpr(this.GetType(), this, "ExprStreamUndSelectClause", requiredType, codegenMethodScope, exprSymbol, codegenClassScope).Build();
        }
        ...
        public static EventBean ConvertToTableEvent(int streamNum, TableMetadataInternalEventToPublic eventToPublic, EventBean[] eventsPerStream, bool isNewData, ExprEvaluatorContext exprEvaluatorContext)
        {
