...
namespace com.espertech.esper.common.@internal.epl.expression.codegen
{
	public class CodegenLegoCompareEquals {
	    public static CodegenExpression CodegenEqualsNonNullNoCoerce(CodegenExpression lhs, Type lhsType, CodegenExpression rhs, Type rhsType) {
	        if (lhsType.IsPrimitive && rhsType.IsPrimitive && !TypeHelper.IsFloatingPointClass(lhsType) && !TypeHelper.IsFloatingPointClass(rhsType)) {
