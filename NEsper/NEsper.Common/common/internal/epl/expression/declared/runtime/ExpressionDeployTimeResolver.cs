...
namespace com.espertech.esper.common.@internal.epl.expression.declared.runtime
{
	public class ExpressionDeployTimeResolver {
	    ...
	    public static CodegenExpressionField MakeRuntimeCacheKeyField(ExpressionDeclItem expression, CodegenClassScope classScope, Type generator) {
	        ...
	        CodegenMethod keyInit = classScope.PackageScope.InitMethod.MakeChild(typeof(ExprDeclaredCacheKeyGlobal), generator, classScope).AddParam(typeof(EPStatementInitServices), EPStatementInitServicesConstants.REF.Ref);
	        keyInit.Block.DeclareVar(typeof(string), "deploymentId", StaticMethod(typeof(ExpressionDeployTimeResolver), "resolveDeploymentId",
	        ...
	        return classScope.PackageScope.AddFieldUnshared(true, typeof(ExprDeclaredCacheKeyGlobal), LocalMethod(keyInit, EPStatementInitServicesConstants.REF));
	    }
