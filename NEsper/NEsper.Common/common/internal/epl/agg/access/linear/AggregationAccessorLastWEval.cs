...
namespace com.espertech.esper.common.@internal.epl.agg.access.linear
{
	...
	public class AggregationAccessorLastWEval {
	    public static void GetValueCodegen(AggregationAccessorLastWEvalForge forge, AggregationStateLinearForge factoryLinear, AggregationAccessorForgeGetCodegenContext context) {
	        ...
	        context.Method.Block.DeclareVar(typeof(EventBean), "bean", factoryLinear.AggregatorLinear.GetLastValueCodegen(context.ClassScope, context.Method, context.NamedMethods))
	    ...
	    public static void GetEnumerableScalarCodegen(AggregationAccessorLastWEvalForge forge, AggregationStateLinearForge stateForge, AggregationAccessorForgeGetCodegenContext context) {
	        CodegenMethod childExpr = CodegenLegoMethodExpression.CodegenExpression(forge.ChildNode, context.Method, context.ClassScope);
	        context.Method.Block.DeclareVar(typeof(EventBean), "bean", stateForge.AggregatorLinear.GetLastValueCodegen(context.ClassScope, context.Method, context.NamedMethods))
	                .IfRefNullReturnNull("bean")
	                .DeclareVar(typeof(EventBean[]), "eventsPerStreamBuf", NewArrayByLength(typeof(EventBean), Constant(forge.StreamNum + 1)))
	                .AssignArrayElement("eventsPerStreamBuf", Constant(forge.StreamNum), @Ref("bean"))
	    ...
	    public static void GetEnumerableEventCodegen(AggregationAccessorLastWEvalForge forge, AggregationStateLinearForge stateForge, AggregationAccessorForgeGetCodegenContext context) {
	        context.Method.Block.MethodReturn(stateForge.AggregatorLinear.GetLastValueCodegen(context.ClassScope, context.Method, context.NamedMethods));
	    }
	}
} // end of namespace