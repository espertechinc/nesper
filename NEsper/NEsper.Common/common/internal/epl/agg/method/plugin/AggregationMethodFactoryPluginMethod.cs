	...
	public class AggregationMethodFactoryPluginMethod : AggregationFactoryMethodBase {
	    ...
	    public override void InitMethodForge(int col, CodegenCtor rowCtor, CodegenMemberCol membersColumnized, CodegenClassScope classScope) {
	        ...
	        if (mode is AggregationFunctionModeManaged) {
	            ...
	            aggregator = new AggregatorPlugInManaged(this, col, rowCtor, membersColumnized, classScope, distinctType, parent.ChildNodes.Length > 1, parent.OptionalFilter, singleValue);
	            ...
	            aggregator = codeGenerated.AggregatorMethodFactory.GetAggregatorMethod(new AggregatorMethodFactoryContext(col, rowCtor, membersColumnized, classScope));
	        } else {
