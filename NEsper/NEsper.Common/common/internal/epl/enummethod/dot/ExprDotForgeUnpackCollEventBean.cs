...
{
	public class ExprDotForgeUnpackCollEventBean : ExprDotForge, ExprDotEval {
	    ...
	    public CodegenExpression Codegen(CodegenExpression inner, Type innerType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        CodegenMethod methodNode = codegenMethodScope.MakeChild(typeof(ICollection<object>), typeof(ExprDotForgeUnpackCollEventBean), codegenClassScope).AddParam(typeof(ICollection<object>), "target");
