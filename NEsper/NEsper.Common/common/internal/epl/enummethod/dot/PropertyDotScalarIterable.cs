...
{
	public class PropertyDotScalarIterable : ExprEnumerationForge, ExprEnumerationEval, ExprEnumerationGivenEvent, ExprEnumerationGivenEventForge, ExprNodeRenderable {
	    ...
	    public PropertyDotScalarIterable(string propertyName, int streamId, EventPropertyGetterSPI getter, Type componentType, Type getterReturnType) {
	    ...
	    public CodegenExpression EvaluateEventGetROCollectionScalarCodegen(CodegenMethodScope codegenMethodScope, ExprEnumerationGivenEventSymbol symbols, CodegenClassScope codegenClassScope) {
	        ...
	        method.Block.DeclareVar(getterReturnType, "result", CodegenLegoCast.CastSafeFromObjectType(typeof(IEnumerable), getter.EventBeanGetCodegen(symbols.GetAddEvent(method), codegenMethodScope, codegenClassScope)))
	    ...
	    private CodegenExpression CodegenEvaluateInternal(CodegenExpression @event, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        ...
	        CodegenMethod method = codegenMethodScope.MakeChild(typeof(ICollection<object>), typeof(PropertyDotScalarIterable), codegenClassScope).AddParam(typeof(EventBean), "event").Block
	                .DeclareVar(getterReturnType, "result", CodegenLegoCast.CastSafeFromObjectType(typeof(IEnumerable), getter.EventBeanGetCodegen(@Ref("event"), codegenMethodScope, codegenClassScope)))
	                .IfRefNullReturnNull("result")
	                .MethodReturn(StaticMethod(typeof(CollectionUtil), "iterableToCollection", @Ref("result")));
