...
namespace com.espertech.esper.common.@internal.epl.enummethod.eval
{
	public class EnumFirstOfPredicateScalarForgeEval : EnumEval {
	    ...
	    public static CodegenExpression Codegen(EnumFirstOfPredicateScalarForge forge, EnumForgeCodegenParams args, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        ...
	        CodegenMethod methodNode = codegenMethodScope.MakeChildWithScope(resultType, typeof(EnumFirstOfPredicateScalarForgeEval), scope, codegenClassScope).AddParam(EnumForgeCodegenNames.PARAMS);
