    ...
    public class EnumGroupByKeyValueSelectorScalarLambdaForgeEval : EnumEval
    {
            ...
            CodegenClassScope codegenClassScope)
        {
            ...
            CodegenMethod methodNode = codegenMethodScope.MakeChildWithScope(
                    typeof(IDictionary<object, object>), typeof(EnumGroupByKeyValueSelectorScalarLambdaForgeEval), scope, codegenClassScope)
            ...
            block.ForEach(typeof(object), "next", EnumForgeCodegenNames.REF_ENUMCOLL)
                ...
                .DeclareVar(typeof(object), "entry", forge.secondExpression.EvaluateCodegen(typeof(object), methodNode, scope, codegenClassScope))
                .DeclareVar(
