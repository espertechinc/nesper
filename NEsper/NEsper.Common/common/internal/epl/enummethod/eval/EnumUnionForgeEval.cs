...
namespace com.espertech.esper.common.@internal.epl.enummethod.eval
{
	public class EnumUnionForgeEval : EnumEval {
	    ...
	    public static CodegenExpression Codegen(EnumUnionForge forge, EnumForgeCodegenParams args, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        ...
	        CodegenMethod methodNode = codegenMethodScope.MakeChildWithScope(typeof(ICollection<object>), typeof(EnumUnionForgeEval), scope, codegenClassScope).AddParam(EnumForgeCodegenNames.PARAMS);
	        ...
	        block.DeclareVar(typeof(List<object>), "result", NewInstance(typeof(List<object>), Op(ExprDotMethod(EnumForgeCodegenNames.REF_ENUMCOLL, "size"), "+", ExprDotMethod(@Ref("other"), "size"))))
