    ...
    public class EnumTakeWhileLastIndexScalarForgeEval : EnumEval
    {
            ...
            CodegenClassScope codegenClassScope)
        {
            ...
            block.DeclareVar(
                    ...
                    NewInstance(
                        typeof(ObjectArrayEventBean), NewArrayByLength(typeof(object), Constant(1)), evalTypeMember))
                ...
                .DeclareVar(
                    ...
                    NewInstance(
                        typeof(ObjectArrayEventBean), NewArrayByLength(typeof(object), Constant(1)), indexTypeMember))
                .AssignArrayElement(
