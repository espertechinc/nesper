...
namespace com.espertech.esper.common.@internal.epl.enummethod.eval
{
	public class EnumAggregateScalarForgeEval : EnumEval {
	    ...
	    public static CodegenExpression Codegen(EnumAggregateScalarForge forge, EnumForgeCodegenParams args, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        ...
	        CodegenMethod methodNode = codegenMethodScope.MakeChildWithScope(forge.initialization.EvaluationType, typeof(EnumAggregateScalarForgeEval), scope, codegenClassScope).AddParam(EnumForgeCodegenNames.PARAMS);
	        ...
	        block.DeclareVar(typeof(ObjectArrayEventBean), "resultEvent", NewInstance(typeof(ObjectArrayEventBean), NewArrayByLength(typeof(object), Constant(1)), resultTypeMember))
	                .DeclareVar(typeof(ObjectArrayEventBean), "evalEvent", NewInstance(typeof(ObjectArrayEventBean), NewArrayByLength(typeof(object), Constant(1)), evalTypeMember))
