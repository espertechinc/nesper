...
{
	public class EnumAnyOfScalarForge : EnumForgeBaseScalar {

	    public EnumAnyOfScalarForge(ExprForge innerExpression, int streamCountIncoming, ObjectArrayEventType type)
	    ...
	    public override CodegenExpression Codegen(EnumForgeCodegenParams premade, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        return EnumAnyOfScalarForgeEval.Codegen(this, premade, codegenMethodScope, codegenClassScope);
	    }
	}
} // end of namespace