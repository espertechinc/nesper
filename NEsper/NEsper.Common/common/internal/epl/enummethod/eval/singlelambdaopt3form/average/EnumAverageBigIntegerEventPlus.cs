...
{
	public class EnumAverageBigIntegerEventPlus : ThreeFormEventPlus
	{
		public EnumAverageBigIntegerEventPlus(
		...
		public EnumEval EnumEvaluator {
			get {
				var inner = InnerExpression.ExprEvaluator; // Local function
