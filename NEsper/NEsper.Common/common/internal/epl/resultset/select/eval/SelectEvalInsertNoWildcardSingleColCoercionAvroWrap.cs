...
namespace com.espertech.esper.common.@internal.epl.resultset.select.eval
{
	public class SelectEvalInsertNoWildcardSingleColCoercionAvroWrap : SelectEvalBaseFirstPropFromWrap {
	    ...
	    protected override CodegenExpression ProcessFirstColCodegen(Type evaluationType, CodegenExpression expression, CodegenExpression resultEventType, CodegenExpression eventBeanFactory, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        return SelectEvalInsertNoWildcardSingleColCoercionMapWrap.ProcessFirstColCodegen(expression, eventBeanFactory, codegenClassScope, wrapper, "adapterForTypedAvro", typeof(object));
	    }
	}
} // end of namespace