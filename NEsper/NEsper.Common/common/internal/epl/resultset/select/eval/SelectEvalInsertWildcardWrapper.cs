...
{
	public class SelectEvalInsertWildcardWrapper : SelectEvalBaseMap , SelectExprProcessorForge {

	    public SelectEvalInsertWildcardWrapper(SelectExprForgeContext selectExprForgeContext, EventType resultEventType)
