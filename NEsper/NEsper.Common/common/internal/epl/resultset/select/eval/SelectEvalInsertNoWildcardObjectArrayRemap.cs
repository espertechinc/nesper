...
namespace com.espertech.esper.common.@internal.epl.resultset.select.eval
{
	public class SelectEvalInsertNoWildcardObjectArrayRemap : SelectExprProcessorForge {
	    ...
	    public CodegenMethod ProcessCodegen(CodegenExpression resultEventTypeExpr, CodegenExpression eventBeanFactory, CodegenMethodScope codegenMethodScope, SelectExprProcessorCodegenSymbol selectSymbol, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        return SelectEvalInsertNoWildcardObjectArrayRemapWWiden.ProcessCodegen(resultEventTypeExpr, eventBeanFactory, codegenMethodScope, exprSymbol, codegenClassScope, context.ExprForges, resultEventType.PropertyNames, remapped, null);
	    }
	}
} // end of namespace