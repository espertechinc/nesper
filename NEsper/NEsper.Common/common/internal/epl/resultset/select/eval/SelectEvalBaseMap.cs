...
{
	public abstract class SelectEvalBaseMap : SelectEvalBase , SelectExprProcessorForge {
	    ...
	    public CodegenMethod ProcessCodegen(CodegenExpression resultEventType, CodegenExpression eventBeanFactory, CodegenMethodScope codegenMethodScope, SelectExprProcessorCodegenSymbol selectSymbol, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        ...
	        if (this.context.ExprForges.Length == 0) {
	            ...
	            block.DeclareVar(typeof(IDictionary<object, object>), "props", NewInstance(typeof(Dictionary<object, object>), Constant(CollectionUtil.CapacityHashMap(this.context.ColumnNames.Length))));
	        }
