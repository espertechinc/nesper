    ...
    public class SelectEvalNoWildcardMap : SelectExprProcessorForge
    {
            ...
            CodegenClassScope codegenClassScope)
        {
            ...
            methodNode.Block.DeclareVar(
                ...
                NewInstance(typeof(Dictionary<object, object>), Constant(CollectionUtil.CapacityHashMap(selectContext.ColumnNames.Length))));
            for (int i = 0; i < selectContext.ColumnNames.Length; i++) {
                CodegenExpression expression = CodegenLegoMayVoid.ExpressionMayVoid(
                    typeof(object), selectContext.ExprForges[i], methodNode, exprSymbol, codegenClassScope);
