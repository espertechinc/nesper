...
{
    public class BindProcessorStreamTable : ExprForge, ExprEvaluator, ExprNodeRenderable
    {
        private readonly int streamNum;
        private readonly Type returnType;
        private readonly TableMetaData tableMetadata;

        public BindProcessorStreamTable(int streamNum, Type returnType, TableMetaData tableMetadata)
        {
        ...
        public CodegenExpression EvaluateCodegen(Type requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope)
        {
            ...
            return StaticMethod(typeof(BindProcessorStreamTable), "evaluateConvertTableEventToUnd", Constant(streamNum), eventToPublic, refEPS, refIsNewData, refExprEvalCtx);
        }
        ...
        public static object[] EvaluateConvertTableEventToUnd(int streamNum, TableMetadataInternalEventToPublic eventToPublic, EventBean[] eventsPerStream, bool isNewData, ExprEvaluatorContext context)
        {
