...
namespace com.espertech.esper.common.@internal.epl.resultset.@select.core
{
    public partial class SelectExprInsertEventBeanFactory
    {
        ...
        {
            internal SelectExprInsertNativeExpressionCoerceObjectArray(EventType eventType, ExprForge exprForge)
                ...
                CodegenClassScope codegenClassScope)
            {
                ...
                methodNode.Block
                    ...
                    .MethodReturn(
                        CodegenExpressionBuilder.ExprDotMethod(eventBeanFactory, "adapterForTypedObjectArray", CodegenExpressionBuilder.Ref("result"), resultEventType));
                return methodNode;
            }
        }
    }
