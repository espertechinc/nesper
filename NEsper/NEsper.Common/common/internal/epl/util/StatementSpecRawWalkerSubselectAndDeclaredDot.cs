...
namespace com.espertech.esper.common.@internal.epl.util
{
	public class StatementSpecRawWalkerSubselectAndDeclaredDot {
	    ...
	    public static void WalkSubselectAndDeclaredDotExpr(StatementSpecRaw spec, ExprNodeSubselectDeclaredDotVisitor visitor) {
	    ...
	    private static void WalkSubselectSelectClause(IList<SelectClauseElementRaw> selectClause, ExprNodeSubselectDeclaredDotVisitor visitor) {
