	...
	public static class DatetimeMethodBuiltinExtensions {
		public static DatetimeMethodProviderForgeFactory GetForgeFactory(this DatetimeMethodBuiltin value) {
	        return value switch {
			    ...
			    DatetimeMethodBuiltin.TOCALENDAR => DatetimeMethodEnumStatics.REFORMAT_FORGE_FACTORY,
			    DatetimeMethodBuiltin.TODATE => DatetimeMethodEnumStatics.REFORMAT_FORGE_FACTORY,
	    ...
	    public static string GetNameCamel(this DatetimeMethodBuiltin value)
	    {
		    return value switch {
			    ...
			    DatetimeMethodBuiltin.TOCALENDAR => "toCalendar",
			    DatetimeMethodBuiltin.TODATE => "toDate",
	    ...
	    public static DotMethodFP[] GetFootprints(this DatetimeMethodBuiltin value)
	    {
		    return value switch {
			    ...
			    DatetimeMethodBuiltin.TOCALENDAR => DatetimeMethodEnumParams.NOPARAM,
			    DatetimeMethodBuiltin.TODATE => DatetimeMethodEnumParams.NOPARAM,
