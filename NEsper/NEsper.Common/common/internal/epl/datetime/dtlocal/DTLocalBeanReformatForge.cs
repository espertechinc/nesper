...
namespace com.espertech.esper.common.@internal.epl.datetime.dtlocal
{
	public class DTLocalBeanReformatForge : DTLocalForge {
	    ...
	    public DTLocalBeanReformatForge(EventPropertyGetterSPI getter, Type getterResultType, DTLocalForge inner, Type returnType) {
	        this.getter = getter;
	    ...
	    public CodegenExpression Codegen(CodegenExpression target, Type targetType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
	        CodegenMethod methodNode = codegenMethodScope.MakeChild(returnType, typeof(DTLocalBeanReformatForge), codegenClassScope).AddParam(typeof(EventBean), "target");
