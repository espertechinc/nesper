...
{
    public class DTLocalDtxOpsDtoForge : DTLocalForgeCalOpsCalBase,
        DTLocalForge
    {
        public DTLocalDtxOpsDtoForge(IList<CalendarForge> calendarForges)
            : base(calendarForges)
        {
        }

        public DTLocalEvaluator DTEvaluator => new DTLocalDtxOpsDtoEval(GetCalendarOps(calendarForges));
        ...
        {
            return DTLocalDtxOpsDtoEval.Codegen(
