...
namespace com.espertech.esper.common.@internal.bytecodemodel.@base
{
	public class CodegenBlock {
	    ...
	    public CodegenBlock() : this(null, null, null) { 
	    }

	    public CodegenBlock(CodegenCtor parentCtor) : this(parentCtor, null, null) {
	    }

	    public CodegenBlock(CodegenMethod parentMethodNode) : this(null, parentMethodNode, null) {
	    }

	    public CodegenBlock(CodegenStatementWBlockBase parentWBlock) : this(null, null, parentWBlock) {
	    }
	    ...
	    public CodegenBlock IfNotInstanceOf(string name, Type clazz) {
	        return IfInstanceOf(name, clazz, true);
	    }

	    public CodegenBlock IfInstanceOf(string name, Type clazz) {
	        return IfInstanceOf(name, clazz, false);
	    }

	    private CodegenBlock IfInstanceOf(string name, Type clazz, bool not) {
	    ...
	    public CodegenBlock ForLoop(Type type, string name, CodegenExpression initialization, CodegenExpression termination, CodegenExpression increment) {
	        CheckClosed();
	    ...
	    public CodegenBlock ForEach(Type type, string name, CodegenExpression target) {
	        CheckClosed();
	    ...
	    public CodegenBlock DeclareVarWCast(Type clazz, string var, string rhsName) {
	        CheckClosed();
	        statements.Add(new CodegenStatementDeclareVarWCast(clazz, var, rhsName));
	        return this;
	    }

	    public CodegenBlock DeclareVar(Type clazz, string var, CodegenExpression initializer) {
	        CheckClosed();
	    ...
	    public CodegenBlock DeclareVar(Type clazz, Type optionalTypeVariable, string var, CodegenExpression initializer) {
	        CheckClosed();
	        statements.Add(new CodegenStatementDeclareVar(clazz, optionalTypeVariable, var, initializer));
	        return this;
	    }

	    public CodegenBlock DeclareVarNoInit(Type clazz, string var) {
	        CheckClosed();
	        statements.Add(new CodegenStatementDeclareVar(clazz, null, var, null));
	        return this;
	    }

	    public CodegenBlock DeclareVarNull(Type clazz, string var) {
	        CheckClosed();
	    ...
	    public CodegenBlock ExprDotMethod(CodegenExpression expression, string method, params CodegenExpression[] @params) {
	        Expression(new CodegenExpressionExprDotMethod(expression, method, @params));
	        return this;
	    }

	    public CodegenBlock StaticMethod(Type clazz, string method, params CodegenExpression[] @params) {
	        Expression(new CodegenExpressionStaticMethod(clazz, method, @params));
	        return this;
	    }

	    public CodegenBlock StaticMethod(string className, string method, params CodegenExpression[] @params) {
	        Expression(new CodegenExpressionStaticMethod(className, method, @params));
	        return this;
	    }

	    public CodegenBlock LocalMethod(CodegenMethod methodNode, params CodegenExpression[] parameters) {
	    ...
	    public CodegenBlock IfRefNotTypeReturnConst(string @ref, Type type, object constant) {
	        CheckClosed();
	    ...
	    public void Render(StringBuilder builder, IDictionary<Type, string> imports, bool isInnerClass, int level, CodegenIndent indent) {
	        foreach (CodegenStatement statement in statements) {
	    ...
	    public CodegenBlock[] SwitchBlockOfLength(string @ref, int length, bool withDefaultUnsupported) {
	        CheckClosed();
	    ...
	    public CodegenBlock[] SwitchBlockOptions(string @ref, int[] options, bool withDefaultUnsupported) {
	        CheckClosed();
	        CodegenStatementSwitch switchStmt = new CodegenStatementSwitch(this, @ref, options, withDefaultUnsupported);
	        statements.Add(switchStmt);
	        return switchStmt.Blocks;
	    ...
	    public CodegenBlock ApplyTri<T>(TriConsumer<CodegenMethod, CodegenBlock, T> consumer, CodegenMethod methodNode, T symbols)
	    ...
	    public CodegenBlock ApplyConditional(bool flag, Consumer<CodegenBlock> consumer) {
	        if (flag) {
	            Apply(consumer);
	        }
	        return this;
	    ...
	    private CodegenBlock WhileOrDoLoop(CodegenExpression expression, bool isWhile) {
	        CheckClosed();
