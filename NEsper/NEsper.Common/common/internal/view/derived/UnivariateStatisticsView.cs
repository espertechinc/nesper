...
namespace com.espertech.esper.common.@internal.view.derived
{
	...
	/// </summary>
	public class UnivariateStatisticsView : ViewSupport , DerivedValueView {
	    ...
	    public override void Update(EventBean[] newData, EventBean[] oldData) {
	        ...
	        if (lastNewEvent == null) {
	            if (child != null) {
	                oldDataMap = PopulateMap(baseStatisticsBean, agentInstanceContext.EventBeanTypedEventFactory, viewFactory.eventType, viewFactory.additionalProps, lastValuesEventNew);
	            }
	        }
	        ...
	        if (child != null) {
	            EventBean newDataMap = PopulateMap(baseStatisticsBean, agentInstanceContext.EventBeanTypedEventFactory, viewFactory.eventType, viewFactory.additionalProps, lastValuesEventNew);
	    ...
	    public override IEnumerator<EventBean> GetEnumerator() {
            return EnumerationHelper.SingletonNullable(
                PopulateMap(baseStatisticsBean,
