...
namespace com.espertech.esper.common.@internal.view.derived
{
    ...
    public class CorrelationViewForge : ViewFactoryForgeBase
    {
            ...
            CodegenClassScope classScope)
        {
            ...
            method.Block
                .ExprDotMethod(
                    factory, "setExpressionXEval", CodegenEvaluator(expressionX.Forge, method, GetType(), classScope))
                .ExprDotMethod(
                    factory, "setExpressionYEval", CodegenEvaluator(expressionY.Forge, method, GetType(), classScope));
        }
    }
} // end of namespace