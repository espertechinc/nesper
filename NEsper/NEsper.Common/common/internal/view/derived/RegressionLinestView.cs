...
namespace com.espertech.esper.common.@internal.view.derived
{
	...
	public class RegressionLinestView : BaseBivariateStatisticsView {
	    ...
	    protected internal override EventBean PopulateMap(BaseStatisticsBean baseStatisticsBean,
	    ...
	    protected internal static EventType CreateEventType(StatViewAdditionalPropsForge additionalProps, ViewForgeEnv env, int streamNum) {
