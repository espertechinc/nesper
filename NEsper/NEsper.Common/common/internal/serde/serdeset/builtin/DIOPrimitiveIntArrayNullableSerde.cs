...
{
	public class DIOPrimitiveIntArrayNullableSerde : DataInputOutputSerde<int[]> {
	    public readonly static DIOPrimitiveIntArrayNullableSerde INSTANCE = new DIOPrimitiveIntArrayNullableSerde();
