...
{
	public class DIOPrimitiveShortArray2DimNullableSerde : DataInputOutputSerde<short[][]> {
	    public readonly static DIOPrimitiveShortArray2DimNullableSerde INSTANCE = new DIOPrimitiveShortArray2DimNullableSerde();
