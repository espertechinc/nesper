...
{
	public class DIOBoxedLongArray2DimNullableSerde : DataInputOutputSerde<long?[][]> {
	    public readonly static DIOBoxedLongArray2DimNullableSerde INSTANCE = new DIOBoxedLongArray2DimNullableSerde();
