...
{
	public class DIOPrimitiveIntArray2DimNullableSerde : DataInputOutputSerde<int[][]> {
	    public readonly static DIOPrimitiveIntArray2DimNullableSerde INSTANCE = new DIOPrimitiveIntArray2DimNullableSerde();
