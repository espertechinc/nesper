...
{
	public class DIOBoxedByteArray2DimNullableSerde : DataInputOutputSerde<byte?[][]> {
	    public readonly static DIOBoxedByteArray2DimNullableSerde INSTANCE = new DIOBoxedByteArray2DimNullableSerde();
