...
namespace com.espertech.esper.common.@internal.serde.serdeset.builtin
{
	...
	/// </summary>
	public class DIOBooleanSerde : DataInputOutputSerde<bool> {
	    public readonly static DIOBooleanSerde INSTANCE = new DIOBooleanSerde();
	    ...
	    public void Write(bool @object, DataOutput stream) {
	        stream.WriteBoolean(@object);
	    }

	    public bool Read(DataInput s, byte[] resourceKey) {
