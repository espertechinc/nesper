...
{
	public class DIOBoxedCharacterArrayNullableSerde : DataInputOutputSerde<char?[]> {
	    public readonly static DIOBoxedCharacterArrayNullableSerde INSTANCE = new DIOBoxedCharacterArrayNullableSerde();
