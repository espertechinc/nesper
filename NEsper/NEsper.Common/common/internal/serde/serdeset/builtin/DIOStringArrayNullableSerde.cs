...
{
	public class DIOStringArrayNullableSerde : DataInputOutputSerde<string[]> {
	    public readonly static DIOStringArrayNullableSerde INSTANCE = new DIOStringArrayNullableSerde();
