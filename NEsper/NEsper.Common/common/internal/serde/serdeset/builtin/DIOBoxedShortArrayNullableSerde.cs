...
{
	public class DIOBoxedShortArrayNullableSerde : DataInputOutputSerde<short?[]> {
	    public readonly static DIOBoxedShortArrayNullableSerde INSTANCE = new DIOBoxedShortArrayNullableSerde();
