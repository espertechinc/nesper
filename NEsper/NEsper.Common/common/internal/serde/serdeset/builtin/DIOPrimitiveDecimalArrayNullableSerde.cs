...
{
	public class DIOPrimitiveDecimalArrayNullableSerde : DataInputOutputSerde<decimal[]> {
	    public readonly static DIOPrimitiveDecimalArrayNullableSerde INSTANCE = new DIOPrimitiveDecimalArrayNullableSerde();
