...
{
	public class DIOPrimitiveLongArrayNullableSerde : DataInputOutputSerde<long[]> {
	    public readonly static DIOPrimitiveLongArrayNullableSerde INSTANCE = new DIOPrimitiveLongArrayNullableSerde();
