...
{
	public class DIOPrimitiveFloatArrayNullableSerde : DataInputOutputSerde<float[]> {
	    public readonly static DIOPrimitiveFloatArrayNullableSerde INSTANCE = new DIOPrimitiveFloatArrayNullableSerde();
