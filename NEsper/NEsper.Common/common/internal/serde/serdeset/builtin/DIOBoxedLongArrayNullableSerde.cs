...
{
	public class DIOBoxedLongArrayNullableSerde : DataInputOutputSerde<long?[]> {
	    public readonly static DIOBoxedLongArrayNullableSerde INSTANCE = new DIOBoxedLongArrayNullableSerde();
