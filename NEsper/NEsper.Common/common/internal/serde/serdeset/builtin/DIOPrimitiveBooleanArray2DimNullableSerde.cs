...
{
	public class DIOPrimitiveBooleanArray2DimNullableSerde : DataInputOutputSerde<bool[][]> {
	    public readonly static DIOPrimitiveBooleanArray2DimNullableSerde INSTANCE = new DIOPrimitiveBooleanArray2DimNullableSerde();
