...
namespace com.espertech.esper.common.@internal.settings
{
    public class ImportServiceCompileTime : ImportServiceBase
    {
        ...
        public ImportServiceCompileTime(
            ...
            MathContext mathContext, bool allowExtendedAggregationFunc, bool sortUsingCollator)
            : base(transientConfiguration, timeAbacus, eventTypeAutoNames)
        {
            aggregationFunctions = new Dictionary<>();
            aggregationAccess = new List<>();
        ...
        public void AddSingleRow(
            string functionName, string singleRowFuncClass, string methodName,
            ...
            bool rethrowExceptions, string optionalEventTypeName)
        {
        ...
        public void AddAggregation(string functionName, ConfigurationCompilerPlugInAggregationFunction aggregationDesc)
        {
