...
namespace com.espertech.esper.common.@internal.context.util
{
    ...
    public class EPStatementHandle
    {
	    ...
	    public EPStatementHandle(string statementName, string deploymentId, int statementId, string optionalStatementEPL, int priority, bool preemptive, bool canSelfJoin, MultiMatchHandler multiMatchHandler, bool hasVariables, bool hasTableAccess, StatementMetricHandle metricsHandle, InsertIntoLatchFactory insertIntoFrontLatchFactory, InsertIntoLatchFactory insertIntoBackLatchFactory) {
