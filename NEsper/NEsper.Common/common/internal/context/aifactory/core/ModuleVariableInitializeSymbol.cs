...
{
    public class ModuleVariableInitializeSymbol : CodegenSymbolProvider
    {
        public readonly static CodegenExpressionRef REF_INITSVC = Ref("moduleVarInitSvc");
        ...
        {
            if (optionalInitServicesRef != null) {
                symbols.Put(optionalInitServicesRef.Ref, typeof(EPModuleVariableInitServices));
            }
        }
    }
} // end of namespace