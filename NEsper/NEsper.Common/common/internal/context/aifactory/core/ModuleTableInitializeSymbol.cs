...
{
    public class ModuleTableInitializeSymbol : CodegenSymbolProvider
    {
        public static readonly CodegenExpressionRef REF_INITSVC = Ref("moduleTableInitSvc");
        ...
        public void Provide(IDictionary<string, Type> symbols)
        {
            if (optionalInitServicesRef != null) {
                symbols.Put(optionalInitServicesRef.Ref, typeof(EPModuleTableInitServices));
            }
        }
