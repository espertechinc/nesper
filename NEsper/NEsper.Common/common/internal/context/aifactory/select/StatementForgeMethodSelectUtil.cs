...
namespace com.espertech.esper.common.@internal.context.aifactory.select
{
    ...
    {
        protected internal static bool[] GetHasIStreamOnly(bool[] isNamedWindow, IList<ViewFactoryForge>[] views)
        {
        ...
        private static string[] DetermineStreamNames(StreamSpecCompiled[] streams)
        {
        ...
        private static StreamJoinAnalysisResultCompileTime VerifyJoinViews(
            StatementSpecCompiled statementSpec, NamedWindowCompileTimeResolver namedWindowCompileTimeResolver)
        {
        ...
        private static void VerifyJoinUnidirectional(
            StreamJoinAnalysisResultCompileTime analysisResult, StatementSpecCompiled statementSpec)
        {
