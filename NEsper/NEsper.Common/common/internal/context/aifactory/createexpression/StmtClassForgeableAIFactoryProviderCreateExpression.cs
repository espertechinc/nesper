...
{
    public class StmtClassForgeableAIFactoryProviderCreateExpression : StmtClassForgeableAIFactoryProviderBase
    {
        private readonly StatementAgentInstanceFactoryCreateExpressionForge forge;

        public StmtClassForgeableAIFactoryProviderCreateExpression(
            string className,
