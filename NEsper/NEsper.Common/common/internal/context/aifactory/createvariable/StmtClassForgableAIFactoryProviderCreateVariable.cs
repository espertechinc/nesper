...
namespace com.espertech.esper.common.@internal.context.aifactory.createvariable
{
    public class StmtClassForgableAIFactoryProviderCreateVariable : StmtClassForgableAIFactoryProviderBase
    {
        ...
        protected override CodegenMethod CodegenConstructorInit(CodegenMethodScope parent, CodegenClassScope classScope)
        {
            ...
            var method = parent.MakeChildWithScope(TypeOfFactory(), this.GetType(), saiffInitializeSymbol, classScope).AddParam(typeof(EPStatementInitServices), REF_STMTINITSVC.Ref);
            method.Block
