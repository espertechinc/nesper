...
{
    public class JsonDeserializerArray2DBoxedInt64 : JsonDeserializerArrayBase<long?[]>
    {
        public JsonDeserializerArray2DBoxedInt64()
            : base(_ => _.ElementToArray(v => v.GetBoxedInt64()))
        {
        }
    }
} // end of namespace
