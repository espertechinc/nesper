...
{
    public class JsonDeserializerArray2DBoxedByte : JsonDeserializerArrayBase<byte?[]>
    {
        public JsonDeserializerArray2DBoxedByte()
            : base(_ => _.ElementToArray(v => v.GetBoxedByte()))
        {
        }
    }
} // end of namespace
