...
{
    public class JsonDeserializerArray2DDateTimeEx : JsonDeserializerArrayBase<DateTimeEx[]>
    {
        public JsonDeserializerArray2DDateTimeEx()
            : base(_ => _.ElementToArray(v => v.GetDateTimeEx()))
        {
        }
    }
} // end of namespace
