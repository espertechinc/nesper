...
{
    public class JsonDelegateArray2DimCharacterPrimitive : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimCharacterPrimitive(
        ...
        {
            return new JsonDelegateArrayCharacterPrimitive(BaseHandler, this);
        }
