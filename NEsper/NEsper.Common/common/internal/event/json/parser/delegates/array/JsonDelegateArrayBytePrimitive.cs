...
{
    public class JsonDelegateArrayBytePrimitive : JsonDelegateArrayBase
    {
        public JsonDelegateArrayBytePrimitive(
        ...
        {
            collection.Add(JsonEndValueForgeByte.JsonToByteNonNull(StringValue, name));
        }
    }
} // end of namespace