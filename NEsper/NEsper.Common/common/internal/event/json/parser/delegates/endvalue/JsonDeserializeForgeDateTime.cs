...
{
    public class JsonDeserializeForgeDateTime : JsonDeserializeForge
    {
        public static readonly JsonDeserializeForgeDateTime INSTANCE = new JsonDeserializeForgeDateTime();

        private JsonDeserializeForgeDateTime()
        {
        }
        ...
        {
            return ExprDotMethod(refs.Element, "GetBoxedDateTime");
        }
    }
} // end of namespace