...
{
    public class JsonDeserializerArray2DimUri : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimUri(
        ...
        {
            return new JsonDeserializerArrayUri(BaseHandler, this);
        }
