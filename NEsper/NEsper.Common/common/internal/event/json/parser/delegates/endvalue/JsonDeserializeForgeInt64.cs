...
{
    public class JsonDeserializeForgeInt64 : JsonDeserializeForge
    {
        public static readonly JsonDeserializeForgeInt64 INSTANCE = new JsonDeserializeForgeInt64();

        private JsonDeserializeForgeInt64()
        {
        }
        ...
        {
            return ExprDotMethod(refs.Element, "GetBoxedInt64");
        }
    }
} // end of namespace