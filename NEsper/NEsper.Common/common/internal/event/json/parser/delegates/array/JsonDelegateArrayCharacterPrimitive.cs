...
{
    public class JsonDelegateArrayCharacterPrimitive : JsonDelegateArrayBase
    {
        public JsonDelegateArrayCharacterPrimitive(
        ...
        {
            collection.Add(JsonEndValueForgeCharacter.JsonToCharacterNonNull(StringValue));
        }
    }
} // end of namespace