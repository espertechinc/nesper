...
{
    public class JsonDelegateArrayShort : JsonDelegateArrayBase
    {
        public JsonDelegateArrayShort(
        ...
        {
            collection.Add(JsonEndValueForgeShort.JsonToShort(StringValue, name));
        }
