...
{
    public class JsonDeserializerArray2DimLong : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimLong(
        ...
        {
            return new JsonDeserializerArrayLong(BaseHandler, this);
        }
