...
{
    public class JsonDeserializerArray2DimDouble : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDouble(
        ...
        {
            return new JsonDeserializerArrayDouble(BaseHandler, this);
        }
