...
{
    public class JsonDelegateArrayIntegerPrimitive : JsonDelegateArrayBase
    {
        public JsonDelegateArrayIntegerPrimitive(
        ...
        {
            collection.Add(JsonEndValueForgeInteger.JsonToIntegerNonNull(StringValue, name));
        }
