...
{
    public class JsonDeserializerArray2DimDateTimeEx : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDateTimeEx(
        ...
        {
            return new JsonDeserializerArrayDateTimeEx(BaseHandler, this);
        }
