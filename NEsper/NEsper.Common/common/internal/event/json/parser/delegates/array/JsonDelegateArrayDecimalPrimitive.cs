...
{
    public class JsonDelegateArrayDecimalPrimitive : JsonDelegateArrayBase
    {
        public JsonDelegateArrayDecimalPrimitive(
        ...
        {
            collection.Add(JsonEndValueForgeDecimal.JsonToDecimalNonNull(StringValue, name));
        }
