...
{
    public class JsonDeserializerArray2DimIntegerPrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimIntegerPrimitive(
        ...
        {
            return new JsonDeserializerArrayIntegerPrimitive(BaseHandler, this);
        }
