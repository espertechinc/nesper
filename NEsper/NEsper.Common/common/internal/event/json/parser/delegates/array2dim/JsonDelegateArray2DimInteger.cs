...
{
    public class JsonDelegateArray2DimInteger : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimInteger(
        ...
        {
            return new JsonDelegateArrayInteger(BaseHandler, this);
        }
