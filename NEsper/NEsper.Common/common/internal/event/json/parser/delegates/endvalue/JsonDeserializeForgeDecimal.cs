...
{
	public class JsonDeserializeForgeDecimal : JsonDeserializeForge
	{
		public static readonly JsonDeserializeForgeDecimal INSTANCE = new JsonDeserializeForgeDecimal();

		private JsonDeserializeForgeDecimal()
		{
		}
		...
		{
			return ExprDotMethod(refs.Element, "GetBoxedDecimal");
		}
	}
} // end of namespace
