...
{
    public class JsonDelegateArray2DimDateTimeOffset : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimDateTimeOffset(
        ...
        {
            return new JsonDelegateArrayDateTimeOffset(BaseHandler, this);
        }
