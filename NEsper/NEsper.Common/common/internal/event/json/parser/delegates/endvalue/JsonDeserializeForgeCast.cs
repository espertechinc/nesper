...
{
    public class JsonDeserializeForgeCast : JsonDeserializeForge
    {
        private readonly Type _target;
        private readonly string _targetClassName;

        public JsonDeserializeForgeCast(Type target)
        {
            this._target = target;
            _targetClassName = null;
        }

        public JsonDeserializeForgeCast(string targetClassName)
        {
