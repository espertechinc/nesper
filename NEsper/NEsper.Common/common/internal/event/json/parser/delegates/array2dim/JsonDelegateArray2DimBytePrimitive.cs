...
{
    public class JsonDelegateArray2DimBytePrimitive : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimBytePrimitive(
        ...
        {
            return new JsonDelegateArrayBytePrimitive(BaseHandler, this);
        }
