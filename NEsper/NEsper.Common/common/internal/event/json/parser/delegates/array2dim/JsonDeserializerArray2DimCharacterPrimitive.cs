...
{
    public class JsonDeserializerArray2DimCharacterPrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimCharacterPrimitive(
        ...
        {
            return new JsonDeserializerArrayCharacterPrimitive(BaseHandler, this);
        }
