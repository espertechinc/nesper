...
{
	public class JsonDeserializeForgeProvidedAdapter : JsonDeserializeForge
	{
		private readonly Type _adapterClass;

		public JsonDeserializeForgeProvidedAdapter(Type adapterClass)
		{
		...
		{
			return ExprDotMethod(NewInstance(_adapterClass), "Parse", refs.Element);
		}
	}
} // end of namespace
