...
{
    public class JsonDeserializerArray2DimDecimal : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDecimal(
        ...
        {
            return new JsonDeserializerArrayDecimal(BaseHandler, this);
        }
