...
{
    public class JsonDelegateArray2DimIntegerPrimitive : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimIntegerPrimitive(
        ...
        {
            return new JsonDelegateArrayIntegerPrimitive(BaseHandler, this);
        }
