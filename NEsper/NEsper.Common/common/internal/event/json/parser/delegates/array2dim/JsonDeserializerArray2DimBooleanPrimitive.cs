...
{
    public class JsonDeserializerArray2DimBooleanPrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimBooleanPrimitive(
        ...
        {
            return new JsonDeserializerArrayBooleanPrimitive(BaseHandler, this);
        }
