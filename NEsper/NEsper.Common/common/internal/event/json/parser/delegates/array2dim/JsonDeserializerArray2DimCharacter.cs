...
{
    public class JsonDeserializerArray2DimCharacter : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimCharacter(
        ...
        {
            return new JsonDeserializerArrayCharacter(BaseHandler, this);
        }
