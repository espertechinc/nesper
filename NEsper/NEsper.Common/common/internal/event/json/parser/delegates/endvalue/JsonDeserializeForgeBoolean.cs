...
{
	public class JsonDeserializeForgeBoolean : JsonDeserializeForge
	{
		public static readonly JsonDeserializeForgeBoolean INSTANCE = new JsonDeserializeForgeBoolean();

		private JsonDeserializeForgeBoolean()
		{
		}
		...
		{
			return ExprDotMethod(refs.Element, "GetBoxedBoolean");
		}
	}
} // end of namespace
