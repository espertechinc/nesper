...
{
    public class JsonDeserializerArray2DimString : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimString(
        ...
        {
            return new JsonDeserializerArrayString(BaseHandler, this);
        }
