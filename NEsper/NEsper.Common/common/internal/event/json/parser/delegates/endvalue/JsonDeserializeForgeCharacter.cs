...
{
    public class JsonDeserializeForgeCharacter : JsonDeserializeForge
    {
        public static readonly JsonDeserializeForgeCharacter INSTANCE = new JsonDeserializeForgeCharacter();

        private JsonDeserializeForgeCharacter()
        {
        }
