...
{
    public class JsonDeserializerArray2DimInteger : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimInteger(
        ...
        {
            return new JsonDeserializerArrayInteger(BaseHandler, this);
        }
