...
{
    public class JsonDeserializerArray2DimShortPrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimShortPrimitive(
        ...
        {
            return new JsonDeserializerArrayShortPrimitive(BaseHandler, this);
        }

        public override object GetResult()
        {
            return collection.Cast<short?[]>().ToArray();
        }
    }
} // end of namespace