...
{
    public class JsonDeserializerArray2DimDateTime : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDateTime(
        ...
        {
            return new JsonDeserializerArrayDateTime(BaseHandler, this);
        }
