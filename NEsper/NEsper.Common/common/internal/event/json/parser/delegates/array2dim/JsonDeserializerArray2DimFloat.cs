...
{
    public class JsonDeserializerArray2DimFloat : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimFloat(
        ...
        {
            return new JsonDeserializerArrayFloat(BaseHandler, this);
        }
