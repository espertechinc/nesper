...
{
    public class JsonDelegateArray2DimDecimalPrimitive : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimDecimalPrimitive(
        ...
        {
            return new JsonDelegateArrayDecimalPrimitive(BaseHandler, this);
        }
