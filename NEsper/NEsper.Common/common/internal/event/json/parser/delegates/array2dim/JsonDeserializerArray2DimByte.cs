...
{
    public class JsonDeserializerArray2DimByte : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimByte(
        ...
        {
            return new JsonDeserializerArrayByte(BaseHandler, this);
        }
