...
{
    public class JsonDeserializerArray2DimFloatPrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimFloatPrimitive(
        ...
        {
            return new JsonDeserializerArrayFloatPrimitive(BaseHandler, this);
        }
