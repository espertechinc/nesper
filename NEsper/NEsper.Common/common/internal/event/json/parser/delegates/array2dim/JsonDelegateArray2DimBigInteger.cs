...
{
    public class JsonDelegateArray2DimBigInteger : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimBigInteger(
        ...
        {
            return new JsonDelegateArrayBigInteger(BaseHandler, this);
        }
