...
{
    public class JsonDeserializerArray2DimBytePrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimBytePrimitive(
        ...
        {
            return new JsonDeserializerArrayBytePrimitive(BaseHandler, this);
        }

        public override object GetResult()
        {
            return collection.Cast<byte[]>().ToArray();
        }
    }
} // end of namespace