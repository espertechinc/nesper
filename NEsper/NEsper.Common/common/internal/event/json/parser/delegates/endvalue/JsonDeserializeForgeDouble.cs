...
{
	public class JsonDeserializeForgeDouble : JsonDeserializeForge
	{
		public static readonly JsonDeserializeForgeDouble INSTANCE = new JsonDeserializeForgeDouble();

		private JsonDeserializeForgeDouble()
		{
		}
		...
		{
			return ExprDotMethod(refs.Element, "GetBoxedDouble");
		}
	}
} // end of namespace
