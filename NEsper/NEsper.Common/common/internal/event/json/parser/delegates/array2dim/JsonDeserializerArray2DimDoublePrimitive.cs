...
{
    public class JsonDeserializerArray2DimDoublePrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDoublePrimitive(
        ...
        {
            return new JsonDeserializerArrayDoublePrimitive(BaseHandler, this);
        }
