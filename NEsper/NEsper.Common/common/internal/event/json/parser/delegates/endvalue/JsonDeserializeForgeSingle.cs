...
{
    public class JsonDeserializeForgeSingle : JsonDeserializeForge
    {
        public static readonly JsonDeserializeForgeSingle INSTANCE = new JsonDeserializeForgeSingle();

        private JsonDeserializeForgeSingle()
        {
        }
