...
{
    public class JsonDeserializerArray2DimShort : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimShort(
        ...
        {
            return new JsonDeserializerArrayShort(BaseHandler, this);
        }
