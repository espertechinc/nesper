...
{
    public class JsonDelegateCollectionBigInteger : JsonDelegateArrayBigInteger
    {
        public JsonDelegateCollectionBigInteger(
        ...
        {
            return collection.Cast<BigInteger?>().ToList();
        }
    }
} // end of namespace