...
{
    public class JsonDelegateArrayDecimal : JsonDelegateArrayBase
    {
        public JsonDelegateArrayDecimal(
        ...
        {
            collection.Add(JsonEndValueForgeDecimal.JsonToDecimal(StringValue, name));
        }
