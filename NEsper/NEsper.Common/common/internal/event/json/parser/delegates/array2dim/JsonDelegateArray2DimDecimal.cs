...
{
    public class JsonDelegateArray2DimDecimal : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimDecimal(
        ...
        {
            return new JsonDelegateArrayDecimal(BaseHandler, this);
        }
