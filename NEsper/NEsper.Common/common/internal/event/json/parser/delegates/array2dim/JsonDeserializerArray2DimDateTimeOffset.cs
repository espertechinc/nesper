...
{
    public class JsonDeserializerArray2DimDateTimeOffset : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDateTimeOffset(
        ...
        {
            return new JsonDeserializerArrayDateTimeOffset(BaseHandler, this);
        }
