...
{
    public class JsonDelegateArrayDouble : JsonDelegateArrayBase
    {
        public JsonDelegateArrayDouble(
        ...
        {
            collection.Add(JsonEndValueForgeDouble.JsonToDouble(StringValue, name));
        }
