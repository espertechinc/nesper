...
{
    public class JsonDelegateArrayDateTimeEx : JsonDelegateArrayBase
    {
        public JsonDelegateArrayDateTimeEx(
        ...
        {
            collection.Add(JsonEndValueForgeDateTimeEx.JsonToDateTimeEx(StringValue, name));
        }
