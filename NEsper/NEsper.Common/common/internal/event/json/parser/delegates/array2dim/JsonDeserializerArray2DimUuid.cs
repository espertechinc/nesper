...
{
    public class JsonDeserializerArray2DimUuid : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimUuid(
        ...
        {
            return new JsonDeserializerArrayUuid(BaseHandler, this);
        }

        public override object GetResult()
        {
            return collection.Cast<Guid[]>().ToArray();
        }
    }
} // end of namespace