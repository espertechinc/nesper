...
{
    public class JsonDeserializerArray2DimDecimalPrimitive : JsonDeserializerArray2DimBase
    {
        public JsonDeserializerArray2DimDecimalPrimitive(
        ...
        {
            return new JsonDeserializerArrayDecimalPrimitive(BaseHandler, this);
        }
