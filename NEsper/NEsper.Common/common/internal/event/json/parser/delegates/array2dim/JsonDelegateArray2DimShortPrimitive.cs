...
{
    public class JsonDelegateArray2DimShortPrimitive : JsonDelegateArray2DimBase
    {
        public JsonDelegateArray2DimShortPrimitive(
        ...
        {
            return new JsonDelegateArrayShortPrimitive(BaseHandler, this);
        }
