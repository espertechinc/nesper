...
{
    public class JsonDelegateArrayDateTime : JsonDelegateArrayBase
    {
        public JsonDelegateArrayDateTime(
        ...
        {
            collection.Add(JsonEndValueForgeDateTime.JsonToDateTime(StringValue, name));
        }
