...
{
    public class JsonDeserializerForgeNull : JsonDeserializerForge
    {
        public static readonly JsonDeserializerForgeNull INSTANCE = new JsonDeserializerForgeNull();

        private JsonDeserializerForgeNull()
        {
        }
