...
{
    /// <summary>
    ///     Getter for a list property backed by a property, identified by a given index, using vanilla reflection.
    /// </summary>
    public class ListPropertyPropertyGetter : BaseNativePropertyGetter,
        ...
        EventPropertyGetterAndIndexed
    {
        ...
        public ListPropertyPropertyGetter(
        ...
        {
            return $"ListPropertyPropertyGetter property={_property} index={_index}";
        }
