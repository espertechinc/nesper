...
namespace com.espertech.esper.common.@internal.@event.xml
{
	public class XPathPropertyGetterCodegenFieldSharable : CodegenFieldSharable {
	    ...
	    public CodegenExpression InitCtorScoped() {
	        return StaticMethod(typeof(XPathPropertyGetterCodegenFieldSharable), "resolveXPathPropertyGetter",
	    ...
	    public static XPathPropertyGetter ResolveXPathPropertyGetter(EventType eventType, string propertyName) {
	        if (!(eventType is BaseXMLEventType)) {
	            throw new EPException("Failed to obtain xpath property getter, expected an xml event type but received type '" + eventType.Metadata.Name + "'");
	        }
	        ...
	        if (!(getter is XPathPropertyGetter)) {
	            throw new EPException("Failed to obtain xpath property getter for property '" + propertyName + "', expected " + typeof(XPathPropertyGetter).Name + " but received " + getter);
	        }
	    ...
	    public override int GetHashCode() {
	        int result = baseXMLEventType.GetHashCode();
