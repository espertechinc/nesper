...
namespace com.espertech.esper.common.@internal.@event.wrap
{
	public class WrapperGetterMapped : EventPropertyGetterMappedSPI {
	    ...
	    public CodegenExpression EventBeanGetMappedCodegen(CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope, CodegenExpression beanExpression, CodegenExpression key) {
	        CodegenMethod method = codegenMethodScope.MakeChild(typeof(object), typeof(WrapperGetterMapped), codegenClassScope).AddParam(typeof(EventBean), "event").AddParam(typeof(string), "key").Block
