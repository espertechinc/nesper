...
namespace com.espertech.esper.common.@internal.@event.map
{
    public class EventTypeNestableGetterFactoryMap : EventTypeNestableGetterFactory
    {
        ...
        public MapEventPropertyGetter GetGetterEventBean(string name, Type underlyingType)
        {
        ...
        public EventPropertyGetterSPI GetGetterNestedMapProp(
            string propertyName, MapEventPropertyGetter getterNestedMap)
        {
        ...
        EventPropertyGetterSPI EventTypeNestableGetterFactory.GetGetterEventBean(string name, Type underlyingType)
        {
            return GetGetterEventBean(name, underlyingType);
        }

        EventPropertyGetterSPI EventTypeNestableGetterFactory.GetGetterEventBeanArray(string name, EventType eventType)
        {
