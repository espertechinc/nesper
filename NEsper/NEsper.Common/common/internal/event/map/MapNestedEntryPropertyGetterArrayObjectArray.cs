...
namespace com.espertech.esper.common.@internal.@event.map
{
	public class MapNestedEntryPropertyGetterArrayObjectArray : MapNestedEntryPropertyGetterBase {
	    ...
	    public MapNestedEntryPropertyGetterArrayObjectArray(string propertyMap, EventType fragmentType, EventBeanTypedEventFactory eventBeanTypedEventFactory, int index, ObjectArrayEventPropertyGetter getter) : base(propertyMap, fragmentType, eventBeanTypedEventFactory)
	        {
	        this.index = index;
	        this.getter = getter;
	    }
	    ...
	    public override CodegenExpression HandleNestedValueCodegen(CodegenExpression name, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        return BaseNestableEventUtil.HandleNestedValueArrayWithObjectArrayCodegen(index, getter, name, codegenMethodScope, codegenClassScope, this.GetType());
	    }
	    ...
	    public override CodegenExpression HandleNestedValueFragmentCodegen(CodegenExpression name, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        return BaseNestableEventUtil.HandleNestedValueArrayWithObjectArrayFragmentCodegen(index, getter, name, codegenMethodScope, codegenClassScope, this.GetType());
	    }
	}
} // end of namespace