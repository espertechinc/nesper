...
namespace com.espertech.esper.common.@internal.@event.map
{
    ...
    public class MapEventBeanArrayPropertyGetter : MapEventPropertyGetter
    {
        ...
        public MapEventBeanArrayPropertyGetter(
            string propertyName,
            Type underlyingType)
        {
            ...
            CodegenClassScope codegenClassScope)
        {
            return codegenMethodScope.MakeChild(typeof(object), GetType(), codegenClassScope)
                ...
                .MethodReturn(
                    LocalMethod(
                        BaseNestableEventUtil.GetArrayPropertyAsUnderlyingsArrayCodegen(underlyingType, codegenMethodScope, codegenClassScope),
