...
namespace com.espertech.esper.common.@internal.@event.map
{
	public class MapNestedEntryPropertyGetterPropertyProvidedDynamic : MapNestedEntryPropertyGetterBase {
	    ...
	    public MapNestedEntryPropertyGetterPropertyProvidedDynamic(string propertyMap, EventType fragmentType, EventBeanTypedEventFactory eventBeanTypedEventFactory, EventPropertyGetter nestedGetter) : base(propertyMap, fragmentType, eventBeanTypedEventFactory)
	        {
	    ...
	    private CodegenMethod HandleNestedValueCodegen(CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        CodegenBlock block = codegenMethodScope.MakeChild(typeof(object), this.GetType(), codegenClassScope).AddParam(typeof(object), "value").Block
	                .IfRefNotTypeReturnConst("value", typeof(IDictionary<object, object>), "null");
	        if (nestedGetter is MapEventPropertyGetter) {
	            return block.MethodReturn(((MapEventPropertyGetter) nestedGetter).UnderlyingGetCodegen(Cast(typeof(IDictionary<object, object>), @Ref("value")), codegenMethodScope, codegenClassScope));
	        }
	    ...
	    private CodegenMethod IsExistsPropertyCodegen(CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        CodegenBlock block = codegenMethodScope.MakeChild(typeof(bool), this.GetType(), codegenClassScope).AddParam(typeof(IDictionary<object, object>), "map").Block
	        ...
	        if (nestedGetter is MapEventPropertyGetter) {
	            return block.MethodReturn(((MapEventPropertyGetter) nestedGetter).UnderlyingExistsCodegen(Cast(typeof(IDictionary<object, object>), @Ref("value")), codegenMethodScope, codegenClassScope));
	        }
	    ...
	    public override CodegenExpression HandleNestedValueCodegen(CodegenExpression valueExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	    ...
	    public override CodegenExpression EventBeanExistsCodegen(CodegenExpression beanExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
	        return UnderlyingExistsCodegen(CastUnderlying(typeof(IDictionary<object, object>), beanExpression), codegenMethodScope, codegenClassScope);
	    }
