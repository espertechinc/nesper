...
namespace com.espertech.esper.common.@internal.@event.core
{
    ...
    public class EventBeanUtility
    {
        ...
        protected internal static EventBean[] Append(EventBean[] source, EventBean[] append)
        {
        ...
        public static HashableMultiKey GetMultiKey(EventBean theEvent, EventPropertyGetter[] propertyGetters, Type[] coercionTypes)
        {
            var keyValues = GetPropertyArray(theEvent, propertyGetters);
        ...
        public static ICollection<EventBean> GetDistinctByProp(ArrayDeque<EventBean> events, EventBeanReader reader)
        {
        ...
        public static EventBean[] Denaturalize(EventBean[] naturals)
        {
            ...
            {
                return new EventBean[] { ((NaturalEventBean)naturals[0]).OptionalSynthetic };
            }
        ...
        public static EventBean[] GetNewDataNonRemoved(EventBean[] newData, ISet<EventBean> removedEvents)
        {
            var filter = false;
        ...
        public static EventBean[] GetNewDataNonRemoved(EventBean[] newData, ISet<EventBean> removedEvents, EventBean[][] newEventsPerView)
        {
        ...
        private static bool FindEvent(EventBean theEvent, EventBean[][] eventsPerView)
        {
