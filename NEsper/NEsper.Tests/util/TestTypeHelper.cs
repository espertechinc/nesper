        ...
        public void TestIsAssignmentCompatible()
        {
            var successCases = new[]
                               {
                                   ...
                                   new[] {typeof(byte), typeof(int?)},
                                   new[] {typeof(byte?), typeof(long)},
                                   new[] {typeof(byte), typeof(long?)},
                                   new[] {typeof(byte), typeof(double?)},
                                   new[] {typeof(byte), typeof(double)},
                                   new[] {typeof(byte?), typeof(float)},
                                   new[] {typeof(byte), typeof(float?)},
                                   new[] {typeof(short?), typeof(short?)},
                                   new[] {typeof(short?), typeof(short?)},
                                   new[] {typeof(short?), typeof(int)},
                                   new[] {typeof(short?), typeof(int?)},
                                   new[] {typeof(short?), typeof(long)},
                                   new[] {typeof(short?), typeof(long?)},
                                   new[] {typeof(short?), typeof(double?)},
                                   new[] {typeof(short?), typeof(double)},
                                   new[] {typeof(short?), typeof(float)},
                                   new[] {typeof(short?), typeof(float?)},
                                   new[] {typeof(char), typeof(char)},
                                   new[] {typeof(char?), typeof(char)},
                                   new[] {typeof(char), typeof(char?)},
                                   new[] {typeof(char), typeof(int)},
                                   new[] {typeof(char), typeof(int?)},
                                   new[] {typeof(char), typeof(long)},
                                   new[] {typeof(char?), typeof(long?)},
                                   new[] {typeof(char), typeof(double?)},
                                   new[] {typeof(char), typeof(double)},
                                   new[] {typeof(char?), typeof(float)},
                                   new[] {typeof(char), typeof(float?)},
                                   ...
                                   new[] {typeof(long), typeof(float?)},
                                   new[] {typeof(float), typeof(double?)},
                                   new[] {typeof(float), typeof(double)},
            ...
            var failCases = new[]
                            {
                                ...
                                new[] {typeof(short?), typeof(byte)},
                                new[] {typeof(string), typeof(bool?)},
                                new[] {typeof(bool?), typeof(string)},
                                new[] {typeof(byte), typeof(string)},
                                new[] {typeof(char), typeof(byte)},
                                new[] {typeof(char), typeof(short?)},
                                new[] {typeof(char?), typeof(short?)},
                                new[] {typeof(int), typeof(short?)},
                                new[] {typeof(long), typeof(int)},
                                new[] {typeof(float), typeof(long)},
                                new[] {typeof(float?), typeof(byte)},
            ...
            for (int i = 0; i < successCases.Length; i++) {
                Assert.IsTrue(TypeHelper.IsAssignmentCompatible(successCases[i][0], successCases[i][1]),
                              "Failed asserting success case " + successCases[i][0] +
            ...
            for (int i = 0; i < failCases.Length; i++) {
                Assert.IsFalse(TypeHelper.IsAssignmentCompatible(failCases[i][0], failCases[i][1]),
                               "Failed asserting fail case " + failCases[i][0] +
                               " and " + failCases[i][1]);
            }
        }
