	...
	public class TestFilterExpressionsOptimizable 
	{
	    ...
	    private void RunAssertionBooleanExprAnd() {
	        ...
	        foreach (var filter in filters) {
	            ...
	            var stmt = AssertFilterMulti(epl, new FilterItem[][] {
	                    ...
	                    new FilterItem[] {new FilterItem("a", FilterOperator.EQUAL), BoolExprFilterItem},
	                    new FilterItem[] {new FilterItem("b", FilterOperator.EQUAL), BoolExprFilterItem},
	    ...
	    private void RunAssertionBooleanExprSimple() {
	        ...
	        foreach (var filter in filters) {
	            ...
	            var stmt = AssertFilterMulti(epl, new FilterItem[][] {
	                    new FilterItem[] {new FilterItem("b", FilterOperator.EQUAL), BoolExprFilterItem},
	                    new FilterItem[] {new FilterItem("c", FilterOperator.EQUAL), BoolExprFilterItem},
	            });
	            stmt.AddListener(_listener);
	    ...
	    private void RunAssertionAndRewriteNotEqualsWithOrConsolidateSecond() {
	        ...
	        foreach (var filter in filters) {
	            ...
	            var stmt = AssertFilterMulti(epl, new FilterItem[][] {
	                    new FilterItem[] {new FilterItem("a", FilterOperator.NOT_IN_LIST_OF_VALUES), BoolExprFilterItem},
	                    new FilterItem[] {new FilterItem("a", FilterOperator.NOT_IN_LIST_OF_VALUES), BoolExprFilterItem},
	            });
	            stmt.AddListener(_listener);
	    ...
	    private void RunAssertionBoolean(string epl)
        {
	        ...
	        MyLib.ResetCountInvoked();
	        Assert.That(MyLib.CountInvoked, Is.EqualTo(0));
        ...
        public FilterItem BoolExprFilterItem
        {
            get
            {
        ...
        public class MyLib
        {
	        internal static int CountInvoked;
