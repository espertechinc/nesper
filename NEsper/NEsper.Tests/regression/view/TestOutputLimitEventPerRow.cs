...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestOutputLimitEventPerRow
    {
        ...
        public void TestUnaggregatedOutputFirst()
        {
            ...
            epRuntime.SendEvent(new SupportBean("E1", 2));
            Assert.IsFalse(listener.IsInvoked);

            epRuntime.SendEvent(new SupportBean("E2", 3));
            EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fields, new Object[] { "E2", 3 });

            SendTimer(5000);

            epRuntime.SendEvent(new SupportBean("E3", 4));
            EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fields, new Object[] { "E3", 4 });

            epRuntime.SendEvent(new SupportBean("E2", 5));
            Assert.IsFalse(listener.IsInvoked);

            SendTimer(10000);

            epRuntime.SendEvent(new SupportBean("E3", 6));
            Assert.IsFalse(listener.IsInvoked);

            epRuntime.SendEvent(new SupportBean("E1", 7));
            EPAssertionUtil.AssertProps(listener.AssertOneGetNewAndReset(), fields, new Object[] { "E1", 7 });

            epRuntime.SendEvent(new SupportBean("E1", 8));
            Assert.IsFalse(listener.IsInvoked);

            epRuntime.SendEvent(new SupportBean("E2", 9));
            ...
            epRuntime.SendEvent(new SupportBean("E2", 11));
            Assert.IsFalse(listener.IsInvoked);
        }
        ...
        private void TryOutputFirstHaving(String statementText)
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(statementText);
        ...
        private void RunAssertion12(String stmtText, String outputLimit)
        {
            ...
            expected.AddResultInsert(1500, 1, new[] {new Object[] {"IBM", 150L, 49d}});
            expected.AddResultInsert(1500, 2, new[] {new Object[] {"YAH", 10000L, 1d}});
            expected.AddResultInsert(2100, 1, new[] {new Object[] {"IBM", 155L, 75d}});
            expected.AddResultInsert(3500, 1, new[] {new Object[] {"YAH", 11000L, 3d}});
            expected.AddResultInsert(4300, 1, new[] {new Object[] {"IBM", 150L, 97d}});
            expected.AddResultInsert(4900, 1, new[] {new Object[] {"YAH", 11500L, 6d}});
            expected.AddResultRemove(5700, 0, new[] {new Object[] {"IBM", 100L, 72d}});
            expected.AddResultInsert(5900, 1, new[] {new Object[] {"YAH", 10500L, 7d}});
            expected.AddResultRemove(6300, 0, new[] {new Object[] {"MSFT", 5000L, null}});
            expected.AddResultRemove(7000, 0, new[] {new Object[] {"IBM", 150L, 48d}, new Object[] {"YAH", 10000L, 6d}});

            var execution = new ResultAssertExecution(_epService, stmt, _listener, expected);
            execution.Execute();
        }

        private void RunAssertion34(String stmtText,
                                    String outputLimit)
        {
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(stmtText);
        ...
        private void RunAssertion13_14(String stmtText, String outputLimit)
        {
            ...
            var fields = new[] {"Symbol", "Volume", "sum(Price)"};
            var expected = new ResultAssertTestResult(CATEGORY, outputLimit, fields);
            expected.AddResultInsert(1200, 0, new[] {new Object[] {"IBM", 100L, 25d}, new Object[] {"MSFT", 5000L, 9d}});
            expected.AddResultInsert(2200, 0, new[] {new Object[] {"IBM", 155L, 75d}, new Object[] {"YAH", 10000L, 1d}});
            expected.AddResultInsRem(3200, 0, null, null);
            expected.AddResultInsert(4200, 0, new[] {new Object[] {"YAH", 11000L, 3d}});
            expected.AddResultInsert(5200, 0, new[] {new Object[] {"IBM", 150L, 97d}, new Object[] {"YAH", 11500L, 6d}});
            expected.AddResultInsRem(6200, 0, new[] {new Object[] {"YAH", 10500L, 7d}},
        ...
        private void RunAssertion15_16(String stmtText, String outputLimit)
        {
            ...
            expected.AddResultInsert(2200, 0, new[] {new Object[] {"IBM", 155L, 75d}});
            expected.AddResultInsRem(3200, 0, null, null);
            expected.AddResultInsRem(4200, 0, null, null);
            expected.AddResultInsert(5200, 0, new[] {new Object[] {"IBM", 150L, 97d}});
            expected.AddResultInsRem(6200, 0, null, new[] {new Object[] {"IBM", 100L, 72d}});
        ...
        private void RunAssertion78(String stmtText,
                                    String outputLimit)
        {
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(stmtText);
        ...
        private void RunAssertion56(String stmtText, String outputLimit)
        {
            ...
            var expected = new ResultAssertTestResult(CATEGORY, outputLimit, fields);
            expected.AddResultInsert(1200, 0, new[] {new Object[] {"IBM", 100L, 25d}, new Object[] {"MSFT", 5000L, 9d}});
            expected.AddResultInsert(2200, 0,
                                     new[]
                                     {
        ...
        private void RunAssertion9_10(String stmtText, String outputLimit)
        {
            ...
            expected.AddResultInsert(3200, 0,
                                     new[]
                                     {
        ...
        private void RunAssertion11_12(String stmtText, String outputLimit)
        {
            ...
            expected.AddResultInsRem(1200, 0, null, null);
            expected.AddResultInsert(2200, 0, new[] {new Object[] {"IBM", 155L, 75d}});
            expected.AddResultInsert(3200, 0, new[] {new Object[] {"IBM", 155L, 75d}});
            expected.AddResultInsert(4200, 0, new[] {new Object[] {"IBM", 155L, 75d}});
            expected.AddResultInsert(5200, 0, new[] {new Object[] {"IBM", 150L, 97d}});
            expected.AddResultInsRem(6200, 0, new[] {new Object[] {"IBM", 150L, 72d}},
                                     new[] {new Object[] {"IBM", 100L, 72d}});
            expected.AddResultInsRem(7200, 0, null, null);
        ...
        private void RunAssertion17(String stmtText,
                                    String outputLimit)
        {
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(stmtText);
            ...
            expected.AddResultInsert(4300, 1, new[] {new Object[] {"IBM", 150L, 97d}});
            expected.AddResultInsert(4900, 1, new[] {new Object[] {"YAH", 11500L, 6d}});
            expected.AddResultInsert(5700, 0, new[] {new Object[] {"IBM", 100L, 72d}});
            expected.AddResultInsert(5900, 1, new[] {new Object[] {"YAH", 10500L, 7d}});
            expected.AddResultInsert(6300, 0, new[] {new Object[] {"MSFT", 5000L, null}});
            expected.AddResultInsert(7000, 0, new[] {new Object[] {"IBM", 150L, 48d}, new Object[] {"YAH", 10000L, 6d}});

            var execution = new ResultAssertExecution(_epService, stmt, _listener, expected);
            execution.Execute();
        }

        private void RunAssertion18(String stmtText,
                                    String outputLimit)
        {
            SendTimer(0);
            EPStatement stmt = _epService.EPAdministrator.CreateEPL(stmtText);
            ...
            expected.AddResultInsert(4200, 0,
                                     new[]
                                     {
                                         new Object[] {"IBM", 100L, 75d}, new Object[] {"MSFT", 5000L, 9d},
                                         new Object[] {"IBM", 150L, 75d},
                                         new Object[] {"YAH", 10000L, 3d}, new Object[] {"IBM", 155L, 75d},
                                         new Object[] {"YAH", 11000L, 3d}
                                     });
            expected.AddResultInsert(5200, 0,
                                     new[]
                                     {
                                         ...
                                         new Object[] {"IBM", 150L, 97d},
                                         new Object[] {"YAH", 10000L, 6d}, new Object[] {"IBM", 155L, 97d},
                                         new Object[] {"YAH", 11000L, 6d}, new Object[] {"IBM", 150L, 97d},
                                         new Object[] {"YAH", 11500L, 6d}
                                     });
            expected.AddResultInsert(6200, 0,
                                     new[]
                                     {
                                         new Object[] {"MSFT", 5000L, 9d}, new Object[] {"IBM", 150L, 72d},
                                         new Object[] {"YAH", 10000L, 7d},
                                         new Object[] {"IBM", 155L, 72d}, new Object[] {"YAH", 11000L, 7d},
                                         new Object[] {"IBM", 150L, 72d}, new Object[] {"YAH", 11500L, 7d},
                                         new Object[] {"YAH", 10500L, 7d}
                                     });
            expected.AddResultInsert(7200, 0,
                                     new[]
                                     {
                                         new Object[] {"IBM", 155L, 48d}, new Object[] {"YAH", 11000L, 6d},
                                         new Object[] {"IBM", 150L, 48d},
            ...
            if (events.First[0].Get("Symbol").Equals(SYMBOL_IBM))
            {
                EPAssertionUtil.AssertPropsPerRow(events.First, fields,
                                                     new[]
                                                     {
                                                         ...
                                                         new Object[] {SYMBOL_DELL, 10000L, 51.0}
                                                     });
            }
            else
            {
        ...
        private void RunAssertionLast()
        {
            ...
            if (events.First[0].Get("Symbol").Equals(SYMBOL_DELL))
            {
                EPAssertionUtil.AssertPropsPerRow(events.First, fields,
                                                     new[]
                                                     {
                                                         new Object[] {SYMBOL_DELL, 30000L, 173.0},
                                                         new Object[] {SYMBOL_IBM, 10000L, 20.0}
                                                     });
            }
            else
            {
        ...
        private void SendBeanEvent(String stringValue, long longPrimitive, int intPrimitive)
        {
            var b = new SupportBean();
            b.TheString = stringValue;
        ...
        public void Test10AllNoHavingJoin()
        {
            const string stmtText =
                "select Symbol, Volume, sum(Price) " +
        ...
        public void TestHaving()
        {
            ...
            String viewExpr = "select irstream Symbol, Volume, sum(Price) as sumPrice" +
                              " from " + typeof(SupportMarketDataBean).FullName + ".win:time(10 sec) " +
                              "group by Symbol " +
                              "having sum(Price) >= 10 " +
        ...
        public void TestHavingJoin()
        {
            ...
            String viewExpr = "select irstream Symbol, Volume, sum(Price) as sumPrice" +
                              " from " + typeof(SupportMarketDataBean).FullName + ".win:time(10 sec) as s0," +
        ...
        public void TestJoinSortWindow()
        {
            ...
            String viewExpr = "select irstream Symbol, Volume, max(Price) as maxVol" +
                              " from " + typeof(SupportMarketDataBean).FullName + ".ext:sort(1, Volume) as s0," +
        ...
        {
            SendTimer(0);
            String selectStmt = "select Symbol, Volume, sum(Price) as sumPrice from " +
            ...
            EPAssertionUtil.AssertPropsPerRow(_listener.LastNewData, fields,
                                                 new[]
                                                 {
                                                     new Object[] {"s0", 1L, 34d}, 
                                                     new Object[] {"IBM", 2L, 16d},
                                                     new Object[] {"s0", 3L, 34d}
                                                 });
            Assert.IsNull(_listener.LastOldData);
            _listener.Reset();
            ...
            EPAssertionUtil.AssertPropsPerRow(_listener.LastNewData, fields,
                                                 new[]
                                                 {
                                                     new Object[] {"s0", 1L, 34d}, new Object[] {"IBM", 2L, 46d},
                                                     new Object[] {"s0", 3L, 34d},
        ...
        public void TestOutputFirstHavingJoinNoJoin()
        {
            ...
            const string stmtText = 
                "select TheString, LongPrimitive, sum(IntPrimitive) as value from MyWindow group by TheString having sum(IntPrimitive) > 20 output first every 2 events";
            TryOutputFirstHaving(stmtText);

            const string stmtTextJoin = 
                "select TheString, LongPrimitive, sum(IntPrimitive) as value from MyWindow mv, SupportBean_A.win:keepall() a where a.id = mv.TheString " +
                "group by TheString having sum(IntPrimitive) > 20 output first every 2 events";
            TryOutputFirstHaving(stmtTextJoin);

            const string stmtTextOrder = 
                "select TheString, LongPrimitive, sum(IntPrimitive) as value from MyWindow group by TheString having sum(IntPrimitive) > 20 output first every 2 events order by TheString asc";
            TryOutputFirstHaving(stmtTextOrder);

            const string stmtTextOrderJoin =
                "select TheString, LongPrimitive, sum(IntPrimitive) as value from MyWindow mv, SupportBean_A.win:keepall() a where a.id = mv.TheString " +
