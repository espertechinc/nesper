...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestViewWhereClause 
    {
        ...
        {
            String viewExpr = "select * from " + typeof(SupportMarketDataBean).FullName + ".win:length(3) where symbol='CSCO'";
            ...
            try {
                ...
                Assert.AreEqual("Error validating expression: The where-clause filter expression must return a boolean value [select TheString From SupportBean.win:time(30 seconds) where IntPrimitive group by TheString]", ex.Message);
            }
            ...
            stmt = _epService.EPAdministrator.CreateEPL("select * From MapEvent.win:time(30 seconds) where criteria");
        ...
        public void TestWhereNumericType()
        {
            String viewExpr = "select " +
                    ...
                    " from " + typeof(SupportBean).FullName + ".win:length(3) where " +
