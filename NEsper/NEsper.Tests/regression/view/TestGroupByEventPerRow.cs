...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestGroupByEventPerRow 
    {
        ...
        public void TestCriteriaByDotMethod()
        {
            ...
            String epl = "select sb.get_LongPrimitive() as c0, sum(IntPrimitive) as c1 from SupportBean.win:length_batch(2) as sb group by sb.get_TheString()";
            ...
            EPAssertionUtil.AssertPropsPerRow(_listener.GetAndResetLastNewData(), "c0,c1".Split(','), new Object[][]{ new object[] {100L, 30}, new object[] {200L, 30}});
        }
        ...
        public void TestUnaggregatedHaving() {
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("select TheString from SupportBean group by TheString having IntPrimitive > 5");
        ...
        public void TestWildcard() {
            ...
            EPStatement selectTestView = _epService.EPAdministrator.CreateEPL(epl);
