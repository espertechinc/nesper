...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestStaticFunctions 
    {
        ...
        public void SetUp()
    	{
    	    ...
    	    _stream = " from " + typeof(SupportMarketDataBean).FullName +".win:length(5) ";
        ...
        public void TestNullPrimitive()
        {
            ...
            _epService.EPAdministrator.Configuration.AddImport(typeof(NullPrimitive));
        ...
        public void TestChainedInstance() {
            ...
            _epService.EPAdministrator.Configuration.AddImport(typeof(LevelZero));
    	...
    	{
    		_statementText = "select com.espertech.esper.support.util.BitWriter.Write(7) " + _stream;
            var result = CreateStatementAndGetProperty(true, "com.espertech.esper.support.util.BitWriter.Write(7)");
