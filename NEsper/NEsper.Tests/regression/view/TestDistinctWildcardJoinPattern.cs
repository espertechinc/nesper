...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestDistinctWildcardJoinPattern 
    {
        ...
        public void TestWildcardJoinPattern() {
            const string epl = "select distinct * from " +
            ...
            Object[][] inserted = _subscriber.InsertStreamList[0];
        ...
        private void SendEvent(string stringValue, int intPrimitive, long longPrimitive) {
