...
namespace com.espertech.esper.regression.view
{
    ...
    public class TestAggregateWithRollupDimensionality 
    {
        ...
        {
            _epService.EPAdministrator.CreateEPL("select LongPrimitive as c0, sum(IntPrimitive) as c1 " +
                    "from SupportBean group by rollup(case when LongPrimitive > 0 then 1 else 0 end)").Events += _listener.Update;
        ...
        public void TestContextPartitionAlsoRollup()
        {
            ...
            _epService.EPAdministrator.CreateEPL("context SegmentedByString select TheString as c0, IntPrimitive as c1, sum(LongPrimitive) as c2 from SupportBean group by rollup(TheString, IntPrimitive)").Events += _listener.Update;
        ...
        public void TestOnSelect()
        {
            ...
            EPStatement stmt = _epService.EPAdministrator.CreateEPL("on SupportBean_S0 as s0 select mw.TheString as c0, sum(mw.IntPrimitive) as c1, count(*) as c2 from MyWindow mw group by rollup(mw.TheString)");
        ...
        private void RunAssertionUnboundCubeUnenclosed(string groupBy)
        {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('s1')" +
                    ...
                    "group by " + groupBy).Events += _listener.Update;
        ...
        public void TestBoundGroupingSet2LevelNoTopNoDetail() {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('s1')" +
                    ...
                    "group by grouping sets(TheString, IntPrimitive)").Events += _listener.Update;
        ...
        public void TestUnboundCube4Dim() {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('s1')" +
                    ...
                    "group by cube(TheString, IntPrimitive, LongPrimitive, DoublePrimitive)").Events += _listener.Update;
        ...
        private void RunAssertionBoundRollup2Dim(bool join) {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('s1')" +
                    ...
                    "group by rollup(TheString, IntPrimitive)").Events += _listener.Update;
            _epService.EPRuntime.SendEvent(new SupportBean_S0(1));
        ...
        private void RunAssertionUnboundRollup1Dim(string rollup) {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('s1')" +
                    ...
                    "group by " + rollup).Events += _listener.Update;
        ...
        private void RunAssertionUnboundRollup3Dim(string groupByClause, bool isJoin) {
            ...
            _epService.EPAdministrator.CreateEPL("@Name('s1')" +
                    ...
                    "group by " + groupByClause).Events += _listener.Update;
            _epService.EPRuntime.SendEvent(new SupportBean_S0(1));
