    ...
    public class TestInfraCreateIndex 
    {
        ...
        private void RunAssertionInvalid(bool namedWindow)
        {
            var eplCreate = namedWindow ?
                    "create window MyInfra.win:keepall() as (f1 string, f2 int)" :
            ...
            var eplCreateWContext = namedWindow ?
                    "context ContextOne create window MyInfraCtx.win:keepall() as (f1 string, f2 int)" :
        ...
        private void RunAssertionOnSelectReUse(bool namedWindow)
        {
            ...
            _epService.EPAdministrator.CreateEPL("create window MyInfraTwo.win:keepall() as SupportBean");
        ...
        private void RunAssertionIndexStaleness(bool isNamedWindow)
        {
            var eplCreate = isNamedWindow ?
                    "@Hint('enable_window_subquery_indexshare') create window MyInfra.win:keepall() (pkey string, col0 int, col1 long)" :
        ...
        {
            var eplCreate = isNamedWindow ?
                    "@Hint('enable_window_subquery_indexshare') create window MyInfra.win:keepall() (col0 string, pkey int)" :
            ...
            _epService.EPAdministrator.CreateEPL("@Name('join') select col0 from MyInfra, SupportBean_S1.std:lastevent() where col0 = p10");
        ...
        private void RunAssertionMultiRangeAndKey(bool isNamedWindow) {
            ...
            var eplCreate = isNamedWindow ?
                    "create window MyInfra.win:keepall() as SupportBeanRange" :
