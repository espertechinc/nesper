...
namespace com.espertech.esper.regression.client
{
    ...
    public class TestDeployRedefinition
    {
        ...
        {
            DeploymentResult result = _deploySvc.ParseDeploy("create window MyWindow.win:time(30) as (col1 int, col2 string)",
                    null, null, null);
            _deploySvc.UndeployRemove(result.DeploymentId);

            result = _deploySvc.ParseDeploy("create window MyWindow.win:time(30) as (col1 short, col2 long)");
            _deploySvc.UndeployRemove(result.DeploymentId);
        }
