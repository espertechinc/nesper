...
namespace com.espertech.esper.regression.epl
{
	...
	public class TestSelectExprStreamSelector 
	{
	    ...
	    public void TestInvalidSelectWildcardProperty()
	    {
	        ...
	        {
	            Assert.AreEqual("Error starting statement: The property wildcard syntax must be used without column name [select simpleProperty.* as a from com.espertech.esper.support.bean.SupportBeanComplexProps as s0]", ex.Message);
	        }
	    }
	    ...
	    public void TestObjectModelJoinAlias()
	    {
	        ...
	        model.FromClause = FromClause.Create()
	                .Add(FilterStream.Create(typeof(SupportBean).FullName, "s0").AddView("win", "keepall"))
	                .Add(FilterStream.Create(typeof(SupportMarketDataBean).FullName, "s1").AddView("win", "keepall"));

	        var selectTestView = _epService.EPAdministrator.Create(model);
	        selectTestView.AddListener(_testListener);

	        var viewExpr = "select s0.*, s1.* as s1stream, TheString as sym from " + typeof(SupportBean).FullName + ".win:keepall() as s0, " +
	    ...
	    {
	        var viewExpr = "select *, win.* from " + typeof(SupportBean).FullName + ".win:length(3) as win";
	    ...
	    {
	        var viewExpr = "select *, s1.* from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select *, win.* as s0 from " + typeof(SupportBean).FullName + ".win:length(3) as win";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select *, s1.* as s1stream, s0.* as s0stream from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select TheString.* as s0, IntPrimitive as a, TheString.* as s1, IntPrimitive as b from " + typeof(SupportBean).FullName + ".win:length(3) as TheString";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select IntPrimitive, s1.* as s1stream, TheString, Symbol as sym, s0.* as s0stream from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select IntPrimitive, s1.*, Symbol as sym from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select TheString.* from " + typeof(SupportBean).FullName + ".win:length(3) as TheString";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select TheString.* as s0 from " + typeof(SupportBean).FullName + ".win:length(3) as TheString";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        var viewExpr = "select s1.* as s1 from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	        var selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	        ...
	        // reverse streams
	        viewExpr = "select s0.* as szero from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	    ...
	    public void TestAloneJoinNoAlias()
	    {
	        ...
	        // reverse streams
	        viewExpr = "select s0.* from " + typeof(SupportBean).FullName + ".win:length(3) as s0, " +
	                typeof(SupportMarketDataBean).FullName + ".win:keepall() as s1";
	        selectTestView = _epService.EPAdministrator.CreateEPL(viewExpr);
	        selectTestView.AddListener(_testListener);
	    ...
	    {
	        TryInvalid("select TheString.* as TheString, TheString from " + typeof(SupportBean).FullName + ".win:length(3) as TheString",
	        ...
	        TryInvalid("select s1.* as abc from " + typeof(SupportBean).FullName + ".win:length(3) as s0",
	        ...
	        TryInvalid("select s0.* as abc, s0.* as abc from " + typeof(SupportBean).FullName + ".win:length(3) as s0",
	        ...
	        TryInvalid("select s0.*, s1.* from " + typeof(SupportBean).FullName + ".win:keepall() as s0, " + typeof(SupportBean).FullName + ".win:keepall() as s1",
