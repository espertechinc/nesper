...
namespace com.espertech.esper.regression.epl
{
	...
	public class TestVariables 
	{
	    ...
	    public void TestConstantVariable()
        {
	        ...
	        EventTypeAssertionUtil.AssertEventTypeProperties(expectedType, stmtArrayOne.EventType, EventTypeAssertionEnum.NAME, EventTypeAssertionEnum.TYPE);
	        ...
	        EventTypeAssertionUtil.AssertEventTypeProperties(expectedType, stmtArrayTwo.EventType, EventTypeAssertionEnum.NAME, EventTypeAssertionEnum.TYPE);
	    ...
	    public void TestSetSubquery()
	    {
	        ...
	        var stmtTextSet = "on " + typeof(SupportBean_S0).FullName + " as s0str set var1 = (select p10 from S1.std:lastevent()), var2 = (select p11||s0str.p01 from S1.std:lastevent())";
	    ...
	    public void TestCoercion()
	    {
	        ...
	        var stmtText = "select irstream var1, var2, var3, id from " + typeof(SupportBean_A).FullName + ".win:length(2)";
	        var stmtSelect = _epService.EPAdministrator.CreateEPL(stmtText);
	        stmtSelect.AddListener(_listener);
	    ...
	    public void TestInvalidSet()
	    {
	        ...
	        TryInvalidSet("on " + typeof(SupportBean).FullName + " set var1 = 1",
                          "Error starting statement: Variable 'var1' of declared type System.String cannot be assigned a value of type " + Name.Of<int>() + " [on com.espertech.esper.support.bean.SupportBean set var1 = 1]");

	        TryInvalidSet("on " + typeof(SupportBean).FullName + " set var3 = 'abc'",
                          "Error starting statement: Variable 'var3' of declared type " + Name.Of<int>() + " cannot be assigned a value of type " + Name.Of<string>() + " [on com.espertech.esper.support.bean.SupportBean set var3 = 'abc']");

	        TryInvalidSet("on " + typeof(SupportBean).FullName + " set var3 = DoublePrimitive",
                          "Error starting statement: Variable 'var3' of declared type " + Name.Of<int>() + " cannot be assigned a value of type " + Name.Of<double>() + " [on com.espertech.esper.support.bean.SupportBean set var3 = DoublePrimitive]");
	        ...
	        TryInvalidSet("on " + typeof(SupportBean).FullName + " set var3", "Error starting statement: Missing variable assignment expression in assignment number 0 [on com.espertech.esper.support.bean.SupportBean set var3]");
	    }
