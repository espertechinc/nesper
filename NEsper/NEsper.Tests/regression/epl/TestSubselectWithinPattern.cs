...
namespace com.espertech.esper.regression.epl
{
    ...
    public class TestSubselectWithinPattern
    {
        ...
        public void TestInvalid() {
            ...
            _epService.EPAdministrator.CreateEPL("create window MyWindow.std:lastevent() as select * from S0");
        ...
        public void TestFilterPatternNamedWindowNoAlias()
        {
            ...
            EPStatement stmtNamedThree = _epService.EPAdministrator.CreateEPL("create window MyS1Window.std:lastevent() as select * from S1");
            ...
            EPStatement stmtNamedFour = _epService.EPAdministrator.CreateEPL("create window MyS1Window.std:lastevent() as select * from S1");
