...
namespace com.espertech.esper.epl.parse
{
    public class TestEPLParser
    {
        ...
        public void TestValidCases()
        {
            ...
            AssertIsValid("select * from pattern [a=" + typeof(SupportBean).FullName + "]#length(100) as xyz");
            AssertIsValid("select * from pattern [a=" + typeof(SupportBean).FullName + "]#length(100)#someview() as xyz");
