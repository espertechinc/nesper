...
namespace com.espertech.esper.support.epl
{
    ...
    public class SupportStaticMethodLib 
    {
        ...
        public static MyMethodReturn[] FetchPOCOArray(String mystring, int myint)
        {
            if (myint < 0) {
                return null;
            }
        ...
        public static ICollection<MyMethodReturn> FetchPOCOCollection(String mystring, int myint)
        {
            if (myint < 0) {
                return null;
            }
        ...
        public static IEnumerable<MyMethodReturn> FetchPOCOIterable(String mystring, int myint)
        {
            if (myint < 0)
            {
                return null;
            }
            return FetchPOCOCollection(mystring, myint);
        }
        
        public static IEnumerator<MyMethodReturn> FetchPOCOIterator(String mystring, int myint)
        {
            if (myint < 0) {
                return null;
            }
            return FetchPOCOCollection(mystring, myint).GetEnumerator();
        }

        public static MyMethodReturn[] FetchPOCOArrayMR(String theString, int id)
        {
            if (id < 0)
            {
                return null;
        ...
        public static ICollection<MyMethodReturn> FetchPOCOCollectionMR(String theString, int id)
        {
            if (id < 0)
            {
                return null;
        ...
        public static IEnumerable<MyMethodReturn> FetchPOCOIterableMR(String theString, int id)
        {
            if (id < 0)
            {
                return null;
            }
            return FetchPOCOCollectionMR(theString, id);
        }


        public static IEnumerator<MyMethodReturn> FetchPOCOIteratorMR(String theString, int id)
        {
            if (id < 0) {
                return null;
            }
            return FetchPOCOCollectionMR(theString, id).GetEnumerator();
        }
