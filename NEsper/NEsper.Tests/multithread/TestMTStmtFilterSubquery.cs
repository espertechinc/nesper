...
namespace com.espertech.esper.multithread
{
    ...
    public class TestMTStmtFilterSubquery 
    {
        ...
        {
            _engine.EPAdministrator.CreateEPL("create window MyWindow.win:keepall() as SupportBean_S0");
        ...
        {
            const string epl = "select * from SupportBean(not exists (select * from SupportBean_S0.win:keepall() mw where mw.P00 = 'E'))";
            _engine.EPAdministrator.CreateEPL(epl);
