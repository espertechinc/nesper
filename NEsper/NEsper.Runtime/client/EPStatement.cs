...
namespace com.espertech.esper.runtime.client
{
	...
	public interface EPStatement : EPListenable, EPIterable {
	    ...
	    /// <para />See the annotation <seealso cref="com.espertech.esper.common.client.annotation" /> package for
	    /// available annotations. Application can define their own annotations.
	    /// </summary>
	    /// <returns>annotations or a zero-length array if no annotaions have been specified.</returns>
	    ...
	    /// <para />Note: Requires the allow-subscriber compiler options.
	    ...
	    /// <throws>EPSubscriberException if the subscriber does not provide the methodsneeded to receive statement results
	    /// </throws>
	    ...
	    /// <throws>EPSubscriberException if the subscriber does not provide the methodsneeded to receive statement results
	    /// </throws>
	    void SetSubscriber(object subscriber, string methodName) ;
	    ...
	    /// <para />The <em>user object</em> is a single, unnamed field that is stored with every statement.
	    /// Applications may put arbitrary objects in this field or a null value.
	    /// <para />User objects are passed at time of statement compilation via options.
	    /// </summary>
	    ...
	    /// <para />The <em>user object</em> is a single, unnamed field that is stored with every statement.
	    /// Applications may put arbitrary objects in this field or a null value.
	    /// <para />User objects are passed at time of deployment via options.
	    /// </summary>
	    /// <returns>user object or null if none defined</returns>
