...
namespace com.espertech.esper.runtime.@internal.metrics.stmtmetrics
{
    public static class PerformanceMetricsHelper
    {
        ...
        public static PerformanceMetricResult Call(
            ...
            int numInput = 1)
        {
            ...
            long kernelTimeNano = 0L;
            long userTimeNano = 0L;
            long wallTimeNano = lWallTimeB - lWallTimeA;
            ...
            var userTimeNano = 100 * (userTimeB - userTimeA);
            var kernelTimeNano = 100 * (kernelTimeB - kernelTimeA);
            var wallTimeNano = lWallTimeB - lWallTimeA;
    ...
    public struct PerformanceMetricResult
    {
        ...
        public PerformanceMetricResult(
            long kernelTime,
            long userTime,
            long wallTime,
            int numInput)
