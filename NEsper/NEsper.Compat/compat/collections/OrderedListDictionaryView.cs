...
{
    /// <summary>
    ///     An efficient subsection of an ordered list dictionary.  Designed for traversal and lookup, but not
    ///     necessarily efficient at counting elements.
    /// </summary>
    public class OrderedListDictionaryView<TK, TV> : IOrderedDictionary<TK, TV>
    {
        ...
        /// </returns>
        public int Count => _parent.CountInRange(_range);
        ...
        /// </summary>
        public KeyValuePair<TK, TV> FirstEntry => _parent.FirstInRange(_range);

        /// <summary>
        ///     Returns the last key-value pair in the dictionary.  If the dictionary
        ///     is empty, this method throws an InvalidOperationException.
        /// </summary>
        public KeyValuePair<TK, TV> LastEntry => _parent.LastInRange(_range);
