...
namespace com.espertech.esper.compat.collections
{
	...
	public class BaseMap<TK, TV> : IDictionary<TK, TV>
	{
		...
		protected IDictionary<TK, TV> SubDictionary {
			get => _subDictionary;
		...
		protected BaseMap(IDictionary<TK, TV> subDictionary)
		{
		...
		public TV this[TK key] {
			...
			set {
				if (key != null) {
					...
					_nullEntry = new KeyValuePair<TK, TV>(key, value);
				}
			}
		}
		...
		public ICollection<TK> Keys => _nullEntry == null
			? _subDictionary.Keys
			: new CollectionPlus<TK>(_subDictionary.Keys, _nullEntry.Value.Key);
		...
		public ICollection<TV> Values => _nullEntry == null
			? _subDictionary.Values
			: new CollectionPlus<TV>(_subDictionary.Values, _nullEntry.Value.Value);
		...
		public void Add(KeyValuePair<TK, TV> item)
		{
			if (item.Key != null) {
				...
				_nullEntry = new KeyValuePair<TK, TV>(item.Key, item.Value);
			}
		}
		...
		{
			if (_nullEntry != null) {
				array[arrayIndex++] = new KeyValuePair<TK, TV>(
