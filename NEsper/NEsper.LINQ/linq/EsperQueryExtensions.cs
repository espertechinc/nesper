...
using Expression = com.espertech.esper.common.client.soda.Expression;
...
namespace com.espertech.esper.runtime.client.linq
{
    public static class EsperQueryExtensions
    {
        ...
        /// <param name="expression">The expression.</param>
        /// <returns></returns>
        public static EsperQuery<T> Having<T>(
            this EsperQuery<T> esperQuery,
            Expression<Func<T, bool>> expression)
        {
            var parentObjectModel = esperQuery.ObjectModel;
        ...
        /// <returns></returns>
        public static EsperQuery<T> RowLimit<T>(
            this EsperQuery<T> esperQuery,
        ...
        /// <param name="keySelectionExpression">The key selection expression.</param>
        /// <returns></returns>
        public static EsperQuery<TSource> OrderBy<TSource, TKey>(
            this EsperQuery<TSource> esperQuery,
            Expression<Func<TSource, TKey>> keySelectionExpression)
        {
            var parentObjectModel = esperQuery.ObjectModel;
        ...
        /// <param name="keySelectionExpression">The key selection expression.</param>
        /// <returns></returns>
        public static EsperQuery<TSource> OrderByDescending<TSource, TKey>(
            this EsperQuery<TSource> esperQuery,
            Expression<Func<TSource, TKey>> keySelectionExpression)
        {
            var parentObjectModel = esperQuery.ObjectModel;
