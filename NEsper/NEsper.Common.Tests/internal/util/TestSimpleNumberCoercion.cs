...
{
    [TestFixture]
    public class TestSimpleNumberCoercion : CommonTest
    {
        [Test]
        public void TestGetCoercer()
        {
            ...
            Assert.AreEqual(10m, SimpleNumberCoercerFactory.GetCoercerBigInteger(typeof(BigInteger)).CoerceBoxedBigInt(10m));
