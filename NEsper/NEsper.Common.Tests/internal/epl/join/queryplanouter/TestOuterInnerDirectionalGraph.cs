...
{
    [TestFixture]
    public class TestOuterInnerDirectionalGraph : CommonTest
    {
        [SetUp]
        public void SetUp()
        {
        ...
        private void TryInvalidIsInner(
            int inner,
            int outer)
        {
            try
        ...
        private void TryInvalidIsOuter(
            int inner,
            int outer)
        {
            try
        ...
        public void TestGetInner()
        {
            ...
            graph.Add(1, 0);
            EPAssertionUtil.AssertEqualsAnyOrder(new[] { 0 }, graph.GetInner(1));
            graph.Add(1, 2);
            graph.Add(1, 3);
        ...
        public void TestGetOuter()
        {
            ...
            graph.Add(1, 0);
            EPAssertionUtil.AssertEqualsAnyOrder(new[] { 0 }, graph.GetOuter(1));
            EPAssertionUtil.AssertEqualsAnyOrder(new[] { 1 }, graph.GetOuter(0));
            graph.Add(1, 3);
            graph.Add(2, 3);
