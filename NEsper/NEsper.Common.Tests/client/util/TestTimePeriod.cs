...
namespace com.espertech.esper.common.client.util
{
    ...
    public class TestTimePeriod : AbstractCommonTest
    {
        ...
        public void TestLargestAbsoluteValue()
        {
            ...
            Assert.AreEqual(9, (int) new TimePeriod().SetMicros(9).LargestAbsoluteValue());
            Assert.AreEqual(10, (int) new TimePeriod().SetMillis(9).SetSeconds(10).SetHours(3).LargestAbsoluteValue());
            Assert.AreEqual(10, (int) new TimePeriod().SetMicros(1).SetMillis(9).SetSeconds(10).SetHours(3).LargestAbsoluteValue());
            Assert.AreEqual(1, (int) new TimePeriod().SetYears(1).SetMonths(1)
