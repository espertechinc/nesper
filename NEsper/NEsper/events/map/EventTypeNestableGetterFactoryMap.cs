...
namespace com.espertech.esper.events.map
{
    ...
    {
        public EventPropertyGetter GetPropertyProvidedGetter(
        ...
        public EventPropertyGetter GetGetterProperty(
            String name,
        ...
        public EventPropertyGetter GetGetterBeanNestedArray(
            String name,
            EventType eventType,
            EventAdapterService eventAdapterService)
        {
        ...
        public EventPropertyGetter GetGetterIndexedUnderlyingArray(
        ...
        public EventPropertyGetter GetGetterIndexedPONO(
            String propertyNameAtomic,
            int index,
            EventAdapterService eventAdapterService,
            Type componentType)
        ...
        public EventPropertyGetter GetGetterIndexedEntryPONO(
            String propertyNameAtomic,
            int index,
        ...
        {
            return new MapArrayBeanEntryIndexedPropertyGetter(
        ...
        public EventPropertyGetter GetGetterNestedEntryBean(
            String propertyName,
            ...
            EventAdapterService eventAdapterService)
        {
            if (getter is ObjectArrayEventPropertyGetter)
            {
                return new MapNestedEntryPropertyGetterObjectArray(
                    propertyName, innerType, eventAdapterService, (ObjectArrayEventPropertyGetter) getter);
            }
            return new MapNestedEntryPropertyGetterMap(
                propertyName, innerType, eventAdapterService, (MapEventPropertyGetter) getter);
        }

        public EventPropertyGetter GetGetterNestedEntryBeanArray(
            String propertyNameAtomic,
            int index,
            EventPropertyGetter getter,
            EventType innerType,
            EventAdapterService eventAdapterService)
        {
            if (getter is ObjectArrayEventPropertyGetter)
            {
                return new MapNestedEntryPropertyGetterArrayObjectArray(
                    propertyNameAtomic, innerType, eventAdapterService, index, (ObjectArrayEventPropertyGetter) getter);
            }
            return new MapNestedEntryPropertyGetterArrayMap(
                propertyNameAtomic, innerType, eventAdapterService, index, (MapEventPropertyGetter) getter);
        }

        public EventPropertyGetter GetGetterBeanNested(
            String name,
            EventType eventType,
            EventAdapterService eventAdapterService)
        {
        ...
        public EventPropertyGetter GetGetterNestedPropertyProvidedGetterDynamic(
            IDictionary<String, Object> nestableTypes,
            String propertyName,
            EventPropertyGetter nestedGetter,
            EventAdapterService eventAdapterService)
        {
            return new MapNestedEntryPropertyGetterPropertyProvidedDynamic(
                propertyName, null, eventAdapterService, nestedGetter);
        }
    }
}
