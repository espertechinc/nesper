    ...
    public class EPStatementStartMethodOnTrigger : EPStatementStartMethodBase
    {
            ...
            bool isRecoveringResilient)
        {
            ...
            if (StatementSpec.OnTriggerDesc is OnTriggerWindowDesc) {
                ...
                else if (services.NamedWindowService.GetProcessor(onTriggerDesc.WindowName) != null) {
            ...
            var resultEventType = contextFactoryResult.ResultSetProcessorPrototype == null ? null : contextFactoryResult.ResultSetProcessorPrototype.ResultSetProcessorFactory.ResultEventType;
            ...
            if (tableMetadata != null) {
                destroyCallbacks.AddCallback(new EPStatementDestroyCallbackTableIdxRef(services.TableService, tableMetadata, statementContext.StatementName).Destroy);
                destroyCallbacks.AddCallback(new EPStatementDestroyCallbackTableUpdStr(services.TableService, tableMetadata, statementContext.StatementName).Destroy);
            }
            ...
            if (StatementSpec.OptionalContextName != null) {
                ...
                foreach (var entry in contextFactoryResult.SubSelectStrategyCollection.Subqueries) {
                    ...
                    subselectStrategyInstances.Put(entry.Key, new SubSelectStrategyHolder(specificService, subselectAggregation, subselectPriorStrategies, subselectPreviousStrategies, null, null));
                }
                ...
                var statement = new ContextManagedStatementOnTriggerDesc(StatementSpec, statementContext, mergeView, contextFactoryResult.ContextFactory);
                ...
                destroyCallbacks.AddCallback(new EPStatementDestroyCallbackContext(services.ContextManagementService, contextName, statementContext.StatementName, statementContext.StatementId).Destroy);
            }
            ...
            ActivatorResult activatorResult)
        {
            ...
            var validationContext = new ExprValidationContext(
                ...
                statementContext.ContextDescriptor, statementContext.ScriptingService, false, false, true, false, null,
                false);
            ...
            ActivatorResult activatorResult)
        {
            ...
            StreamTypeService typeService = new StreamTypeServiceImpl(new EventType[] {activatorResult.ActivatorResultEventType}, new string[] {streamName}, new bool[] {true}, services.EngineURI, false);
            ...
            processorFactories[0] = ResultSetProcessorFactoryFactory.GetProcessorPrototype(
                    statementSpec, statementContext, typeService, null, new bool[0], false, contextPropertyRegistry, null, services.ConfigSnapshot);
            ...
            foreach (var splits in desc.SplitStreams)
            {
                ...
                processorFactories[index] = ResultSetProcessorFactoryFactory.GetProcessorPrototype(
                        splitSpec, statementContext, typeService, null, new bool[0], false, contextPropertyRegistry, null, services.ConfigSnapshot);
                whereClauses[index] = splitSpec.FilterRootNode;
                isNamedWindowInsert[index] = statementContext.NamedWindowService.IsNamedWindow(splits.InsertInto.EventTypeName);
        ...
        {
            var processor = services.NamedWindowService.GetProcessor(onTriggerDesc.WindowName);
            ...
            var validationResult = ValidateOnTriggerPlanSubSelects(services, statementContext, onTriggerDesc, namedWindowType, streamSpec, activatorResult, contextPropertyRegistry, subSelectStreamDesc, null);
            ...
            if (StatementSpec.InsertIntoDesc != null) {
                ...
                addToFront = statementContext.NamedWindowService.IsNamedWindow(StatementSpec.InsertIntoDesc.EventTypeName);
            }
                    ...
                    (StatementSpec.OnTriggerDesc.OnTriggerType == OnTriggerType.ON_MERGE))
            {
                ...
                outputResultSetProcessorPrototype = ResultSetProcessorFactoryFactory.GetProcessorPrototype(defaultSelectAllSpec, statementContext, streamTypeService, null, new bool[0], true, contextPropertyRegistry, null, services.ConfigSnapshot);
            }
        ...
        private TriggerValidationPlanResult ValidateOnTriggerPlanSubSelects(
            EPServicesContext services,
            StatementContext statementContext,
            OnTriggerWindowDesc onTriggerDesc,
            ...
            string optionalTableName)
        {
            ...
            var subSelectStrategyCollection = EPStatementStartMethodHelperSubselect.PlanSubSelect(services, statementContext, IsQueryPlanLogging(services), subSelectStreamDesc, new string[]{zeroStreamAliasName, streamSpec.OptionalStreamName}, new EventType[]{namedWindowType, activatorResult.ActivatorResultEventType}, new string[]{namedWindowTypeName, activatorResult.TriggerEventTypeName}, StatementSpec.DeclaredExpressions, contextPropertyRegistry);
            ...
            var validatedJoin = ValidateJoinNamedWindow(services.EngineURI, statementContext, ExprNodeOrigin.WHERE, StatementSpec.FilterRootNode,
            ...
            var resultSetProcessorPrototype = ResultSetProcessorFactoryFactory.GetProcessorPrototype(
                    StatementSpec, statementContext, typeService, null, new bool[0], true, contextPropertyRegistry, null, services.ConfigSnapshot);
                ...
                
        {
            if (onExprContextName == null) {
                if (desiredContextName != null) {
                    throw new ExprValidationException(string.Format("Cannot create on-trigger expression: {0} was declared with context '{1}', please declare the same context name",
                        title ?? "null",
                        desiredContextName) ?? "null");
                }
                return;
            }
            if (!onExprContextName.Equals(desiredContextName)) {
                throw new ExprValidationException(string.Format("Cannot create on-trigger expression: {0} was declared with context '{1}', please use the same context instead",
                    title ?? "null",
                    desiredContextName ?? "null"));
            }
        }
            ...
            SubSelectActivationCollection subSelectStreamDesc)
        {
            ...
            // validate expressions and plan subselects
            var validationResult = ValidateOnTriggerPlanSubSelects(services, statementContext, onTriggerDesc, metadata.InternalEventType, streamSpec, activatorResult, contextPropertyRegistry, subSelectStreamDesc, metadata.TableName);
                        ...
                        foreach (var raw in insert.SelectClause)
                        {
                            ...
                            else if (raw is SelectClauseExprRawSpec)
                            {
                                ...
                                var validationContext = new ExprValidationContext(
                                    ...
                                    statementContext.ContextDescriptor, statementContext.ScriptingService, false, false,
        ...
        public class ContextFactoryResult
        {
            public ContextFactoryResult(StatementAgentInstanceFactoryOnTriggerBase contextFactory, SubSelectStrategyCollection subSelectStrategyCollection, ResultSetProcessorFactoryDesc resultSetProcessorPrototype)
            {
            ...
            public StatementAgentInstanceFactoryOnTriggerBase ContextFactory { get; private set; }

            public SubSelectStrategyCollection SubSelectStrategyCollection { get; private set; }

            public ResultSetProcessorFactoryDesc ResultSetProcessorPrototype { get; private set; }
        }
        ...
        public class ActivatorResult
        {
            ...
            public string TriggerEventTypeName { get; private set; }

            public EventType ActivatorResultEventType { get; private set; }

            public ActivatorResult(ViewableActivator activator, string triggerEventTypeName, EventType activatorResultEventType)
            {
                Activator = activator;
        ...
        public class TriggerValidationPlanResult
        {
            public TriggerValidationPlanResult(SubSelectStrategyCollection subSelectStrategyCollection, ResultSetProcessorFactoryDesc resultSetProcessorPrototype, ExprNode validatedJoin, string zeroStreamAliasName) 
            {
                SubSelectStrategyCollection = subSelectStrategyCollection;
                ResultSetProcessorPrototype = resultSetProcessorPrototype;
            ...
            public ExprNode ValidatedJoin { get; private set; }

            public string ZeroStreamAliasName { get; private set; }
        }
    }
}
