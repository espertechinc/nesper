...
namespace com.espertech.esper.core.start
{
    public class EPStatementStartMethodHelperValidate {
        ...
        public static void ValidateNoDataWindowOnNamedWindow(List<ViewFactory> viewFactories) {
        ...
        internal static void ValidateNodes(StatementSpecCompiled statementSpec,
                                            StatementContext statementContext,
                                            StreamTypeService typeService,
                                            ViewResourceDelegateUnverified viewResourceDelegate) {
            EngineImportService engineImportService = statementContext.EngineImportService;
            ...
            if (statementSpec.FilterRootNode != null) {
                ...
                try {
                    var validationContext = new ExprValidationContext(typeService, engineImportService, statementContext.StatementExtensionServicesContext, viewResourceDelegate, statementContext.SchedulingService, statementContext.VariableService, statementContext.TableService, evaluatorContextStmt, statementContext.EventAdapterService, statementContext.StatementName, statementContext.StatementId, statementContext.Annotations, statementContext.ContextDescriptor, false, false, true, false, intoTableName, false);
                    optionalFilterNode = ExprNodeUtility.GetValidatedSubtree(ExprNodeOrigin.FILTER, optionalFilterNode, validationContext);
                    if (optionalFilterNode.ExprEvaluator.Type != typeof(bool) && optionalFilterNode.ExprEvaluator.Type != typeof(bool?)) {
                        throw new ExprValidationException("The where-clause filter expression must return a bool value");
                    }
                    statementSpec.FilterExprRootNode = optionalFilterNode;
    
                    // Make sure there is no aggregation in the where clause
                    var aggregateNodes = new LinkedList<ExprAggregateNode>();
            ...
            if ((statementSpec.OutputLimitSpec != null) && ((statementSpec.OutputLimitSpec.WhenExpressionNode != null) || (statementSpec.OutputLimitSpec.AndAfterTerminateExpr != null))) {
                // Validate where clause, initializing nodes to the stream ids used
                try {
                    EventType outputLimitType = OutputConditionExpressionFactory.GetBuiltInEventType(statementContext.EventAdapterService);
                    var typeServiceOutputWhen = new StreamTypeServiceImpl(new EventType[]{outputLimitType}, new string[]{null}, new bool[]{true}, statementContext.EngineURI, false);
                    var validationContext = new ExprValidationContext(typeServiceOutputWhen, engineImportService, statementContext.StatementExtensionServicesContext, null, statementContext.SchedulingService, statementContext.VariableService, statementContext.TableService, evaluatorContextStmt, statementContext.EventAdapterService, statementContext.StatementName, statementContext.StatementId, statementContext.Annotations, statementContext.ContextDescriptor, false, false, false, false, intoTableName, false);
                    ...
                    if (outputLimitWhenNode != null) {
                        ...
                        if (TypeHelper.GetBoxedType(outputLimitWhenNode.ExprEvaluator.Type) != typeof(bool?)) {
                            throw new ExprValidationException("The when-trigger expression in the OUTPUT WHEN clause must return a bool-type value");
                        }
                    ...
                    if (statementSpec.OutputLimitSpec.AndAfterTerminateExpr != null) {
                        ...
                        ExprNode validated = ExprNodeUtility.GetValidatedSubtree(ExprNodeOrigin.OUTPUTLIMIT, statementSpec.OutputLimitSpec.AndAfterTerminateExpr, validationContext);
                        statementSpec.OutputLimitSpec.AndAfterTerminateExpr = validated;
    
                        if (TypeHelper.GetBoxedType(validated.ExprEvaluator.Type) != typeof(bool?)) {
                            throw new ExprValidationException("The terminated-and expression must return a bool-type value");
                        }
            ...
            for (int outerJoinCount = 0; outerJoinCount < statementSpec.OuterJoinDescList.Length; outerJoinCount++) {
                ...
                if (outerJoinDesc.OptLeftNode != null) {
                    UniformPair<int?> streamIdPair = ValidateOuterJoinPropertyPair(statementContext, outerJoinDesc.OptLeftNode, outerJoinDesc.OptRightNode, outerJoinCount,
                    ...
                    if (outerJoinDesc.AdditionalLeftNodes != null) {
                        ...
                        for (int i = 0; i < outerJoinDesc.AdditionalLeftNodes.Length; i++) {
                            UniformPair<int?> streamIdPairAdd = ValidateOuterJoinPropertyPair(statementContext, outerJoinDesc.AdditionalLeftNodes[i], outerJoinDesc.AdditionalRightNodes[i], outerJoinCount,
                                    typeService, viewResourceDelegate);
        ...
        internal static UniformPair<int?> ValidateOuterJoinPropertyPair(
            ...
            var evaluatorContextStmt = new ExprEvaluatorContextStatement(statementContext, false);
            try {
                var validationContext = new ExprValidationContext(typeService, statementContext.EngineImportService, statementContext.StatementExtensionServicesContext, viewResourceDelegate, statementContext.SchedulingService, statementContext.VariableService, statementContext.TableService, evaluatorContextStmt, statementContext.EventAdapterService, statementContext.StatementName, statementContext.StatementId, statementContext.Annotations, statementContext.ContextDescriptor, false, false, true, false, null, false);
        ...
        internal static ExprNode ValidateExprNoAgg(ExprNodeOrigin exprNodeOrigin, ExprNode exprNode, StreamTypeService streamTypeService, StatementContext statementContext, ExprEvaluatorContext exprEvaluatorContext, string errorMsg, bool allowTableConsumption) {
            var validationContext = new ExprValidationContext(streamTypeService, statementContext.EngineImportService, statementContext.StatementExtensionServicesContext, null, statementContext.SchedulingService, statementContext.VariableService, statementContext.TableService, exprEvaluatorContext, statementContext.EventAdapterService, statementContext.StatementName, statementContext.StatementId, statementContext.Annotations, statementContext.ContextDescriptor, false, false, allowTableConsumption, false, null, false);
