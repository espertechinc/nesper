...
namespace com.espertech.esper.core.service
{
	public class ResultDeliveryStrategyMapWStmt : ResultDeliveryStrategyMap
    {
	    ...
	    public ResultDeliveryStrategyMapWStmt(EPStatement statement, object subscriber, MethodInfo method, string[] columnNames)
	        : base(statement, subscriber, method, columnNames)
        {
	    }
