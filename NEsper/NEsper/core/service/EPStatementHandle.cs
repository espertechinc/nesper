...
namespace com.espertech.esper.core.service
{
    ...
    public class EPStatementHandle : MetaDefItem
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (EPStatementHandle)) return false;
