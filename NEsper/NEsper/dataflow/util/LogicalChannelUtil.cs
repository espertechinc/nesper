...
namespace com.espertech.esper.dataflow.util
{
    ...
    {
        public static List<LogicalChannelBinding> GetBindingsConsuming(int producerOpNum, IList<LogicalChannelBinding> bindings)
        {
        ...
        public static List<LogicalChannelProducingPortCompiled> GetOutputPortByStreamName(ICollection<int> incomingOpNums, String[] inputStreamNames, IDictionary<int, IList<LogicalChannelProducingPortCompiled>> compiledOutputPorts)
        {
            ...
            foreach (int @operator in incomingOpNums)
            {
                ...
                if (opPorts != null)
                {  // Can be null if referring to itself
