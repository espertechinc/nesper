...
namespace com.espertech.esper.rowregex
{
    ...
    /// </summary>
    public class RegexNFAStateOneOptional
        : RegexNFAStateBase
        , RegexNFAState
    {
        ...
        public RegexNFAStateOneOptional(String nodeNum, String variableName, int streamNum, bool multiple, bool? isGreedy, ExprNode exprNode, bool exprRequiresMultimatchState)
