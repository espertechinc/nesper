...
namespace com.espertech.esper.rowregex
{
    ...
    /// </summary>
    public class RegexNFAStateZeroToMany
        : RegexNFAStateBase
        , RegexNFAState
    {
        ...
        public RegexNFAStateZeroToMany(String nodeNum, String variableName, int streamNum, bool multiple, bool? isGreedy, ExprNode exprNode, bool exprRequiresMultimatchState)
