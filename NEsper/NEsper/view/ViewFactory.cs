...
namespace com.espertech.esper.view
{
    ...
    public interface ViewFactory
    {
        ...
        /// <summary>
        /// Attaches the factory to a parent event type such that the factory can validate attach requirements
        /// and determine an event type for resulting views.
        /// </summary>
        ...
        /// <summary>
        /// Determines if the given view could be used instead of creating a new view, requires the view factory to compare view type, parameters 
        /// and other capabilities provided.
        /// </summary>
        ...
        /// </returns>
        bool CanReuse(View view, AgentInstanceContext agentInstanceContext);
