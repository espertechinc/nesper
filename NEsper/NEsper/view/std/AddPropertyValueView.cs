...
namespace com.espertech.esper.view.std
{
        ...
        , StoppableView
    {
        ...
        {
            return new AddPropertyValueView(_agentInstanceContext, _propertyNames, _propertyValues, _eventType);
        }
        ...
        public override Viewable Parent
        {
            set
            {
                ...
                _mustAddProperty = value.EventType != _eventType;
            }
        }
        ...
        public override void Update(EventBean[] newData, EventBean[] oldData)
        {
            ...
            if (oldData != null)
            {
                ...
                {
                    var outgoing = _newToOldEventMap.Pluck(oldEvent);
                    if (outgoing != null)
                    {
        ...
        {
            IEnumerator<EventBean> parentIterator = base.Parent.GetEnumerator();
            while (parentIterator.MoveNext())
            {
                ...
                if (_mustAddProperty)
                {
                    yield return AddProperty(
                        nextEvent, _propertyNames, _propertyValues, _eventType,
        ...
        internal static EventBean AddProperty(EventBean originalEvent,
        ...
        {
            return GetType().FullName + " propertyNames=" + _propertyNames.Render() +
