...
namespace com.espertech.esper.view.window
{
    ...
    {
        private readonly IDictionary<EventBean, IStreamRelativeAccess> _accessorByEvent = 
            new Dictionary<EventBean, IStreamRelativeAccess>();
        private readonly IDictionary<IStreamRelativeAccess, EventBean[]> _eventsByAccessor = 
            new Dictionary<IStreamRelativeAccess, EventBean[]>();
