...
namespace com.espertech.esper.view.window
{
    ...
    public class TimeBatchViewFactoryParams
    {
        ...
        /// </summary>
        internal ExprTimePeriodEvalDeltaConstFactory timeDeltaComputationFactory;
        ...
        protected void ProcessKeywords(Object keywords, string errorMessage)
        {
            ...
            string[] keyword = ((string) keywords).SplitCsv();
            for (int i = 0; i < keyword.Length; i++)
            {
                ...
                else
                {
                    ...
                    throw new ViewParameterException(
                        "TimeInMillis-length-combination view encountered an invalid keyword '" + keywordText +
                        "', valid control keywords are: " + keywordRange);
                }
            }
        }

        public bool IsForceUpdate { get; protected set; }

        public bool IsStartEager { get; protected set; }
    }
} // end of namespace
