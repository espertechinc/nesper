...
namespace com.espertech.esper.view
{
    ...
    public interface ViewService
    {
        ...
        /// <summary>
        /// Creates the views given a chain of view factories. <para/>Attempts to reuse compatible views under then parent event stream viewable as indicated by each view factories reuse method.
        /// </summary>
