...
namespace com.espertech.esper.util
{
    public class SerializerFactory
    {
        ...
        static SerializerFactory()
        {
            ...
            Serializers.Add(new SmartSerializer<bool>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadBoolean()
            });
            Serializers.Add(new SmartSerializer<char>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadChar()
            });
            Serializers.Add(new SmartSerializer<byte>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadByte()
            });
            Serializers.Add(new SmartSerializer<short>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadInt16()
            });
            Serializers.Add(new SmartSerializer<int>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadInt32()
            });
            Serializers.Add(new SmartSerializer<long>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadInt64()
            });
            Serializers.Add(new SmartSerializer<float>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadSingle()
            });
            Serializers.Add(new SmartSerializer<double>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadDouble()
            });
            Serializers.Add(new SmartSerializer<decimal>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
                ProcDeserialize = reader => reader.ReadDecimal()
            });
            Serializers.Add(new SmartSerializer<string>
            {
                ProcSerialize = (obj, writer) => writer.Write(obj),
        ...
        public static byte[] Serialize(Serializer[] serializers, Object[] objects)
        {
