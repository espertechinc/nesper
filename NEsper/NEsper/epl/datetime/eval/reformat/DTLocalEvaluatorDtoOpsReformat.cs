...
{
    internal class DTLocalEvaluatorDtoOpsReformat : DTLocalEvaluatorCalopReformatBase
    {
        private readonly TimeZoneInfo _timeZone;

        internal DTLocalEvaluatorDtoOpsReformat(IList<CalendarOp> calendarOps, ReformatOp reformatOp, TimeZoneInfo timeZoneInfo)
