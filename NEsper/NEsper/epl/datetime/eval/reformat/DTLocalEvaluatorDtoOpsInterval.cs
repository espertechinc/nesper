...
{
    internal class DTLocalEvaluatorDtoOpsInterval : DTLocalEvaluatorCalOpsIntervalBase
    {
        private readonly TimeZoneInfo _timeZone;

        internal DTLocalEvaluatorDtoOpsInterval(
        ...
        {
            var startLong = ((DateTimeOffset)startTimestamp).TimeInMillis();
            var endLong = ((DateTimeOffset)endTimestamp).TimeInMillis();
