...
{
    internal class DTLocalEvaluatorLongReformat : DTLocalEvaluatorReformatBase
    {
        ...
        {
            return ReformatOp.Evaluate((long)target, evaluateParams.EventsPerStream, evaluateParams.IsNewData, evaluateParams.ExprEvaluatorContext);
        }
    }
}
