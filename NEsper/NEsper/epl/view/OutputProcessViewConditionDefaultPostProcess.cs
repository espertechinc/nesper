...
namespace com.espertech.esper.epl.view
{
    ...
    public class OutputProcessViewConditionDefaultPostProcess : OutputProcessViewConditionDefault
    {
        ...
        public OutputProcessViewConditionDefaultPostProcess(
            ...
            : base(
                resultSetProcessorHelperFactory, resultSetProcessor, afterConditionTime, afterConditionNumberOfEvents,
                afterConditionSatisfied, parent, agentInstanceContext, isJoin)
        {
