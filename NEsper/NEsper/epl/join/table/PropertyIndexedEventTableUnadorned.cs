...
{
	public class PropertyIndexedEventTableUnadorned : PropertyIndexedEventTable
	{
	    protected readonly IDictionary<MultiKeyUntyped, ISet<EventBean>> propertyIndex;
	    ...
	    {
	        get { return typeof (PropertyIndexedEventTable); }
	    }
	}
} // end of namespace
