	...
	public class ResultSetProcessorFactoryFactory
	{
	        ...
	        AggregationGroupByRollupLevel level)
	    {
	        ...
	        foreach (var groupingNodePair in groupingVisitor.GroupingNodes) {
	            ...
	            ExprConstantNodeImpl constant = new ExprConstantNodeImpl(result, typeof(int?));
	    ...
	    private static IList<OrderByItem> ExpandColumnNames(SelectClauseElementCompiled[] selectionList, OrderByItem[] orderByUnexpanded)
	    {
