...
namespace com.espertech.esper.epl.core.eval
{
    public abstract class EvalSelectStreamBaseObjectArray : EvalSelectStreamBase, SelectExprProcessor
    {
        ...
        protected EvalSelectStreamBaseObjectArray(SelectExprContext selectExprContext, EventType resultEventType, IList<SelectClauseStreamCompiledSpec> namedStreams, bool usingWildcard)
