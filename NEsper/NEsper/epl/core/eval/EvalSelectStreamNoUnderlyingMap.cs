...
namespace com.espertech.esper.epl.core.eval
{
    public class EvalSelectStreamNoUnderlyingMap : EvalSelectStreamBaseMap, SelectExprProcessor
    {
        ...
        public EvalSelectStreamNoUnderlyingMap(SelectExprContext selectExprContext, EventType resultEventType, IList<SelectClauseStreamCompiledSpec> namedStreams, bool usingWildcard)
