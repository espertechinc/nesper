...
{
    public class EvalInsertNoWildcardSingleColCoercionAvroWrap : EvalBaseFirstPropFromWrap, SelectExprProcessor
    {
        ...
        {
            EventBean wrappedEvent = base.EventAdapterService.AdapterForTypedAvro(result, Wrapper.UnderlyingEventType);
