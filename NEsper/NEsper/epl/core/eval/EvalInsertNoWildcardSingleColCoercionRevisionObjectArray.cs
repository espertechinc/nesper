...
{
    public class EvalInsertNoWildcardSingleColCoercionRevisionObjectArray : EvalBaseFirstProp, SelectExprProcessor
    {
        ...
        {
            EventBean wrappedEvent = base.EventAdapterService.AdapterForTypedObjectArray((Object[])result, base.ResultEventType);
