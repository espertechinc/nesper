...
{
	public class ResultSetProcessorAggregateGroupedOutputAllHelper
    {
	    ...
	    public ResultSetProcessorAggregateGroupedOutputAllHelper(ResultSetProcessorAggregateGrouped processor) {
	    ...
	    public void ProcessView(EventBean[] newData, EventBean[] oldData, bool isGenerateSynthetic) {
	        ...
	        if (_processor.Prototype.IsSelectRStream) {
	            _processor.GenerateOutputBatchedView(oldData, oldDataMultiKey, false, isGenerateSynthetic, _eventsOld, null);
	        }
	        _processor.GenerateOutputBatchedView(newData, newDataMultiKey, true, isGenerateSynthetic, _eventsNew, null);
	    ...
	    public void ProcessJoin(ISet<MultiKey<EventBean>> newData, ISet<MultiKey<EventBean>> oldData, bool isGenerateSynthetic) {
	        ...
	        if (_processor.Prototype.IsSelectRStream) {
	            _processor.GenerateOutputBatchedJoin(oldData, oldDataMultiKey, false, isGenerateSynthetic, _eventsOld, null);
	        }
	        _processor.GenerateOutputBatchedJoin(newData, newDataMultiKey, false, isGenerateSynthetic, _eventsNew, null);
