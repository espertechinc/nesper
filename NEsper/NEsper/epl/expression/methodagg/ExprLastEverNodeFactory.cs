...
{
    [Serializable]
	public class ExprLastEverNodeFactory : AggregationMethodFactory
	{
	    private readonly ExprLastEverNode _parent;
	    private readonly Type _childType;

	    public ExprLastEverNodeFactory(ExprLastEverNode parent, Type childType) {
	        this._parent = parent;
	    ...
	    public AggregationMethod Make(MethodResolutionService methodResolutionService, int agentInstanceId, int groupId, int aggregationId) {
	        return methodResolutionService.MakeLastEverValueAggregator(agentInstanceId, groupId, aggregationId, _childType, _parent.HasFilter);
	    }
