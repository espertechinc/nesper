...
{
    [Serializable]
	public class ExprStddevNodeFactory : AggregationMethodFactory
	{
	    private readonly ExprStddevNode _parent;
	    private readonly Type _aggregatedValueType;

	    public ExprStddevNodeFactory(ExprStddevNode parent, Type aggregatedValueType) {
	        this._parent = parent;
        ...
        public AggregationMethod Make(MethodResolutionService methodResolutionService, int agentInstanceId, int groupId, int aggregationId) {
	        AggregationMethod method = methodResolutionService.MakeStddevAggregator(agentInstanceId, groupId, aggregationId, _parent.HasFilter);
        ...
        public void ValidateIntoTableCompatible(AggregationMethodFactory intoTableAgg) {
	        ...
	        ExprStddevNodeFactory that = (ExprStddevNodeFactory) intoTableAgg;
