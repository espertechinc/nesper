...
{
    [Serializable]
	public class ExprMedianNodeFactory : AggregationMethodFactory
	{
	    private readonly ExprMedianNode _parent;
	    private readonly Type _aggregatedValueType;

	    public ExprMedianNodeFactory(ExprMedianNode parent, Type aggregatedValueType)
	    {
	        this._parent = parent;
        ...
        public void ValidateIntoTableCompatible(AggregationMethodFactory intoTableAgg) {
	        ...
	        ExprMedianNodeFactory that = (ExprMedianNodeFactory) intoTableAgg;
