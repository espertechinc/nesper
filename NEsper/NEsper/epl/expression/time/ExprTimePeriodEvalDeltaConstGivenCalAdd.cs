...
namespace com.espertech.esper.epl.expression.time
{
        ...
        , ExprTimePeriodEvalDeltaConstFactory
    {
        ...
        public ExprTimePeriodEvalDeltaConstGivenCalAdd(
        ...
        {
            if (otherComputation is ExprTimePeriodEvalDeltaConstGivenCalAdd)
            {
                var other = (ExprTimePeriodEvalDeltaConstGivenCalAdd) otherComputation;
