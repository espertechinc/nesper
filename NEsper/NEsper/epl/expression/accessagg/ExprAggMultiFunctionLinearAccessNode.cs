        ...
        , ExprAggregateAccessMultiValueNode
    {
            ...
            ExprValidationContext validationContext)
        {
            ...
            if (evaluatorIndex != null)
            {
                ...
                accessor = new AggregationAccessorFirstLastIndexWEval(
                    streamNum, evaluator, evaluatorIndex.ExprEvaluator, constant, isFirst);
            }
            else
            {
            ...
            {
                var factory =
                    validationContext.EngineImportService.AggregationFactoryFactory.MakeLinearUnbounded(
                        validationContext.StatementExtensionSvcContext, this, containedType, accessorResultType,
                        streamNum);
            ...
            var stateKey = new AggregationStateKeyWStream(
                streamNum, containedType, AggregationStateTypeWStream.DATAWINDOWACCESS_LINEAR, new ExprNode[0]);
            ...
            var factoryX = new ExprAggMultiFunctionLinearAccessNodeFactoryAccess(
                this, accessor, accessorResultType, containedType,
            ...
            TableMetadataColumnAggregation tableAccess)
        {
            ...
            {
                var factoryAccess = new ExprAggMultiFunctionLinearAccessNodeFactoryAccess(
                    this, defaultAccessor, resultType, original.ContainedEventType, null, null, null);
            ...
            if (childNodes.Length == 2)
            {
                ...
                var factory = new ExprAggMultiFunctionLinearAccessNodeFactoryAccess(
                    this, accessor, resultType, original.ContainedEventType, null, null, null);
                return new LinearAggregationFactoryDesc(factory, factory.ContainedEventType, null);
            }
        ...
        {
            return base.AggregationResultFuture.GetCollectionScalar(base.Column, evaluateParams);
        }
