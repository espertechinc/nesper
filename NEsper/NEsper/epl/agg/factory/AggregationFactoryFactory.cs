...
namespace com.espertech.esper.epl.agg.factory
{
    public interface AggregationFactoryFactory
    {
        ...
        AggregationMethodFactory MakeStddev(
            StatementExtensionSvcContext statementExtensionSvcContext,
            ExprStddevNode exprStddevNode,
            Type childType);

        AggregationMethodFactory MakeLinearUnbounded(
            StatementExtensionSvcContext statementExtensionSvcContext,
        ...
        AggregationStateFactory MakeLinear(
            StatementExtensionSvcContext statementExtensionSvcContext,
