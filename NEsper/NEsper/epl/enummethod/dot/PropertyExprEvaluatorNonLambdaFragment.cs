...
{
    [Serializable]
    public class PropertyExprEvaluatorNonLambdaFragment : ExprEvaluator
    {
        private readonly int _streamId;
        private readonly EventPropertyGetter _getter;
        private readonly Type _returnType;
    
        public PropertyExprEvaluatorNonLambdaFragment(int streamId, EventPropertyGetter getter, Type returnType)
        {
            _streamId = streamId;
            _getter = getter;
