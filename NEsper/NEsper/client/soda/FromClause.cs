...
namespace com.espertech.esper.client.soda
{
    ...
    public class FromClause
    {
        ...
        public List<OuterJoinQualifier> OuterJoinQualifiers { get; set; }
        ...
        /// <summary>Creates a from clause that selects from a single stream. <para /> Use <seealso cref="FilterStream" /> to create filter-based streams to add. </summary>
