...
namespace com.espertech.esper.client.soda
{
    ...
    public class CreateIndexClause
    {
        ...
        public CreateIndexClause(String indexName, String windowName, List<CreateIndexColumn> columns, bool isUnique)
        {
            IndexName = indexName;
        ...
        /// <param name="properties">properties to index</param>
        /// <param name="isUnique">if set to <c>true</c> [is unique].</param>
        public CreateIndexClause(String indexName, String windowName, String[] properties, bool isUnique)
        {
            Columns = new List<CreateIndexColumn>();
            IndexName = indexName;
            WindowName = windowName;
        ...
        /// <value>columns</value>
        public List<CreateIndexColumn> Columns { get; set; }
        ...
        public static CreateIndexClause Create(String indexName, String windowName, params String[] properties)
        {
        ...
        /// <returns>create variable clause</returns>
        public static CreateIndexClause Create(bool unique, String indexName, String windowName, params String[] properties)
        {
        ...
        public void ToEPL(TextWriter writer)
        {
            ...
            writer.Write('(');
            String delimiter = "";
            foreach (CreateIndexColumn prop in Columns)
            {
