...
namespace com.espertech.esper.client
{
    ...
    public class EventPropertyDescriptor
    {
        ...
        public EventPropertyDescriptor(String propertyName, Type propertyType, Type propertyComponentType, bool requiresIndex, bool requiresMapkey, bool indexed, bool mapped, bool fragment)
        {
            PropertyName = propertyName;
            PropertyType = propertyType; // GetBoxedType
            PropertyComponentType = propertyComponentType;
            RequiresIndex = requiresIndex;
            RequiresMapKey = requiresMapkey;
            IsIndexed = indexed;
            IsMapped = mapped;
            IsFragment = fragment;
        }
        ...
        /// </returns>
        public bool RequiresIndex { get; private set; }
        ...
        /// true to indicate that property value access requires an index value
        /// </returns>
        public bool RequiresMapKey { get; private set; }
        ...
        public override bool Equals(Object obj)
        {
            ...
            if (RequiresIndex != that.RequiresIndex) return false;
            if (RequiresMapKey != that.RequiresMapKey) return false;
