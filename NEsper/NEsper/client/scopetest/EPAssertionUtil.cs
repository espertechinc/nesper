...
namespace com.espertech.esper.client.scopetest
{
    ...
    public class EPAssertionUtil
    {
        ...
        public static void AssertPropsPerRow(IList<Object[]> received, String[] propertyNames, Object[][] expected)
        {
        ...
        public static void AssertPropsPONO(Object received, String[] propertyNames, params Object[] expected)
        {
            ...
            var theEvent = GetEventAdapterService().AdapterForObject(received);
