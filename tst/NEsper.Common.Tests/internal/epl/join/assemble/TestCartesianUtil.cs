...
namespace com.espertech.esper.common.@internal.epl.join.assemble
{
    ...
    public class TestCartesianUtil : AbstractCommonTest
    {
        ...
        public void TestCompute()
        {
            ...
            ClassicAssert.IsTrue(_results.IsEmpty());
            ...
            rowsB = null;
            TryCompute(rowsA, rowsB);
            ClassicAssert.AreEqual(1, _results.Count);
            ...
            rowsB = MakeRowsB(1);
            TryCompute(rowsA, rowsB);
            ClassicAssert.AreEqual(2, _results.Count);
            ...
            rowsB = MakeRowsB(2);
            TryCompute(rowsA, rowsB);
            ClassicAssert.AreEqual(4, _results.Count);
            EPAssertionUtil.AssertEqualsAnyOrder(
                new[] {
                    new[] {rowsA[0][0], rowsB[0][1], null, rowsA[0][3]},
                    new[] {rowsA[0][0], rowsB[1][1], null, rowsA[0][3]},
            ...
            rowsB = MakeRowsB(3);
            TryCompute(rowsA, rowsB);
            ClassicAssert.AreEqual(6, _results.Count);
            EPAssertionUtil.AssertEqualsAnyOrder(
                new[] {
                    new[] {rowsA[0][0], rowsB[0][1], null, rowsA[0][3]},
                    new[] {rowsA[0][0], rowsB[1][1], null, rowsA[0][3]},
