...
namespace com.espertech.esper.common.@internal.@event.bean.core
{
    ...
    public class TestBeanEventBean : AbstractCommonTest
    {
        ...
        public void TestGetIterableListMap()
        {
            ...
            AssertPropEquals(
                new SupportEventPropDesc("IterableNested", typeof(IEnumerable<SupportBeanIterableProps.SupportBeanSpecialGetterNested>))
                    .WithComponentType(typeof(SupportBeanIterableProps.SupportBeanSpecialGetterNested))
                    .WithIndexed()
                    .WithFragment(),
                eventBean.EventType.GetPropertyDescriptor("IterableNested"));
            AssertPropEquals(
                new SupportEventPropDesc("IterableInteger", typeof(IEnumerable<int>))
                    .WithComponentType(typeof(int))
                    .WithIndexed(),
                eventBean.EventType.GetPropertyDescriptor("IterableInteger"));
            AssertPropEquals(
                new SupportEventPropDesc("ListNested", typeof(IList<SupportBeanIterableProps.SupportBeanSpecialGetterNested>))
                    .WithComponentType(typeof(SupportBeanIterableProps.SupportBeanSpecialGetterNested))
                    .WithIndexed()
                    .WithFragment(),
            ...
            AssertPropEquals(
                new SupportEventPropDesc("MapNested", typeof(IDictionary<string, SupportBeanIterableProps.SupportBeanSpecialGetterNested>))
                    .WithComponentType(typeof(SupportBeanIterableProps.SupportBeanSpecialGetterNested))
                    .WithIndexed(false)
                    .WithMapped(),
            ...
            AssertPropEquals(
                new SupportEventPropDesc("IterableObject", typeof(IEnumerable<object>))
                    .WithComponentType(typeof(object))
                    .WithIndexed(),
