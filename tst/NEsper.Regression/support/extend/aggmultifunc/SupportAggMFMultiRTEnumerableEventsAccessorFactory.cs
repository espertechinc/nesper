...
{
    public class SupportAggMFMultiRTEnumerableEventsAccessorFactory : AggregationMultiFunctionAccessorFactory
    {
        public AggregationMultiFunctionAccessor NewAccessor(AggregationMultiFunctionAccessorFactoryContext ctx)
        {
            return new SupportAggMFMultiRTEnumerableEventsAccessor();
        }
    }
} // end of namespace