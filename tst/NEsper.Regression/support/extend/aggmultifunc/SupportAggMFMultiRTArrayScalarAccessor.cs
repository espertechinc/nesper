...
{
    public class SupportAggMFMultiRTArrayScalarAccessor : AggregationMultiFunctionAccessor
    {
        ...
        {
            return ((SupportAggMFMultiRTArrayCollScalarState) state).GetValueAsArray();
        }
