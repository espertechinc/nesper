...
namespace com.espertech.esper.regressionlib.support.util
{
    public class SupportXPathVariableResolver : IXPathVariableResolver
    {
        ...
        public class Variable : IXsltContextVariable
        {
            ...
            ///     An <see cref="T:System.Xml.Xsl.XsltContext" /> representing the execution context of the
            ///     variable.
            /// </param>
            /// <returns>
            ///     An <see cref="T:System.Object" /> representing the value of the variable. Possible return types include number,
            ...
            /// <summary>
            ///     Gets the <see cref="T:System.Xml.XPath.XPathResultType" /> representing the XML Path Language (XPath) type of the
            ///     variable.
            /// </summary>
            /// <value></value>
            /// <returns>
