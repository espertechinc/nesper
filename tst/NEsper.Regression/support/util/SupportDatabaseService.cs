...
namespace com.espertech.esper.regressionlib.support.util
{
    public class SupportDatabaseService
    {
        public static string DBUSER =>
            Environment.GetEnvironmentVariable("ESPER_SQL_HOST") ?? "esper";

        public static string DBPWD =>
            Environment.GetEnvironmentVariable("ESPER_SQL_PASSWORD") ?? "3sp3rP@ssw0rd";

        public static string DBHOST =>
            Environment.GetEnvironmentVariable("ESPER_SQL_HOST") ?? "localhost";

        public static string DBNAME =>
            Environment.GetEnvironmentVariable("ESPER_SQL_DBNAME") ?? "esper";
