	...
	public class PatternOperatorAnd {
	    ...
	    public class PatternOperatorAndSimple : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select a.theString as c0, b.theString as c1 from pattern [a=SupportBean(intPrimitive=0) and b=SupportBean(intPrimitive=1)]";
	    ...
	    public class PatternOperatorAndWHarness : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            Assert.AreEqual("select * from pattern [every (b=SupportBean_B and d=SupportBean_D" + ")]", model.ToEPL());
