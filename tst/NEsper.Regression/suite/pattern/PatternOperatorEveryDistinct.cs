...
namespace com.espertech.esper.regressionlib.suite.pattern {
	public class PatternOperatorEveryDistinct {
		...
		internal class PatternEveryDistinctMultikeyWArray : RegressionExecution {
			...
			private void SendAssertReceived (RegressionEnvironment env, string id, int[] array, bool received) {
		...
		internal class PatternEveryDistinctSimple : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var epl = "@name('s0') select a.theString as c0 from pattern [every-distinct(a.theString) a=SupportBean]";
		...
		internal class PatternEveryDistinctWTime : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AdvanceTime (0);
				var epl = "@name('s0') select a.theString as c0 from pattern [every-distinct(a.theString, 5 sec) a=SupportBean]";
				env.CompileDeploy (epl).AddListener ("s0");
		...
		internal class PatternExpireSeenBeforeKey : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				env.AdvanceTime (0);
				var expression = "@name('s0') select * from pattern [every-distinct(a.intPrimitive, 1 sec) a=SupportBean(theString like 'A%')]";
		...
		internal class PatternEveryDistinctOverFilter : RegressionExecution {
			...
			private static void RunEveryDistinctOverFilter (RegressionEnvironment env, string expression, AtomicLong milestone) {
				env.CompileDeploy (expression).AddListener ("s0");
		...
		internal class PatternRepeatOverDistinct : RegressionExecution {
			...
			private static void RunRepeatOverDistinct (RegressionEnvironment env, string expression, AtomicLong milestone) {
				env.CompileDeploy (expression).AddListener ("s0");
		...
		internal class PatternEveryDistinctOverRepeat : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [every-distinct(a[0].intPrimitive) [2] a=SupportBean]";
			...
			private static void RunEveryDistinctOverRepeat (RegressionEnvironment env, string expression, AtomicLong milestone) {
		...
		internal class PatternTimerWithinOverDistinct : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [(every-distinct(a.intPrimitive) a=SupportBean) where timer:within(10 sec)]";
			...
			private static void RunTimerWithinOverDistinct (RegressionEnvironment env, string expression, AtomicLong milestone) {
		...
		internal class PatternEveryDistinctOverTimerWithin : RegressionExecution {
			...
			private static void RunEveryDistinctOverTimerWithin (RegressionEnvironment env, string expression, AtomicLong milestone) {
		...
		internal class PatternEveryDistinctOverAnd : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [every-distinct(a.intPrimitive, b.intPrimitive) (a=SupportBean(theString like 'A%') and b=SupportBean(theString like 'B%'))]";
			...
			private static void RunEveryDistinctOverAnd (RegressionEnvironment env, string expression, AtomicLong milestone) {
		...
		internal class PatternEveryDistinctOverOr : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [every-distinct(coalesce(a.intPrimitive, 0) + coalesce(b.intPrimitive, 0)) (a=SupportBean(theString like 'A%') or b=SupportBean(theString like 'B%'))]";
			...
			private static void RunEveryDistinctOverOr (RegressionEnvironment env, string expression, AtomicLong milestone) {
		...
		internal class PatternEveryDistinctOverNot : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [every-distinct(a.intPrimitive) (a=SupportBean(theString like 'A%') and not SupportBean(theString like 'B%'))]";
			...
			private static void RunEveryDistinctOverNot (RegressionEnvironment env, string expression, AtomicLong milestone) {
		...
		internal class PatternEveryDistinctOverFollowedBy : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [every-distinct(a.intPrimitive + b.intPrimitive) (a=SupportBean(theString like 'A%') -> b=SupportBean(theString like 'B%'))]";
			...
			private static void RunEveryDistinctOverFollowedBy (RegressionEnvironment env, string expression, AtomicLong milestone) {
				env.CompileDeploy (expression).AddListener ("s0");
		...
		internal class PatternEveryDistinctWithinFollowedBy : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [(every-distinct(a.intPrimitive) a=SupportBean(theString like 'A%')) -> b=SupportBean(intPrimitive=a.intPrimitive)]";
			...
			private static void RunEveryDistinctWithinFollowedBy (RegressionEnvironment env, string expression, AtomicLong milestone) {
				env.CompileDeploy (expression).AddListener ("s0");
		...
		internal class PatternFollowedByWithDistinct : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var expression = "@name('s0') select * from pattern [every-distinct(a.intPrimitive) a=SupportBean(theString like 'A%') -> every-distinct(b.intPrimitive) b=SupportBean(theString like 'B%')]";
			...
			private static void RunFollowedByWithDistinct (RegressionEnvironment env, string expression, AtomicLong milestone) {
				env.CompileDeploy (expression).AddListener ("s0");
