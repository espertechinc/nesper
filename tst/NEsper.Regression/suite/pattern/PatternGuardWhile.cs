	...
	public class PatternGuardWhile {
	    ...
	    public class PatternGuardWhileSimple : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select a.theString as c0 from pattern [(every a=SupportBean) while (a.theString like 'E%')]";
	    ...
	    private class PatternVariable : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var expression = "@name('s0') select * from pattern [every a=SupportBean(theString like 'A%') -> (every b=SupportBean(theString like 'B%')) while (myVariable)]";
