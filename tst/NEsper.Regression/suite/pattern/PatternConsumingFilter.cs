	...
	public class PatternConsumingFilter {
	    ...
	    private class PatternFollowedBy : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var pattern = "@name('s0') select a.theString as a, b.theString as b from pattern[every a=SupportBean -> b=SupportBean@consume]";
	    ...
	    private class PatternAnd : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var fields = "a,b".SplitCsv();
	            var pattern = "@name('s0') select a.theString as a, b.theString as b from pattern[every (a=SupportBean and b=SupportBean)]";
	            env.CompileDeploy(pattern).AddListener("s0");
	    ...
	    public class PatternFilterAndSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('A') select a.theString as a, b.theString as b from pattern[a=SupportBean and b=SupportBean(theString='A')@consume]";
