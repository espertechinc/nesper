	...
	public class PatternOperatorOr {
	    ...
	    public class PatternOrSimple : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select a.theString as c0, b.theString as c1 from pattern [a=SupportBean(intPrimitive=0) or b=SupportBean(intPrimitive=1)]";
	    ...
	    private static void TryOrAndNot(RegressionEnvironment env, string pattern, AtomicLong milestone) {
