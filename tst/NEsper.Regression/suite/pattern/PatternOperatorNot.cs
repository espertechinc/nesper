	...
	public class PatternOperatorNot {
	    ...
	    private class PatternNotFollowedBy : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtText = "@name('s0') select * from pattern [ every( SupportBean(intPrimitive>0) -> (SupportMarketDataBean and not SupportBean(intPrimitive=0) ) ) ]";
	    ...
	    public class PatternNotWithEvery : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select a.theString as c0 from pattern [(every a=SupportBean(intPrimitive>=0)) and not SupportBean(intPrimitive<0)]";
