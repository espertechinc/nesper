...
namespace com.espertech.esper.regressionlib.suite.pattern
{
    public class PatternOperatorNot
    {
        ...
        internal class PatternOperatorNotWHarness : RegressionExecution
        {
        ...
        internal class PatternUniformEvents : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
        ...
        internal class PatternNotTimeInterval : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
        ...
        internal class PatternNotFollowedBy : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                var stmtText =
