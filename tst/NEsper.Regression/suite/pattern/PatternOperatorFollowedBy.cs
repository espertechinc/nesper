	...
	public class PatternOperatorFollowedBy {
	    ...
	    private class PatternFollowedByTimer : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eventOne = SendEvent(env, 2000002601, "18", "123456789014795", DateToLong("2005-09-26 13:02:53.200"), DateToLong("2005-09-26 13:03:34.400"));
	            var eventTwo = SendEvent(env, 2000002607, "20", "123456789014795", DateToLong("2005-09-26 13:03:17.300"), DateToLong("2005-09-26 13:03:58.600"));
	            ...
	            var eventThree = SendEvent(env, 2000002610, "22", "123456789014795", DateToLong("2005-09-26 13:03:31.300"), DateToLong("2005-09-26 13:04:12.100"));
	    ...
	    private class PatternFollowedNotEvery : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var expression = "@name('s0') select * from pattern [every A=SupportBean -> (timer:interval(1 seconds) and not SupportBean_A)]";
	    ...
	    private class PatternFollowedEveryMultiple : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var expression = "@name('s0') select * from pattern [every a=SupportBean_A -> b=SupportBean_B -> c=SupportBean_C -> d=SupportBean_D]";
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][] {new object[] {events[0], events[2], events[3], events[4]}, new object[] {events[1], events[2], events[3], events[4]}});
