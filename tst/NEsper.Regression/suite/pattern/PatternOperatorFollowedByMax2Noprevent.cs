...
namespace com.espertech.esper.regressionlib.suite.pattern
{
	public class PatternOperatorFollowedByMax2Noprevent : RegressionExecution {
	    ...
	    public void Run(RegressionEnvironment env) {
	        ...
	        AssertContextEnginePool(env, env.Statement("A"), SupportConditionHandlerFactory.LastHandler.Contexts, 2, GetExpectedCountMap("A", 3));

	        var fields = new string[]{"a", "b"};
	        env.SendEventBean(new SupportBean_B("B1"));
	        env.AssertPropsPerRowLastNew("A", fields, new object[][]{new object[] {"A1", "B1"}, new object[] {"A2", "B1"}, new object[] {"A3", "B1"}, new object[] {"A4", "B1"}});
