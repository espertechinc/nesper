...
namespace com.espertech.esper.regressionlib.suite.client.stage
{
    public class ClientStageObjectResolution
    {
        ...
        public static IList<RegressionExecution> Executions()
        {
            ...
            WithResolutionAfterStaging(execs);
            WithAlreadyExists(execs);
            return execs;
        }

        public static IList<RegressionExecution> WithAlreadyExists(IList<RegressionExecution> execs = null)
        {
        ...
        public static IList<RegressionExecution> WithResolutionAfterStaging(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        private class ClientStageObjectResolutionAfterStaging : ClientStageRegressionExecution
        {
            public override void Run(RegressionEnvironment env)
            {
                ...
                TryInvalidDeploy(
                    ...
                    path,
                    eplNamedWindow,
                    "A precondition is not satisfied: Required dependency named window 'MyWindow' cannot be found");
                ...
                TryInvalidDeploy(
                    ...
                    path,
                    eplContext,
                    "A precondition is not satisfied: Required dependency context 'MyContext' cannot be found");
                ...
                TryInvalidDeploy(
                    ...
                    path,
                    eplVariable,
                    "A precondition is not satisfied: Required dependency variable 'MyVariable' cannot be found");
                ...
                TryInvalidDeploy(
                    ...
                    path,
                    eplTable,
                    "A precondition is not satisfied: Required dependency table 'MyTable' cannot be found");
                ...
                TryInvalidDeploy(
                    ...
                    path,
                    eplScript,
                    "A precondition is not satisfied: Required dependency script 'MyScript' cannot be found");
