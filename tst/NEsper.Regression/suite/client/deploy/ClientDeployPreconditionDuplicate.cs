	...
	public class ClientDeployPreconditionDuplicate {
	    ...
	    public class ClientDeployPrecondDupNamedWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            Consumer<CompilerOptions> options = opt =>  opt.AccessModifierNamedWindow = ctx =>  NameAccessModifier.PUBLIC;
	    ...
	    public class ClientDeployPrecondDupEventType : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            Consumer<CompilerOptions> options = opt =>  opt.AccessModifierEventType = ctx =>  NameAccessModifier.PUBLIC;
	            var path = new RegressionPath();
	    ...
	    public class ClientDeployPrecondDupVariable : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            Consumer<CompilerOptions> options = opt =>  opt.AccessModifierVariable = ctx =>  NameAccessModifier.PUBLIC;
	            var path = new RegressionPath();
	    ...
	    public class ClientDeployPrecondDupExprDecl : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            Consumer<CompilerOptions> options = opt =>  opt.AccessModifierExpression = ctx =>  NameAccessModifier.PUBLIC;
	            var path = new RegressionPath();
	    ...
	    public class ClientDeployPrecondDupClass : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var path = new RegressionPath();
	            var epl = "@public create inlined_class \"\"\" public class MyClass { public static String doIt() { return \"def\"; } }\"\"\"";
	            env.CompileDeploy(epl, path);
