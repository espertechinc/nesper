...
namespace com.espertech.esper.regressionlib.suite.client.extension {
    ...
    public class ClientExtendEnumMethod {
        ...
        private class ClientExtendEnumLambdaScalarInputValueAndIndex : RegressionExecution {
            public void Run (RegressionEnvironment env) {
                var epl = "@name('s0') select Intvals.enumPlugInLambdaScalarWPredicateAndIndex((v, ind) => v > 0 and ind < 3) as c0 " +
                          "from SupportCollection";
                env.CompileDeploy (epl).AddListener ("s0");
                env.AssertStatement ("s0", statement => Assert.AreEqual (typeof(int?), statement.EventType.GetPropertyType ("c0")));
            ...
            private static void  SendAssert (RegressionEnvironment env, int? expected, string csv) {
        ...
        private class ClientExtendEnumLambdaEventInputValueAndIndex : RegressionExecution {
            ...
            private static void  SendAssert (RegressionEnvironment env, int? expected) {
        ...
        private class ClientExtendEnumScalarEarlyExit : RegressionExecution {
            ...
            private static void  SendAssert (RegressionEnvironment env, string[] fields, int? expected, string csv) {
                env.SendEventBean (SupportCollection.MakeNumeric (csv));
        ...
        private class ClientExtendEnumEventLambdaMedian : RegressionExecution {
            ...
            private static void  SendAssert (RegressionEnvironment env, string[] fields, double? expected, params string[] values) {
