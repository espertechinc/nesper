...
namespace com.espertech.esper.regressionlib.suite.expr.define
{
	public class ExprDefineValueParameter {
	    ...
	    private static void AssertTypeExpected(RegressionEnvironment env, Type clazz) {
	        var expectedColTypes = new object[][]{
	            new object[] {"c0", clazz},
	        };
	        env.AssertStatement("s0", statement => SupportEventTypeAssertionUtil.AssertEventTypeProperties(expectedColTypes, statement.EventType, NAME, TYPE));
	    }
