	...
	public class ExprFilterInAndBetween {
	    ...
	    private class ExprFilterInMultipleNonMatchingFirst : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplNotMatching = "@name('A') select * from SupportBean(intPrimitive in (0,0,1) and theString like 'X%')";
	    ...
	    private class ExprFilterInDynamic : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select * from pattern [a=SupportBeanNumeric -> every b=SupportBean(intPrimitive in (a.intOne, a.intTwo))]";
	    ...
	    private class ExprFilterSimpleIntAndEnumWrite : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var compiled = env.Compile("@name('s0') select * from SupportBean ev " + "where ev.enumValue in (?::java.util.Collection)");
	            env.Deploy(compiled, new DeploymentOptions().WithStatementSubstitutionParameter(new SupportPortableDeploySubstitutionParams(1, types).SetStatementParameters));
	            env.AddListener("s0");
	    ...
	    private class ExprFilterInExpr : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString > 'b')", new bool[]{false, false, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString < 'b')", new bool[]{true, false, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString >= 'b')", new bool[]{false, true, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString <= 'b')", new bool[]{true, true, false, false}));
	            ...
	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString in ['b':'d'])", new bool[]{false, true, true, true, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString in ('b':'d'])", new bool[]{false, false, true, true, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString in ['b':'d'))", new bool[]{false, true, true, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString in ('b':'d'))", new bool[]{false, false, true, false, false}));
	            ...
	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(boolPrimitive in (false))", new bool[]{false, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(boolPrimitive in (false, false, false))", new bool[]{false, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(boolPrimitive in (false, true, false))", new bool[]{true, true}));
	            ...
	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed in (4, 6, 1))", new bool[]{false, true, false, false, true, false, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed in (3))", new bool[]{false, false, false, true, false, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed between 4 and 6)", new bool[]{false, false, false, false, true, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed between 2 and 1)", new bool[]{false, true, true, false, false, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed between 4 and -1)", new bool[]{true, true, true, true, true, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed in [2:4])", new bool[]{false, false, true, true, true, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed in (2:4])", new bool[]{false, false, false, true, true, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed in [2:4))", new bool[]{false, false, true, true, false, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed in (2:4))", new bool[]{false, false, false, true, false, false, false}));
	            ...
	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(longBoxed in (3))", new bool[]{false, false, false, true, false, false, false}));
	    ...
	    private class ExprFilterNotIn : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not between 4 and 6)", new bool[]{true, true, true, true, false, false, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not between 2 and 1)", new bool[]{true, false, false, true, true, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not between 4 and -1)", new bool[]{false, false, false, false, false, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not in [2:4])", new bool[]{true, true, false, false, false, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not in (2:4])", new bool[]{true, true, true, false, false, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not in [2:4))", new bool[]{true, true, false, false, true, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not in (2:4))", new bool[]{true, true, true, false, true, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not in (4, 6, 1))", new bool[]{true, false, true, true, false, true, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(intBoxed not in (3))", new bool[]{true, true, true, false, true, true, true}));
	            MultiStmtAssertUtil.RunIsInvokedWithEventSender(env, assertions, 7, num => SendBean(env, "intBoxed", new object[]{0, 1, 2, 3, 4, 5, 6}[num]), milestone);

	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString not in ['b':'d'])", new bool[]{true, false, false, false, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString not in ('b':'d'])", new bool[]{true, true, false, false, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString not in ['b':'d'))", new bool[]{true, false, false, true, true}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString not in ('b':'d'))", new bool[]{true, true, false, true, true}));
	            MultiStmtAssertUtil.RunIsInvokedWithEventSender(env, assertions, 5, num => SendBean(env, "theString", new string[]{"a", "b", "c", "d", "e"}[num]), milestone);

	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(theString not in ('a', 'b'))", new bool[]{false, true, false, true}));
	            ...
	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(boolPrimitive not in (false))", new bool[]{true, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(boolPrimitive not in (false, false, false))", new bool[]{true, false}));
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(boolPrimitive not in (false, true, false))", new bool[]{false, false}));
	            MultiStmtAssertUtil.RunIsInvokedWithEventSender(env, assertions, 2, num => SendBean(env, "boolPrimitive", new object[]{true, false}[num]), milestone);

	            assertions.Clear();
	            assertions.Add(new EPLWithInvokedFlags("select * from SupportBean(longBoxed not in (3))", new bool[]{true, true, true, false, true, true, true}));
	            MultiStmtAssertUtil.RunIsInvokedWithEventSender(env, assertions, 7, num => SendBean(env, "longBoxed", new object[]{0L, 1L, 2L, 3L, 4L, 5L, 6L}[num]), milestone);
	        }
	    }
	    ...
	    private class ExprFilterInInvalid : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            if (SupportFilterOptimizableHelper.HasFilterIndexPlanBasicOrMore(env)) {
	                ...
	                var expr = "select * from pattern [a=SupportBean -> b=SupportBean(intPrimitive in (a.longPrimitive, a.longBoxed))]";
	    ...
	    private static void TryReuse(RegressionEnvironment env, string[] statements, AtomicLong milestone) {
