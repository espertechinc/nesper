...
namespace com.espertech.esper.regressionlib.suite.expr.exprcore
{
    public class ExprCoreCast
    {
        public static ICollection<RegressionExecution> Executions()
        {
            ...
            WithDates(execs);
            WithSimple(execs);
            WithSimpleMoreTypes(execs);
            WithAsParse(execs);
            WithDoubleAndNullOM(execs);
            WithInterface(execs);
            WithStringAndNullCompile(execs);
            WithBoolean(execs);
            WithWStaticType(execs);
            WithWArray(execs);
            WithGeneric(execs);
        ...
        public static IList<RegressionExecution> WithDecimalBigInt(IList<RegressionExecution> execs = null)
        {
            ...
            execs.Add(new ExprCoreCastDecimalBigInt());
            return execs;
        }
        ...
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastGeneric());
            return execs;
        }
        ...
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastWArray(false));
            execs.Add(new ExprCoreCastWArray(true));
            return execs;
        }

        public static IList<RegressionExecution> WithWStaticType(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastWStaticType());
            return execs;
        }

        public static IList<RegressionExecution> WithBoolean(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastBoolean());
            return execs;
        }

        public static IList<RegressionExecution> WithStringAndNullCompile(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithInterface(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastInterface());
            return execs;
        }

        public static IList<RegressionExecution> WithDoubleAndNullOM(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithAsParse(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastAsParse());
            return execs;
        }

        public static IList<RegressionExecution> WithSimpleMoreTypes(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastSimpleMoreTypes());
            return execs;
        }
        ...
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastSimple());
            return execs;
        }

        public static IList<RegressionExecution> WithDates(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCastDates());
            return execs;
        }
            ...
            AtomicLong milestone)
        {
            ...
            var builder = new SupportEvalBuilder("MyDateType")
                ...
                .WithExpression(
                    fields[7],
                    "cast(yyyymmddhhmmsszz,System.DateTimeOffset,dateformat:\"yyyyMMddHHmmsszzz\")");
