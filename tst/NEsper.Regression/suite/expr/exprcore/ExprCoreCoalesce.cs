...
namespace com.espertech.esper.regressionlib.suite.expr.exprcore
{
    public class ExprCoreCoalesce
    {
        ...
        public static IList<RegressionExecution> WithInvalid(IList<RegressionExecution> execs = null)
        {
            ...
            execs.Add(new ExprCoreCoalesceInvalid());
            return execs;
        }
        ...
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCoalesceNull());
            return execs;
        }
        ...
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCoalesceDouble());
            return execs;
        }

        public static IList<RegressionExecution> WithLongCompile(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCoalesceLongCompile());
            return execs;
        }

        public static IList<RegressionExecution> WithLongOM(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCoalesceLongOM());
            return execs;
        }
        ...
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCoalesceLong());
            return execs;
        }

        public static IList<RegressionExecution> WithBeans(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
            execs.Add(new ExprCoreCoalesceBeans());
            return execs;
        }
        ...
        private class ExprCoreCoalesceDouble : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                builder.WithAssertion(MakeEventWithDouble(env, null, short.Parse("2"), null, null, null, 1d))
                    .Expect(fields, 2d);

                builder.WithAssertion(MakeEventWithDouble(env, null, null, null, null, null, 100d))
                    .Expect(fields, 100d);
                ...
                builder.WithAssertion(MakeEventWithDouble(env, byte.Parse("3"), null, null, null, null, null))
                    .Expect(fields, 3d);
