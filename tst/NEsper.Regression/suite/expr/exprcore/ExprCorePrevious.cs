...
namespace com.espertech.esper.regressionlib.suite.expr.exprcore
{
    public class ExprCorePrevious
    {
        public static ICollection<RegressionExecution> Executions()
        {
            ...
            WithPrevStream(execs);
            WithLengthWindow(execs);
            WithTimeBatch(execs);
            WithPrevCountStar(execs);
            WithPerGroupTwoCriteria(execs);
            WithExprNameAndTypeAndSODA(execs);
            WithSortWindowPerGroup(execs);
            WithTimeBatchPerGroup(execs);
            WithLengthBatchPerGroup(execs);
            WithTimeWindowPerGroup(execs);
            WithExtTimeWindowPerGroup(execs);
            WithLengthWindowPerGroup(execs);
            WithTimeWindow(execs);
            WithExtTimedWindow(execs);
            WithTimeBatchWindow(execs);
            WithLengthBatch(execs);
            WithLengthWindowDynamic(execs);
            WithSortWindow(execs);
            WithExtTimedBatch(execs);
            WithPrevCountStarWithStaticMethod(execs);
        ...
        public static IList<RegressionExecution> WithPrevCountStarWithStaticMethod(
        ...
        internal class ExprCorePreviousPrevCountStarWithStaticMethod : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                var exprCorePrevious = typeof(ExprCorePrevious).FullName;
                var epl = $"@name('s0')select irstream count(*) as Total, prev({exprCorePrevious}.IntToLong(count(*)) - 1, Price) as firstPrice from SupportMarketDataBean#time(60)";
                env.CompileDeploy(epl).AddListener("s0");
        ...
        internal class ExprCorePreviousPerGroupTwoCriteria : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { "MSFT", "F2", 100d, 100d, 2L, SplitDoubles("101d,100d") });
                ...
                env.CompileDeployAddListenerMile(
                    "@name('s0') select prev(5,IntPrimitive) as val0 from SupportBean#groupwin(TheString)#length(5)",
                    "s0",
                    1);
        ...
        internal class ExprCorePreviousSortWindowPerGroup : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                AssertReceived(
                    ...
                    80d,
                    5L,
                    SplitDoubles("75d,79d,79.5,80d,81d")); // 75, 79, 79.5, 80, 81
                ...
                AssertReceived(
                    ...
                    80d,
                    6L,
                    SplitDoubles("74d,75d,79d,79.5,80d,81d")); // 74, 75, 79, 79.5, 80, 81
                ...
                env.AssertListener(
                    ...
                    listener => {
                        AssertEventWTail(
                            ...
                            3d,
                            6L,
                            SplitDoubles("7d,6d,5d,4d,3d,2d"));
                ...
                env.AssertListener(
                    ...
                    listener => {
                        AssertEventWTail(
                            ...
                            4d,
                            6L,
                            SplitDoubles("8d,7d,6d,5d,4d,3d"));
        ...
        internal class ExprCorePreviousSortWindow : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                AssertNewEvents(
                    ...
                    33d,
                    5L,
                    SplitDoubles("30d,56d,45d,33d,55d"));
                ...
                AssertNewEvents(
                    ...
                    33d,
                    6L,
                    SplitDoubles("30d,56d,1d,45d,33d,55d"));
                ...
                AssertNewEvents(
                    ...
                    33d,
                    7L,
                    SplitDoubles("1d,30d,56d,1d,45d,33d,55d"));
        ...
        private static void AssertEventWTail(
            EventBean eventBean,
            string currSymbol,
            string prevSymbol,
            double? prevPrice,
        ...
        private static void AssertNewEventWTail(
            RegressionEnvironment env,
            string currSymbol,
            string prevSymbol,
            double? prevPrice,
        ...
        private static void AssertOldEventWTail(
            RegressionEnvironment env,
            string currSymbol,
            string prevSymbol,
            double? prevPrice,
        ...
        private static void AssertPerGroup(
            string epl,
            RegressionEnvironment env)
        {
            env.CompileDeploy(epl).AddListener("s0");
