...
namespace com.espertech.esper.regressionlib.suite.expr.exprcore
{
	public class ExprCoreCase {
	    ...
	    private class ExprCoreCaseWithTypeParameterizedProperty : RegressionExecution {
	        ...
	        private void RunAssertion(RegressionEnvironment env, string typeOne, string typeTwo, Type expected) {
	        ...
	        private void RunAssertionEPL(RegressionEnvironment env, string epl, Type expected) {
	            env.CompileDeploy(epl);
	            env.AssertStatement("s0", statement => Assert.AreEqual(expected, statement.EventType.GetPropertyType("thecase")));
	            env.UndeployAll();
	        }
	    ...
	    private class ExprCoreCaseWithArrayResult : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertEventNew("s0", @event =>EPAssertionUtil.AssertEqualsExactOrder((int?[]) @event.Get("c1"), new int?[]{1, 2}));
	    ...
	    private class ExprCoreCaseSyntax1SumOM : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            model
		            .SelectClause = SelectClause.Create().Add(Expressions.CaseWhenThen()
	                .Add(Expressions.Eq("symbol", "GE"), Expressions.Property("volume"))
	                .Add(Expressions.Eq("symbol", "DELL"), Expressions.Sum("price")), "p1");
	            model.FromClause = FromClause.Create(FilterStream.Create(nameof(SupportMarketDataBean)).AddView("win", "length", Expressions.Constant(10)));
	    ...
	    private class ExprCoreCaseSyntax1Branches3 : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var builder = new SupportEvalBuilder("SupportMarketDataBean")
	                .WithExpressions(fields, "case when (symbol='GE') then volume " +
	    ...
	    private class ExprCoreCaseSyntax2 : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var builder = new SupportEvalBuilder("SupportBean")
	                .WithExpressions(fields, "case intPrimitive " +
	    ...
	    private class ExprCoreCaseSyntax2StringsNBranches : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendSupportBeanEvent(env, true, false, 1, 0, 0L, 0L, '0', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "true");

	            SendSupportBeanEvent(env, true, false, 2, 0, 0L, 0L, '0', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "false");

	            SendSupportBeanEvent(env, true, false, 3, 0, 0L, 0L, '0', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "3");

	            SendSupportBeanEvent(env, true, false, 4, 4, 0L, 0L, '0', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "4");

	            SendSupportBeanEvent(env, true, false, 5, 0, 5L, 0L, '0', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "5");

	            SendSupportBeanEvent(env, true, false, 6, 0, 0L, 6L, '0', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "6");

	            SendSupportBeanEvent(env, true, false, 7, 0, 0L, 0L, 'A', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "A");

	            SendSupportBeanEvent(env, true, false, 8, 0, 0L, 0L, 'A', 'a', 0, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "a");

	            SendSupportBeanEvent(env, true, false, 9, 0, 0L, 0L, 'A', 'a', 9, 0, 0, 0, 0.0f, 0.0f, 0.0, 0.0, null, SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "9");

	            SendSupportBeanEvent(env, true, false, 10, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "10");

	            SendSupportBeanEvent(env, true, false, 11, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "11");

	            SendSupportBeanEvent(env, true, false, 12, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "12");

	            SendSupportBeanEvent(env, true, false, 13, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "13.0");

	            SendSupportBeanEvent(env, true, false, 14, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "14.0");

	            SendSupportBeanEvent(env, true, false, 15, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "15.0");

	            SendSupportBeanEvent(env, true, false, 16, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "16.0");

	            SendSupportBeanEvent(env, true, false, 17, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "testCoercion");

	            SendSupportBeanEvent(env, true, false, -1, 0, 0L, 0L, 'A', 'a', 9, 10, 11, 12, 13.0f, 14.0f, 15.0, 16.0, "testCoercion", SupportEnum.ENUM_VALUE_1);
	            AssertP1(env, "x");
	    ...
	    private class ExprCoreCaseSyntax2WithNullOM : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            model.FromClause = FromClause.Create(FilterStream.Create(nameof(SupportBean)).AddView("length", Expressions.Constant(100)));
	            model = copier.Copy(model);
	    ...
	    private class ExprCoreCaseSyntax2EnumChecks : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select case supportEnum " +
	                      " when " + nameof(SupportEnum) + ".getValueForEnum(0) then 1 " +
	                      " when " + nameof(SupportEnum) + ".getValueForEnum(1) then 2 " +
	                      " end as p1 " +
	    ...
	    private class ExprCoreCaseSyntax2EnumResult : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select case intPrimitive * 2 " +
	                      " when 2 then " + nameof(SupportEnum) + ".getValueForEnum(0) " +
	                      " when 4 then " + nameof(SupportEnum) + ".getValueForEnum(1) " +
	                      " else " + nameof(SupportEnum) + ".getValueForEnum(2) " +
	                      " end as p1 " +
	                      " from SupportBean#length(10)";
	    ...
	    private class ExprCoreCaseSyntax2NoAsName : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select " + caseSubExpr +
	                      " from SupportBean#length(10)";
