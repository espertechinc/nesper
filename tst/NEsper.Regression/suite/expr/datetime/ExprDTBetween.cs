...
namespace com.espertech.esper.regressionlib.suite.expr.datetime
{
	public class ExprDTBetween {
	    ...
	    private static void TryAssertionExcludeEndpoints(RegressionEnvironment env, RegressionPath path, string fields, AtomicLong milestone) {
	    ...
	    private static void AssertPropsAllValuesSame(RegressionEnvironment env, string[] fields, bool expected) {
