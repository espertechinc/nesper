	...
	public class InfraNamedWindowProcessingOrder {
	    ...
	    private class InfraDispatchBackQueue : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            var epl = eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedStartValueEvent)) + " @buseventtype @public create schema StartValueEvent as (dummy string);\n";
	            epl += eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedTestForwardEvent)) + " @buseventtype @public create schema TestForwardEvent as (prop1 string);\n";
	            epl += eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedTestInputEvent)) + " @buseventtype @public create schema TestInputEvent as (dummy string);\n";
	            epl += "insert into TestForwardEvent select'V1' as prop1 from TestInputEvent;\n";
	            epl += eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedNamedWin)) + " @public create window NamedWin#unique(prop1) (prop1 string, prop2 string);\n";
