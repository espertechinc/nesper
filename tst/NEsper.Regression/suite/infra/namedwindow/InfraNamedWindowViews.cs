	...
	public class InfraNamedWindowViews {
	    ...
	    internal class InfraNamedWindowTimeToLiveDelete : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('win') create window MyWindow#timetolive(current_timestamp() + longPrimitive) as SupportBean;\n" +
	        ...
	        private void AssertIterate(RegressionEnvironment env, params string[] values) {
	            ...
	            env.AssertIterator("win", enumerator =>  {
	    ...
	    internal class InfraKeepAllSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:keepall() as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");

	            // create insert into
	            var stmtTextInsert = "@name('insert') insert into MyWindow(key, value) select irstream theString, intBoxed from SupportBean";
	            ...
	            // delete event G2
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G1", 10}, new object[] {"G2", 20}});
	            ...
	            // delete event G1
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G1", 10}, new object[] {"G3", 30}});
	            ...
	            // send event G5
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 30}, new object[] {"G4", 40}});
	            ...
	            // send event G6
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 30}, new object[] {"G4", 40}, new object[] {"G5", 50}});
	            ...
	            // delete event G6
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 30}, new object[] {"G4", 40}, new object[] {"G5", 50}, new object[] {"G6", 60}});
	    ...
	    internal class InfraBeanContained : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = EventRepresentationChoice.AVRO.GetAnnotationText() + " @name('create') create window MyWindowBC#keepall as (bean SupportBean_S0)";
	            env.TryInvalidCompile(epl, "Property 'bean' type '" + typeof(SupportBean_S0).FullName + "' does not have a mapping to an Avro type ");
	        }
	    }
	    ...
	    internal class InfraIntersection : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertListener("s0", listener => EPAssertionUtil.AssertPropsPerRowAnyOrder(listener.AssertInvokedAndReset(), fields, new object[][]{new object[]{"E3"}}, new object[][]{new object[]{"E1"}, new object[] {"E2"}}));
	    ...
	    internal class InfraBeanSchemaBacked : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@public create schema ABC as " + typeof(SupportBean).FullName + ";\n" +
	                      "@public create window MyWindowBSB#keepall as ABC;\n" +
	                      "insert into MyWindowBSB select * from SupportBean;\n";
	            env.CompileDeploy(epl, path);

	            env.SendEventBean(new SupportBean());
	            env.AssertThat(() => AssertEvent(env.CompileExecuteFAF("select * from MyWindowBSB", path).Array[0], "MyWindowBSB"));
	    ...
	    internal class InfraTimeWindow : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindowTW#time(10 sec) as MySimpleKeyValueMap";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            env.AssertPropsPerRowIterator("create", fields, null);

	            // create insert into
	            var stmtTextInsert = "insert into MyWindowTW select theString as key, longBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextInsert, path);
	            ...
	            // create delete stmt
	            var stmtTextDelete = "@name('delete') on SupportMarketDataBean as s0 delete from MyWindowTW as s1 where s0.symbol = s1.key";
	            env.CompileDeploy(stmtTextDelete, path).AddListener("delete");
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E2", 2L}});

	            SendTimer(env, 10000);
	            SendSupportBean(env, "E3", 3L);
	            env.AssertPropsNew("create", fields, new object[]{"E3", 3L});
	            env.AssertPropsNew("s0", fields, new object[]{"E3", 3L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E2", 2L}, new object[] {"E3", 3L}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E2", 2L}, new object[] {"E3", 3L}});

	            SendSupportBean(env, "E4", 4L);
	            env.AssertPropsNew("create", fields, new object[]{"E4", 4L});
	            env.AssertPropsNew("s0", fields, new object[]{"E4", 4L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E2", 2L}, new object[] {"E3", 3L}, new object[] {"E4", 4L}});

	            // delete E2
	            SendMarketBean(env, "E2");
	            env.AssertPropsOld("create", fields, new object[]{"E2", 2L});
	            env.AssertPropsOld("s0", fields, new object[]{"E2", 2L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 3L}, new object[] {"E4", 4L}});
	    ...
	    internal class InfraTimeWindowSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow#time(10 sec) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4", 40}, new object[] {"G5", 50}});
	    ...
	    internal class InfraTimeFirstWindow : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsOld("create", fields, new object[]{"E2", 2L});
	            env.AssertPropsOld("s0", fields, new object[]{"E2", 2L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E3", 3L}});
	    ...
	    internal class InfraExtTimeWindow : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') create window MyWindowETW#ext_timed(value, 10 sec) as MySimpleKeyValueMap;\n" +
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1000L}, new object[] {"E2", 5000L}, new object[] {"E3", 10000L}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E2", 5000L}, new object[] {"E3", 10000L}, new object[] {"E4", 11000L}});

	            // delete E2
	            SendMarketBean(env, "E2");
	            env.AssertPropsOld("create", fields, new object[]{"E2", 5000L});
	            env.AssertPropsOld("s0", fields, new object[]{"E2", 5000L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 10000L}, new object[] {"E4", 11000L}});
	    ...
	    internal class InfraExtTimeWindowSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:ext_timed(value, 10 sec) as select theString as key, longBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");

	            env.Milestone(0);

	            // create insert into
	            var stmtTextInsert = "insert into MyWindow(key, value) select irstream theString, longBoxed from SupportBean";
	            env.CompileDeploy(stmtTextInsert, path);
	            ...
	            // delete event G2
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G1", 0L}, new object[] {"G2", 5000L}});
	            SendMarketBean(env, "G2");
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 10000L}, new object[] {"G4", 15000L}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4", 15000L}, new object[] {"G5", 21000L}});
	    ...
	    internal class InfraExtTimeWindowSceneThree : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[]{"E2"}, new object[] {"E3"}});
	    ...
	    internal class InfraTimeOrderWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') @public create window MyWindowTOW#time_order(value, 10 sec) as MySimpleKeyValueMap;\n" +
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 1000L}, new object[] {"E2", 2000L}, new object[] {"E1", 3000L}});

	            // Should push out the window
	            SendTimer(env, 11000);
	            env.AssertPropsOld("create", fields, new object[]{"E3", 1000L});
	            env.AssertPropsOld("s0", fields, new object[]{"E3", 1000L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E2", 2000L}, new object[] {"E1", 3000L}});
	    ...
	    internal class InfraTimeOrderSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.ext:time_order(value, 10) as select theString as key, longBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G2"}, new object[] {"G1"}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4"}, new object[] {"G1"}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4"}, new object[] {"G5"}, new object[] {"G1"}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G5"}, new object[] {"G1"}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G1"}, new object[] {"G6"}});
	            env.AdvanceTime(32000);
	            SendMarketBean(env, "G1");
	    ...
	    internal class InfraLengthWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("create", fields, new object[]{"E4", 4L});
	            env.AssertPropsNew("s0", fields, new object[]{"E4", 4L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E3", 3L}, new object[] {"E4", 4L}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 3L}, new object[] {"E4", 4L}, new object[] {"E5", 5L}});
	    ...
	    internal class InfraLengthWindowSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:length(3) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");

	            // create insert into
	            var stmtTextInsert = "insert into MyWindow(key, value) select irstream theString, intBoxed from SupportBean";
	            env.CompileDeploy(stmtTextInsert, path);
	            ...
	            // delete event G6
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4", 40}, new object[] {"G5", 50}, new object[] {"G6", 60}});
	            SendMarketBean(env, "G6");
	            env.AssertPropsOld("create", fields, new object[]{"G6", 60});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4", 40}, new object[] {"G5", 50}});
	            ...
	            // send event G8
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G4", 40}, new object[] {"G5", 50}, new object[] {"G7", 70}});
	    ...
	    internal class InfraLengthFirstWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("create", fields, new object[]{"E4", 4L});
	            env.AssertPropsNew("s0", fields, new object[]{"E4", 4L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E4", 4L}});
	    ...
	    internal class InfraTimeAccum : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("create", fields, new object[]{"E4", 4L});
	            env.AssertPropsNew("s0", fields, new object[]{"E4", 4L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E2", 2L}, new object[] {"E3", 3L}, new object[] {"E4", 4L}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E5", 5L}, new object[] {"E6", 6L}, new object[] {"E7", 7L}});
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E5", 5L}, new object[] {"E6", 6L}});
	    ...
	    internal class InfraTimeAccumSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:time_accum(10 sec) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            // delete event G2
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G1", 1}, new object[] {"G2", 2}});
	            SendMarketBean(env, "G2");
	            ...
	            // Delete G3
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 3}, new object[] {"G4", 4}});
	            SendMarketBean(env, "G3");
	            ...
	            // Send G7
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G5", 5}, new object[] {"G6", 6}});
	            ...
	            // Send G8
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G5", 5}, new object[] {"G6", 6}, new object[] {"G7", 7}});
	            ...
	            // Delete G6
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G5", 5}, new object[] {"G6", 6}, new object[] {"G7", 7}, new object[] {"G8", 8}});
	            SendMarketBean(env, "G6");
	            ...
	            // Delete G8
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G5", 5}, new object[] {"G7", 7}, new object[] {"G8", 8}});
	    ...
	    internal class InfraTimeBatchSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:time_batch(10) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	    ...
	    internal class InfraTimeBatchLateConsumer : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') @public create window MyWindowTBLC#time_batch(10 sec) as MySimpleKeyValueMap;\n" +
	    ...
	    internal class InfraLengthBatchSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:length_batch(3) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            // send G6, batch fires
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 30}, new object[] {"G5", 50}});
	            SendBeanInt(env, "G6", 60);
	            env.AssertListener("create", listener => {
	                Assert.AreEqual(3, listener.LastNewData.Length);
	            ...
	            SendBeanInt(env, "G8", 80);
	            env.AssertListenerNotInvoked("create");
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G7", 70}, new object[] {"G8", 80}});
	            ...
	            // Send G10
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G8", 80}, new object[] {"G9", 90}});
	            ...
	            // Send G14
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G11", 110}, new object[] {"G13", 130}});
	    ...
	    internal class InfraSortWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 10L}, new object[] {"E3", 15L}, new object[] {"E2", 20L}});

	            // delete E2
	            SendMarketBean(env, "E2");
	            env.AssertPropsOld("create", fields, new object[]{"E2", 20L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 10L}, new object[] {"E3", 15L}});

	            SendSupportBean(env, "E4", 18L);
	            env.AssertPropsNew("create", fields, new object[]{"E4", 18L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 10L}, new object[] {"E3", 15L}, new object[] {"E4", 18L}});

	            SendSupportBean(env, "E5", 17L);
	            env.AssertPropsIRPair("create", fields, new object[]{"E5", 17L}, new object[]{"E4", 18L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 10L}, new object[] {"E3", 15L}, new object[] {"E5", 17L}});

	            // delete E1
	            SendMarketBean(env, "E1");
	            env.AssertPropsOld("create", fields, new object[]{"E1", 10L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 15L}, new object[] {"E5", 17L}});

	            SendSupportBean(env, "E6", 16L);
	            env.AssertPropsNew("create", fields, new object[]{"E6", 16L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 15L}, new object[] {"E6", 16L}, new object[] {"E5", 17L}});

	            SendSupportBean(env, "E7", 16L);
	            env.AssertPropsIRPair("create", fields, new object[]{"E7", 16L}, new object[]{"E5", 17L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 15L}, new object[] {"E7", 16L}, new object[] {"E6", 16L}});

	            // delete E7 has no effect
	            SendMarketBean(env, "E7");
	            env.AssertPropsOld("create", fields, new object[]{"E7", 16L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E3", 15L}, new object[] {"E6", 16L}});

	            SendSupportBean(env, "E8", 1L);
	            env.AssertPropsNew("create", fields, new object[]{"E8", 1L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E8", 1L}, new object[] {"E3", 15L}, new object[] {"E6", 16L}});
	    ...
	    internal class InfraSortWindowSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.ext:sort(3, value) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            // delete event G2
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G2", 9}, new object[] {"G1", 10}});
	            SendMarketBean(env, "G2");
	            ...
	            // send g4
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 3}, new object[] {"G1", 10}});
	            SendBeanInt(env, "G4", 4);
	            env.AssertPropsNew("create", fields, new object[]{"G4", 4});
	            ...
	            // send g5
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 3}, new object[] {"G4", 4}, new object[] {"G1", 10}});
	            SendBeanInt(env, "G5", 5);
	            ...
	            // send g6
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G3", 3}, new object[] {"G4", 4}, new object[] {"G5", 5}});
	            SendBeanInt(env, "G6", 6);
	    ...
	    internal class InfraTimeLengthBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') create window MyWindowTLB#time_length_batch(10 sec, 3) as MySimpleKeyValueMap;\n" +
	    ...
	    internal class InfraTimeLengthBatchSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.win:time_length_batch(10 sec, 4) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            // delete g7 and g9
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"G7", 7}, new object[] {"G8", 8}, new object[] {"G9", 9}});
	            SendMarketBean(env, "G7");
	            SendMarketBean(env, "G9");
	            env.AssertListenerNotInvoked("create");
	    ...
	    internal class InfraLengthWindowPerGroup : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') create window MyWindowWPG#groupwin(value)#length(2) as MySimpleKeyValueMap;\n" +
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E2", 1L}, new object[] {"E3", 2L}});

	            // delete E2
	            SendMarketBean(env, "E2");
	            env.AssertPropsOld("create", fields, new object[]{"E2", 1L});
	            env.AssertPropsOld("s0", fields, new object[]{"E2", 1L});
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1L}, new object[] {"E3", 2L}});
	    ...
	    internal class InfraTimeBatchPerGroup : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendTimer(env, 0);
	            var epl = "@name('create') create window MyWindowTBPG#groupwin(value)#time_batch(10 sec) as MySimpleKeyValueMap;\n" +
	    ...
	    internal class InfraDoubleInsertSameWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowNewFlattened("s0",  fields, new object[][]{new object[]{"E1", 11L}, new object[] {"E1", 12L}});
	    ...
	    internal class InfraLastEventSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow.std:lastevent() as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	    ...
	    internal class InfraUnique : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 1L}, new object[] {"G2", 20L}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 2L}, new object[] {"G2", 21L}});

	            SendSupportBean(env, "G2", 22L);
	            env.AssertPropsIRPair("s0", fields, new object[]{"G2", 22L}, new object[]{"G2", 21L});
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 2L}, new object[] {"G2", 22L}});
	    ...
	    internal class InfraUniqueSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindow#unique(key) as select theString as key, intBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path).AddListener("create");
	            ...
	            SendBeanInt(env, "G2", 20);
	            env.AssertPropsNew("create", fields, new object[]{"G2", 20});
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 10}, new object[] {"G2", 20}});
	    ...
	    internal class InfraFirstUnique : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendSupportBean(env, "G2", 21L);
	            env.AssertPropsNew("s0", fields, new object[]{"G2", 21L});
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 1L}, new object[] {"G2", 21L}});
	    ...
	    internal class InfraFilteringConsumer : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') create window MyWindowFC#unique(key) as select theString as key, intPrimitive as value from SupportBean;\n" +
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 15}, new object[] {"G2", 8}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"G1", 15}, new object[] {"G3", -1}});
	            env.AssertPropsPerRowIterator("s0", fields, null);
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[]{"G1", 6}, new object[] {"G2", 7}});
	    ...
	    internal class InfraSelectGroupedViewLateStart : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') @public create window MyWindowSGVS#groupwin(theString, intPrimitive)#length(9) as select theString, intPrimitive from SupportBean;\n" +
	            ...
	            // create select stmt
	            var stmtTextSelect = "@name('s0') select theString, intPrimitive, count(*) from MyWindowSGVS group by theString, intPrimitive order by theString, intPrimitive";
	    ...
	    internal class InfraSelectGroupedViewLateStartVariableIterate : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create window
	            var stmtTextCreate = "@name('create') @public create window MyWindowSGVLS#groupwin(theString, intPrimitive)#length(9) as select theString, intPrimitive, longPrimitive, boolPrimitive from SupportBean";
	            env.CompileDeploy(stmtTextCreate, path);

	            // create insert into
	            var stmtTextInsert = "insert into MyWindowSGVLS select theString, intPrimitive, longPrimitive, boolPrimitive from SupportBean";
	            env.CompileDeploy(stmtTextInsert, path);
	            ...
	            // create select stmt
	            var stmtTextSelect = "@name('s0') select theString, intPrimitive, avg(longPrimitive) as avgLong, count(boolPrimitive) as cntBool" +
	    ...
	    internal class InfraFilteringConsumerLateStart : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') @public create window MyWindowFCLS#keepall as select theString as key, intPrimitive as value from SupportBean;\n" +
	            ...
	            // create consumer
	            var stmtTextSelectOne = "@name('s0') select irstream sum(value) as sumvalue from MyWindowFCLS(value > 0, value < 10)";
	            env.CompileDeploy(stmtTextSelectOne, path).AddListener("s0");
	            ...
	            // create delete stmt
	            var stmtTextDelete = "@name('delete') on SupportMarketDataBean as s0 delete from MyWindowFCLS as s1 where s0.symbol = s1.key";
	            env.CompileDeploy(stmtTextDelete, path);
	    ...
	    internal class InfraNamedWindowInvalidAlreadyExists : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var compiled = env.Compile("create window MyWindowAE#keepall as MySimpleKeyValueMap", compilerOptions => compilerOptions
	    ...
	    internal class InfraLateConsumer : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtTextInsert = "insert into MyWindowLCL select theString as key, longBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextInsert, path);
	    ...
	    internal class InfraLateConsumerJoin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtTextInsert = "insert into MyWindowLCJ select theString as key, longBoxed as value from SupportBean";
	            env.CompileDeploy(stmtTextInsert, path);
	            ...
	            env.AssertPropsPerRowIterator("s2", fieldsJoin, new object[][]{new object[]{"E1", 1L, null}, new object[] {"E2", 1L, null}});
	            ...
	            env.AssertListener("s2", listener => {
	                ...
	                if (listener.LastNewData[0].Get("key").Equals("E1")) {
	                    EPAssertionUtil.AssertProps(listener.LastNewData[0], fieldsJoin, new object[]{"E1", 1L, "S1"});
	                    EPAssertionUtil.AssertProps(listener.LastNewData[1], fieldsJoin, new object[]{"E2", 1L, "S1"});
	                } else {
	                    EPAssertionUtil.AssertProps(listener.LastNewData[0], fieldsJoin, new object[]{"E2", 1L, "S1"});
	                    EPAssertionUtil.AssertProps(listener.LastNewData[1], fieldsJoin, new object[]{"E1", 1L, "S1"});
	                }
	                listener.Reset();
	            });
	            env.AssertPropsPerRowIterator("s2", fieldsJoin, new object[][]{new object[]{"E1", 1L, "S1"}, new object[] {"E2", 1L, "S1"}});
	            ...
	            env.AssertPropsPerRowIterator("s2", fieldsJoin, new object[][]{new object[]{"E1", 1L, "S1"}, new object[] {"E2", 1L, "S1"}, new object[] {"E3", 2L, "S2"}});
	    ...
	    internal class InfraExternallyTimedBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') create window MyWindowETB#ext_timed_batch(value, 10 sec, 0L) as MySimpleKeyValueMap;\n" +
	            ...
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1000L}, new object[] {"E2", 8000L}, new object[] {"E3", 9999L}});

	            env.Milestone(2);

	            // delete E2
	            SendMarketBean(env, "E2");
	            env.AssertListener("create", listener => EPAssertionUtil.AssertPropsPerRow(listener.AssertInvokedAndReset(), fields, null, new object[][]{new object[]{"E2", 8000L}}));
	            env.AssertListener("s0", listener => EPAssertionUtil.AssertPropsPerRow(listener.AssertInvokedAndReset(), fields, null, new object[][]{new object[]{"E2", 8000L}}));
	            env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 1000L}, new object[] {"E3", 9999L}});
	            ...
	            // delete E4
	            SendMarketBean(env, "E4");
	            env.AssertListener("create", listener => EPAssertionUtil.AssertPropsPerRow(listener.AssertInvokedAndReset(), fields, null, new object[][]{new object[]{"E4", 10000L}}));
	            env.AssertListener("s0", listener => EPAssertionUtil.AssertPropsPerRow(listener.AssertInvokedAndReset(), fields, null, new object[][]{new object[]{"E4", 10000L}}));
	            env.AssertPropsPerRowIterator("create", fields, null);
	            ...
	            env.AssertPropsPerRowIRPair("create", fields, new object[][]{new object[]{"E5", 14000L}}, new object[][]{new object[]{"E1", 1000L}, new object[] {"E3", 9999L}});
	    ...
	    private static void TryAssertionBeanContained(RegressionEnvironment env, EventRepresentationChoice rep) {
	        ...
	        env.AssertStatement("create", statement =>Assert.IsTrue(rep.MatchesClass(statement.EventType.UnderlyingType)));
	    ...
	    private static void TryCreateWindow(RegressionEnvironment env, string createWindowStatement, string deleteStatement) {
	        ...
	        var epl = "@name('create') @public " + createWindowStatement + ";\n" +
	        ...
	        env.AssertPropsNew("create", fields, new object[]{"E2", 20L});
	        env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 10L}, new object[] {"E2", 20L}});
	        env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[]{"E1", 20L}, new object[] {"E2", 40L}});
	        ...
	        env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E1", 10L}, new object[] {"E2", 20L}, new object[] {"E3", 5L}});
	        ...
	        env.AssertPropsOld("create", fields, new object[]{"E1", 10L});
	        env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[]{"E2", 20L}, new object[] {"E3", 5L}});
