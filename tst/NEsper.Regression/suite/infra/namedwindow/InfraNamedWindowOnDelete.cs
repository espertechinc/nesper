	...
	public class InfraNamedWindowOnDelete {
	    ...
	    private class InfraNamedWindowSilentDeleteOnDeleteMany : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertListener("count", listener => {
	                Assert.AreEqual(4L, listener.GetAndResetDataListsFlattened().First[3].Get("cnt"));
	            });
	            env.ListenerReset("create");

	            env.SendEventBean(new SupportBean_S0(0));
	            env.AssertListener("count", listener => Assert.AreEqual(0L, listener.AssertOneGetNewAndReset().Get("cnt")));
	            env.AssertPropsPerRowLastNew("delete", "theString,intPrimitive".SplitCsv(), new object[][]{
	    ...
	    private class InfraFirstUnique : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('create') create window MyWindowFU#firstunique(theString) as select * from SupportBean;\n" +
	    ...
	    private class InfraCoercionKeyMultiPropIndexes : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtTextDelete = "@name('d1') on SupportBean(theString='DB') as s0 delete from MyWindowCK as win where win.intPrimitive = s0.doubleBoxed";
	            ...
	            // create insert into
	            var stmtTextInsertOne = "insert into MyWindowCK select theString, intPrimitive, intBoxed, doublePrimitive, doubleBoxed "
	            ...
	            env.AssertPropsPerRowIterator("createOne", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}});
	            ...
	            env.AssertPropsPerRowIterator("createOne", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E4"}});

	            SendSupportBean(env, "DP", 0, 0, 5d, null);
	            env.AssertListenerNotInvoked("createOne");
	            SendSupportBean(env, "DP", 0, 0, 4d, null);
	            env.AssertPropsOld("createOne", fields, new object[]{"E4"});
	            env.AssertPropsPerRowIterator("createOne", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}});
	            ...
	            env.AssertPropsPerRowIterator("createOne", fields, new object[][]{new object[] {"E2"}, new object[] {"E6"}, new object[] {"E7"}});

	            SendSupportBean(env, "IPDP2", 6, 0, 600d, null);
	            env.AssertPropsOld("createOne", fields, new object[]{"E6"});
	            env.AssertPropsPerRowIterator("createOne", fields, new object[][]{new object[] {"E2"}, new object[] {"E7"}});
	            ...
	            env.ListenerReset("createOne");
	            env.AssertPropsPerRowIterator("createOne", fields, new object[][]{new object[] {"E2"}, new object[] {"E8"}});
	    ...
	    private class InfraCoercionRangeMultiPropIndexes : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtText = "insert into MyWindowCR select theString, intPrimitive, intBoxed, doublePrimitive, doubleBoxed from SupportBean";
	            ...
	            IList<string> deleteStatements = new List<string>();
	            var stmtTextDelete = "@name('d0') on SupportBeanTwo as s2 delete from MyWindowCR as win where win.intPrimitive between s2.doublePrimitiveTwo and s2.doubleBoxedTwo";
	            env.CompileDeploy(stmtTextDelete, path);
	            deleteStatements.Add("d0");
	    ...
	    private class InfraCoercionKeyAndRangeMultiPropIndexes : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtText = "insert into MyWindowCKR select theString, intPrimitive, intBoxed, doublePrimitive, doubleBoxed from SupportBean";
	            env.CompileDeploy(stmtText, path);
	            var fields = new string[]{"theString"};
	            ...
	            IList<string> deleteStatements = new List<string>();
	            var stmtTextDelete = "@name('d0') on SupportBeanTwo delete from MyWindowCKR where theString = stringTwo and intPrimitive between doublePrimitiveTwo and doubleBoxedTwo";
	            env.CompileDeploy(stmtTextDelete, path);
	            deleteStatements.Add("d0");
	    ...
	    private static void SendSupportBean(RegressionEnvironment env, string theString, int intPrimitive, int? intBoxed,
	    ...
	    private static void SendSupportBeanTwo(RegressionEnvironment env, string theString, int intPrimitive, int? intBoxed,
	                                           double doublePrimitive, double? doubleBoxed) {
	    ...
	    private static void TryAssertionStaggered(RegressionEnvironment env, EventRepresentationChoice outputType) {
	        ...
	        // create window one
	        var stmtTextCreateOne = outputType.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedSTAG)) + "@name('createOne') @public create window MyWindowSTAG#keepall as select theString as a1, intPrimitive as b1 from SupportBean";
	        env.CompileDeploy(stmtTextCreateOne, path).AddListener("createOne");
	        Assert.AreEqual(0, GetCount(env, "createOne", "MyWindowSTAG"));
	        env.AssertStatement("createOne", statement => Assert.IsTrue(outputType.MatchesClass(statement.EventType.UnderlyingType)));

	        // create window two
	        var stmtTextCreateTwo = outputType.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedSTAGTwo)) + " @name('createTwo') @public create window MyWindowSTAGTwo#keepall as select theString as a2, intPrimitive as b2 from SupportBean";
	        env.CompileDeploy(stmtTextCreateTwo, path).AddListener("createTwo");
	        Assert.AreEqual(0, GetCount(env, "createTwo", "MyWindowSTAGTwo"));
	        env.AssertStatement("createTwo", statement => Assert.IsTrue(outputType.MatchesClass(statement.EventType.UnderlyingType)));
	        ...
	        env.AssertStatement("delete", statement => Assert.AreEqual(StatementType.ON_DELETE, statement.GetProperty(StatementProperty.STATEMENTTYPE)));

	        // create insert into
	        var stmtTextInsert = "@name('insert') insert into MyWindowSTAG select theString as a1, intPrimitive as b1 from SupportBean(intPrimitive > 0)";
	        ...
	        env.AssertPropsPerRowIterator("createTwo", fieldsTwo, new object[][]{new object[] {"E1", -10}, new object[] {"E3", -1}});
	        env.AssertListenerNotInvoked("createOne");
	        Assert.AreEqual(2, GetCount(env, "createTwo", "MyWindowSTAGTwo"));

	        SendSupportBean(env, "E3", 1);
	        env.AssertPropsNew("createOne", fieldsOne, new object[]{"E3", 1});
	        env.AssertPropsPerRowIterator("createOne", fieldsOne, new object[][]{new object[] {"E2", 5}, new object[] {"E3", 1}});
	    ...
	    [Serializable] public class MyLocalJsonProvidedSTAG {
	        	        public string a1;
	        public int b1;
	    }

	    [Serializable] public class MyLocalJsonProvidedSTAGTwo {
	        	        public string a2;
	        public int b2;
	    }
	}
