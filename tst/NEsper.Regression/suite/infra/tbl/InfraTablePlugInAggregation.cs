...
namespace com.espertech.esper.regressionlib.suite.infra.tbl
{
    ...
    public class InfraTablePlugInAggregation
    {
        public static IList<RegressionExecution> Executions()
        {
            ...
            With(AccessRefCountedMap)(execs);
#endif
            return execs;
        }
            ...
            for (var i = 0; i < words.Length; i++) {
                ...
                env.AssertEventNew(
                    ...
                    @event => {
                        ...
                        ClassicAssert.AreEqual(counts[index], count, $"failed for word '{words[index]}'");
                    });
            }
        }
        ...
        internal class InfraPlugInAggMethodCSVLast3Strings : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                env.CompileDeploy(
                    "into table varaggPIN select csvWords(TheString) as csv from SupportBean#length(3)",
                    path);
