	...
	public class InfraTableJoin : IndexBackingTableInfo {
	    ...
	    private class InfraJoinIndexChoice : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplDeclare = "@public create table varagg as (k0 string primary key, k1 int primary key, v1 string, total sum(long))";
	            var eplPopulate = "into table varagg select sum(longPrimitive) as total from SupportBean group by theString, intPrimitive";
	            ...
	            IndexAssertionEventSend eventSendAssertionRangeTwoExpected = () =>  {
                    ...
                    env.AssertListener("s0", listener => {
                        EPAssertionUtil.AssertPropsPerRowAnyOrder(listener.NewDataListFlattened, "value".SplitCsv(),
	            ...
	            IndexAssertionEventSend eventSendAssertionHash = () =>  {
                    ...
                    env.AssertListener("s0", listener => {
                        EPAssertionUtil.AssertPropsPerRow(listener.NewDataListFlattened, "value".SplitCsv(),
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexEmpty, preloadedEventsHash, milestone,
	                new IndexAssertion[]{
	                    // primary index found
	                    new IndexAssertion("k1 = id and k0 = p00", "varagg", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    new IndexAssertion("k0 = p00 and k1 = id", "varagg", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    new IndexAssertion("k0 = p00 and k1 = id and v1 is null", "varagg", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    // no index found
	                    new IndexAssertion("k1 = id", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertionHash)
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexHashSingleK1, preloadedEventsHash,
	                milestone, new IndexAssertion[]{
	                    ...
	                    new IndexAssertion("k1 = id", "idx_k1", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    new IndexAssertion("id = k1", "idx_k1", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    // no index found
	                    new IndexAssertion("k0 = p00", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertionHash)
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexHashTwoDiscrete, preloadedEventsHash,
	                milestone, new IndexAssertion[]{
	                    ...
	                    new IndexAssertion("k1 = id and k0 = p00", "varagg", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    // secondary index found
	                    new IndexAssertion("k0 = p00", "idx_k0", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    new IndexAssertion("k1 = id", "idx_k1", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    new IndexAssertion("v1 is null and k1 = id", "idx_k1", typeof(IndexedTableLookupPlanHashedOnlyForge), eventSendAssertionHash),
	                    // no index found
	                    new IndexAssertion("1=1", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertionHash)
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexEmpty, preloadedEventsTwo,
	                milestone, new IndexAssertion[]{
	                    // no index found
	                    new IndexAssertion("k1 between 20 and 30", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertionRangeTwoExpected)
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexRangeOne, preloadedEventsTwo,
	                milestone, new IndexAssertion[]{
	                    new IndexAssertion("k1 between 20 and 30", "b_k1", typeof(SortedTableLookupPlanForge), eventSendAssertionRangeTwoExpected),
	                    new IndexAssertion("(k0 = 'G3' or k0 = 'G2') and k1 between 20 and 30", "b_k1", typeof(SortedTableLookupPlanForge), eventSendAssertionRangeTwoExpected),
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexRangeOne, preloadedEventsTwo,
	                milestone, new IndexAssertion[]{
	                    new IndexAssertion("k0 = 'G2' and k1 between 20 and 30", "b_k1", typeof(SortedTableLookupPlanForge), eventSendAssertionRangeOneExpected),
	                    new IndexAssertion("k1 between 20 and 30 and k0 = 'G2'", "b_k1", typeof(SortedTableLookupPlanForge), eventSendAssertionRangeOneExpected),
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexRangeCombined, preloadedEventsTwo,
	                milestone, new IndexAssertion[]{
	                    new IndexAssertion("k0 = 'G2' and k1 between 20 and 30", "h_k0_b_k1", typeof(CompositeTableLookupPlanForge), eventSendAssertionRangeOneExpected),
	                    new IndexAssertion("k1 between 20 and 30 and k0 = 'G2'", "h_k0_b_k1", typeof(CompositeTableLookupPlanForge), eventSendAssertionRangeOneExpected),
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexHashSingleK0, preloadedEventsTwo,
	                milestone, new IndexAssertion[]{
	                    new IndexAssertion("k0 in ('G2', 'G3')", "idx_k0", typeof(InKeywordTableLookupPlanSingleIdxForge), eventSendAssertionRangeTwoExpected),
	                }
	            );
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexHashSingleK0, preloadedEventsHash,
	                milestone, new IndexAssertion[]{
	                    new IndexAssertion("'G1' in (k0)", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertionHash),
	                }
	            );
	        }
	    }
	    ...
	    private class InfraCoercion : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplPopulate = "into table varagg select sum(longPrimitive) as total from SupportBean group by intPrimitive";
	            ...
	            AssertIndexChoice(env, eplDeclare, eplPopulate, eplQuery, createIndexEmpty, preloadedEvents,
	                milestone, new IndexAssertion[]{
	                    new IndexAssertion("k0 = keyLong", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertion),
	                    new IndexAssertion("k0 = keyLong", "varagg", typeof(FullTableScanUniquePerKeyLookupPlanForge), eventSendAssertion),
	                }
	            );
	        }
	    ...
	    private static void AssertIndexChoice(RegressionEnvironment env, string eplDeclare, string eplPopulate, string eplQuery,
	                                          ...
	                                          AtomicLong milestone, IndexAssertion[] assertions) {
	    ...
	    private static void AssertIndexChoice(RegressionEnvironment env, string eplDeclare, string eplPopulate, string eplQuery,
	                                          string[] indexes, object[] preloadedEvents,
	                                          IndexAssertion[] assertions, AtomicLong milestone, bool multistream) {
	    ...
	    private static void AssertValues(RegressionEnvironment env, string keys, int?[] values) {
	        ...
	        for (var i = 0; i < keyarr.Length; i++) {
	            ...
	            if (values[i] == null) {
	                ...
	                var index = i;
	                env.AssertEventNew("s0", @event => Assert.AreEqual(values[index], @event.Get("value"), "Failed for key '" + keyarr[index] + "'"));
	            }
	        }
	    }
