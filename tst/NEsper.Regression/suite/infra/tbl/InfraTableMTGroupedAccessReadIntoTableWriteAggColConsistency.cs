    ...
    public class InfraTableMTGroupedAccessReadIntoTableWriteAggColConsistency : RegressionExecution
    {
            ...
            int numSeconds)
        {
            ...
            var t1 = new Thread(writeRunnable.Run) {
                Name = nameof(InfraTableMTGroupedAccessReadIntoTableWriteAggColConsistency) + "-write"
            };
            var t2 = new Thread(readRunnable.Run) {
                Name = nameof(InfraTableMTGroupedAccessReadIntoTableWriteAggColConsistency) + "-read"
            };
            t1.Start();
            t2.Start();
