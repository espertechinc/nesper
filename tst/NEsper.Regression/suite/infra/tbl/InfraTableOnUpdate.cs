	...
	public class InfraTableOnUpdate {
	    ...
	    private class InfraTableOnUpdateMultikeyWArrayTwoArrayNonGetter : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('tbl') create table MyTable(k1 int[primitive] primary key, k2 int[primitive] primary key, v int);\n" +
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("tbl", "k1,k2,v".SplitCsv(), new object[][] {
	    ...
	    private class InfraTableOnUpdateMultikeyWArrayOneArray : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("tbl", "k1,v".SplitCsv(),
	                new object[][] {new object[] {new int[] {1, 2}, 11}, new object[] {new int[] {1, 2, 3}, 21}, new object[] {new int[] {1}, 31}});
	    ...
	    private class InfraTableOnUpdateTwoKey : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var expectedType = new object[][]{new object[] {"keyOne", typeof(string)}, new object[] {"keyTwo", typeof(int?)}, new object[] {"p0", typeof(long?)}};
