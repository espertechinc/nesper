...
namespace com.espertech.esper.regressionlib.suite.infra.tbl
{
	...
	public class InfraTableAccessAggregationState {
	    ...
	    private class InfraNestedMultivalueAccess : RegressionExecution {
	        ...
	        public InfraNestedMultivalueAccess(bool grouped, bool soda) {
	    ...
	    private class InfraAccessAggShare : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("into", statement => Assert.AreEqual(typeof(SupportBean[]), statement.EventType.GetPropertyType("mywin")));
	    ...
	    public class InfraTableAccessGroupedThreeKey : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplUse = "@name('s0') select varTotal[p00, id, 100L].total as c0, varTotal[p00, id, 100L].cnt as c1 from SupportBean_S0";
