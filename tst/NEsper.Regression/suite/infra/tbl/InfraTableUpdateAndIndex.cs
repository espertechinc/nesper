	...
	public class InfraTableUpdateAndIndex {
	    ...
	    private class InfraEarlyUniqueIndexViolation : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            try {
	                ...
	                SupportMessageAssertUtil.AssertMessage(ex.Message, "Failed to deploy: Unique index violation, index 'SecIndex' is a unique index and key 'E1' already exists");
	            }
	            ...
	            try {
	                ...
	                env.AssertPropsPerRowIteratorAnyOrder("create", "pkey0,pkey1".SplitCsv(), new object[][]{new object[] {"E1", 10}, new object[] {"E1", 20}});
	            }
	            ...
	            try {
	                ...
	                SupportMessageAssertUtil.AssertMessage(ex.InnerException, "Unexpected exception in statement 'on-update': Unique index violation, index 'MyTableEUIV' is a unique index and key 'MultiKey[E1,0]' already exists");
	                // assert events are unchanged - no update actually performed
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(env.Statement("create").GetEnumerator(), "pkey0,pkey1".SplitCsv(), new object[][]{new object[] {"E1", 10}, new object[] {"E1", 20}});
	            }
	    ...
	    private class InfraLateUniqueIndexViolation : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            try {
	                ...
	                // assert events are unchanged - no update actually performed
	                env.AssertPropsPerRowIteratorAnyOrder("create", "pkey0,pkey1".SplitCsv(), new object[][]{new object[] {"E1", 10}, new object[] {"E2", 20}});
	            }
	    ...
	    private class InfraTableKeyUpdateMultiKey : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s1", fields, new object[][]{new object[] {"E1", 10, 100L}, new object[] {"E20", 20, 200L}, new object[] {"E3", 30, 300L}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s1", fields, new object[][]{new object[] {"E10", 10, 100L}, new object[] {"E20", 20, 200L}, new object[] {"E3", 30, 300L}});

	            env.SendEventBean(new SupportBean_S0(0, "E3", "E30"));

	            env.Milestone(3);

	            env.AssertPropsPerRowIteratorAnyOrder("s1", fields, new object[][]{new object[] {"E10", 10, 100L}, new object[] {"E20", 20, 200L}, new object[] {"E30", 30, 300L}});
	    ...
	    private class InfraTableKeyUpdateSingleKey : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean_S0(0, "E2", "E20"));
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 10}, new object[] {"E20", 20}, new object[] {"E3", 30}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E10", 10}, new object[] {"E20", 20}, new object[] {"E3", 30}});

	            env.SendEventBean(new SupportBean_S0(0, "E3", "E30"));

	            env.Milestone(3);

	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E10", 10}, new object[] {"E20", 20}, new object[] {"E30", 30}});
