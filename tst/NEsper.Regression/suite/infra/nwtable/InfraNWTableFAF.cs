	...
	public class InfraNWTableFAF : IndexBackingTableInfo {
	    ...
	    private class InfraInvalidInsert : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var expected = "Event type named 'MyWindow' has already been declared with differing column name or type information: ";
	    ...
	    private class InfraSelectDistinct : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            EPAssertionUtil.AssertPropsPerRow(result.Array, fields, new object[][]{new object[] {10L}, new object[] {11L}});
	    ...
	    private class Infra3StreamInnerJoin : RegressionExecution {
	        ...
	        internal Infra3StreamInnerJoin(EventRepresentationChoice eventRepresentationEnum, bool namedWindow) {
	            this.eventRepresentationEnum = eventRepresentationEnum;
	            this.namedWindow = namedWindow;
	        }

	        public void Run(RegressionEnvironment env) {
	            var eplEvents = eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedProduct)) + " @public @buseventtype create schema Product (productId string, categoryId string);" +
	                            eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedCategory)) + " @public @buseventtype create schema Category (categoryId string, owner string);" +
	                            eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedProductOwnerDetails)) + " @public @buseventtype create schema ProductOwnerDetails (productId string, owner string);";
	            string epl;
	            if (namedWindow) {
	                epl = eplEvents +
	    ...
	    private class InfraJoin : RegressionExecution {
	        ...
	        internal InfraJoin(bool isFirstNW, bool isSecondNW) {
	    ...
	    public class InfraSelectWildcardSceneTwo : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtTextInsert = "insert into MyInfra(key, value) select irstream theString, intBoxed from SupportBean";
	            ...
	            if (namedWindow) {
	                EPAssertionUtil.AssertPropsPerRow(result.Array, fields, new object[][]{new object[] {"G1", 10}, new object[] {"G4", 21}});
	            } else {
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(result.Array, fields, new object[][]{new object[] {"G1", 10}, new object[] {"G4", 21}});
	            }
	            ...
	            Assert.AreEqual(2, result.Array.Length);
	            EPAssertionUtil.AssertPropsPerRowAnyOrder(result.Array, fields, new object[][]{new object[] {"G2", -1}, new object[] {"G3", -2}});
	    ...
	    private class InfraDeleteContextPartitioned : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplCtx = "@public create context MyCtx coalesce consistent_hash_crc32(theString) from SupportBean granularity 4 preallocate";
	            ...
	            var result = CompileExecuteFAF(env, path, "delete from CtxInfra where theString = 'E0'", new ContextPartitionSelector[]{new SupportSelectorByHashCode(3)});
	            AssertCtxInfraCountPerCode(env, path, new long[]{0, 2, 1, 1});
	            if (namedWindow) {
	                EPAssertionUtil.AssertPropsPerRow(result.Array, "theString".SplitCsv(), new object[][]{new object[] {"E0"}});
	            }
	            ...
	            var eplCtxCategory = "@public create context MyCtxCat group by intPrimitive < 0 as negative, group by intPrimitive > 0 as positive from SupportBean";
	            ...
	            EPAssertionUtil.AssertPropsPerRow(result.Array, "theString".SplitCsv(), new object[][]{new object[] {"E1"}, new object[] {"E3"}});
	    ...
	    private class InfraDelete : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            if (namedWindow) {
	                Assert.AreEqual(env.Statement("TheInfra").EventType, result.EventType);
	                EPAssertionUtil.AssertPropsPerRow(result.Array, "theString".SplitCsv(), new object[][]{new object[] {"E1"}});
	            }
	    ...
	    private class InfraUpdate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("TheInfra", fields, new object[][]{new object[] {"ABC", 0}, new object[] {"ABC", 1}});
	            if (namedWindow) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("TheInfra", fields, new object[][]{new object[] {"E0", 0}, new object[] {"E2", 2}, new object[] {"X", -1}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("TheInfra", fields, new object[][]{new object[] {"E0", 0}, new object[] {"X", -1}, new object[] {"E2", 12}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("TheInfra", fields, new object[][]{new object[] {"X", -1}, new object[] {"E2", 12}, new object[] {"E0y", 100}});
	            ...
	            if (namedWindow) {
	                ...
	                env.AssertPropsPerRowIterator("TheInfra", "theString,intPrimitive".SplitCsv(), new object[][]{new object[] {"XYZ", 20}});
	            }
	    ...
	    private class InfraInsert : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            try {
	                ...
	                Assert.AreEqual("Unique index violation, index 'I1' is a unique index and key 'a' already exists", ex.Message);
	            }
	            env.AssertPropsPerRowIteratorAnyOrder("TheInfra", propertyNames, new object[][]{new object[] {"a", 1}, new object[] {"b", 2}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("InfraThree", "p0,p1".SplitCsv(), new object[][]{new object[] {"a", 1}});

	            // try enum-value insert
	            var epl = "create schema MyMode (mode " + typeof(SupportEnum).FullName + ");\n" +
	                      (namedWindow ?
		                      "@name('enumwin') @public create window MyInfraTwo#unique(mode) as MyMode" :
		                      "@name('enumwin') @public create table MyInfraTwo as (mode " + typeof(SupportEnum).FullName + ");\n");
	            env.CompileDeploy(epl, path);
	            env.CompileExecuteFAF("insert into MyInfraTwo select " + typeof(SupportEnum).FullName + "." + SupportEnum.ENUM_VALUE_2.GetName() + " as mode", path);
	            env.AssertIterator("enumwin", iterator => EPAssertionUtil.AssertProps(iterator.Advance(), "mode".SplitCsv(), new object[]{SupportEnum.ENUM_VALUE_2}));
	            ...
	            env.AssertStatement("TheInfra", stmt => EPAssertionUtil.AssertPropsPerRowAnyOrder(stmt.GetEnumerator(), propertyNames, new object[][]{new object[] {"a", 1}}));
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("InfraThree", "p0,p1".SplitCsv(), new object[][]{new object[] {"b", 2}});
	    ...
	    private static void AssertFAFInsertResult(EPFireAndForgetQueryResult resultOne, object[] objects, string[] propertyNames, EPStatement stmt, bool namedWindow) {
	    ...
	    private static RegressionPath SetupInfra(RegressionEnvironment env, bool namedWindow) {
	        var path = new RegressionPath();
	        var eplCreate = namedWindow ?
	    ...
	    private static RegressionPath SetupInfraJoin(RegressionEnvironment env, bool namedWindow) {
	    ...
	    private static long GetCtxInfraCount(RegressionEnvironment env, RegressionPath path, int hashCode) {
	        ...
	        var result = env.Runtime.FireAndForgetService.ExecuteQuery(compiled, new ContextPartitionSelector[]{new SupportSelectorByHashCode(hashCode)});
	    ...
	    private static long GetCtxInfraCatCount(RegressionEnvironment env, RegressionPath path, string categoryName) {
	        ...
	        var result = env.Runtime.FireAndForgetService.ExecuteQuery(compiled, new ContextPartitionSelector[]{new SupportSelectorCategory(categoryName)});
	        return result.Array[0].Get("c0").AsInt64();
	    }
	    ...
	    private static void RunQueryAssertCountNonNegative(RegressionEnvironment env, RegressionPath path, string epl, int count, string indexName, string backingClass) {
	        ...
	        var actual = env.CompileExecuteFAF("select count(*) as c0 from MyInfra where intPrimitive >= 0", path).Array[0].Get("c0").AsInt64();
	    ...
	    [Serializable] public class MyLocalJsonProvidedProduct {
	        public string productId;
	        public string categoryId;
	    }

	    [Serializable] public class MyLocalJsonProvidedCategory {
	        public string categoryId;
	        public string owner;
	    }

	    [Serializable] public class MyLocalJsonProvidedProductOwnerDetails {
	        public string productId;
	        public string owner;
	    }
	}
