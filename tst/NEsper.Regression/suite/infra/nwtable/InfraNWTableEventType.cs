	...
	public class InfraNWTableEventType {
	    ...
	    private class InfraNWTableEventTypeInsertIntoProtected : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("window", "foo,bar".SplitCsv(), new object[][] {new object[] {"a", 1d}, new object[] {"b", 2d}});
	    ...
	    private static void RunAssertionType(RegressionEnvironment env, bool namedWindow) {
