...
namespace com.espertech.esper.regressionlib.suite.infra.nwtable
{
	public class InfraNWTableSubqCorrelCoerce {
	    ...
	    private class InfraNWTableSubqCorrelCoerceSimple : RegressionExecution {
	        ...
	        public InfraNWTableSubqCorrelCoerceSimple(bool namedWindow, bool enableIndexShareCreate, bool disableIndexShareConsumer, bool createExplicitIndex) {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var c2 = env.Compile("@public @buseventtype create schema WindowSchema(col0 string, col1 long, col2 string)");
	            ...
	            var consumeEpl = "@name('s0') select e0, (select col0 from MyInfra where col2 = es.e2 and col1 = es.e1) as val from EventSchema es";
