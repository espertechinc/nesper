	...
	public class InfraNWTableOnDelete {
	    ...
	    private class InfraDeleteAll : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("OnDelete", statement => EPAssertionUtil.AssertEqualsAnyOrder(statement.EventType.PropertyNames, new string[]{"a", "b"}));

	            // create insert into
	            var stmtTextInsertOne = "@name('Insert') insert into MyInfra select theString as a, intPrimitive as b from SupportBean";
	            ...
	            env.AssertPropsPerRowIterator("CreateInfra", fields, new object[][]{new object[] {"E2", 2}, new object[] {"E3", 3}});
	            env.AssertListenerNotInvoked("OnDelete");
	    ...
	    private class InfraDeletePattern : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create delete stmt
	            var stmtTextDelete = "@name('OnDelete') on pattern [every ea=SupportBean_A or every eb=SupportBean_B] delete from MyInfra";
	            env.CompileDeploy(stmtTextDelete, path).AddListener("OnDelete");
	    ...
	    private class InfraDeleteCondition : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.ListenerReset("CreateInfra");
	            var fields = new string[]{"a", "b"};
	            env.AssertPropsPerRowIterator("CreateInfra", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E2", 2}, new object[] {"E3", 3}});
	            ...
	            env.ListenerReset("CreateInfra");
	            env.AssertPropsPerRowIteratorAnyOrder("CreateInfra", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E3", 3}});
	            env.AssertThat(() => Assert.AreEqual(2, GetCount(env, path, "MyInfra")));

	            SendSupportBean(env, "E7", 7);
	            env.AssertPropsPerRowIteratorAnyOrder("CreateInfra", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E3", 3}, new object[] {"E7", 7}});
	            env.AssertThat(() => Assert.AreEqual(3, GetCount(env, path, "MyInfra")));
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("CreateInfra",  fields, new object[][]{new object[] {"E7", 7}});
	            env.AssertThat(() => Assert.AreEqual(1, GetCount(env, path, "MyInfra")));
