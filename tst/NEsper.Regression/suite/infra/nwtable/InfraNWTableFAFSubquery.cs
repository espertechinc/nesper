	...
	public class InfraNWTableFAFSubquery : IndexBackingTableInfo {
	    ...
	    private class InfraFAFSubqueryContextSelect : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            AssertQueryMultirowAnyOrder(env, path, query, "p00,theString", new object[][]{new object[] {"a", "E1"}, new object[] {"b", "E1"}});
	    ...
	    private class InfraFAFSubqueryContextBothWindows : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            AssertQueryMultirowAnyOrder(env, path, query, "p00,p10", new object[][]{new object[] {"a", "X"}, new object[] {"b", "Y"}, new object[] {"c", "Z"}});
	    ...
	    private class InfraFAFSubqueryDeleteCorrelatedWhere : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            AssertQueryMultirowAnyOrder(env, path, query, "id,p00", new object[][]{new object[] {1, "a"}, new object[] {3, "c"}});
	    ...
	    private class InfraFAFSubqueryUpdateCorrelatedWhere : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var query = "select * from WinS0";
	            AssertQueryMultirowAnyOrder(env, path, query, "id,p00", new object[][]{new object[] {1, "a"}, new object[] {2, "x"}, new object[] {3, "c"}});
	    ...
	    private class InfraFAFSubqueryUpdateCorrelatedSet : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var query = "select * from WinS0";
	            AssertQueryMultirowAnyOrder(env, path, query, "id,p00", new object[][]{new object[] {1, "Y"}, new object[] {2, "X"}, new object[] {3, "Z"}});
	    ...
	    private class InfraFAFSubquerySelectCorrelated : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            AssertQueryMultirowAnyOrder(env, path, query, "id,theString", new object[][]{new object[] {1, "Y"}, new object[] {2, "X"}, new object[] {3, "Z"}});

	            SendSB(env, "Q", 1);
	            SendSB(env, "R", 3);
	            SendSB(env, "S", 2);
	            AssertQueryMultirowAnyOrder(env, path, query, "id,theString", new object[][]{new object[] {1, "Q"}, new object[] {2, "S"}, new object[] {3, "R"}});
	    ...
	    private class InfraFAFSubqueryDeleteUncorrelated : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            AssertQueryMultirowAnyOrder(env, path, query, "key,value", new object[][]{new object[] {"k1", 1}, new object[] {"k2", 2}, new object[] {"k3", 3}});
	            ...
	            SendSB(env, "E1", 2);
	            CompileExecute(env, path, delete);
	            AssertQueryMultirowAnyOrder(env, path, query, "key,value", new object[][]{new object[] {"k1", 1}, new object[] {"k3", 3}});
	    ...
	    private class InfraFAFSubqueryInsert : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendSB(env, "E1", 0);
	            CompileExecute(env, path, insert);
	            AssertQueryMultirowAnyOrder(env, path, query, "value", new object[][]{new object[] {null}, new object[] {"E1"}});

	            SendSB(env, "E2", 0);
	            CompileExecute(env, path, insert);
	            AssertQueryMultirowAnyOrder(env, path, query, "value", new object[][]{new object[] {null}, new object[] {"E1"}, new object[] {"E2"}});
	    ...
	    private class InfraFAFSubquerySimpleJoin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendS0(env, 3, "S0_1");
	            AssertQueryMultirowAnyOrder(env, path, query, "c0,p00,p10", new object[][]{new object[] {"SB_0", "S0_0", "S1_0"}, new object[] {"SB_0", "S0_1", "S1_0"}});
