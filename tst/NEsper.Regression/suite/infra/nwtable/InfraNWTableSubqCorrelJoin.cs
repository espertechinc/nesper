...
namespace com.espertech.esper.regressionlib.suite.infra.nwtable
{
	public class InfraNWTableSubqCorrelJoin {
	    ...
	    private class InfraNWTableSubqCorrelJoinAssertion : RegressionExecution {
	        ...
	        public InfraNWTableSubqCorrelJoinAssertion(bool namedWindow, bool enableIndexShareCreate) {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var consumeEpl = "@name('s0') select (select intPrimitive from MyInfra where theString = s1.p10) as val from SupportBean_S0#lastevent as s0, SupportBean_S1#lastevent as s1";
