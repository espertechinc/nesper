...
namespace com.espertech.esper.regressionlib.suite.infra.nwtable {
	public class InfraNWTableOnMerge {
	    ...
	    internal class InfraSetArrayElementWithIndex : RegressionExecution {
	        ...
	        public InfraSetArrayElementWithIndex(bool soda, bool namedWindow) {
	            this.soda = soda;
	        ...
	        private static void RunAssertionSetWithIndex(RegressionEnvironment env, bool namedWindow, bool soda, string setter, int cntExpected, params double[] thearrayExpected) {
	            ...
	            env.AssertIterator("create", iterator =>  EPAssertionUtil.AssertProps(iterator.Advance(), "cnt,thearray".SplitCsv(), new object[] {cntExpected, thearrayExpected}));
	    ...
	    internal class InfraSetArrayElementWithIndexInvalid : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var path = new RegressionPath();
	            var eplTable = "@name('create') @public create table MyInfra(doublearray double[primitive], intarray int[primitive], notAnArray int)";
	    ...
	    internal class InfraPropertyEvalInsertNoMatch : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNew("merge", fields, new object[][]{new object[]{"10020", "Enders Game"},
	    ...
	    internal class InfraDeleteThenUpdate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create merge
	            var stmtTextMerge = "@name('merge') on SupportBean sb merge MyInfra where theString = p0 when matched " +
	                                "then delete " +
	    ...
	    internal class InfraOnMergeSimpleInsert : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create merge
	            var stmtTextMerge = "@name('merge') on SupportBean sb merge MyInfra insert select theString as p0, intPrimitive as p1";
	            env.CompileDeploy(stmtTextMerge, path).AddListener("merge");
	            env.AssertStatement("merge", statement =>Assert.AreEqual(StatementType.ON_MERGE, statement.GetProperty(StatementProperty.STATEMENTTYPE)));
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"E1", 1}, new object[] {"E2", 2}});
	    ...
	    internal class InfraInsertOnly : RegressionExecution {
	        ...
	        public InfraInsertOnly(bool namedWindow, bool useEquivalent, bool soda, bool useColumnNames) {
	            this.namedWindow = namedWindow;
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E2", 2));
	            env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 1}, new object[] {"E2", 2}});
	    ...
	    internal class InfraFlow : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E99", 2, 3}});
	    ...
	    private static void RunAssertionFlow(RegressionEnvironment env, bool namedWindow, string[] fields, AtomicLong milestone) {
	        env.ListenerReset("Window");
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 11, 401}, new object[] {"E2", 13, 300}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 11, 401}, new object[] {"E2", 14, 601}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 11, 401}, new object[] {"E2", 15, 903}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 11, 401}, new object[] {"E2", 15, 903}, new object[] {"E3", 40, 400}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 11, 401}, new object[] {"E2", 15, 903}, new object[] {"E3", 0, 0}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("Window", fields, new object[][]{new object[]{"E1", 11, 401}, new object[] {"E3", 0, 0}});
	    ...
	    internal class InfraInvalid : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            if (namedWindow) {
	                ...
	                env.TryInvalidCompile(path, epl, "Validation failed in when-not-matched (clause 1): Expression-returned event type 'SupportBean_A' with underlying type '" + typeof(SupportBean_A).FullName + "' cannot be converted to target event type 'MergeInfra' with underlying type '" + typeof(SupportBean).FullName + "' [on SupportBean_A as up merge MergeInfra as mv where mv.theString=id when matched then insert select *]");
	            }
	    ...
	    internal class InfraInnerTypeAndVariable : RegressionExecution {
	        ...
	        public InfraInnerTypeAndVariable(bool namedWindow, EventRepresentationChoice eventRepresentationEnum) {
	            this.namedWindow = namedWindow;
	        ...
	        public void Run(RegressionEnvironment env) {
	            var path = new RegressionPath();
	            var schema = eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedMyInnerSchema)) + " @public create schema MyInnerSchema(in1 string, in2 int);\n" +
	                         eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedMyEventSchema)) + " @public @buseventtype @public create schema MyEventSchema(col1 string, col2 MyInnerSchema)";
	            env.CompileDeploy(schema, path);

	            var eplCreate = namedWindow ?
	                eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedMyInfraITV)) + " @public create window MyInfraITV#keepall as (c1 string, c2 MyInnerSchema)" :
	    ...
	    internal class InfraPatternMultimatch : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('Merge') on pattern[every a=SupportBean(theString like 'A%') -> b=SupportBean(theString like 'B%', intPrimitive = a.intPrimitive)] me " +
	                      "merge MyInfraPM mw " +
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"A1", "B1"}, new object[] {"A2", "B1"}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[]{"A1", "B1"}, new object[] {"A2", "B1"}, new object[] {"A3", "B2"}, new object[] {"A4", "B2"}});
	    ...
	    internal class InfraOnMergeInsertStream : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("Create", "v1,v2".SplitCsv(), new object[][]{new object[]{"K1", 1}, new object[] {"K2", 2}});
	    ...
	    internal class InfraMultiactionDeleteUpdate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("Create", fields, new object[][]{new object[]{"E1", 1}, new object[] {"E3", 3}, new object[] {"E4", 3000}});

	            env.SendEventBean(new SupportBean("E5", 1000));
	            env.SendEventBean(new SupportBean_ST0("ST0", "E5", 0));
	            env.AssertPropsPerRowIteratorAnyOrder("Create", fields, new object[][]{new object[]{"E1", 1}, new object[] {"E3", 3}, new object[] {"E4", 3000}, new object[] {"E5", 999}});

	            env.Milestone(2);

	            env.SendEventBean(new SupportBean("E6", 2000));
	            env.SendEventBean(new SupportBean_ST0("ST0", "E6", 0));
	            env.AssertPropsPerRowIteratorAnyOrder("Create", fields, new object[][]{new object[]{"E1", 1}, new object[] {"E3", 3}, new object[] {"E4", 3000}, new object[] {"E5", 999}, new object[] {"E6", 1999}});
	            env.UndeployModuleContaining("merge");
	    ...
	    internal class InfraSubqueryNotMatched : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("Create", "string,intPrimitive".SplitCsv(), new object[][]{new object[]{"Y", 50}});

	            if (namedWindow) {
	                env.SendEventBean(new SupportBean_S0(51));  // InfraTwo now has a row {W2, 1}
	                env.SendEventBean(new SupportBean("W2", 2));
	                env.AssertPropsPerRowIterator("Create", "string,intPrimitive".SplitCsv(), new object[][]{new object[]{"Y", 51}});
	            }
	    ...
	    internal class InfraInsertOtherStream : RegressionExecution {
	        ...
	        public InfraInsertOtherStream(bool namedWindow, EventRepresentationChoice eventRepresentationEnum) {
	            this.namedWindow = namedWindow;
	            this.eventRepresentationEnum = eventRepresentationEnum;
	        }

	        public void Run(RegressionEnvironment env) {
	            var epl = eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedMyEvent)) + " @public @buseventtype @public create schema MyEvent as (name string, value double);\n" +
	                      (namedWindow ?
		                      eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedMyEvent)) + " @public create window MyInfraIOS#unique(name) as MyEvent;\n" :
	                      ...
	                      eventRepresentationEnum.GetAnnotationTextWJsonProvided(typeof(MyLocalJsonProvidedInputEvent)) + " create schema InputEvent as (col1 string, col2 double);\n" +
	                      "\n" +
	                      "on MyEvent as eme\n" +
	            ...
	            env.AssertPropsNew("s0", "event_name,status".SplitCsv(), new object[]{"name1", namedWindow ? 0d : 10d});
	        ...
	        private static void MakeSendNameValueEvent(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, string typeName, string name, double value) {
	            if (eventRepresentationEnum.IsObjectArrayEvent()) {
	                ...
	                env.SendEventJson(new JObject(new JProperty("name", name), new JProperty("value", value)).ToString(), typeName);
	            } else {
	                Assert.Fail();
	            }
	        }
	    ...
	    private static void RunUpdateNestedEvent(RegressionEnvironment env, bool namedWindow, string metaType, AtomicLong milestone) {
	        var eplTypes =
	        ...
	        env.AssertThat(() => {
	            var result = env.CompileExecuteFAF("select cflat.c0 as cf0, carr[0].c0 as ca0, carr[1].c0 as ca1 from AInfra", path);
	    ...
	    private static void SendSupportBeanEvent(RegressionEnvironment env, bool boolPrimitive, string theString, int intPrimitive, int? intBoxed) {
	    ...
	    [Serializable] internal class MyLocalJsonProvidedMyEvent {
	        public string name;
	        public double value;
	    }

	    [Serializable] internal class MyLocalJsonProvidedInputEvent {
	        public string col1;
	        public double col2;
	    }

	    [Serializable] internal class MyLocalJsonProvidedMyInnerSchema {
	        public string in1;
	        public int in2;
	    }

	    [Serializable] internal class MyLocalJsonProvidedMyEventSchema {
	        public string col1;
	        public MyLocalJsonProvidedMyInnerSchema col2;
	    }

	    [Serializable] internal class MyLocalJsonProvidedMyInfraITV {
	        public string c1;
