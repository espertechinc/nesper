	...
	public class InfraNWTableStartStop {
	    ...
	    private class InfraStartStopInserter : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            if (namedWindow) {
	                ...
	                env.AssertPropsPerRowIterator("select", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E3", 3}});
	            }
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E3", 3}});
	    ...
	    private class InfraStartStopConsumer : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.CompileDeploy(stmtTextSelect, path).AddListener("select");
	            env.AssertPropsPerRowIteratorAnyOrder("select", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E2", 2}});
	            ...
	            if (namedWindow) {
	                env.AssertPropsNew("create", fields, new object[]{"E3", 3});
	                env.AssertPropsNew("select", fields, new object[]{"E3", 3});
	                env.AssertPropsPerRowIterator("select", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E2", 2}, new object[] {"E3", 3}});
	            }
