	...
	public class InfraNWTableSubquery {
	    ...
	    public class InfraSubquerySceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create subquery
	            var stmtSubquery = "@name('Subq') select (select intPrimitive from MyInfra where theString = s0.p00) as c0 from SupportBean_S0 as s0";
	    ...
	    private class InfraUncorrelatedSubqueryAggregation : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create insert into
	            var stmtTextInsertOne = "insert into MyInfraUCS select theString as a, longPrimitive as b from SupportBean";
	            env.CompileDeploy(stmtTextInsertOne, path);

	            // create consumer
	            var stmtTextSelectOne = "select irstream (select sum(b) from MyInfraUCS) as value, symbol from SupportMarketDataBean";
	    ...
	    private class InfraInvalidSubquery : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            try {
	                ...
	                if (namedWindow) {
	                    Assert.AreEqual("Failed to plan subquery number 1 querying MyInfraIS: Consuming statements to a named window cannot declare a data window view onto the named window [select (select theString from MyInfraIS#lastevent) from MyInfraIS]", ex.Message);
	                } else {
	    ...
	    private class InfraSubqueryDeleteInsertReplace : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            // create insert into
	            var stmtTextInsertOne = "insert into MyInfra select theString as key, intBoxed as value from SupportBean as s0";
	            env.CompileDeploy(stmtTextInsertOne, path);
	            ...
	            if (namedWindow) {
	                ...
	                env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E2", 2}});
	            } else {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[] {"E2", 2}, new object[] {"E1", 3}});
	    ...
	    private class InfraSubquerySelfCheck : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtTextInsertOne = "insert into MyInfraSSS select theString as key, intBoxed as value from SupportBean as s0" +
	            ...
	            if (namedWindow) {
	                ...
	                env.AssertPropsPerRowIterator("create", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E2", 2}, new object[] {"E3", 4}});
	            } else {
	                env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E2", 2}, new object[] {"E3", 4}});
	            }
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E3", 4}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("create", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E3", 4}, new object[] {"E2", 5}});
