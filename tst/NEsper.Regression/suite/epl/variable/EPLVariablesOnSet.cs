	...
	public class EPLVariablesOnSet {
	    ...
	    private class EPLVariableOnSetExpression : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl =
	                "import " + typeof(MyLocalVariable).FullName + ";\n" +
	    ...
	    private class EPLVariableOnSetSubqueryMultikeyWArray : RegressionExecution {
	        ...
	        private void AssertVariable(RegressionEnvironment env, int? expected) {
	    ...
	    private class EPLVariableOnSetSubquery : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtTextSet = "@name('s0') on SupportBean_S0 as s0str set var1SS = (select p10 from SupportBean_S1#lastevent), var2SS = (select p11||s0str.p01 from SupportBean_S1#lastevent)";
	    ...
	    private class EPLVariableOnSetObjectModel : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("set", statement => {
	    ...
	    private class EPLVariableOnSetSimpleSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertListener("s0_0", listener => EPAssertionUtil.AssertProps(listener.LastNewData[0], fieldsVarOne, new object[]{20}));
	            env.AssertListener("s0_1", listener => EPAssertionUtil.AssertProps(listener.LastNewData[0], fieldsVarTwo, new object[]{20}));
	    ...
	    private class EPLVariableOnSetWithFilter : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("set", fieldsVar, new object[][]{new object[] {"begin", true, "value"}});
	    ...
	    private class EPLVariableOnSetCoercion : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fieldsSelect, new object[][]{new object[] {null, null, null, "A1"}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fieldsSelect, new object[][]{new object[] {1f, 1d, 2L, "A1"}, new object[] {1f, 1d, 2L, "A2"}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fieldsSelect, new object[][]{new object[] {10f, 10d, 20L, "A2"}, new object[] {10f, 10d, 20L, "A3"}});
	    ...
	    private static SupportBean SendSupportBean(RegressionEnvironment env, string theString, int intPrimitive, int? intBoxed) {
	        var bean = MakeSupportBean(theString, intPrimitive, intBoxed);
	        env.SendEventBean(bean);
	        return bean;
	    }

	    private static void SendSupportBeanNewThread(RegressionEnvironment env, string theString, int intPrimitive, int? intBoxed) {
	        try {
	            var t = new Thread(() => {
		            var bean = MakeSupportBean(theString, intPrimitive, intBoxed);
	                env.SendEventBean(bean);
