	...
	public class EPLSpatialPointRegionQuadTreeInvalid {
	    ...
	    private class EPLSpatialInvalidEventIndexCreate : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // invalid column type
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((id, py) pointregionquadtree(0, 0, 100, 100))",
	                "Index of type 'pointregionquadtree' for column 0 that is providing x-values expecting type Number but received type String");
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, id) pointregionquadtree(0, 0, 100, 100))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((dummy, dummy2) pointregionquadtree(0, 0, 100, 100))",
	                "Failed to validate create-index index-column expression 'dummy': Property named 'dummy' is not valid in any stream");
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(dummy, 0, 100, 100))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(px, 0, 100, 100))",
	                "Index parameters may not refer to event properties");

	            // invalid number of parameters
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree)",
	                "Index of type 'pointregionquadtree' requires at least 4 parameters but received 0");
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree('a'))",
	                "Index of type 'pointregionquadtree' requires at least 4 parameters but received 1");
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(0, 0, 0, 0, 0, 0, 0))",
	                "Index of type 'pointregionquadtree' requires at least 4 parameters but received 7");

	            // invalid parameter type
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree('a', 0, 100, 100))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(0, 'a', 100, 100))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(0, 0, 'a', 100))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(0, 0, 100, 'a'))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(0, 0, 100, 100, 'a'))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndex on MyWindow((px, py) pointregionquadtree(0, 0, 100, 100, 1, 'a'))",
	            ...
	            env.TryInvalidCompile(path, "create index SomeWindowIdx1 on SomeWindow((py, px) pointregionquadtree(0, 0, 1, 1))",
	                "An index by name 'SomeWindowIdx1' already exists");

	            // non-plain column or parameter expressions
	            env.TryInvalidCompile(path, "create index MyIndexInv on MyWindow((sum(px), py) pointregionquadtree(0, 0, 1, 1))",
	            ...
	            env.TryInvalidCompile(path, "create index MyIndexInv on MyWindow((px, py) pointregionquadtree(count(*), 0, 1, 1))",
	    ...
	    private class EPLSpatialInvalidMethod : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.TryInvalidCompile("select * from SupportEventRectangleWithOffset(point('a', 0).inside(rectangle(0, 0, 0, 0)))",
	            ...
	            env.TryInvalidCompile("select * from SupportEventRectangleWithOffset(point(0).inside(rectangle(0, 0, 0, 0)))",
	            ...
	            env.TryInvalidCompile("select * from SupportEventRectangleWithOffset(point(0,0).inside(rectangle('a', 0, 0, 0)))",
	            ...
	            env.TryInvalidCompile("select * from SupportEventRectangleWithOffset(point(0,0).inside(rectangle(0)))",
	            ...
	            env.TryInvalidCompile("select * from SupportEventRectangleWithOffset(point(0,0).inside(0))",
	    ...
	    private class EPLSpatialInvalidFilterIndex : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.TryInvalidCompile("select * from SupportSpatialAABB#keepall where point(0, 0, a:1).inside(rectangle(x, y, width, height))",
	            ...
	            // not a filter
	            env.TryInvalidCompile("expression myindex {pointregionquadtree(0, 0, 100, 100)} select * from SupportSpatialAABB#keepall where point(0, 0, filterindex:myindex).inside(rectangle(x, y, width, height))",
	            ...
	            env.TryInvalidCompile("select * from SupportSpatialAABB(point(0, 0, filterindex:1).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("select * from SupportSpatialAABB(point(0, 0, filterindex:dummy).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("expression myindex {0} select * from SupportSpatialAABB(point(0, 0, filterindex:myindex).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("expression myindex {dummy(0)} select * from SupportSpatialAABB(point(0, 0, filterindex:myindex).inside(rectangle(x, y, width, height)))",
	                "Failed to validate filter expression 'point(0,0,filterindex:myindex()).in...(68 chars)': Unrecognized advanced-type index 'dummy'");
	            env.TryInvalidCompile("expression myindex {pointregionquadtree(0)} select * from SupportSpatialAABB(point(0, 0, filterindex:myindex).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("expression myindex {pointregionquadtree(0,0,0,0)} select * from SupportSpatialAABB(point(0, 0, filterindex:myindex).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("expression myindex {pointregionquadtree(0,0,100,100).help()} select * from SupportSpatialAABB(point(0, 0, filterindex:myindex).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("expression myindex {pointregionquadtree(0, 0, 100, 100)} select * from SupportSpatialAABB(point(x, y, filterindex:myindex).inside(rectangle(x, y, width, height)))",
	            ...
	            env.TryInvalidCompile("expression myindex {pointregionquadtree(0, 0, 100, 100)} select * from SupportSpatialAABB(point(0, 0, filterindex:myindex).inside(rectangle(0, y, width, height)))",
