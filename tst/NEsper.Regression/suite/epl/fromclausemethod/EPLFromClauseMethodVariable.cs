	...
	public class EPLFromClauseMethodVariable {
	    ...
	    private class EPLFromClauseMethodVariableInvalid : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.CompileDeploy("@Public context BetweenStartAndEnd create variable " + typeof(MyMethodHandlerMap).FullName + " themap", path);
	    ...
	    private class EPLFromClauseMethodVariableMapAndOA : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            foreach (var epl in new string[]{
	                ...
	                env.AssertIterator("s0", iterator => EPAssertionUtil.AssertProps(iterator.Advance(), "field1,field2".SplitCsv(), new object[]{"a", "b"}));
	                env.UndeployAll();
	            }
	        }
	    }
