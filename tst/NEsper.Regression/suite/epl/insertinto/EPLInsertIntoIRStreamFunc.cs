...
namespace com.espertech.esper.regressionlib.suite.epl.insertinto
{
	public class EPLInsertIntoIRStreamFunc : RegressionExecution {
	    public void Run(RegressionEnvironment env) {
	        ...
	        env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E2", true}, new object[] {"E1", false}}, Array.Empty<object[]>());

	        env.SendEventBean(new SupportBean("E3", 0));
	        env.AssertPropsIRPair("i0", fields, new object[]{"E3", true}, new object[]{"E2", false});
	        env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E3", true}, new object[] {"E2", false}}, Array.Empty<object[]>());

	        // test SODA
	        var eplModel = "@name('s1') select istream() from SupportBean";
	        env.EplToModelCompileDeploy(eplModel);
	        env.AssertStatement("s1", statement => Assert.AreEqual(typeof(bool?), statement.EventType.GetPropertyType("istream()")));
