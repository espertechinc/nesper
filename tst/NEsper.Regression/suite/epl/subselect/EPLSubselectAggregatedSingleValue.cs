...
namespace com.espertech.esper.regressionlib.suite.epl.subselect
{
	public class EPLSubselectAggregatedSingleValue {
	    ...
	    private class EPLSubselectGroupedCorrelationInsideHaving : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') @name('s0')select (select theString from SupportBean#keepall group by theString having sum(intPrimitive) = s0.id) as c0 from SupportBean_S0 as s0";
	    ...
	    private class EPLSubselectUngroupedCorrelationInsideHaving : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') @name('s0')select (select last(theString) from SupportBean#keepall having sum(intPrimitive) = s0.id) as c0 from SupportBean_S0 as s0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectGroupedTableWHaving : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "create table MyTableWith2Keys(k1 string primary key, k2 string primary key, total sum(int));\n" +
	    ...
	    private class EPLSubselectGroupedCorrelatedWHaving : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') @name('s0')select (select sum(intPrimitive) from SupportBean#keepall where s0.id = intPrimitive group by theString having sum(intPrimitive) > 10) as c0 from SupportBean_S0 as s0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectGroupedUncorrelatedWHaving : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') @name('s0')select (select sum(intPrimitive) from SupportBean#keepall group by theString having sum(intPrimitive) > 10) as c0 from SupportBean_S0 as s0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectUngroupedCorrelatedWHaving : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') @name('s0')select (select sum(intPrimitive) from SupportBean#keepall where theString = s0.p00 having sum(intPrimitive) > 10) as c0 from SupportBean_S0 as s0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectUngroupedUncorrelatedFiltered : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select (select sum(id) from SupportBean_S1(id < 0)#length(3)) as value from SupportBean_S0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectUngroupedUncorrelatedWWhereClause : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select (select sum(id) from SupportBean_S1#length(3) where id < 0) as value from SupportBean_S0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectUngroupedUncorrelatedNoDataWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select p00 as c0, (select sum(intPrimitive) from SupportBean) as c1 from SupportBean_S0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    public class EPLSubselectUngroupedCorrelatedSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var text = "@name('s0') select id, (select count(*) from SupportBean_S1#length(3) s1 where s1.p10 = s0.p00) as mycount from SupportBean_S0 s0";
	    ...
	    private class EPLSubselectUngroupedUncorrelatedInSelectClause : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select (select s0.id + max(s1.id) from SupportBean_S1#length(3) as s1) as value from SupportBean_S0 as s0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectUngroupedUncorrelatedInSelect : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select (select max(id) from SupportBean_S1#length(3)) as value from SupportBean_S0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class EPLSubselectUngroupedUncorrelatedTwoAggStopStart : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select (select avg(id) + max(id) from SupportBean_S1#length(3)) as value from SupportBean_S0";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private static void TryAssertion2StreamRangeCoercion(RegressionEnvironment env, AtomicLong milestone, string epl, bool isHasRangeReversal) {
	        env.CompileDeployAddListenerMile(epl, "s0", milestone.GetAndIncrement());
	    ...
	    private static void TryAssertion3StreamKeyRangeCoercion(RegressionEnvironment env, AtomicLong milestone, string epl, bool isHasRangeReversal) {
	        env.CompileDeployAddListenerMile(epl, "s0", milestone.GetAndIncrement());
