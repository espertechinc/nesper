...
namespace com.espertech.esper.regressionlib.suite.epl.subselect
{
    public class EPLSubselectAggregatedMultirowAndColumn
    {
        ...
        public static IList<RegressionExecution> WithrowGroupedIndexSharedMultikeyWArray(
        ...
        public static IList<RegressionExecution> WithcolumnGroupedContextPartitioned(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithrowGroupedUncorrelatedIteratorAndExpressionDef(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithcolumnGroupedUncorrelatedUnfiltered(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithrowGroupedNamedWindowSubqueryIndexShared(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithrowGroupedCorrelatedWHaving(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithrowGroupedUncorrelatedWithEnumerationMethod(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithrowGroupedCorrelatedWithEnumMethod(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        public static IList<RegressionExecution> WithrowGroupedNoDataWindowUncorrelated(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        private class EPLSubselectMultirowGroupedIndexSharedMultikeyWArray : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                var epl =
                    "@Hint('enable_window_subquery_indexshare') @public create window MyWindow#keepall as SupportEventWithManyArray;\n" +
        ...
        private class EPLSubselectMultirowGroupedCorrelatedWHaving : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                AssertMapMultiRowAndReset(
                    ...
                    "c0",
                    fields,
                    new object[][] { new object[] { "E1", 20 }, new object[] { "E2", 20 } });
        ...
        private class EPLSubselectMultirowGroupedNamedWindowSubqueryIndexShared : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                env.AssertEventNew(
                    "s0",
                    @event => AssertMapMultiRow(
                        "e1",
                        @event,
                        "c0",
                        "c0,c1".SplitCsv(),
                        new object[][] { new object[] { "E1", 30 } }));
            ...
            public void Run(RegressionEnvironment env)
            {
                ...
                Consumer<EventBean> assertionTwo = @event => {
                    ...
                    AssertMapMultiRow(
                        ...
                        "c0",
                        fields,
                        new object[][] { new object[] { "E1", 20 }, new object[] { "E2", 30 } });
                };
        ...
        private class EPLSubselectMultirowGroupedUncorrelatedWithEnumerationMethod : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                AssertMapMultiRowAndReset(
                    ...
                    "c0",
                    fields,
                    new object[][] { new object[] { "E1", 30 }, new object[] { "E2", 100 } });
                ...
                AssertMapMultiRowAndReset(
                    ...
                    fields,
                    new object[][]
                        { new object[] { "E1", 30 }, new object[] { "E2", 100 }, new object[] { "E3", 2000 } });
                env.UndeployAll();
                ...
                AssertMapMultiRowAndReset(
                    ...
                    "c0",
                    fields,
                    new object[][] { new object[] { "E1", 401 }, new object[] { "E2", 300 } });
        ...
        private static void RunAssertionNoDelete(
        ...
        private static void SendSBEventAndTrigger(
            RegressionEnvironment env,
            string theString,
            int intPrimitive)
        {
        ...
        private static void SendS1EventAndTrigger(
            RegressionEnvironment env,
            int id)
        {
        ...
        private static void AssertMapFieldAndReset(
            RegressionEnvironment env,
            string fieldName,
            string[] names,
            object[] values)
        ...
        private static void AssertMapMultiRowAndReset(
            RegressionEnvironment env,
            string fieldName,
            string sortKey,
            string[] names,
