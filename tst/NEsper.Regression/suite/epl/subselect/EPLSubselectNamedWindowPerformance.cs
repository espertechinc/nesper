...
namespace com.espertech.esper.regressionlib.suite.epl.subselect
{
	public class EPLSubselectNamedWindowPerformance {
	    ...
	    private class EPLSubselectConstantValue : RegressionExecution {
	        ...
	        public EPLSubselectConstantValue(bool indexShare, bool buildIndex) {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplSingle = "@name('s0') select (select intPrimitive from MyWindow where theString = 'E9734') as val from SupportBeanRange sbr";
	            ...
	            // two-field compare
	            var eplTwoHash = "@name('s1') select (select intPrimitive from MyWindow where theString = 'E9736' and intPrimitive = 9736) as val from SupportBeanRange sbr";
	            ...
	            var eplSingleBTree = "@name('s2') select (select intPrimitive from MyWindow where intPrimitive between 9735 and 9735) as val from SupportBeanRange sbr";
	            ...
	            var eplComposite = "@name('s3') select (select intPrimitive from MyWindow where theString = 'E9738' and intPrimitive between 9738 and 9738) as val from SupportBeanRange sbr";
	    ...
	    private class EPLSubselectKeyAndRange : RegressionExecution {
	        ...
	        public EPLSubselectKeyAndRange(bool indexShare, bool buildIndex) {
	            this.indexShare = indexShare;
	            this.buildIndex = buildIndex;
	        }
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var queryEpl = "@name('s0') select (select min(intPrimitive) as mini, max(intPrimitive) as maxi from MyWindow where theString = sbr.key and intPrimitive between sbr.rangeStart and sbr.rangeEnd) as cols from SupportBeanRange sbr";
	    ...
	    private class EPLSubselectRange : RegressionExecution {
	        ...
	        public EPLSubselectRange(bool indexShare, bool buildIndex) {
	            this.indexShare = indexShare;
	            this.buildIndex = buildIndex;
	        }
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var fields = "cols.mini,cols.maxi".SplitCsv();
	            var queryEpl = "@name('s0') select (select min(intPrimitive) as mini, max(intPrimitive) as maxi from MyWindow where intPrimitive between sbr.rangeStart and sbr.rangeEnd) as cols from SupportBeanRange sbr";
	            env.CompileDeploy(queryEpl, path).AddListener("s0");
	    ...
	    private class EPLSubselectKeyedRange : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var fields = "cols.mini,cols.maxi".SplitCsv();
	            var queryEpl = "@name('s0') select (select min(intPrimitive) as mini, max(intPrimitive) as maxi from MyWindow " +
	    ...
	    private static void TryAssertion(RegressionEnvironment env, bool enableIndexShareCreate, bool disableIndexShareConsumer, bool createExplicitIndex) {
	        var path = new RegressionPath();
	        ...
	        var consumeEpl = "@name('s0') select e0, (select theString from MyWindow where intPrimitive = es.e1 and theString = es.e2) as val from EventSchema as es";
