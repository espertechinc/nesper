	...
	public class EPLSubselectMulticolumn {
	    ...
	    public class EPLSubselectMulticolumnAgg : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var text = "@name('s0') select id, (select count(*) as v1, sum(id) as v2 from SupportBean_S1#length(3)) as s1totals " +
	    ...
	    private class EPLSubselectInvalid : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "select (select theString, sum(intPrimitive) from SupportBean#lastevent as sb) from SupportBean_S0";
