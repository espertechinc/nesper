	...
	public class EPLDatabase3StreamOuterJoin {
	    ...
	    private class EPLDatabaseInnerJoinLeftS0 : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", "sb.theString,sbt.stringTwo,s1.myint".SplitCsv(), new object[]{"T2", "T2", 30});

	            env.SendEventBean(new SupportBean("T3", -1));
	            env.SendEventBean(new SupportBeanTwo("T3", 40));
	            env.AssertPropsNew("s0", "sb.theString,sbt.stringTwo,s1.myint".SplitCsv(), new object[]{"T3", "T3", 40});
	    ...
	    private class EPLDatabaseOuterJoinLeftS0 : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", "sb.theString,sbt.stringTwo,s1.myint".SplitCsv(), new object[]{"T1", "T1", null});
	            ...
	            env.SendEventBean(new SupportBean("T3", -1));
	            env.AssertPropsNew("s0", "sb.theString,sbt.stringTwo,s1.myint".SplitCsv(), new object[]{"T3", null, null});
