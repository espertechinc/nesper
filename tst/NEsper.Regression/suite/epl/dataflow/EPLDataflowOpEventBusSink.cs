	...
	public class EPLDataflowOpEventBusSink {
	    ...
	    private class EPLDataflowAllTypes : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            RunAssertionAllTypes(env, DefaultSupportGraphEventUtil.EVENTTYPENAME, DefaultSupportGraphEventUtil.GetPONOEvents());
	    ...
	    private static void RunAssertionAllTypes(RegressionEnvironment env, string typeName, object[] events) {
	        ...
	        env.AssertPropsPerRowNewFlattened("s0",  "myDouble,myInt,myString".SplitCsv(), new object[][]{new object[] {1.1d, 1, "one"}, new object[] {2.2d, 2, "two"}});
	    ...
	    private class EPLDataflowSendEventDynamicType : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var source = new MyObjectArrayGraphSource(Arrays.AsList(
