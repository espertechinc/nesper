	...
	public class EPLOuterJoin7Stream {
	    ...
	    private class EPLJoinKeyPerStream : RegressionExecution {
	        ...
	        private static void TryAssertsKeysPerStream(RegressionEnvironment env) {
	            ...
	            SendEvent(env, s0Events);
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[0], s1Events[1], s2Events[0], s3Events[0], null, s5Events1[0], s6Events1[0]},
	                new object[] {s0Events[0], s1Events[1], s2Events[1], s3Events[0], null, s5Events2[0], s6Events2[0]},
	                new object[] {s0Events[0], s1Events[1], s2Events[1], s3Events[0], null, s5Events2[1], s6Events2[0]},
	            });
	            ...
	            SendEvent(env, s0Events);
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[0], s1Events[0], s2Events[0], s3Events2[0], s4Events[0], null, s6Events[0]},
	                new object[] {s0Events[0], s1Events[0], s2Events[0], s3Events2[0], s4Events[1], null, s6Events[0]},
	                new object[] {s0Events[0], s1Events[0], s2Events[0], s3Events2[1], s4Events[0], null, s6Events[0]},
	                new object[] {s0Events[0], s1Events[0], s2Events[0], s3Events2[1], s4Events[1], null, s6Events[0]},
	            ...
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[0], s1Events[0], s2Events1[1], s3Events[0], s4Events[0], s5Events1[0], s6Events1[0]},
	                new object[] {s0Events[0], s1Events[0], s2Events1[1], s3Events[0], s4Events[0], s5Events1[1], s6Events1[0]},
	                new object[] {s0Events[3], s1Events[0], s2Events3[0], s3Events[0], s4Events[0], null, s6Events2[0]},
	            });
	            ...
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[0], s1Events1[0], s2Events[0], s3Events1[0], s4Events[0], s5Events[0], s6Events[0]},
	                new object[] {s0Events[0], s1Events3[0], s2Events[0], s3Events2[0], null, s5Events[0], s6Events[0]}
	            });
	            ...
	            SendEvent(env, s3Events);
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[1], s1Events[1], s2Events1[0], s3Events[0], s4Events[0], null, s6Events1[0]},
	                new object[] {s0Events[2], s1Events[1], s2Events2[1], s3Events[0], s4Events[0], null, s6Events2[0]},
	                new object[] {s0Events[2], s1Events[1], s2Events2[1], s3Events[0], s4Events[0], null, s6Events2[1]},
	            });
	            ...
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[1], s1Events[2], s2Events2[0], s3Events[0], s4Events[0], s5Events[0], s6Events[0]},
	                new object[] {s0Events[1], s1Events[2], s2Events2[0], s3Events[0], s4Events[0], s5Events[1], s6Events[0]},
	                new object[] {s0Events[1], s1Events[2], s2Events2[0], s3Events[0], s4Events[0], s5Events[0], s6Events[1]},
	                new object[] {s0Events[1], s1Events[2], s2Events2[0], s3Events[0], s4Events[0], s5Events[1], s6Events[1]}
	            });
	            ...
	            SendEvent(env, s5Events);
	            AssertListenerUnd(env, new object[][]{
	                new object[] {s0Events[0], s1Events[1], s2Events[1], s3Events1[0], null, s5Events[0], s6Events[0]},
	                new object[] {s0Events[0], s1Events[1], s2Events[1], s3Events1[1], null, s5Events[0], s6Events[0]},
	                new object[] {s0Events[0], s1Events[2], s2Events[1], s3Events2[0], null, s5Events[0], s6Events[0]},
	                new object[] {s0Events[0], s1Events[1], s2Events[1], s3Events1[0], null, s5Events[0], s6Events[1]},
	                new object[] {s0Events[0], s1Events[1], s2Events[1], s3Events1[1], null, s5Events[0], s6Events[1]},
	                new object[] {s0Events[0], s1Events[2], s2Events[1], s3Events2[0], null, s5Events[0], s6Events[1]}
	            });
	    ...
	    private static void AssertListenerUnd(RegressionEnvironment env, object[][] expected) {
	        env.AssertListener("s0", listener => {
	            var und = ArrayHandlingUtil.GetUnderlyingEvents(listener.GetAndResetLastNewData(), new string[]{"s0", "s1", "s2", "s3", "s4", "s5", "s6"});
