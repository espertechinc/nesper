...
namespace com.espertech.esper.regressionlib.suite.epl.join
{
	public class EPLOuterFullJoin3Stream {
	    ...
	    private class EPLJoinFullJoin2SidesMulticolumn : RegressionExecution {
	        ...
	        private static void TryAssertionFullJoin_2sides_multicolumn(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, AtomicLong milestone) {
