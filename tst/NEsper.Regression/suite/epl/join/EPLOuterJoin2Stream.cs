	...
	public class EPLOuterJoin2Stream {
		...
		private class EPLJoinRangeOuterJoin : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var stmtOne = "@name('s0') select sb.theString as sbstr, sb.intPrimitive as sbint, sbr.key as sbrk, sbr.rangeStart as sbrs, sbr.rangeEnd as sbre " +
				...
				var stmtTwo = "@name('s0') select sb.theString as sbstr, sb.intPrimitive as sbint, sbr.key as sbrk, sbr.rangeStart as sbrs, sbr.rangeEnd as sbre " +
				...
				var stmtThree = "@name('s0') select sb.theString as sbstr, sb.intPrimitive as sbint, sbr.key as sbrk, sbr.rangeStart as sbrs, sbr.rangeEnd as sbre " +
				                "from SupportBeanRange#keepall sbr " +
				                "full outer join " +
				                "SupportBean#keepall sb " +
				                "on theString = key " +
			...
			private static void TryAssertion (RegressionEnvironment env, string epl, AtomicLong milestone) {
				...
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "K1", 41, "K1", 39, 41 }, new object[] { "K1", 41, "K1", 40, 42 }, new object[] { "K1", 41, "K1", 41, 42 }
				});

				env.SendEventBean (new SupportBeanRange ("R2", "K1", 35, 42));
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "K1", 40, "K1", 35, 42 }, new object[] { "K1", 41, "K1", 35, 42 } });
			...
			public void Run (RegressionEnvironment env) {
				...
				env.AssertIterator ("s0", iterator => {
					...
					EPAssertionUtil.AssertPropsPerRow (events, "theString,intPrimitive,symbol,volume".Split (","),
						new object[][] { new object[] { null, null, "c3", 400L }, new object[] { "c0", 0, "c0", 200L }, new object[] { "c0", 1, "c0", 200L }, new object[] { "c0", 2, "c0", 200L }, new object[] { "c1", 0, null, null }, new object[] { "c1", 1, null, null }, new object[] { "c1", 2, null, null }, new object[] { "c2", 0, null, null }, new object[] { "c2", 1, null, null }, new object[] { "c2", 2, null, null }
						});
				});
		...
		private class EPLJoinFullOuterJoin : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 100, "0", null, null }, new object[] { null, null, 201, "1" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 100, "0", null, null }, new object[] { null, null, 201, "1" }, new object[] { null, null, 202, "2" }
					});

				SendEvent (EVENTS_S0[2], env);
				CompareEventNew (env, 102, "2", 202, "2");
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 100, "0", null, null }, new object[] { null, null, 201, "1" }, new object[] { 102, "2", 202, "2" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 100, "0", null, null }, new object[] { null, null, 201, "1" }, new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", null, null }
					});
				SendEvent (EVENTS_S1[3], env);
				CompareEventNew (env, 103, "3", 203, "3");
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 100, "0", null, null }, new object[] { null, null, 201, "1" }, new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", 203, "3" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { null, null, 201, "1" }, new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", 203, "3" }, new object[] { 104, "4", null, null }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { null, null, 201, "1" }, new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", 203, "3" }, new object[] { 104, "4", 204, "4" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { null, null, 201, "1" }, new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", 203, "3" }, new object[] { 104, "4", 204, "4" }, new object[] { null, null, 205, "5" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", 203, "3" }, new object[] { 104, "4", 204, "4" }, new object[] { null, null, 205, "5" }, new object[] { null, null, 205, "5" }
					});
		...
		private class EPLJoinRightOuterJoin : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 102, "2", 202, "2" }, new object[] { null, null, 203, "3" }
					});
				...
				CompareEventNew (env, 103, "3", 203, "3");
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 102, "2", 202, "2" }, new object[] { 103, "3", 203, "3" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { null, null, 202, "2" }, new object[] { 103, "3", 203, "3" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { null, null, 202, "2" }, new object[] { 103, "3", 203, "3" }, new object[] { null, null, 206, "6" }, new object[] { null, null, 207, "7" }, new object[] { null, null, 208, "8" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 103, "3", 203, "3" }, new object[] { null, null, 206, "6" }, new object[] { null, null, 207, "7" }, new object[] { null, null, 208, "8" }, new object[] { null, null, 209, "9" }
					});
		...
		private class EPLJoinLeftOuterJoin : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 102, "2", 202, "2" }, new object[] { 105, "5", 205, "5" }
					});
				...
				CompareEventOld (env, 102, "2", 202, "2");
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 102, "2", null, null }, new object[] { 105, "5", 205, "5" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 102, "2", null, null }, new object[] { 109, "9", null, null }, new object[] { 105, "5", 205, "5" }
					});
				...
				env.AssertPropsPerRowIteratorAnyOrder ("s0", FIELDS,
					new object[][] { new object[] { 110, "10", null, null }, new object[] { 109, "9", null, null }, new object[] { 105, "5", 205, "5" }
					});
		...
		private static void CompareEventNew (RegressionEnvironment env, int? idS0, string p00, int? idS1, string p10) {
			env.AssertEventNew ("s0", @event => CompareEvent (@event, idS0, p00, idS1, p10));
		}

		private static void CompareEventOld (RegressionEnvironment env, int? idS0, string p00, int? idS1, string p10) {
