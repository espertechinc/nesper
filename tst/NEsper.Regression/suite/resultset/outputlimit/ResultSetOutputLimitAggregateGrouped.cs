	...
	public class ResultSetOutputLimitAggregateGrouped {
	    ...
	    internal class ResultSetLastNoDataWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.AdvanceTime(0);
	            var epl = "@name('s0') select theString, intPrimitive as intp from SupportBean group by theString output last every 1 seconds order by theString asc";
	            ...
	            env.AssertPropsPerRowLastNew("s0", new string[]{"theString", "intp"}, new object[][]{new object[]{"E1", 3}, new object[] {"E2", 21}, new object[] {"E3", 31}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", new string[]{"theString", "intp"}, new object[][]{new object[]{"E1", 5}, new object[] {"E3", 33}});
	    ...
	    internal class ResultSetWildcardRowPerGroup : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select * from SupportBean group by theString output last every 3 events order by theString asc";
	            env.CompileDeploy(epl).AddListener("s0");
	    ...
	    internal class ResultSetOutputLastMultikeyWArray : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select theString, longPrimitive, intPrimitive, sum(intPrimitive) as thesum from SupportBean#keepall " +
	            ...
	            env.AssertListener("s0", listener => EPAssertionUtil.AssertPropsPerRowAnyOrder(listener.GetAndResetLastNewData(), fields, new object[][]{
	                new object[] {"B", 1L, 11, 11}, new object[] {"A", 0L, 12, 22}, new object[] {"C", 0L, 13, 13}}));
	    ...
	    internal class ResultSetOutputAllMultikeyWArray : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AdvanceTime(1000);
	            env.AssertListener("s0", listener => EPAssertionUtil.AssertPropsPerRowAnyOrder(listener.GetAndResetLastNewData(), fields, new object[][]{
	                new object[] {"A", 0L, 10, 10}, new object[] {"B", 1L, 11, 11}, new object[] {"A", 0L, 12, 22}, new object[] {"C", 0L, 13, 13}}));

	            SendBeanEvent(env, "A", 0, 14);

	            env.AdvanceTime(2000);
	            env.AssertListener("s0", listener => EPAssertionUtil.AssertPropsPerRowAnyOrder(listener.GetAndResetLastNewData(), fields, new object[][]{
	                new object[] {"A", 0L, 14, 36}, new object[] {"B", 1L, 11, 11}, new object[] {"C", 0L, 13, 13}}));
	    ...
	    internal class ResultSetOutputFirstHavingJoinNoJoin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var stmtText = "@name('s0') select theString, longPrimitive, sum(intPrimitive) as value from MyWindow group by theString having sum(intPrimitive) > 20 output first every 2 events";
	            TryOutputFirstHaving(env, stmtText, milestone);

	            var stmtTextJoin = "@name('s0') select theString, longPrimitive, sum(intPrimitive) as value from MyWindow mv, SupportBean_A#keepall a where a.id = mv.theString " +
	                               "group by theString having sum(intPrimitive) > 20 output first every 2 events";
	            TryOutputFirstHaving(env, stmtTextJoin, milestone);

	            var stmtTextOrder = "@name('s0') select theString, longPrimitive, sum(intPrimitive) as value from MyWindow group by theString having sum(intPrimitive) > 20 output first every 2 events order by theString asc";
	            TryOutputFirstHaving(env, stmtTextOrder, milestone);

	            var stmtTextOrderJoin = "@name('s0') select theString, longPrimitive, sum(intPrimitive) as value from MyWindow mv, SupportBean_A#keepall a where a.id = mv.theString " +
	    ...
	    private static void RunAssertion16LastHavingJoin(RegressionEnvironment env, SupportOutputLimitOpt opt, AtomicLong milestone) {
	        var stmtText = opt.GetHint() + "@name('s0') select symbol, volume, sum(price) " +
	                       "from SupportMarketDataBean#time(5.5 sec), " +
	                       "SupportBean#keepall where theString=symbol " +
	                       "group by symbol " +
	                       "having sum(price) > 50 " +
	    ...
	    internal class ResultSetLimitSnapshot : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            SendTimer(env, 0);
	            var selectStmt = "@name('s0') select symbol, volume, sum(price) as sumprice from SupportMarketDataBean" +
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"s0", 1L, 34d}, new object[] {"IBM", 2L, 16d}, new object[] {"s0", 3L, 34d}});
	            ...
	            SendTimer(env, 10000);
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"s0", 1L, 34d}, new object[] {"IBM", 2L, 46d}, new object[] {"s0", 3L, 34d}, new object[] {"MSFT", 4L, 18d}, new object[] {"IBM", 5L, 46d}});

	            SendTimer(env, 11000);
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"MSFT", 4L, 18d}, new object[] {"IBM", 5L, 30d}});
	    ...
	    internal class ResultSetLimitSnapshotJoin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendTimer(env, 1000);
	            var fields = new string[]{"symbol", "volume", "sumprice"};
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"ABC", 1L, 34d}, new object[] {"ABC", 3L, 34d}, new object[] {"IBM", 2L, 16d}});
	            ...
	            SendTimer(env, 10000);
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"ABC", 1L, 34d}, new object[] {"ABC", 3L, 34d}, new object[] {"IBM", 2L, 46d}, new object[] {"IBM", 5L, 46d}, new object[] {"MSFT", 4L, 18d}});

	            SendTimer(env, 10500);
	            SendTimer(env, 11000);
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"IBM", 5L, 30d}, new object[] {"MSFT", 4L, 18d}});
	    ...
	    internal class ResultSetNoJoinAll : RegressionExecution {
	        ...
	        private static void TryAssertionNoJoinAll(RegressionEnvironment env, SupportOutputLimitOpt opt) {
	            // Every event generates a new row, this time we sum the price by symbol and output volume
	            var epl = opt.GetHint() + "@name('s0') select symbol, volume, sum(price) as mySum " +
	                      "from SupportMarketDataBean#length(5) " +
	                      "where symbol='DELL' or symbol='IBM' or symbol='GE' " +
	                      "group by symbol " +
	    ...
	    private static void TryOutputFirstHaving(RegressionEnvironment env, string statementText, AtomicLong milestone) {
	    ...
	    private static void TryAssertion12(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	    ...
	    private static void TryAssertion34(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion13_14(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion15_16(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion78(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion56(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion9_10(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion11_12(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion17(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void TryAssertion18(RegressionEnvironment env, string stmtText, string outputLimit, AtomicLong milestone) {
	        SendTimer(env, 0);
	        env.CompileDeploy(stmtText).AddListener("s0");
	    ...
	    private static void RunAssertion15LastHavingNoJoin(RegressionEnvironment env, SupportOutputLimitOpt opt, AtomicLong milestone) {
	        var stmtText = opt.GetHint() + "@name('s0') select symbol, volume, sum(price) " +
	                       "from SupportMarketDataBean#time(5.5 sec)" +
	                       "group by symbol " +
	                       "having sum(price) > 50 " +
	    ...
	    private static void RunAssertion12AllHavingJoin(RegressionEnvironment env, SupportOutputLimitOpt opt, AtomicLong milestone) {
	        var stmtText = opt.GetHint() + "@name('s0') select symbol, volume, sum(price) " +
	                       "from SupportMarketDataBean#time(5.5 sec), " +
	                       "SupportBean#keepall where theString=symbol " +
	                       "group by symbol " +
	    ...
	    private static void RunAssertion6LastHavingJoin(RegressionEnvironment env, SupportOutputLimitOpt opt, AtomicLong milestone) {
	        var stmtText = opt.GetHint() + "@name('s0') select symbol, volume, sum(price) " +
	                       "from SupportMarketDataBean#time(5.5 sec), " +
	                       "SupportBean#keepall where theString=symbol " +
	                       "group by symbol " +
	    ...
	    private static void RunAssertion11AllHavingNoJoin(RegressionEnvironment env, SupportOutputLimitOpt opt, AtomicLong milestone) {
	        var stmtText = opt.GetHint() + "@name('s0') select symbol, volume, sum(price) " +
	                       "from SupportMarketDataBean#time(5.5 sec) " +
	                       "group by symbol " +
	                       "having sum(price) > 50 " +
