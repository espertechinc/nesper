	...
	public class ResultSetAggregateFirstEverLastEver {
	    ...
	    public class ResultSetAggregateFirstLastEver : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var fields = "firsteverstring,lasteverstring,firststring,laststring,cntstar,cntexpr,cntstarfiltered,cntexprfiltered".SplitCsv();
	    ...
	    private static void MakeSendBean(RegressionEnvironment env, string theString, int intPrimitive, int? intBoxed, bool boolPrimitive) {
