...
namespace com.espertech.esper.regressionlib.suite.resultset.aggregate
{
    public class ResultSetAggregateFilterNamedParameter
    {
        ...
        public static IList<RegressionExecution> WithAccessAggSortedMulticriteria(
        ...
        public static IList<RegressionExecution> WithAccessAggLinearBoundMixedFilter(
            IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        internal class ResultSetAggregateIntoTable : RegressionExecution
        {
            ...
            public void Run(RegressionEnvironment env)
            {
                ...
                SendEventAssertInfoTable(
                    ...
                    22,
                    new SupportBean[] { a1, a3 },
                    new SupportBean[] { b2, b4 },
                    new SupportBean[] { a1, a3 },
                    new SupportBean[] { b4, b2 });
        ...
        internal class ResultSetAggregateAccessAggSortedBound : RegressionExecution
        {
            ...
            public void Run(RegressionEnvironment env)
            {
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { null, null, null, "B1", "B1", new SupportBean[] { b1 } });

                var a10 = SendEvent(env, "A10", 10);
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { "A10", "A10", new SupportBean[] { a10 }, "B1", "B1", new SupportBean[] { b1 } });
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { "A10", "A10", new SupportBean[] { a10 }, "B2", "B1", new SupportBean[] { b1, b2 } });
                ...
                env.AssertPropsNew(
                    ...
                    fields,
                    new object[]
                        { "A10", "A5", new SupportBean[] { a5, a10 }, "B2", "B1", new SupportBean[] { b1, b2 } });
                ...
                env.AssertPropsNew(
                    ...
                    fields,
                    new object[]
                        { "A15", "A5", new SupportBean[] { a5, a10, a15 }, "B2", "B2", new SupportBean[] { b2 } });

                SendEvent(env, "X3", 3);
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { "A15", "A5", new SupportBean[] { a5, a15 }, "B2", "B2", new SupportBean[] { b2 } });
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { "A15", "A5", new SupportBean[] { a5, a15 }, null, null, null });

                SendEvent(env, "X5", 5);
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { "A15", "A15", new SupportBean[] { a15 }, null, null, null });
        ...
        internal class ResultSetAggregateAccessAggSortedMulticriteria : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { new SupportBean[] { a1 }, new SupportBean[] { b2, b1 } });

                var a2 = SendEvent(env, "A2", 100, 3);
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { new SupportBean[] { a1, a2 }, new SupportBean[] { b2, b1 } });
        ...
        internal class ResultSetAggregateAccessAggLinearBound : RegressionExecution
        {
            ...
            public void Run(RegressionEnvironment env)
            {
                ...
                SendEventAssert(
                    ...
                    4,
                    fields,
                    new object[] { 4, 4, new int?[] { 4 }, 2, 3, new int?[] { 2, 3 } });
                SendEventAssert(
                    env,
                    "B5",
                    5,
                    fields,
                    new object[] { 4, 4, new int?[] { 4 }, 2, 5, new int?[] { 2, 3, 5 } });
                ...
                SendEventAssert(
                    ...
                    6,
                    fields,
                    new object[] { 4, 6, new int?[] { 4, 6 }, 2, 5, new int?[] { 2, 3, 5 } });
                SendEventAssert(
                    env,
                    "X2",
                    7,
                    fields,
                    new object[] { 4, 6, new int?[] { 4, 6 }, 3, 5, new int?[] { 3, 5 } });
                SendEventAssert(
                    env,
                    "X3",
                    8,
                    fields,
                    new object[] { 4, 6, new int?[] { 4, 6 }, 5, 5, new int?[] { 5 } });
        ...
        internal class ResultSetAggregateAccessAggLinearBoundMixedFilter : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { new SupportBean[] { a2 }, new SupportBean[] { x1, a2 }, null });
                ...
                env.AssertPropsNew(
                    ...
                    fields,
                    new object[]
                        { new SupportBean[] { a2 }, new SupportBean[] { x1, a2, b3 }, new SupportBean[] { b3 } });
            ...
            object sb)
        {
            ...
            env.AssertPropsNew("s0", "ta,tb,wa,wb,sa,sb".SplitCsv(), new object[] { ta, tb, wa, wb, sa, sb });
        }
