	...
	public class ResultSetOrderByRowPerGroup {
	    ...
	    private class ResultSetOrderByLast : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowNewOnly("s0", "c0,c1".SplitCsv(), new object[][]{new object[] {14, "E1"}, new object[] {13, "E2"}, new object[] {12, "E3"}});
	    ...
	    private static void TryAssertionLast(RegressionEnvironment env, AtomicLong milestone) {
	        ...
	        env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"CMU", 3.0}, new object[] {"IBM", 7.0}, new object[] {"CAT", 11.0}}, new object[][]{new object[] {"CAT", null}, new object[] {"CMU", null}, new object[] {"IBM", null}});
	        ...
	        env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"DOG", 1.0}, new object[] {"CMU", 13.0}, new object[] {"IBM", 14.0}},
	            new object[][]{new object[] {"DOG", null}, new object[] {"CMU", 3.0}, new object[] {"IBM", 7.0}});
	    }

	    private static void TryAssertionNoHaving(RegressionEnvironment env, AtomicLong milestone) {
	        var fields = "symbol,mysum".SplitCsv();
	        ...
	        SendEvent(env, "CAT", 5);
	        SendEvent(env, "CAT", 6);
	        env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"CMU", 1.0}, new object[] {"CMU", 3.0}, new object[] {"IBM", 3.0}, new object[] {"CAT", 5.0}, new object[] {"IBM", 7.0}, new object[] {"CAT", 11.0}},
	        ...
	        SendEvent(env, "DOG", 1);
	        env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"DOG", 0.0}, new object[] {"DOG", 1.0}, new object[] {"CMU", 8.0}, new object[] {"IBM", 10.0}, new object[] {"CMU", 13.0}, new object[] {"IBM", 14.0}},
	    ...
	    private static void TryAssertionHaving(RegressionEnvironment env, AtomicLong milestone) {
	        var fields = "symbol,mysum".SplitCsv();
	        ...
	        SendEvent(env, "DOG", 1);
	        env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"DOG", 1.0}, new object[] {"CMU", 8.0}, new object[] {"IBM", 10.0}, new object[] {"CMU", 13.0}, new object[] {"IBM", 14.0}},
