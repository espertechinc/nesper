	...
	public class ResultSetQueryTypeAggregateGrouped {
	    ...
	    private class ResultSetQueryTypeIterateUnbound : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') @IterableUnbound select theString as c0, sum(intPrimitive) as c1 from SupportBean group by theString";
	            env.CompileDeploy(epl).AddListener("s0");
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 10}, new object[] {"E2", 20}});

	            env.Milestone(1);

	            env.SendEventBean(new SupportBean("E1", 11));
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 21}, new object[] {"E2", 20}});
	    ...
	    private class ResultSetQueryTypeWildcard : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select *, min(intPrimitive) as minval from SupportBean#length(2) group by theString";
	            env.CompileDeploy(epl).AddListener("s0");
	    ...
	    private class ResultSetQueryTypeAggregationOverGroupedProps : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1000L, "DELL", 10.0, 1L}});

	            env.Milestone(0);

	            SendEvent(env, SYMBOL_DELL, 900, 11);
	            env.AssertPropsNew("s0", fields, new object[]{900L, "DELL", 11.0, 1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1000L, "DELL", 10.0, 1L}, new object[] {900L, "DELL", 11.0, 1L}});

	            SendEvent(env, SYMBOL_DELL, 1500, 10);
	            env.AssertPropsNew("s0", fields, new object[]{1500L, "DELL", 10.0, 2L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1000L, "DELL", 10.0, 2L}, new object[] {900L, "DELL", 11.0, 1L}, new object[] {1500L, "DELL", 10.0, 2L}});

	            env.Milestone(1);

	            SendEvent(env, SYMBOL_IBM, 500, 5);
	            env.AssertPropsNew("s0", fields, new object[]{500L, "IBM", 5.0, 1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1000L, "DELL", 10.0, 2L}, new object[] {900L, "DELL", 11.0, 1L}, new object[] {1500L, "DELL", 10.0, 2L}, new object[] {500L, "IBM", 5.0, 1L}});

	            SendEvent(env, SYMBOL_IBM, 600, 5);
	            env.AssertPropsNew("s0", fields, new object[]{600L, "IBM", 5.0, 2L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1000L, "DELL", 10.0, 2L}, new object[] {900L, "DELL", 11.0, 1L}, new object[] {1500L, "DELL", 10.0, 2L}, new object[] {500L, "IBM", 5.0, 2L}, new object[] {600L, "IBM", 5.0, 2L}});

	            env.Milestone(2);

	            SendEvent(env, SYMBOL_IBM, 500, 5);
	            env.AssertPropsIRPair("s0", fields, new object[]{500L, "IBM", 5.0, 3L}, new object[]{1000L, "DELL", 10.0, 1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {900L, "DELL", 11.0, 1L}, new object[] {1500L, "DELL", 10.0, 1L}, new object[] {500L, "IBM", 5.0, 3L}, new object[] {600L, "IBM", 5.0, 3L}, new object[] {500L, "IBM", 5.0, 3L}});

	            SendEvent(env, SYMBOL_IBM, 600, 5);
	            env.AssertPropsIRPair("s0", fields, new object[]{600L, "IBM", 5.0, 4L}, new object[]{900L, "DELL", 11.0, 0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1500L, "DELL", 10.0, 1L}, new object[] {500L, "IBM", 5.0, 4L}, new object[] {600L, "IBM", 5.0, 4L}, new object[] {500L, "IBM", 5.0, 4L}, new object[] {600L, "IBM", 5.0, 4L}});
	    ...
	    private class ResultSetQueryTypeInsertInto : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var stmt = "@name('s0') select symbol as symbol, avg(price) as average, sum(volume) as sumation from SupportMarketDataBean#length(3000)";
	    ...
	    private static void AssertEvents(RegressionEnvironment env, string symbolOld, long volumeOld, double sumOld,
	        ...
	        env.AssertPropsIRPair("s0", "symbol,volume,mySum".SplitCsv(), new object[] {symbolNew, volumeNew, sumNew}, new object[] {symbolOld, volumeOld, sumOld});
	    }
