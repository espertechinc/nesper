	...
	public class ResultSetQueryTypeRollupDimensionality {
	    ...
	    internal class ResultSetQueryTypeRollupMultikeyWArrayGroupingSet : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select sum(value) as thesum from SupportThreeArrayEvent group by grouping sets((intArray), (longArray), (doubleArray))";
	    ...
	    internal class ResultSetQueryTypeRollupMultikeyWArray : RegressionExecution {
	        ...
	        public ResultSetQueryTypeRollupMultikeyWArray(bool join, bool unbound) {
	            this.join = join;
	    ...
	    internal class ResultSetQueryTypeGroupByWithComputation : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("s0", statement =>Assert.AreEqual(typeof(long?), statement.EventType.GetPropertyType("c0")));
	    ...
	    internal class ResultSetQueryTypeUnboundCubeUnenclosed : RegressionExecution{
	        ...
	        private static void TryAssertionUnboundCubeUnenclosed(RegressionEnvironment env, string groupBy, AtomicLong milestone) {
	    ...
	    internal class ResultSetQueryTypeBoundGroupingSet2LevelNoTopNoDetail : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("s0", statement =>Assert.AreEqual(typeof(int?), statement.EventType.GetPropertyType("c1")));
	    ...
	    internal class ResultSetQueryTypeNamedWindowCube2Dim : RegressionExecution{
	        ...
	        private static void TryAssertionNamedWindowCube2Dim(RegressionEnvironment env, string groupBy, AtomicLong milestone) {
	    ...
	    internal class ResultSetQueryTypeNamedWindowDeleteAndRStream2Dim : RegressionExecution{
	        ...
	        private static void TryAssertionNamedWindowDeleteAndRStream2Dim(RegressionEnvironment env, string groupBy, AtomicLong milestone) {
	            var fields = "c0,c1,c2".SplitCsv();
	            var epl = "create window MyWindow#keepall as SupportBean;\n" +
	                      "insert into MyWindow select * from SupportBean(intBoxed = 0);\n" +
	    ...
	    internal class ResultSetQueryTypeBoundRollup2Dim : RegressionExecution{
	        ...
	        private static void TryAssertionBoundRollup2Dim(RegressionEnvironment env, bool join, AtomicLong milestone) {
	    ...
	    internal class ResultSetQueryTypeNonBoxedTypeWithRollup : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            env.CompileDeploy("@name('s0') select intPrimitive as c0, doublePrimitive as c1, longPrimitive as c2, sum(shortPrimitive) " +
	            ...
	            env.CompileDeploy("@name('s1') select intPrimitive as c0, doublePrimitive as c1, longPrimitive as c2, sum(shortPrimitive) " +
	            ...
	            env.CompileDeploy("@name('s2') select intPrimitive as c0, doublePrimitive as c1, longPrimitive as c2, sum(shortPrimitive) " +
	            ...
	            env.CompileDeploy("@name('s3') select intPrimitive as c0, doublePrimitive as c1, longPrimitive as c2, sum(shortPrimitive) " +
	    ...
	    private static void TryAssertionOutputWhenTerminated(RegressionEnvironment env, string outputLimit, SupportOutputLimitOpt opt, AtomicLong milestone) {
	        ...
	        env.AssertPropsPerRowLastNew("s0", "c0,c1".SplitCsv(),
	        ...
	        env.SendEventBean(new SupportBean_S0(0));
	        env.AssertPropsPerRowLastNewAnyOrder("s0", "c0,c1".SplitCsv(),
	            new object[][]{new object[]{"E2", 4}, new object[] {"E1", 11}, new object[] {null, 15}});

	        env.UndeployAll();
	    }

	    private static void TryAssertionBoundCube(RegressionEnvironment env, string groupBy, AtomicLong milestone) {
	    ...
	    private static void TryAssertionUnboundRollupUnenclosed(RegressionEnvironment env, string groupBy, AtomicLong milestone) {
	    ...
	    private static void TryAssertionUnboundRollup1Dim(RegressionEnvironment env, string rollup, AtomicLong milestone) {
	    ...
	    private static void TryAssertionUnboundRollup3Dim(RegressionEnvironment env, string groupByClause, bool isJoin, AtomicLong milestone) {
	    ...
	    private static void AssertTypesC0C1C2(RegressionEnvironment env, string stmtName, Type expectedC0, Type expectedC1, Type expectedC2) {
	        env.AssertStatement("s0", statement =>{
