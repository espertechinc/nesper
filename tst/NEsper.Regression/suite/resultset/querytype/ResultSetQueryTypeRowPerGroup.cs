	...
	public class ResultSetQueryTypeRowPerGroup {
	    ...
	    public class ResultSetQueryTypeRowPerGrpNullGroupKey : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@public @buseventtype create schema MyEventWNullType(id string, value int, groupkey null);\n" +
	    ...
	    public class ResultSetQueryTypeRowPerGrpMultikeyWReclaim : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.AdvanceTime(0);
	            var epl = "@Hint('reclaim_group_aged=10,reclaim_group_freq=1') @name('s0') select theString, intPrimitive, sum(longPrimitive) as thesum from SupportBean group by theString, intPrimitive";
	    ...
	    public class ResultSetQueryTypeRowPerGrpMultikeyWArray : RegressionExecution {
	        ...
	        public ResultSetQueryTypeRowPerGrpMultikeyWArray(bool join, bool unbound) {
	            this.join = join;
	    ...
	    private class ResultSetQueryTypeSelectAvgExprGroupBy : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendEvent(env, "B", 5);
	            env.AssertPropsPerRowLastNewAnyOrder("s0", fields, new object[][]{new object[] {null, "A"}, new object[] {4.0, "B"}});

	            env.Milestone(1);

	            SendEvent(env, "A", 10);
	            env.AssertPropsPerRowLastNewAnyOrder("s0", fields, new object[][]{new object[] {10.0, "A"}, new object[] {5.0, "B"}});

	            SendEvent(env, "A", 20);
	            env.AssertPropsPerRowLastNewAnyOrder("s0", fields, new object[][]{new object[] {15.0, "A"}, new object[] {null, "B"}});
	    ...
	    public class ResultSetQueryTypeReclaimSideBySide : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var eplOne = "@name('S0') @Hint('disable_reclaim_group') select sum(intPrimitive) as val from SupportBean.win:keepall() group by theString";
	            env.CompileDeploy(eplOne).AddListener("S0");
	            var eplTwo = "@name('S1') @Hint('disable_reclaim_group') select window(intPrimitive) as val from SupportBean.win:keepall() group by theString";
	            env.CompileDeploy(eplTwo).AddListener("S1");
	            var eplThree = "@name('S2') @Hint('disable_reclaim_group') select sum(intPrimitive) as val1, window(intPrimitive) as val2 from SupportBean.win:keepall() group by theString";
	            env.CompileDeploy(eplThree).AddListener("S2");
	            var eplFour = "@name('S3') @Hint('reclaim_group_aged=10,reclaim_group_freq=5') select sum(intPrimitive) as val1, window(intPrimitive) as val2 from SupportBean.win:keepall() group by theString";
	    ...
	    private class ResultSetQueryTypeUnboundStreamIterate : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select theString as c0, sum(intPrimitive) as c1 from SupportBean group by theString " +
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1", 10}, new object[] {"E2", 20}});
	            env.AssertListenerNotInvoked("s0");

	            env.SendEventBean(new SupportBean("E1", 11));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1", 21}, new object[] {"E2", 20}});
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[] {"E1", 21}, new object[] {"E2", 20}});

	            env.MilestoneInc(milestone);

	            env.SendEventBean(new SupportBean("E0", 30));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1", 21}, new object[] {"E2", 20}, new object[] {"E0", 30}});
	            env.AssertListenerNotInvoked("s0");
	            ...
	            env.SendEventBean(new SupportBean("E0", 30));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E0", 30}, new object[] {"E1", 21}, new object[] {"E2", 20}});
	            env.AssertListenerNotInvoked("s0");

	            env.SendEventBean(new SupportBean("E3", 40));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E0", 30}, new object[] {"E1", 21}, new object[] {"E2", 20}, new object[] {"E3", 40}});
	            env.AssertListenerNotInvoked("s0");
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[] {"E1", 10}, new object[] {"E0", 11}, new object[] {"E2", 12}});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1", 10}, new object[] {"E0", 11}, new object[] {"E2", 12}});

	            env.MilestoneInc(milestone);

	            env.AdvanceTime(2200);
	            env.SendEventBean(new SupportBean("E2", 13));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E0", 11}, new object[] {"E2", 25}});
	    ...
	    private class ResultSetQueryTypeUnboundStreamUnlimitedKey : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') @Hint('reclaim_group_aged=30,reclaim_group_freq=5') select longPrimitive, count(*) from SupportBean group by longPrimitive";
	            env.CompileDeploy(epl).AddListener("s0");
	    ...
	    private class ResultSetQueryTypeAggregateGroupedProps : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsIRPair("s0", fields, new object[]{1L}, new object[]{0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {1L}, new object[] {1L}});

	            SendEvent(env, SYMBOL_IBM, 10);
	            env.AssertPropsIRPair("s0", fields, new object[]{2L}, new object[]{1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {2L}, new object[] {1L}});
	    ...
	    private class ResultSetQueryTypeAggregateGroupedPropsPerGroup : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendEvent(env, SYMBOL_IBM, 10);
	            env.AssertPropsIRPair("s0", fields, new object[]{1L}, new object[]{0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {2L}, new object[] {1L}, new object[] {1L}});
	    ...
	    private class ResultSetQueryTypeAggregationOverGroupedProps : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendEvent(env, SYMBOL_DELL, 10);
	            env.AssertPropsIRPair("s0", fields, new object[]{"DELL", 10.0, 1L}, new object[]{"DELL", 10.0, 0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 10.0, 1L}});

	            SendEvent(env, SYMBOL_DELL, 11);
	            env.AssertPropsIRPair("s0", fields, new object[]{"DELL", 11.0, 1L}, new object[]{"DELL", 11.0, 0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 10.0, 1L}, new object[] {"DELL", 11.0, 1L}});

	            env.Milestone(0);

	            SendEvent(env, SYMBOL_DELL, 10);
	            env.AssertPropsIRPair("s0", fields, new object[]{"DELL", 10.0, 2L}, new object[]{"DELL", 10.0, 1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 10.0, 2L}, new object[] {"DELL", 11.0, 1L}});

	            SendEvent(env, SYMBOL_IBM, 5);
	            env.AssertPropsIRPair("s0", fields, new object[]{"IBM", 5.0, 1L}, new object[]{"IBM", 5.0, 0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 10.0, 2L}, new object[] {"DELL", 11.0, 1L}, new object[] {"IBM", 5.0, 1L}});

	            SendEvent(env, SYMBOL_IBM, 5);
	            env.AssertPropsIRPair("s0", fields, new object[]{"IBM", 5.0, 2L}, new object[]{"IBM", 5.0, 1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 10.0, 2L}, new object[] {"DELL", 11.0, 1L}, new object[] {"IBM", 5.0, 2L}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 11.0, 1L}, new object[] {"DELL", 10.0, 1L}, new object[] {"IBM", 5.0, 3L}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"DELL", 10.0, 1L}, new object[] {"IBM", 5.0, 4L}});
	    ...
	    private static void TryAssertionNamedWindowDelete(RegressionEnvironment env, string[] fields, AtomicLong milestone) {
	        ...
	        env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 201}, new object[] {"B", 41}});
	        ...
	        env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 102}, new object[] {"B", 41}});
	        ...
	        env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 102}, new object[] {"B", 22}});
	    }
	    ...
	    private static void TryAssertionSum(RegressionEnvironment env) {
	        ...
	        AssertEvents(env, SYMBOL_DELL,
	            30d, 15d,
	            130d, 130d / 3d);
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"DELL", 130d, 130d / 3d}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"DELL", 170d, 170d / 3d}});
	        ...
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"DELL", 155d, 155d / 3d}});
	        ...
	        AssertEvents(env, SYMBOL_DELL,
	            155d, 155d / 3,
	            55d, 55d / 2);    // 50 + 5
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"DELL", 55d, 55d / 2d}});
	        ...
	        AssertEvents(env, SYMBOL_DELL,
	            ...
	            null, null,
	            70, 70);    // Dell:5
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"DELL", 5d, 5d}, new object[] {"IBM", 70d, 70d}});
