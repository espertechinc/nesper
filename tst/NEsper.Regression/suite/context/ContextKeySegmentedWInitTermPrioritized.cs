	...
	public class ContextKeySegmentedWInitTermPrioritized {
	    ...
	    private class ContextKeySegmentedInitWCorrelatedTermFilter : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SupportContextPropUtil.AssertContextProps(env, "ctx", "CtxPartitionInitWCorrTerm", new int[]{0, 1}, "key1,sb", new object[][]{new object[] {"A", initA}, new object[] {"B", initB}});
	        ...
	        private static void AssertPartitionsInitWCorrelatedTermFilter(RegressionEnvironment env) {
	            env.AssertThat(() => {
	                var partitions = env.Runtime.ContextPartitionService.GetContextPartitions(env.DeploymentId("ctx"), "CtxPartitionInitWCorrTerm", ContextPartitionSelectorAll.INSTANCE);
	    ...
	    private class ContextKeySegmentedInitNoTerm : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("s0", statement => Assert.AreEqual(typeof(SupportBean_S0), statement.EventType.GetPropertyType("s0")));
	    ...
	    private class ContextKeySegmentedTermByUnrelated : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNewAnyOrder("s0", fields, new object[][]{new object[] {"A", 2L}, new object[] {"B", 1L}});
	            ...
	            env.SendEventBean(new SupportBean_S0(-1));
	            env.AssertPropsPerRowLastNewAnyOrder("s0", fields, new object[][]{new object[] {"A", 1L}, new object[] {"C", 1L}});
	    ...
	    private class ContextKeySegmentedTermByCrontabOutputWhenTerminated : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNewAnyOrder("s0", "theString,cnt".SplitCsv(), new object[][]{new object[] {"A", 3L}, new object[] {"B", 2L}});
	            ...
	            env.AssertPropsPerRowLastNewAnyOrder("s0", "theString,cnt".SplitCsv(), new object[][]{new object[] {"A", 1L}, new object[] {"C", 2L}, new object[] {"D", 1L}});
