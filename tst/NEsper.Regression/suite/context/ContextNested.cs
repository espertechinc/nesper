	...
	public class ContextNested {
	    ...
	    internal class ContextNestedInitWStartNowSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertThat(() => {
	                var cpc = env.Runtime.ContextPartitionService.GetContextPartitions(env.DeploymentId("ctx"), "MyContext", ContextPartitionSelectorAll.INSTANCE);
	    ...
	    internal class ContextNestedIterateTargetedCP : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertStatement("s0", statement =>{
	                ...
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(ContextPartitionSelectorAll.INSTANCE), statement.GetSafeEnumerator(ContextPartitionSelectorAll.INSTANCE), fields, expectedAll);
	                var allIds = new SupportSelectorById(Collections.Set(0, 1, 2, 3, 4, 5));
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(allIds), statement.GetSafeEnumerator(allIds), fields, expectedAll);
	                ...
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(nestedSelector), statement.GetSafeEnumerator(nestedSelector), fields, new object[][]{new object[]{"S0_2", "grp3", "E1", 2}});
	                ...
	                var nestedSelectorTwo = new SupportSelectorNested(Arrays.AsList(new ContextPartitionSelector[]{firstOne, secondOne}, new ContextPartitionSelector[]{firstTwo, secondTwo}));
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(nestedSelectorTwo), statement.GetSafeEnumerator(nestedSelectorTwo), fields, new object[][]{new object[]{"S0_2", "grp3", "E1", 2}, new object[] {"S0_1", "grp1", "E2", -1}});
	                ...
	                try {
	                    ...
	                    Assert.IsTrue(
		                    ex.Message.StartsWith("Invalid context partition selector, expected an implementation class of any of [ContextPartitionSelectorAll, ContextPartitionSelectorById, ContextPartitionSelectorNested] interfaces but received com."),
		                    "message: " + ex.Message);
	                }
	            });
	            ...
	            env.AssertStatement("StmtOne", statement =>{
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(), statement.GetSafeEnumerator(), fieldsSelect, expectedRows);
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(ContextPartitionSelectorAll.INSTANCE), statement.GetSafeEnumerator(ContextPartitionSelectorAll.INSTANCE), fields, expectedRows);
	            });
	            ...
	            env.AssertStatement("StmtOne", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(nestedSelectorSelect), statement.GetSafeEnumerator(nestedSelectorSelect), fieldsSelect, new object[][]{new object[]{"i3", "l1", "b2", 1L}}));
	    ...
	    internal class ContextNestedInvalid : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.TryInvalidCompile(epl, "Context by name 'EightToNine' has already been declared within nested context 'ABC' [");
	    ...
	    internal class ContextNestedIterator : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E1", 1));
	            var expectedOne = new object[][]{new object[]{DateTimeParsingFunctions.ParseDefaultMSec("2002-05-1T08:00:00.000"), "E1", 1}};
	            env.AssertPropsPerRowLastNew("s0", fields, expectedOne);
	            env.AssertPropsPerRowIterator("s0", fields, expectedOne);
	            env.AssertSafeEnumerator("s0", iterator =>  EPAssertionUtil.AssertPropsPerRow(iterator, fields, expectedOne));
	            ...
	            env.AssertSafeEnumerator("s0", iterator =>  EPAssertionUtil.AssertPropsPerRow(iterator, fields, expectedTwo));
	    ...
	    internal class ContextNestedNestingFilterCorrectness : RegressionExecution {
	        ...
	        private static void AssertFilters(RegressionEnvironment env, string expected, string name) {
	            env.AssertThat(() => Assert.AreEqual(expected, SupportFilterServiceHelper.GetFilterSvcToString(env, name)));
	        }
	    }
	    ...
	    internal class ContextNestedCategoryOverPatternInitiated : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"g1", "S0_1", "S1_2", -2}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"g2", "S0_1", "S1_2", 15}, new object[] {"g2", "S0_3", "S1_3", 7}});
	    ...
	    internal class ContextNestedPartitionedWithFilterNonOverlap : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertListenerNotInvoked("s0");
	            SupportContextPropUtil.AssertContextPropsNested(env, "ctx", "NestedContext", new int[]{0}, "SegByString,InitCtx".SplitCsv(), new string[]{"key1", "s0"},
	            ...
	            SupportContextPropUtil.AssertContextPropsNested(env, "ctx", "NestedContext", new int[]{0, 1, 2}, "SegByString,InitCtx".SplitCsv(), new string[]{"key1", "s0"},
	                new object[][][]{new object[][]{new object[]{"E1"}, new object[] {s0Bean1}}, new object[][] {new object[]{"E1"}, new object[] {s0Bean2}}, new object[][] {new object[]{"E2"}, new object[] {s0Bean2}}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_1", "E1", 8}, new object[] {"S0_2", "E1", 6}});
	    ...
	    internal class ContextNestedFourContextsNested : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E2", 2));
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_2", "S2_2", 2}});

	            env.SendEventBean(new SupportBean("E3", 3));
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_2", "S2_2", 5}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_2", "S2_2", 9}});

	            env.MilestoneInc(milestone);

	            env.SendEventBean(new SupportBean_S2(201, "S2_3"));
	            env.SendEventBean(new SupportBean("E5", 5));
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_2", "S2_2", 14}, new object[] {"S0_2", "S1_2", "S2_3", 5}, new object[] {"S0_2", "S1_3", "S2_3", 5}});
	            ...
	            env.SendEventBean(new SupportBean("E6", 6));
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_2", "S2_3", 11}, new object[] {"S0_2", "S1_3", "S2_3", 11}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_2", "S2_4", 8}, new object[] {"S0_2", "S1_3", "S2_4", 8}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "S1_3", "S2_5", 10}, new object[] {"S0_2", "S1_5", "S2_5", 10}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_6", "S1_6", "S2_6", 12}});
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_8", "S1_8", "S2_8", 15}});
	    ...
	    internal class ContextNestedTemporalOverlapOverPartition : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "E3", 14}, new object[] {"S0_4", "E3", 6}});

	            env.Milestone(4);

	            env.SendEventBean(new SupportBean("E4", 7));
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[]{"S0_2", "E4", 11}, new object[] {"S0_4", "E4", 7}});
	    ...
	    internal class ContextNestedFixedTemporalOverPartitioned : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendTimeEvent(env, "2002-05-1T08:00:00.000");
	            env.AssertThat(() => Assert.AreEqual(1, SupportFilterServiceHelper.GetFilterSvcCountApprox(env)));
	    ...
	    internal class ContextNestedPartitionedOverFixedTemporal : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E2", 0));
	            env.AssertListenerNotInvoked("s0");
	            env.AssertThat(() => Assert.AreEqual(2, SupportScheduleHelper.ScheduleCountOverall(env.Runtime)));
	    ...
	    internal class ContextNestedContextProps : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", fields, new object[]{"EightToNine", DateTimeParsingFunctions.ParseDefaultMSec("2002-05-1T08:30:00.000"),
	    ...
	    internal class ContextNestedInitTermWCategoryWHash : RegressionExecution {
	        ...
	        private void AssertPartitionInfoMulti(RegressionEnvironment env, int size) {
	            env.AssertThat(() => {
	                ...
	                var partitions = partitionAdmin.GetContextPartitions(env.DeploymentId("ctx"), "NestedContext", ContextPartitionSelectorAll.INSTANCE);
	        ...
	        private void AssertNested(ContextPartitionIdentifierNested nested) {
	            ...
	            EPAssertionUtil.AssertEqualsExactOrder(new object[]{"E1"}, ((ContextPartitionIdentifierPartitioned) nested.Identifiers[2]).Keys);
	        }
	    ...
	    internal class ContextNestedInitTermOverHashIterate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E2", 1));
	            var expectedAll = new object[][]{new object[]{1, "E1"}, new object[] {2, "E1"}, new object[] {1, "E2"}, new object[] {2, "E2"}};
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, expectedAll);

	            // all-selector
	            var selectorNestedOne = new SupportSelectorNested(new ContextPartitionSelectorAll(), new ContextPartitionSelectorAll());
	            env.AssertStatement("s0", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedOne), fields, expectedAll));
	            // hash-specific-selector
	            var selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), SupportSelectorByHashCode.FromSetOfAll(4));
	            env.AssertStatement("s0", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedTwo), fields, expectedAll));
	            // filter-specific-selector
	            var selectorNestedThree = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
	            env.AssertStatement("s0", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedThree), fields, expectedAll));
	            // id-specific-selector
	            var selectorNestedFour = new SupportSelectorNested(new ContextPartitionSelectorAll(), SupportSelectorById.FromSetOfAll(100));
	            env.AssertStatement("s0", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedFour), fields, expectedAll));
	    ...
	    internal class ContextNestedInitTermOverPartitionedIterate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorPartitioned(Arrays.AsList(new object[]{"E1"}, new object[]{"E2"})));
	            env.AssertStatement("s0", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedTwo), fields, expectedAll));
	            // filter-specific-selector
	            var selectorNestedThree = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
	            env.AssertStatement("s0", statement =>EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedThree), fields, expectedAll));
	    ...
	    internal class ContextNestedInitTermOverCategoryIterate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorCategory(
	    ...
	    internal class ContextNestedInitTermOverInitTermIterate : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E2", 1));
	            var expectedAll = new object[][]{new object[]{1, 10, "E1"}, new object[] {2, 10, "E1"}, new object[] {1, 10, "E2"}, new object[] {2, 10, "E2"}};
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, expectedAll);
	            ...
	            env.AssertStatement("s0", statement => EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedOne), fields, expectedAll));
	            // filter-specific-selector
	            var  selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
	            env.AssertStatement("s0", statement => EPAssertionUtil.AssertPropsPerRowAnyOrder(statement.GetEnumerator(selectorNestedTwo), fields, expectedAll));
	    ...
	    private static void TryAssertion(RegressionEnvironment env, RegressionPath path) {
	        ...
	        env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[]{"E1", 1}, new object[] {"E2", 2}}, null);
	        ...
	        env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[]{"E1", 3}, new object[] {"E3", 4}}, null);

	        env.UndeployAll();
	    }

	    private static void TryAssertion3Contexts(RegressionEnvironment env, AtomicLong milestone, string[] fields, string startTime, string subsequentTime) {
	        env.SendEventBean(MakeEvent("E1", 0, 10));
	        env.AssertPropsNew("s0", fields, new object[]{"g2", "E1", 10L});
	    ...
	    private static object MakeEvent(string theString, int intPrimitive, long longPrimitive, bool boolPrimitive) {
	        var bean = new SupportBean(theString, intPrimitive);
	        bean.LongPrimitive = longPrimitive;
	    ...
	    private static void AssertPartitionInfo(RegressionEnvironment env, string startTime) {
	        env.AssertThat(() => {
	            ...
	            var partitions = partitionAdmin.GetContextPartitions(deploymentId, "NestedContext", ContextPartitionSelectorAll.INSTANCE);
	            Assert.AreEqual(1, partitions.Identifiers.Count);
	            var nested = (ContextPartitionIdentifierNested) partitions.Identifiers.Values.First();
	    ...
	    private static void AssertNested(ContextPartitionIdentifierNested nested, string startTime) {
	        Assert.AreEqual(DateTimeParsingFunctions.ParseDefaultMSec(startTime), ((ContextPartitionIdentifierInitiatedTerminated) nested.Identifiers[0]).StartTime);
	        Assert.AreEqual("g2", ((ContextPartitionIdentifierCategory) nested.Identifiers[1]).Label);
	        EPAssertionUtil.AssertEqualsExactOrder(new object[]{"E1"}, ((ContextPartitionIdentifierPartitioned) nested.Identifiers[2]).Keys);
	    }

	    private static SupportBean SendBean(RegressionEnvironment env, string theString, int intPrimitive, long longPrimitive, bool boolPrimitive) {
