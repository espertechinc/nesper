...
namespace com.espertech.esper.regressionlib.suite.context {
	public class ContextInitTerm {
		...
		internal class ContextInitTermWithTermEvent : RegressionExecution {
			...
			private IDictionary<string, object> SendUser (RegressionEnvironment env, string user, string alert) {
		...
		internal class ContextStartEndFilterWithPatternCorrelatedWithAsName : RegressionExecution {
			...
			public void Run (RegressionEnvironment env) {
				...
				var eplSelect = "@name('s0') context MyContext select context.starter as starter, context.ender as ender, context.ender.s1 as enderS1, context.ender.s1.id as enderS1id from SupportBean_S0 output when terminated";
				...
				var eplInvalidTagProvidedByFilter = "create context MyContext as start SupportBean_S1(id=0) as starter " +
				...
				var eplInvalidTagProvidedByPatternUnnamed = "create context MyContext as start pattern[starter=SupportBean_S1(id=0)] " +
				                                            "end pattern [starter=SupportBean_S1(id=1) or timer:interval(30)] as ender";
				env.TryInvalidCompile (eplInvalidTagProvidedByPatternUnnamed, "Tag 'starter' for event 'SupportBean_S1' is already assigned");

				var eplInvalidTagProvidedByPatternNamed = "create context MyContext as start pattern[s1=SupportBean_S1(id=0)] as starter " +
				                                          "end pattern [starter=SupportBean_S1(id=1) or timer:interval(30)] as ender";
		...
		internal class ContextStartEndPatternCorrelated : RegressionExecution {
			...
			private void SendAssertSB (RegressionEnvironment env, bool received) {
		...
		internal class ContextInitTermPatternCorrelated : RegressionExecution {
			...
			private void SendAssertS0 (RegressionEnvironment env, string p00, bool received) {
		...
		internal class ContextInitTermPatternIntervalZeroInitiatedNow : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var epl = "create context CtxPerId initiated by pattern [timer:interval(0) or every timer:interval(1 min)] terminated after 60 sec;\n" +
		...
		internal class ContextInitTermPatternInclusion : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var contextExpr = "@public create context CtxPerId initiated by pattern [every-distinct (a.theString, 10 sec) a=SupportBean]@Inclusive terminated after 10 sec ";
				env.CompileDeploy (contextExpr, path);
				var streamExpr = "@name('s0') context CtxPerId select * from SupportBean(theString = context.a.theString) output last when terminated";
				...
				var contextExprMulti = "@public create context CtxPerId initiated by pattern [every a=SupportBean_S0 -> b=SupportBean_S1]@Inclusive terminated after 10 sec ";
				env.CompileDeploy (contextExprMulti, path);
				var streamExprMulti = "@name('s0') context CtxPerId select * from pattern [every a=SupportBean_S0 -> b=SupportBean_S1]";
		...
		internal class ContextInitTermContextPartitionSelection : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.SendEventBean (new SupportBean ("E1", 3));
				env.AssertPropsPerRowIteratorAnyOrder ("s0", fields, new object[][] { new object[] { 0, "S0_1", "E1", 6 }, new object[] { 0, "S0_1", "E2", 10 }, new object[] { 0, "S0_1", "E3", 201 }, new object[] { 1, "S0_2", "E1", 3 }, new object[] { 1, "S0_2", "E3", 201 } });
				SupportContextPropUtil.AssertContextProps (env, "ctx", "MyCtx", new int[] { 0, 1 }, "startTime,endTime,s0", new object[][] { new object[] { 1000L, null, initOne }, new object[] { 2000L, null, initTwo } });
				...
				env.AssertStatement ("s0", statement => {
					...
					EPAssertionUtil.AssertPropsPerRowAnyOrder (statement.GetEnumerator (selectorById), statement.GetSafeEnumerator (selectorById), fields, new object[][] { new object[] { 1, "S0_2", "E1", 3 }, new object[] { 1, "S0_2", "E3", 201 } });

					// test iterator targeted by property on triggering event
					var filtered = new SupportSelectorFilteredInitTerm ("S0_2");
					EPAssertionUtil.AssertPropsPerRowAnyOrder (statement.GetEnumerator (filtered), statement.GetSafeEnumerator (filtered), fields, new object[][] { new object[] { 1, "S0_2", "E1", 3 }, new object[] { 1, "S0_2", "E3", 201 } });
		...
		internal class ContextInitTermFilterAndAfter1Min : RegressionExecution {
			...
			public void Run (RegressionEnvironment env) {
				...
				env.AssertPropsPerRowLastNew ("S1", fields, new object[][] { new object[] { "G4", 9, "SB01" }, new object[] { "G4", 4, "SB02" } });

				env.Milestone (1);

				env.SendEventBean (new SupportBean ("G5", 5));
				env.AssertPropsPerRowLastNew ("S1", fields, new object[][] { new object[] { "G5", 14, "SB01" }, new object[] { "G5", 9, "SB02" } });
		...
		internal class ContextInitTermPatternAndAfter1Min : RegressionExecution {
			...
			public void Run (RegressionEnvironment env) {
				...
				env.SendEventBean (new SupportBean ("E2", 2));
				env.AssertPropsPerRowLastNew ("S1", fields, new object[][] { new object[] { "E2", 3, "S0_1", "S1_2" }, new object[] { "E2", 2, "S0_2", "S1_2" } });

				env.Milestone (3);

				env.SendEventBean (new SupportBean ("E3", 3));
				env.AssertPropsPerRowLastNew ("S1", fields, new object[][] { new object[] { "E3", 6, "S0_1", "S1_2" }, new object[] { "E3", 5, "S0_2", "S1_2" } });
		...
		internal class ContextInitTermPatternInitiatedStraightSelect : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.SendEventBean (new SupportBean ("E2", 0));
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { null, 2, "E2" }, new object[] { 3, null, "E2" } });
		...
		internal class ContextInitTermFilterAllOperators : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				TryOperator (env, path, milestone, "context.sb.id = intBoxed", new object[][] { new object[] { 10, true }, new object[] { 9, false }, new object[] { null, false } });
				TryOperator (env, path, milestone, "intBoxed = context.sb.id", new object[][] { new object[] { 10, true }, new object[] { 9, false }, new object[] { null, false } });

				TryOperator (env, path, milestone, "context.sb.id > intBoxed", new object[][] { new object[] { 11, false }, new object[] { 10, false }, new object[] { 9, true }, new object[] { 8, true } });
				TryOperator (env, path, milestone, "context.sb.id >= intBoxed", new object[][] { new object[] { 11, false }, new object[] { 10, true }, new object[] { 9, true }, new object[] { 8, true } });
				TryOperator (env, path, milestone, "context.sb.id < intBoxed", new object[][] { new object[] { 11, true }, new object[] { 10, false }, new object[] { 9, false }, new object[] { 8, false } });
				TryOperator (env, path, milestone, "context.sb.id <= intBoxed", new object[][] { new object[] { 11, true }, new object[] { 10, true }, new object[] { 9, false }, new object[] { 8, false } });

				TryOperator (env, path, milestone, "intBoxed < context.sb.id", new object[][] { new object[] { 11, false }, new object[] { 10, false }, new object[] { 9, true }, new object[] { 8, true } });
				TryOperator (env, path, milestone, "intBoxed <= context.sb.id", new object[][] { new object[] { 11, false }, new object[] { 10, true }, new object[] { 9, true }, new object[] { 8, true } });
				TryOperator (env, path, milestone, "intBoxed > context.sb.id", new object[][] { new object[] { 11, true }, new object[] { 10, false }, new object[] { 9, false }, new object[] { 8, false } });
				TryOperator (env, path, milestone, "intBoxed >= context.sb.id", new object[][] { new object[] { 11, true }, new object[] { 10, true }, new object[] { 9, false }, new object[] { 8, false } });

				TryOperator (env, path, milestone, "intBoxed in (context.sb.id)", new object[][] { new object[] { 11, false }, new object[] { 10, true }, new object[] { 9, false }, new object[] { 8, false } });
				TryOperator (env, path, milestone, "intBoxed between context.sb.id and context.sb.id", new object[][] { new object[] { 11, false }, new object[] { 10, true }, new object[] { 9, false }, new object[] { 8, false } });

				TryOperator (env, path, milestone, "context.sb.id != intBoxed", new object[][] { new object[] { 10, false }, new object[] { 9, true }, new object[] { null, false } });
				TryOperator (env, path, milestone, "intBoxed != context.sb.id", new object[][] { new object[] { 10, false }, new object[] { 9, true }, new object[] { null, false } });

				TryOperator (env, path, milestone, "intBoxed not in (context.sb.id)", new object[][] { new object[] { 11, true }, new object[] { 10, false }, new object[] { 9, true }, new object[] { 8, true } });
				TryOperator (env, path, milestone, "intBoxed not between context.sb.id and context.sb.id", new object[][] { new object[] { 11, true }, new object[] { 10, false }, new object[] { 9, true }, new object[] { 8, true } });

				TryOperator (env, path, milestone, "context.sb.id is intBoxed", new object[][] { new object[] { 10, true }, new object[] { 9, false }, new object[] { null, false } });
				TryOperator (env, path, milestone, "intBoxed is context.sb.id", new object[][] { new object[] { 10, true }, new object[] { 9, false }, new object[] { null, false } });

				TryOperator (env, path, milestone, "context.sb.id is not intBoxed", new object[][] { new object[] { 10, false }, new object[] { 9, true }, new object[] { null, true } });
				TryOperator (env, path, milestone, "intBoxed is not context.sb.id", new object[][] { new object[] { 10, false }, new object[] { 9, true }, new object[] { null, true } });

				// try coercion
				TryOperator (env, path, milestone, "context.sb.id = shortBoxed", new object[][] { new object[] {
						(short) 10, true }, new object[] {
						(short) 9, false }, new object[] { null, false } });
				TryOperator (env, path, milestone, "shortBoxed = context.sb.id", new object[][] { new object[] {
						(short) 10, true }, new object[] {
						(short) 9, false }, new object[] { null, false } });
				...
				TryOperator (env, path, milestone, "shortBoxed in (context.sb.id)", new object[][] { new object[] {
						(short) 11, false }, new object[] {
						(short) 10, true }, new object[] {
			...
			private static void TryOperator (RegressionEnvironment env, RegressionPath path, AtomicLong milestone, string @operator, object[][] testdata) {
		...
		internal class ContextInitTermFilterBooleanOperator : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AssertPropsPerRowLastNewAnyOrder ("s0", fields, new object[][] { new object[] { "E3", 2, "S01" }, new object[] { "E3", 2, "S02" } });
				...
				env.AssertPropsPerRowLastNewAnyOrder ("s0", fields, new object[][] { new object[] { "E4", 2, "S01" }, new object[] { "E4", 2, "S02" } });
		...
		internal class ContextInitTermTerminateTwoContextSameTime : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var fields = "c1,c2,c3".Split (",");
				var eplGrouped = "@name('s0') context CtxInitiated select theString as c1, sum(intPrimitive) as c2, context.sb0.p00 as c3 from SupportBean";
				...
				env.SendEventBean (new SupportBean ("G4", 4));
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "G4", 9, "SB01" }, new object[] { "G4", 4, "SB02" } });

				env.Milestone (5);

				env.SendEventBean (new SupportBean ("G5", 5));
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "G5", 14, "SB01" }, new object[] { "G5", 9, "SB02" } });
		...
		internal class ContextInitTermOutputSnapshotWhenTerminated : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				var epl = "@name('s0') context EveryMinute select sum(intPrimitive) as c1 from SupportBean output snapshot when terminated";
		...
		internal class ContextInitTermOutputAllEvery2AndTerminated : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				// terminate
				SendTimeEvent (env, "2002-05-1T08:02:00.000");
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "E1", 1 + 2 }, new object[] { "E2", 3 } });

				SendTimeEvent (env, "2002-05-1T08:02:01.000");
				env.SendEventBean (new SupportBean ("E4", 4));
				env.SendEventBean (new SupportBean ("E5", 5));
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "E4", 4 }, new object[] { "E5", 5 } });
				...
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "E4", 14 }, new object[] { "E5", 5 }, new object[] { "E6", 6 } });
				...
				env.AssertPropsPerRowLastNew ("s0", fields, new object[][] { new object[] { "E1", -1 }, new object[] { "E6", -2 } });
		...
		internal class ContextInitTermOutputOnlyWhenTerminatedThenSet : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AssertThat (() => Assert.AreEqual (10, env.Runtime.VariableService.GetVariableValue (env.DeploymentId ("var"), "myvar")));
		...
		internal class ContextInitTermAggregationGrouped : RegressionExecution {
			...
			private void AssertPartitionInfo (RegressionEnvironment env) {
				env.AssertThat (() => {
					...
					var partitions = partitionAdmin.GetContextPartitions (env.DeploymentId ("Ctx1"), "MyContext", ContextPartitionSelectorAll.INSTANCE);
					Assert.AreEqual (1, partitions.Identifiers.Count);
					var ident = (ContextPartitionIdentifierInitiatedTerminated) partitions.Identifiers.Values.First();
		...
		private static void TryAssertionNoTerminationConditionOverlapping (RegressionEnvironment env, AtomicLong milestone, bool soda) {
			...
			env.AssertStatement ("ctx", statement => {
				Assert.AreEqual (StatementType.CREATE_CONTEXT, statement.GetProperty (StatementProperty.STATEMENTTYPE));
				Assert.AreEqual ("SupportBeanInstanceCtx", statement.GetProperty (StatementProperty.CREATEOBJECTNAME));
			});
		...
		private static void TryAssertionNoTerminationConditionNonoverlapping (RegressionEnvironment env, AtomicLong milestone, bool soda) {
