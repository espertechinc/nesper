...
namespace com.espertech.esper.regressionlib.suite.@event.map
{
    public class EventMapNested
    {
        public static IList<RegressionExecution> Executions()
        {
            ...
            WithEventType(execs);
            WithNestedPono(execs);
            WithIsExists(execs);
            return execs;
        }

        public static IList<RegressionExecution> WithIsExists(IList<RegressionExecution> execs = null)
        {
        ...
        public static IList<RegressionExecution> WithNestedPono(IList<RegressionExecution> execs = null)
        {
            execs = execs ?? new List<RegressionExecution>();
        ...
        private class EventMapNestedInsertInto : RegressionExecution
        {
            public void Run(RegressionEnvironment env)
            {
                ...
                env.AssertPropsNew(
                    "s0",
                    fields,
                    new object[] { EventMapCore.GetNestedKeyMap(testdata, "map", "mapOne") });
                ...
                env.AssertListener(
                    ...
                    listener => {
                        ...
                        EPAssertionUtil.AssertProps(
                            ...
                            new object[] {
                                "abc", new SupportBean_A("A1"), testdataOne.Get("nodefmap"), testdataOne.Get("map")
                            });
                        EPAssertionUtil.AssertProps(
                            received,
                        ...
                        EPAssertionUtil.AssertProps(
                            ...
                            new object[]
                                { EventMapCore.GetNestedKeyMap(testdataOne, "map", "objectOne"), 10, "val2", 300 });
                        EPAssertionUtil.AssertProps(received, "c1,c2".SplitCsv(), new object[] { 2, "NestedValue" });
                        EPAssertionUtil.AssertProps(
                            received,
                            "d1,d2,d3".SplitCsv(),
                            new object[] {
                                300, EventMapCore.GetNestedKeyMap(testdataOne, "map", "mapOne", "objectTwo"),
                                EventMapCore.GetNestedKeyMap(testdataOne, "map", "mapOne", "nodefmapTwo")
                            });
                        EPAssertionUtil.AssertProps(
                            received,
                            "e1,e2,e3".SplitCsv(),
                            new object[] {
                                EventMapCore.GetNestedKeyMap(testdataOne, "map", "mapOne", "mapTwo"), 4000L,
                ...
                env.AssertListener(
                    ...
                    listener => {
                        ...
                        EPAssertionUtil.AssertProps(
                            ...
                            "simple,object,nodefmap,map".SplitCsv(),
                            new object[] {
                                "abc", new SupportBean_A("A1"), testdataTwo.Get("nodefmap"), testdataTwo.Get("map")
                            });
                        EPAssertionUtil.AssertProps(
                            received,
                            "a1,a2,a3,a4".SplitCsv(),
                        ...
                        EPAssertionUtil.AssertProps(
                            ...
                            "b1,b2,b3,b4".SplitCsv(),
                            new object[]
                                { EventMapCore.GetNestedKeyMap(testdataTwo, "map", "objectOne"), null, null, null });
                        EPAssertionUtil.AssertProps(received, "c1,c2".SplitCsv(), new object[] { null, null });
                        EPAssertionUtil.AssertProps(
                            received,
                            "d1,d2,d3".SplitCsv(),
                            new object[] {
                                null, EventMapCore.GetNestedKeyMap(testdataTwo, "map", "mapOne", "objectTwo"),
                                EventMapCore.GetNestedKeyMap(testdataTwo, "map", "mapOne", "nodefmapTwo")
                            });
                        EPAssertionUtil.AssertProps(
                            received,
                            "e1,e2,e3".SplitCsv(),
                            new object[]
                                { EventMapCore.GetNestedKeyMap(testdataTwo, "map", "mapOne", "mapTwo"), 4000L, null });
                        EPAssertionUtil.AssertProps(
                            received,
                            "f1,f2".SplitCsv(),
        ...
        private static IDictionary<string, object> GetTestData()
        {
            ...
            var levelTwo = EventMapCore.MakeMap(
                new object[][] {
                    ...
                    new object[]
                        { "nodefmapTwo", EventMapCore.MakeMap(new object[][] { new object[] { "key3", "val3" } }) },
            ...
            var levelOne = EventMapCore.MakeMap(
                new object[][] {
                    ...
                    new object[]
                        { "nodefmapOne", EventMapCore.MakeMap(new object[][] { new object[] { "key2", "val2" } }) },
            ...
            var levelZero = EventMapCore.MakeMap(
                new object[][] {
                    ...
                    new object[]
                        { "nodefmap", EventMapCore.MakeMap(new object[][] { new object[] { "key1", "val1" } }) },
