	...
	public class EventJsonTypingCoreParse {
		...
		private class EventJsonTypingParseMapType : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				env.AssertStatement ("s0", statement => SupportEventTypeAssertionUtil.AssertEventTypeProperties (namesAndTypes, statement.EventType, SupportEventTypeAssertionEnum.NAME, SupportEventTypeAssertionEnum.TYPE));
		...
		private class EventJsonTypingParseObjectArrayType : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				...
				SendAssertColumn (env, "{\"c0\": [[]]}", new object[] {
					Array.Empty<object>()
				});
				...
				env.AssertIterator ("s0", en => {
					...
					AssertColumn (en.Advance(), new object[] {
						Array.Empty<object>()
					});
					AssertColumn (en.Advance(), new object[][] { new object[] { "abc", 2 } });
					AssertColumn (en.Advance(), new object[][][] { new object[][] { new object[] { "abc" }, new object[] { 5d } } });
		...
		private class EventJsonTypingParseDecimalBigInt : RegressionExecution {
			...
			public void Run (RegressionEnvironment env) {
				var epl = "@public @buseventtype create json schema JsonEvent (c0 BigInteger, c1 decimal," +
				          ...
				          "@name('s0') select * from JsonEvent#keepall;\n";
				env.CompileDeploy (epl).AddListener ("s0");
				var namesAndTypes = new object[][] { new object[] { "c0", typeof (BigInteger) }, new object[] { "c1", typeof (decimal) }, new object[] { "c2", typeof (BigInteger[]) }, new object[] { "c3", typeof (decimal[]) }, new object[] { "c4", typeof (BigInteger[][]) }, new object[] { "c5", typeof (decimal[][]) }
				};
				env.AssertStatement ("s0", statement => SupportEventTypeAssertionUtil.AssertEventTypeProperties (namesAndTypes, statement.EventType, SupportEventTypeAssertionEnum.NAME, SupportEventTypeAssertionEnum.TYPE));
			...
			private void SendAssertFields (EventBean @event, BigInteger? c0, decimal? c1,
				BigInteger[] c2, decimal?[] c3, BigInteger[][] c4, decimal?[][] c5) {
		...
		private class EventJsonTypingParseEnumType : RegressionExecution {
			public void Run (RegressionEnvironment env) {
				var epl = "@public @buseventtype create json schema JsonEvent (c0 SupportEnum, c1 SupportEnum[], c2 SupportEnum[][]);\n" +
				          "@name('s0') select * from JsonEvent#keepall;\n";
				env.CompileDeploy (epl).AddListener ("s0");
				var namesAndTypes = new object[][] { new object[] { "c0", typeof (SupportEnum) }, new object[] { "c1", typeof (SupportEnum[]) }, new object[] { "c2", typeof (SupportEnum[][]) }
				};
				env.AssertStatement ("s0", statement => SupportEventTypeAssertionUtil.AssertEventTypeProperties (namesAndTypes, statement.EventType, SupportEventTypeAssertionEnum.NAME, SupportEventTypeAssertionEnum.TYPE));

				var json = "{\"c0\": \"ENUM_VALUE_2\", \"c1\": [\"ENUM_VALUE_2\", \"ENUM_VALUE_1\"], \"c2\": [[\"ENUM_VALUE_2\"], [\"ENUM_VALUE_1\", \"ENUM_VALUE_3\"]]}";
				env.SendEventJson (json, "JsonEvent");
				env.AssertEventNew ("s0", this.AssertFilled);
			...
			private void AssertFilled (EventBean @event) {
				AssertFields (@event, ENUM_VALUE_2, new SupportEnum[] { ENUM_VALUE_2, ENUM_VALUE_1 },
					new SupportEnum[][] { new SupportEnum[] { ENUM_VALUE_2 }, new SupportEnum[] { ENUM_VALUE_1, ENUM_VALUE_3 } });
			}
		...
		private class EventJsonTypingParseBasicTypeArray : RegressionExecution {
			...
			public void Run (RegressionEnvironment env) {
				var epl = "@public @buseventtype create json schema JsonEvent (" +
				          ...
				          "@name('s0') select * from JsonEvent#keepall;\n";
				env.CompileDeploy (epl).AddListener ("s0");
				var namesAndTypes = new object[][] { new object[] { "c0", typeof (string[]) }, new object[] { "c1", typeof (char[]) }, new object[] { "c2", typeof (char[]) }, new object[] { "c3", typeof (bool?[]) }, new object[] { "c4", typeof (bool[]) }, new object[] { "c5", typeof (byte?[]) }, new object[] { "c6", typeof (byte[]) }, new object[] { "c7", typeof (short?[]) }, new object[] { "c8", typeof (short[]) }, new object[] { "c9", typeof (int?[]) }, new object[] { "c10", typeof (int[]) }, new object[] { "c11", typeof (long?[]) }, new object[] { "c12", typeof (long[]) }, new object[] { "c13", typeof (double?[]) }, new object[] { "c14", typeof (double[]) }, new object[] { "c15", typeof (float?[]) }, new object[] { "c16", typeof (float[]) },
				};
				env.AssertStatement ("s0", statement => SupportEventTypeAssertionUtil.AssertEventTypeProperties (namesAndTypes, statement.EventType, SupportEventTypeAssertionEnum.NAME, SupportEventTypeAssertionEnum.TYPE));
			...
			private void AssertEmptyArray (EventBean @event) {
				EPAssertionUtil.AssertProps (@event, FIELDS_ZERO, new object[] {
					Array.Empty<string>(), Array.Empty<char?>(),
						Array.Empty<char>(), Array.Empty<bool?>(), Array.Empty<bool>(), Array.Empty<byte?>(), Array.Empty<byte>()
				});
				EPAssertionUtil.AssertProps (@event, FIELDS_ONE, new object[] {
					Array.Empty<short?>(), Array.Empty<short>(),
						Array.Empty<int?>(), Array.Empty<int>(), Array.Empty<long?>(), Array.Empty<long>()
				});
				EPAssertionUtil.AssertProps (@event, FIELDS_TWO, new object[] { Array.Empty<double?>(), Array.Empty<double>(), Array.Empty<float?>(), Array.Empty<float>() });
			}
		...
		private class EventJsonTypingParseBasicType : RegressionExecution {
			...
			public void Run (RegressionEnvironment env) {
				var epl = "@public @buseventtype create json schema JsonEvent (" +
				          ...
				          "@name('s0') select * from JsonEvent#keepall;\n";
				env.CompileDeploy (epl).AddListener ("s0");
				var namesAndTypes = new object[][] { new object[] { "c0", typeof (string) }, new object[] { "c1", typeof (char?) }, new object[] { "c2", typeof (char?) }, new object[] { "c3", typeof (bool?) }, new object[] { "c4", typeof (bool?) }, new object[] { "c5", typeof (byte?) }, new object[] { "c6", typeof (short?) }, new object[] { "c7", typeof (int?) }, new object[] { "c8", typeof (int?) }, new object[] { "c9", typeof (long?) }, new object[] { "c10", typeof (double?) }, new object[] { "c11", typeof (float?) }, new object[] { "c12", null },
				};
				env.AssertStatement ("s0", statement => SupportEventTypeAssertionUtil.AssertEventTypeProperties (namesAndTypes, statement.EventType, SupportEventTypeAssertionEnum.NAME, SupportEventTypeAssertionEnum.TYPE));
			...
			private void AssertEventFilled (EventBean @event) {
				EPAssertionUtil.AssertProps (@event, FIELDS_ONE, new object[] { "abc", 'x', 'z', true, false, byte.Parse ("1"), (short) 10 });
