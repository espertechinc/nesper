	...
	public class EventJsonTypingCoreWrite {
	    ...
	    private class EventJsonTypingWriteNested : RegressionExecution {
	        ...
	        private void SendAssertLibrary(RegressionEnvironment env, string json, string libraryId, string isleId, string shelfId, string bookId) {
	            ...
	            env.AssertEventNew("s0", @event => {
	                ...
	                EPAssertionUtil.AssertProps(@event, "libraryId,isle.isleId,isle.shelf.shelfId,isle.shelf.book.bookId".SplitCsv(),
	    ...
	    private class EventJsonTypingWriteEnumType : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var jsonOne = "{\"c0\": \"ENUM_VALUE_2\", \"c1\": [\"ENUM_VALUE_2\", \"ENUM_VALUE_1\"], \"c2\": [[\"ENUM_VALUE_2\"], [\"ENUM_VALUE_1\", \"ENUM_VALUE_3\"]]}";
	            env.SendEventJson(jsonOne, "JsonEvent");
	            env.AssertEventNew("s0", @event =>AssertJsonWrite(jsonOne, @event));
	    ...
	    private static JObject BuildBook(string bookId, int price) {
	    ...
	    private static JObject BuildShelf(string shelfId, params JObject[] books) {
	    ...
	    private static JObject BuildIsle(string isleId, params JObject[] shelfs) {
	        var shelf = new JObject();
	    ...
	    private static JObject BuildLibrary(string libraryId, params JObject[] isles) {
	        var shelf = new JObject();
