	...
	public class EventJsonInherits {
	    ...
	    private class EventJsonInheritsFourLevelSparseOne : RegressionExecution {
	        ...
	        private void AssertEvent(EventBean @event) {
	            ...
	            AssertByIndex(2, und.GetNativeEntry, new [] {
		            ToEntry("a1", 4d),
		            ToEntry("c1", "def")
	            });
	    ...
	    private class EventJsonInheritsTwoLevel : RegressionExecution {
	        ...
	        private void AssertEvent(EventBean @event) {
	            ...
	            AssertByIndex(4, und.GetNativeEntry, new [] {
		            ToEntry("p1", "abc"),
		            ToEntry("p2", 10), 
		            ToEntry("c1", "def"),
		            ToEntry("c2", 20)
	    ...
	    private static KeyValuePair<string, object> ToEntry(string name, object value) {
	    ...
	    private static void AssertByIndex<T>(int numFields, Func<int, T> indexFunction, T[] expected) {
