	...
	public class EventJsonDocSamples {
	    ...
	    private class EventJsonDocApplicationClass : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@public @buseventtype create json schema JsonEvent(person " + typeof(MyLocalPersonEvent).FullName + ");\n" +
	    ...
	    private class EventJsonDocDynamicEmpty : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", "entityId,temperature,status,entityName,vt,flags".SplitCsv(),
	                new object[]{"cd9f930e", 70, true, Collections.SingletonMap("english", "Cooling Water Temperature"), new object[]{"2014-08-20T15:30:23.524Z"},
	                    null});
	            env.AssertPropsNew("s1", "englishEntityName".SplitCsv(),
	    ...
	    private class EventJsonDocSamplesCarLocUpdate : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", "carId,direction,cnt".SplitCsv(),
	    ...
	    private class EventJsonDocSamplesBook : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", "isbn,authorName,editorName,primaryCategory".SplitCsv(),
	    ...
	    private class EventJsonDocSamplesCake : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNew("s0", "name,firstBatterType,firstToppingType,batterMachine,countBatters,countToppings".SplitCsv(),
