...
namespace com.espertech.esper.regressionlib.suite.@event.infra
{
	public class EventInfraGetterDynamicIndexexPropertyPredefined : RegressionExecution {
	    public void Run(RegressionEnvironment env) {
	        ...
	        var beanepl =
	            "@public @buseventtype create schema LocalInnerEvent as " + typeof(LocalInnerEvent).FullName + ";\n" +
	                ...
	                "@public @buseventtype create schema LocalEventSubA as " + typeof(LocalEventSubA).FullName + ";\n";
	    ...
	    private void AssertGetters(EventBean @event, bool existsZero, bool existsOne) {
	    ...
	    private void AssertGetter(EventBean @event, EventPropertyGetter getter, bool exists) {
	    ...
	    private void AssertProps(RegressionEnvironment env, bool hasA, bool hasB) {
