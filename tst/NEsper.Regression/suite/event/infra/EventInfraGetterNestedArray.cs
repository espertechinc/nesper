...
namespace com.espertech.esper.regressionlib.suite.@event.infra
{
	public class EventInfraGetterNestedArray : RegressionExecution {
	    public void Run(RegressionEnvironment env) {
	        ...
	        var beanepl = "@public @buseventtype create schema LocalInnerEvent as " + typeof(LocalInnerEvent).FullName + ";\n" +
	        ...
	        Consumer<string[]> avro = array => {
	            ...
	            if (array == null) {
	                ...
	                for (var i = 0; i < array.Length; i++) {
	                    var inner = new GenericRecord(schema.GetField("property").Schema.AsArraySchema().ItemSchema.AsRecordSchema());
	    ...
	    private void AssertProps(RegressionEnvironment env, bool existsA, string expectedA, bool existsB, string expectedB) {
	        env.AssertPropsNew("s1", "c0,c1,c2,c3,c4,c5".SplitCsv(),
