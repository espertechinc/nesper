	...
	public class EventInfraPropertyDynamicNestedRootedSimple : RegressionExecution {
	    ...
	    public void Run(RegressionEnvironment env) {
	        ...
	        var beanTests = new Pair<object, object>[]{
	            new Pair<object, object>(SupportBeanComplexProps.MakeDefaultBean(), AllExist("simple", "nestedValue", "nestedNestedValue")),
	        ...
	        var mapTests = new Pair<object, object>[]{
	            new Pair<object, object>(Collections.SingletonMap("simpleProperty", "a"), new ValueWithExistsFlag[]{Exists("a"), NotExists(), NotExists()}),
	        ...
	        var oaTests = new Pair<object, object>[]{
	            new Pair<object, object>(new object[]{"a", null}, new ValueWithExistsFlag[]{Exists("a"), NotExists(), NotExists()}),
	        ...
	        var xmlTests = new Pair<object, object>[]{
	            new Pair<object, object>("<simpleProperty>abc</simpleProperty>" +
	        ...
	        var avroTests = new Pair<object, object>[]{
	            new Pair<object, object>(new GenericRecord(avroSchema), new ValueWithExistsFlag[]{Exists(null), NotExists(), NotExists()}),
	            new Pair<object, object>(datumNull, new ValueWithExistsFlag[]{Exists(null), NotExists(), NotExists()}),
	        ...
	        var jsonTests = new Pair<object, object>[]{
	            ...
	            new Pair<object, object>("{\"simpleProperty\": 1}", new ValueWithExistsFlag[]{Exists(1), NotExists(), NotExists()}),
	            new Pair<object, object>("{\"simpleProperty\": \"abc\", \"nested\": { \"nestedValue\": 100, \"nestedNested\": { \"nestedNestedValue\": 101 } } }", AllExist("abc", 100, 101)),
	        };
	        var schemasJson = "@JsonSchema(dynamic=true) @public @buseventtype @name('schema') create json schema " + JSON_TYPENAME + "()";
	        ...
	        var schemasJsonProvided = "@JsonSchema(className='" + typeof(MyLocalJsonProvided).FullName + "') @public @buseventtype @name('schema') create json schema " + JSONPROVIDED_TYPENAME + "()";
