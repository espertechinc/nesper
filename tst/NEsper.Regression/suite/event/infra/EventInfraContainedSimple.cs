	...
	public class EventInfraContainedSimple : RegressionExecution {
	    public void Run(RegressionEnvironment env) {
	        ...
	        Consumer<string> map = id => {
	            env.SendEventMap(Collections.SingletonDataMap("property", Collections.SingletonDataMap("id", id)), "LocalEvent");
	        };
	        ...
	        Consumer<string> avro = id => {
	            var schema = SchemaBuilder.Record("name", Field("id", StringType(Property(PROP_STRING_KEY, PROP_STRING_VALUE))));
