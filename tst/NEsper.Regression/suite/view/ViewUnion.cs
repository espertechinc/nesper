	...
	public class ViewUnion {
	    ...
	    private class ViewUnionFirstUniqueAndLengthOnDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "create window MyWindowOne#firstunique(theString)#firstlength(3) retain-union as SupportBean;\n" +
	            ...
	            SendEvent(env, "E1", 99);
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E1", 99}});
	            env.AssertPropsNew("s0", fields, new object[]{"E1", 99});

	            SendEvent(env, "E2", 2);
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E1", 99}, new object[] {"E2", 2}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", "theString".SplitCsv(), null, new object[][]{new object[] {"E1"}, new object[] {"E1"}});
	    ...
	    private class ViewUnionFirstUniqueAndFirstLength : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString, intPrimitive from SupportBean#firstlength(3)#firstunique(theString) retain-union";
	    ...
	    private class ViewUnionBatchWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString from SupportBean#length_batch(3)#unique(intPrimitive) retain-union";
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E9"}}, new object[][]{new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    private class ViewUnionAndDerivedValue : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select * from SupportBean#unique(intPrimitive)#unique(intBoxed)#uni(doublePrimitive) retain-union";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class ViewUnionGroupBy : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var text = "@name('s0') select irstream theString from SupportBean#groupwin(intPrimitive)#length(2)#unique(intBoxed) retain-union";
	    ...
	    private class ViewUnionSubselect : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var text = "@name('s0') select * from SupportBean_S0 where p00 in (select theString from SupportBean#length(2)#unique(intPrimitive) retain-union)";
	            env.CompileDeployAddListenerMileZero(text, "s0");
	    ...
	    private class ViewUnionThreeUnique : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString from SupportBean#unique(intPrimitive)#unique(intBoxed)#unique(doublePrimitive) retain-union";
	            env.CompileDeploy(epl).AddListener("s0");
	    ...
	    private class ViewUnionPattern : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var text = "@name('s0') select irstream a.p00||b.p10 as string from pattern [every a=SupportBean_S0 -> b=SupportBean_S1]#unique(a.id)#unique(b.id) retain-union";
	            env.CompileDeployAddListenerMileZero(text, "s0");
	    ...
	    private class ViewUnionTwoUnique : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString from SupportBean#unique(intPrimitive)#unique(intBoxed) retain-union";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][] {new object[] {"E10"}}, new object[][] {new object[] {"E5"}, new object[] {"E7"}});
	    ...
	    private class ViewUnionSorted : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString from SupportBean#sort(2, intPrimitive)#sort(2, intBoxed) retain-union";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class ViewUnionTimeWin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.AdvanceTime(0);
	            var epl = "@name('s0') select irstream theString from SupportBean#unique(intPrimitive)#time(10 sec) retain-union";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class ViewUnionTimeWinSODA : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.AdvanceTime(0);
	            var epl = "@name('s0') select irstream theString from SupportBean#time(10 seconds)#unique(intPrimitive) retain-union";
	    ...
	    private class ViewUnionTimeWinNamedWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.AdvanceTime(0);
	            var epl = "@name('s0') create window MyWindowTwo#time(10 sec)#unique(intPrimitive) retain-union as select * from SupportBean;\n" +
	    ...
	    private class ViewUnionTimeWinNamedWindowDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            env.AdvanceTime(0);
	            var epl = "@name('s0') create window MyWindowThree#time(10 sec)#unique(intPrimitive) retain-union as select * from SupportBean;\n" +
	    ...
	    private static void TryAssertionTimeWinUnique(RegressionEnvironment env) {
	        ...
	        env.AssertPropsPerRowIRPair("s0", fields, null, new object[][] {new object[] {"E7"}, new object[] {"E8"}});
	    ...
	    private static void TryAssertionFirstUniqueAndFirstLength(RegressionEnvironment env) {
	        ...
	        SendEvent(env, "E1", 2);
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E1", 2}});
	        env.AssertPropsNew("s0", fields, new object[]{"E1", 2});

	        SendEvent(env, "E2", 1);
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E1", 2}, new object[] {"E2", 1}});
	        ...
	        SendEvent(env, "E3", 3);
	        env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E1", 1}, new object[] {"E1", 2}, new object[] {"E2", 1}, new object[] {"E3", 3}});
