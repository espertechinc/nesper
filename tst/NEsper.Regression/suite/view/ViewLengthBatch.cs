	...
	public class ViewLengthBatch {
	    ...
	    private class ViewLengthBatchSceneOne : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"symbol"}, new object[][]{new object[] {"E4"}, new object[] {"E5"}});
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertListener("s0", listener => {
	                ...
	                EPAssertionUtil.AssertPropsPerRow(newEvents, fields,
	                    new object[][]{new object[] {"E1", null, "E1", "E2", 3L, win}, new object[] {"E2", "E1", "E1", "E2", 3L, win}, new object[] {"E3", "E2", "E1", "E2", 3L, win}});
	    ...
	    public class ViewLengthBatchDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E2"}, new object[] {"E4"}, new object[] {"E5"}}, null);
	            ...
	            env.Milestone(6);
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E6"}, new object[] {"E7"}});

	            SendSupportBean(env, "E8");
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E6"}, new object[] {"E7"}, new object[] {"E8"}}, new object[][]{new object[] {"E2"}, new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    public class ViewLengthBatchNormal : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertListener("s0", listener => {
	                Assert.IsNull(listener.LastOldData);
	                if (runType == ViewLengthBatchNormalRunType.VIEW) {
	                    EPAssertionUtil.AssertPropsPerRow(listener.LastNewData, "prevString".SplitCsv(), new object[][]{new object[] {null}, new object[] {"E1"}, new object[] {"E2"}});
	                }
