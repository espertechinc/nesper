	...
	public class ViewExpressionWindow {
	    ...
	    public class ViewExpressionWindowSceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString as c0 from SupportBean#expr(newest_timestamp - oldest_timestamp < 1000)";
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E6"}},
	    ...
	    private class ViewExpressionWindowNewestEventOldestEvent : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream * from SupportBean#expr(newest_event.intPrimitive = oldest_event.intPrimitive)";
	            env.CompileDeploy(epl).AddListener("s0").Milestone(0);
	            ...
	            env.AssertPropsNew("s0", fields, new object[]{"E2"});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}});

	            env.Milestone(2);

	            env.SendEventBean(new SupportBean("E3", 2));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E3"}}, new object[][]{new object[] {"E1"}, new object[] {"E2"}});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E3"}});

	            env.Milestone(3);

	            env.SendEventBean(new SupportBean("E4", 3));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E4"}}, new object[][]{new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E4"}, new object[] {"E5"}});

	            env.Milestone(5);

	            env.SendEventBean(new SupportBean("E6", 3));
	            env.AssertPropsNew("s0", fields, new object[]{"E6"});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}});

	            env.Milestone(6);

	            env.SendEventBean(new SupportBean("E7", 2));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E7"}}, new object[][]{new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}});
	    ...
	    private class ViewExpressionWindowTimeWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var fields = new string[]{"theString"};
	            var epl = "@name('s0') select irstream * from SupportBean#expr(oldest_timestamp > newest_timestamp - 2000)";
	            env.CompileDeploy(epl).AddListener("s0");
	            ...
	            env.SendEventBean(new SupportBean("E3", 3));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}});
	            env.AssertPropsNew("s0", fields, new object[]{"E3"});

	            env.AdvanceTime(2500);
	            env.SendEventBean(new SupportBean("E4", 4));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}});
	            env.ListenerReset("s0");

	            env.AdvanceTime(3000);
	            env.SendEventBean(new SupportBean("E5", 5));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}});
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E5"}}, new object[][]{new object[] {"E1"}});

	            env.AdvanceTime(3499);
	            env.SendEventBean(new SupportBean("E6", 6));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}});

	            env.Milestone(1);

	            env.AdvanceTime(3500);
	            env.SendEventBean(new SupportBean("E7", 7));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}, new object[] {"E7"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E8"}}, new object[][]{new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}, new object[] {"E7"}});
	    ...
	    private class ViewExpressionWindowDynamicTimeWindow : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E3"}, new object[] {"E4"}});
	    ...
	    private class ViewExpressionWindowNamedWindowDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E3"}});
	    ...
	    private class ViewExpressionWindowAggregationUngrouped : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E2"}});
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E2"}}, new object[][]{new object[] {"E1"}});

	            env.SendEventBean(new SupportBean("E3", 11));
	            env.AssertPropsPerRowIterator("s0", fields, null);
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E3"}}, new object[][]{new object[] {"E2"}, new object[] {"E3"}});

	            env.Milestone(1);

	            env.SendEventBean(new SupportBean("E4", 12));
	            env.AssertPropsPerRowIterator("s0", fields, null);
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E4"}}, new object[][]{new object[] {"E4"}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E5"}, new object[] {"E6"}});
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E6"}}, null);

	            env.SendEventBean(new SupportBean("E7", 3));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E5"}, new object[] {"E6"}, new object[] {"E7"}});
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E7"}}, null);

	            env.Milestone(3);

	            env.SendEventBean(new SupportBean("E8", 6));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E7"}, new object[] {"E8"}});
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E8"}}, new object[][]{new object[] {"E5"}, new object[] {"E6"}});

	            env.SendEventBean(new SupportBean("E9", 9));
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E9"}});
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E9"}}, new object[][]{new object[] {"E7"}, new object[] {"E8"}});
	    ...
	    private class ViewExpressionWindowAggregationWGroupwin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var fields = new string[]{"theString"};
	            var epl = "@name('s0') select irstream theString from SupportBean#groupwin(intPrimitive)#expr(sum(longPrimitive) < 10)";
	            env.CompileDeploy(epl).AddListener("s0");
	            ...
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E5"}}, new object[][]{new object[] {"E2"}, new object[] {"E4"}});

	            SendEvent(env, "E6", 1, 2);
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E6"}}, new object[][]{new object[] {"E1"}});
	    ...
	    private class ViewExpressionWindowAggregationWOnDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[] {"E4"}}, new object[][]{new object[] {"E1"}});
