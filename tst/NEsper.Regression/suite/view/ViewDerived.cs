	...
	public class ViewDerived {
	    ...
	    public class ViewSizeSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNV("s0", new object[][]{new object[] {"size", 1L}}, new object[][]{new object[] {"size", 0L}});

	            env.Milestone(1);

	            env.SendEventBean(MakeMarketDataEvent("E2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"size", 2L}}, new object[][]{new object[] {"size", 1L}});

	            env.Milestone(2);

	            for (var i = 3; i < 10; i++) {
	                env.SendEventBean(MakeMarketDataEvent("E" + i));
	                env.AssertPropsNV("s0", new object[][]{new object[] {"size", (long) i}}, // new data
	    ...
	    public class ViewSizeAddProps : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(MakeMarketDataEvent("E1"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"size", 1L}, new object[] {"symbol", "E1"}}, new object[][]{new object[] {"size", 0L}, new object[] {"symbol", null}});

	            env.Milestone(0);

	            env.SendEventBean(MakeMarketDataEvent("E2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"size", 2L}, new object[] {"symbol", "E2"}}, new object[][]{new object[] {"size", 1L}, new object[] {"symbol", "E1"}});

	            env.AssertPropsPerRowIterator("s0", new string[]{"size", "symbol"}, new object[][]{new object[] {2L, "E2"}});
	    ...
	    public class ViewDerivedLengthWUniSceneOne : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNV("s0", new object[][]{new object[] {"total", 50d}, new object[] {"datapoints", 1L}}, new object[][]{new object[] {"total", 0.0}, new object[] {"datapoints", 0L}});

	            env.Milestone(1);

	            env.SendEventBean(MakeBean(25, "f2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"total", 75.0}, new object[] {"datapoints", 2L}}, new object[][]{new object[] {"total", 50d}, new object[] {"datapoints", 1L}});

	            env.Milestone(2);

	            env.SendEventBean(MakeBean(25, "f3"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"total", 100.0}, new object[] {"datapoints", 3L}}, new object[][]{new object[] {"total", 75d}, new object[] {"datapoints", 2L}});

	            env.Milestone(3);

	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"total", "datapoints"}, new object[][]{new object[] {100.0, 3L}});

	            env.SendEventBean(MakeBean(1, "f4"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"total", 51.0}, new object[] {"datapoints", 3L}}, new object[][]{new object[] {"total", 100d}, new object[] {"datapoints", 3L}});
	    ...
	    public class ViewDerivedLengthWUniSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select irstream * from SupportMarketDataBean(symbol='" + SYMBOL + "')#length(3)#uni(price, symbol, feed)";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    public class ViewDerivedLengthWUniSceneThree : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(MakeBean(50, "f1"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"total", 50d}, new object[] {"datapoints", 1L}, new object[] {"feed", "f1"}}, new object[][]{new object[] {"total", 0.0}, new object[] {"datapoints", 0L}, new object[] {"feed", null}});

	            env.Milestone(0);

	            env.SendEventBean(MakeBean(25, "f2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"total", 75.0}, new object[] {"datapoints", 2L}, new object[] {"feed", "f2"}}, new object[][]{new object[] {"total", 50d}, new object[] {"datapoints", 1L}, new object[] {"feed", "f1"}});
	    ...
	    public class ViewDerivedLengthWWeightedAvgSceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            var text = "@name('s0') select irstream * from SupportMarketDataBean#length(3)#weighted_avg(price, volume)";
	            env.CompileDeployAddListenerMileZero(text, "s0");

	            env.SendEventBean(MakeBean(10, 1000));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10d}}, new object[][]{new object[] {"average", double.NaN}});

	            env.Milestone(1);

	            env.SendEventBean(MakeBean(11, 2000));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10.666666666666666}}, new object[][]{new object[] {"average", 10.0}});

	            env.Milestone(2);

	            env.SendEventBean(MakeBean(10.5, 1500));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10.61111111111111}}, new object[][]{new object[] {"average", 10.666666666666666}});

	            env.Milestone(3);

	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"average"}, new object[][]{new object[] {10.61111111111111}});

	            env.SendEventBean(MakeBean(9.5, 600));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10.597560975609756}}, new object[][]{new object[] {"average", 10.61111111111111}});
	    ...
	    public class ViewDerivedLengthWWeightedAvgSceneTwo : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            var text = "@name('s0') select irstream * from SupportMarketDataBean#length(3)#weighted_avg(price, volume, feed)";
	            env.CompileDeploy(text).AddListener("s0");

	            env.SendEventBean(MakeBean(10, 1000, "f1"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10d}, new object[] {"feed", "f1"}}, new object[][]{new object[] {"average", double.NaN}, new object[] {"feed", null}});

	            env.Milestone(0);

	            env.SendEventBean(MakeBean(11, 2000, "f2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10.666666666666666}, new object[] {"feed", "f2"}}, new object[][]{new object[] {"average", 10.0}, new object[] {"feed", "f1"}});

	            env.Milestone(1);

	            env.SendEventBean(MakeBean(10.5, 1500, "f3"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"average", 10.61111111111111}, new object[] {"feed", "f3"}}, new object[][]{new object[] {"average", 10.666666666666666}, new object[] {"feed", "f2"}});
	    ...
	    public class ViewDerivedLengthWRegressionLinestSceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", double.NaN}, new object[] {"YIntercept", double.NaN}}, new object[][]{new object[] {"slope", double.NaN}, new object[] {"YIntercept", double.NaN}});
	            env.Milestone(1);

	            env.SendEventBean(MakeBean(70.5, 1500));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", 1000.0}, new object[] {"YIntercept", -69000.0}}, new object[][]{new object[] {"slope", double.NaN}, new object[] {"YIntercept", double.NaN}});
	            env.Milestone(2);

	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"slope", "YIntercept"}, new object[][]{new object[] {1000.0, -69000.0}});

	            env.SendEventBean(MakeBean(70.1, 1200));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", 928.571428587354}, new object[] {"YIntercept", -63952.38095349892}}, new object[][]{new object[] {"slope", 1000.0}, new object[] {"YIntercept", -69000.0}});
	            env.Milestone(3);

	            env.SendEventBean(MakeBean(70.25, 1000));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", 877.5510204634593}, new object[] {"YIntercept", -60443.8775549068}}, new object[][]{new object[] {"slope", 928.571428587354}, new object[] {"YIntercept", -63952.38095349892}});
	            env.Milestone(4);
	    ...
	    public class ViewDerivedLengthWRegressionLinestSceneTwo : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            var text = "@name('s0') select irstream * from SupportMarketDataBean#length(3)#linest(price, volume, feed)";
	            env.CompileDeploy(text).AddListener("s0");

	            env.SendEventBean(MakeBean(70, 1000, "f1"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", double.NaN}, new object[] {"YIntercept", double.NaN}, new object[] {"feed", "f1"}}, new object[][]{new object[] {"slope", double.NaN}, new object[] {"YIntercept", double.NaN}, new object[] {"feed", null}});

	            env.Milestone(0);

	            env.SendEventBean(MakeBean(70.5, 1500, "f2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", 1000.0}, new object[] {"YIntercept", -69000.0}, new object[] {"feed", "f2"}}, new object[][]{new object[] {"slope", double.NaN}, new object[] {"YIntercept", double.NaN}, new object[] {"feed", "f1"}});

	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"slope", "YIntercept", "feed"}, new object[][]{new object[] {1000.0, -69000.0, "f2"}});

	            env.SendEventBean(MakeBean(70.1, 1200, "f3"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"slope", 928.571428587354}, new object[] {"YIntercept", -63952.38095349892}, new object[] {"feed", "f3"}}, new object[][]{new object[] {"slope", 1000.0}, new object[] {"YIntercept", -69000.0}, new object[] {"feed", "f2"}});
	    ...
	    public class ViewDerivedLengthWCorrelation : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(MakeBean(70, 1000));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"correlation", double.NaN}}, new object[][]{new object[] {"correlation", double.NaN}});

	            env.Milestone(1);

	            env.SendEventBean(MakeBean(70.5, 1500));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"correlation", 1.0}}, new object[][]{new object[] {"correlation", double.NaN}});

	            env.Milestone(2);

	            env.SendEventBean(MakeBean(70.1, 1200));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"correlation", 0.9762210399358}}, new object[][]{new object[] {"correlation", 1.0}});

	            // test iterator
	            env.AssertPropsPerRowIterator("s0", "correlation".SplitCsv(), new object[][]{new object[] {0.9762210399358}});

	            env.Milestone(3);

	            env.SendEventBean(MakeBean(70.25, 1000));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"correlation", 0.7046340397673054}}, new object[][]{new object[] {"correlation", 0.9762210399358}});
	    ...
	    public class ViewDerivedAll : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(MakeBean(70, 1000));
	            env.AssertPropsNV("S1", new object[][]{new object[] {"correlation", double.NaN}}, new object[][]{new object[] {"correlation", double.NaN}});
	            ...
	            env.SendEventBean(MakeBean(70.5, 1500));
	            env.AssertPropsNV("S1", new object[][]{new object[] {"correlation", 1.0}}, new object[][]{new object[] {"correlation", double.NaN}});
	            ...
	            env.SendEventBean(MakeBean(70.1, 1200));
	            env.AssertPropsNV("S1", new object[][]{new object[] {"correlation", 0.9762210399358}}, new object[][]{new object[] {"correlation", 1.0}});
	            ...
	            env.AssertPropsPerRowIterator("S3", f3, new object[][]{new object[] {928.571428587354, -63952.38095349892}});
	            env.AssertPropsPerRowIterator("S4", f4, new object[][]{new object[] {3700.0, 3L}});
	            env.AssertPropsPerRowIterator("S5", f5, new object[][]{new object[] {(70.0 * 1000 + 70.5 * 1500 + 70.1 * 1200) / 3700.0}});
	            ...
	            env.SendEventBean(MakeBean(70.25, 1000));
	            env.AssertPropsNV("S1", new object[][]{new object[] {"correlation", 0.7865410694065471}}, new object[][]{new object[] {"correlation", 0.9762210399358}});
	            env.AssertPropsIRPair("S2", f2, new object[]{4L}, new object[]{3L});
	            env.AssertPropsPerRowIterator("S3", f3, new object[][]{new object[] {854.6255506976092, -58830.39647835589}});
	    ...
	    private static void AssertSize(RegressionEnvironment env, long newSize, long oldSize) {
	        env.AssertPropsPerRowIRPair("s0", "size".SplitCsv(), new object[][]{new object[] {newSize}}, new object[][]{new object[] {oldSize}});
	    }
	    ...
	    private static void CheckOld(RegressionEnvironment env, bool isFirst, long countE, double sumE, double avgE, double stdevpaE, double stdevE, double varianceE) {
	        env.AssertListener("s0", listener => {
	    ...
	    private static void CheckValues(EventBean values, bool isFirst, bool isNewData, long countE, double sumE, double avgE, double stdevpaE, double stdevE, double varianceE) {
