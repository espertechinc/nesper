	...
	public class ViewTimeOrderAndTimeToLive {
	    ...
	    internal class ViewTimeOrderSceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E2"}, new object[] {"E1"}});
	            ...
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E4"}, new object[] {"E1"}, new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E1"}, new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E6"}, new object[] {"E8"}, new object[] {"E5"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[]{"E9"}}, new object[][]{new object[]{"E9"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E12"}, new object[] {"E13"}});
	    ...
	    internal class ViewTimeOrderSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[]{"E2", 4000L}, new object[] {"E1", 5000L}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[]{"E1", 5000L}, new object[] {"E3", 5000L}});
	            env.AdvanceTime(14999);
	            env.AssertListenerNotInvoked("s0");
	            env.AdvanceTime(15000);
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E1", 5000L}, new object[] {"E3", 5000L}});
	    ...
	    internal class ViewTimeOrderTTLTimeToLive : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[]{"E2"}, new object[] {"E1"}});
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[]{"E1"}, new object[] {"E4"}});

	            env.Milestone(5);

	            SendEvent(env, "E5", 1000);
	            env.AssertPropsNew("s0", fields, new object[]{"E5"});
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[]{"E1"}, new object[] {"E4"}, new object[] {"E5"}});

	            env.AdvanceTime(999);
	            env.AssertListenerNotInvoked("s0");

	            env.AdvanceTime(1000);
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E1"}, new object[] {"E5"}});
	    ...
	    internal class ViewTimeOrderTTLTimeOrderRemoveStream : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            var fields = "id".SplitCsv();
	            SendTimer(env, 1000);
	            var epl = "insert rstream into OrderedStream select rstream id from SupportBeanTimestamp#time_order(timestamp, 10 sec);\n" +
	            ...
	            env.AssertListenerNotInvoked("s0");
	            SendTimer(env, 32000);
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[]{"E2"}, new object[] {"E5"}}, null);
	            ...
	            env.AssertListenerNotInvoked("s0");
	            SendTimer(env, 38000);
	            env.AssertPropsPerRowIRPairFlattened("s0", fields, new object[][]{new object[]{"E3"}, new object[] {"E9"}}, null);
	    ...
	    internal class ViewTimeOrderTTLTimeOrder : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendEvent(env, "E2", 22000);
	            AssertId(env, "E2");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E1"}, new object[] {"E2"}});

	            // 3nd event at 28 sec
	            SendTimer(env, 28000);
	            SendEvent(env, "E3", 28000);
	            AssertId(env, "E3");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E1"}, new object[] {"E2"}, new object[] {"E3"}});
	            ...
	            SendEvent(env, "E4", 27000);
	            AssertId(env, "E4");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E1"}, new object[] {"E2"}, new object[] {"E4"}, new object[] {"E3"}});

	            // 5th event at 30 sec, however is 22 sec (old 8 sec)
	            SendEvent(env, "E5", 22000);
	            AssertId(env, "E5");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E1"}, new object[] {"E2"}, new object[] {"E5"}, new object[] {"E4"}, new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E2"}, new object[] {"E5"}, new object[] {"E4"}, new object[] {"E3"}});

	            // 6th event at 31 sec, however is 21 sec (old 10 sec)
	            SendEvent(env, "E6", 21000);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[]{"E6"}}, new object[][]{new object[]{"E6"}});
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E2"}, new object[] {"E5"}, new object[] {"E4"}, new object[] {"E3"}});

	            // 7th event at 31 sec, however is 21.3 sec (old 9.7 sec)
	            SendEvent(env, "E7", 21300);
	            AssertId(env, "E7");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E7"}, new object[] {"E2"}, new object[] {"E5"}, new object[] {"E4"}, new object[] {"E3"}});
	            ...
	            env.AssertListenerNotInvoked("s0");
	            SendTimer(env, 32000);
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E2"}, new object[] {"E5"}});
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E4"}, new object[] {"E3"}});
	            ...
	            // rather old event
	            SendEvent(env, "E8", 21000);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[]{"E8"}}, new object[][]{new object[]{"E8"}});
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E3"}});

	            // 9-second old event for posting at 38 sec
	            SendEvent(env, "E9", 28000);
	            AssertId(env, "E9");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E3"}, new object[] {"E9"}});

	            // flush two
	            SendTimer(env, 37999);
	            env.AssertListenerNotInvoked("s0");
	            SendTimer(env, 38000);
	            env.AssertPropsPerRowIRPair("s0", fields, null, new object[][]{new object[]{"E3"}, new object[] {"E9"}});
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, null);
	    ...
	    internal class ViewTimeOrderTTLGroupedWindow : RegressionExecution{
	        public void Run(RegressionEnvironment env) {
	            var fields = "id".SplitCsv();
	            SendTimer(env, 20000);
	            var epl = "@name('s0') select irstream * from SupportBeanTimestamp#groupwin(groupId)#time_order(timestamp, 10 sec)";
	            env.CompileDeploy(epl).AddListener("s0");

	            // 1st event is old
	            SendEvent(env, "E1", "G1", 10000);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[]{"E1"}}, new object[][]{new object[]{"E1"}});
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, null);
	            ...
	            AssertId(env, "E3");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E2"}, new object[] {"E3"}});

	            SendEvent(env, "E4", "G2", 20000);
	            AssertId(env, "E4");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E2"}, new object[] {"E4"}, new object[] {"E3"}});
	            ...
	            AssertId(env, "E5");
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, new object[][]{new object[]{"E5"}, new object[] {"E4"}, new object[] {"E3"}});
	            ...
	            env.AssertListener("s0", listener => {
	                ...
	                EPAssertionUtil.AssertPropsPerRowAnyOrder(listener.LastOldData, "id".SplitCsv(), new object[][]{new object[]{"E4"}, new object[] {"E3"}});
	                listener.Reset();
	            });
	            env.AssertPropsPerRowIterator("s0", new string[]{"id"}, null);
