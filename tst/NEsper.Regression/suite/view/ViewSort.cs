	...
	public class ViewSort {
	    ...
	    private class ViewSortSceneOne : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1", 100, 0L}, new object[] {"E2", 99, 5L}});

	            env.SendEventBean(MakeEvent("E3", 100, -1L));
	            env.AssertPropsNew("s0", fields, new object[]{"E3", 100, -1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E3", 100, -1L}, new object[] {"E1", 100, 0L}, new object[] {"E2", 99, 5L}});

	            env.SendEventBean(MakeEvent("E4", 100, 1L));
	            env.AssertPropsIRPair("s0", fields, new object[]{"E4", 100, 1L}, new object[]{"E2", 99, 5L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E3", 100, -1L}, new object[] {"E1", 100, 0L}, new object[] {"E4", 100, 1L}});

	            env.SendEventBean(MakeEvent("E5", 101, 10L));
	            env.AssertPropsIRPair("s0", fields, new object[]{"E5", 101, 10L}, new object[]{"E4", 100, 1L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E5", 101, 10L}, new object[] {"E3", 100, -1L}, new object[] {"E1", 100, 0L}});

	            env.SendEventBean(MakeEvent("E6", 101, 11L));
	            env.AssertPropsIRPair("s0", fields, new object[]{"E6", 101, 11L}, new object[]{"E1", 100, 0L});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E5", 101, 10L}, new object[] {"E6", 101, 11L}, new object[] {"E3", 100, -1L}});
	    ...
	    public class ViewSortSceneTwo : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E", 2}, new object[] {"G", 1}});
	            SendSupportBean(env, "H", 3);
	            env.AssertPropsNew("s0", fields, new object[]{"H", 3});

	            env.Milestone(3);

	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E", 2}, new object[] {"G", 1}, new object[] {"H", 3}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 5}, new object[] {"E", 2}, new object[] {"G", 1}});
	            SendSupportBean(env, "C", 6);
	            env.AssertPropsIRPair("s0", fields, new object[]{"C", 6}, new object[]{"G", 1});

	            env.Milestone(6);

	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 5}, new object[] {"C", 6}, new object[] {"E", 2}});
	            SendSupportBean(env, "C", 7);
	            env.AssertPropsIRPair("s0", fields, new object[]{"C", 7}, new object[]{"E", 2});

	            env.Milestone(7);

	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 5}, new object[] {"C", 7}, new object[] {"C", 6}});
	            SendSupportBean(env, "C", 8);
	            env.AssertPropsIRPair("s0", fields, new object[]{"C", 8}, new object[]{"C", 6});
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A", 5}, new object[] {"C", 8}, new object[] {"C", 7}});
	    ...
	    public class ViewSortedSingleKeyBuiltin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNV("s0", new object[][]{new object[] {"symbol", "A1"}}, new object[][]{new object[] {"symbol", "D1"}});

	            env.Milestone(4);

	            env.SendEventBean(MakeMarketDataEvent("F1"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"symbol", "F1"}}, new object[][]{new object[] {"symbol", "F1"}});

	            env.Milestone(5);

	            env.SendEventBean(MakeMarketDataEvent("B2"));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"symbol", "B2"}}, new object[][]{new object[] {"symbol", "C1"}});

	            env.Milestone(6);

	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"symbol"}, new object[][]{new object[] {"A1"}, new object[] {"B1"}, new object[] {"B2"}});
	    ...
	    public class ViewSortedMultikey : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNV("s0", new object[][]{new object[] {"theString", "E1"}, new object[] {"supportEnum", SupportEnum.ENUM_VALUE_1}}, null);

	            env.Milestone(1);

	            env.SendEventBean(new SupportBeanWithEnum("E2", SupportEnum.ENUM_VALUE_2));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"theString", "E2"}}, new object[][]{new object[] {"theString", "E2"}});

	            env.Milestone(2);

	            env.SendEventBean(new SupportBeanWithEnum("E0", SupportEnum.ENUM_VALUE_1));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"theString", "E0"}}, new object[][]{new object[] {"theString", "E1"}});
	    ...
	    public class ViewSortedPrimitiveKey : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsNV("s0", new object[][]{new object[] {"price", 10.0}}, new object[][]{new object[] {"price", 10.5}});

	            env.Milestone(2);

	            env.SendEventBean(MakeMarketDataEvent(11));
	            env.AssertPropsNV("s0", new object[][]{new object[] {"price", 11.0}}, new object[][]{new object[] {"price", 11.0}});
	    ...
	    public class ViewSortedPrev : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowNewFlattened("s0",
	                fields, new object[][]{new object[] {"B1", null, "B1", 1L, new object[]{"B1"}}});

	            env.Milestone(0);

	            env.SendEventBean(MakeMarketDataEvent("D1"));
	            env.AssertPropsPerRowNewFlattened("s0",
	                fields, new object[][]{new object[] {"D1", "D1", "D1", 2L, new object[]{"B1", "D1"}}});

	            env.SendEventBean(MakeMarketDataEvent("C1"));
	            env.AssertPropsPerRowNewFlattened("s0",
	                fields, new object[][]{new object[] {"C1", "C1", "D1", 3L, new object[]{"B1", "C1", "D1"}}});

	            env.Milestone(1);

	            env.SendEventBean(MakeMarketDataEvent("A1"));
	            env.AssertPropsPerRowNewFlattened("s0",
	                fields, new object[][]{new object[] {"A1", "B1", "C1", 3L, new object[]{"A1", "B1", "C1"}}});

	            env.Milestone(2);

	            env.SendEventBean(MakeMarketDataEvent("F1"));
	            env.AssertPropsPerRowNewFlattened("s0",
	                fields, new object[][]{new object[] {"F1", "B1", "C1", 3L, new object[]{"A1", "B1", "C1"}}});
