	...
	public class ViewExpressionBatch {
	    ...
	    private class ViewExpressionBatchNewestEventOldestEvent : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream * from SupportBean#expr_batch(newest_event.intPrimitive != oldest_event.intPrimitive, false)";
	    ...
	    private class ViewExpressionBatchLengthBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}}, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E7"}, new object[] {"E8"}, new object[] {"E9"}}, new object[][]{new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}});
	    ...
	    private class ViewExpressionBatchTimeBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var fields = new string[]{"theString"};
	            var epl = "@name('s0') select irstream * from SupportBean#expr_batch(newest_timestamp - oldest_timestamp > 2000)";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	            ...
	            env.SendEventBean(new SupportBean("E5", 5));
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}});
	            ...
	            env.SendEventBean(new SupportBean("E8", 8));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E6"}, new object[] {"E7"}, new object[] {"E8"}}, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    private class ViewExpressionBatchVariableBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E2", 1));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E2"}}, new object[][]{new object[] {"E1"}});

	            env.SendEventBean(new SupportBean("E3", 1));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E3"}}, new object[][]{new object[] {"E2"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E4"}, new object[] {"E5"}}, new object[][]{new object[] {"E3"}});

	            env.SendEventBean(new SupportBean("E6", 1));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E6"}}, new object[][]{new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    private class ViewExpressionBatchDynamicTimeBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E6"}, new object[] {"E7"}, new object[] {"E8"}}, new object[][]{new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    private class ViewExpressionBatchUDFBuiltin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            var epl = "@name('s0') select * from SupportBean#expr_batch(udf(theString, view_reference, expired_count))";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class ViewExpressionBatchNamedWindowDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E5", 5));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}}, null);
	    ...
	    private class ViewExpressionBatchPrev : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select prev(1, theString) as val0 from SupportBean#expr_batch(current_count > 2)";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	            ...
	            env.SendEventBean(new SupportBean("E3", 3));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {null}, new object[] {"E1"}, new object[] {"E2"}}, null);
	    ...
	    private class ViewExpressionBatchEventPropBatch : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E3"}, new object[] {"E4"}}, new object[][]{new object[] {"E2"}});
	    ...
	    private class ViewExpressionBatchAggregationUngrouped : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E4"}}, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E5"}, new object[] {"E6"}, new object[] {"E7"}}, new object[][]{new object[] {"E4"}});
	    ...
	    private class ViewExpressionBatchAggregationWGroupwin : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString from SupportBean#groupwin(intPrimitive)#expr_batch(sum(longPrimitive) > 100)";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E2"}, new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}}, null);

	            SendEvent(env, "E7", 2, 50);
	            env.AssertListenerNotInvoked("s0");

	            SendEvent(env, "E8", 1, 2);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E3"}, new object[] {"E8"}}, null);

	            SendEvent(env, "E9", 2, 50);
	            SendEvent(env, "E10", 1, 101);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E10"}}, new object[][]{new object[] {"E1"}, new object[] {"E3"}, new object[] {"E8"}});

	            SendEvent(env, "E11", 2, 1);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E7"}, new object[] {"E9"}, new object[] {"E11"}}, new object[][]{new object[] {"E2"}, new object[] {"E4"}, new object[] {"E5"}, new object[] {"E6"}});

	            SendEvent(env, "E12", 1, 102);
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E12"}}, new object[][]{new object[] {"E10"}});
	    ...
	    private class ViewExpressionBatchAggregationOnDelete : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.SendEventBean(new SupportBean("E4", 1));
	            env.AssertPropsPerRowIRPair("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E3"}, new object[] {"E4"}}, null);
