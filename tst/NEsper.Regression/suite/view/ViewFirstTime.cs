	...
	public class ViewFirstTime {
	    ...
	    public class ViewFirstTimeSceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AdvanceTime(0);
	            var epl = "@name('s0') select irstream theString as c0, intPrimitive as c1 from SupportBean#firsttime(10 sec)";
	    ...
	    public class ViewFirstTimeSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", new string[]{"symbol"}, new object[][]{new object[] {"E1"}});
	    ...
	    private class ViewFirstTimeSimple : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", "theString".SplitCsv(), new object[][]{new object[] {"E1"}, new object[] {"E2"}});
