	...
	public class ViewTimeWin {
	    ...
	    public class ViewTimeWindowSceneOne : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastOld("s0", fields, new object[][]{new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    public class ViewTimeWindowSceneTwo : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.Milestone(3);
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}, new object[] {"E4"}, new object[] {"E5"}});
	    ...
	    private class ViewTimeSumWFilter : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            // Every event generates a new row, this time we sum the price by symbol and output volume
	            var epl = "@name('s0') select symbol, volume, sum(price) as mySum from SupportMarketDataBean(symbol = 'IBM')#time(30)";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class ViewTimeJustSelectStar : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            // test iterator
	            env.AssertPropsPerRowIterator("s0", new string[]{"symbol"}, new object[][]{new object[] {"E1"}, new object[] {"E2"}});
	    ...
	    public class ViewTimeWindowWPrev : RegressionExecution {
	        ...
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowNewFlattened("s0", fields,
	                new object[][]{new object[] {"E1", null, "E1", 1L, new object[]{"E1"}}, new object[] {"E2", "E1", "E1", 2L, new object[]{"E2", "E1"}}, new object[] {"E3", "E2", "E1", 3L, new object[]{"E3", "E2", "E1"}}});
	            ...
	            env.AdvanceTime(1600);
	            env.AssertPropsPerRowOldFlattened("s0", "symbol".SplitCsv(), new object[][]{new object[] {"E1"}, new object[] {"E2"}, new object[] {"E3"}});
	    ...
	    private class ViewTimeWindowPreparedStmt : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.Deploy(compiled, new DeploymentOptions()
	                .WithStatementSubstitutionParameter(new SupportPortableDeploySubstitutionParams(1, 4).SetStatementParameters)
	                .WithStatementNameRuntime(new SupportPortableDeployStatementName("s0").GetStatementName));
	            env.Deploy(compiled, new DeploymentOptions()
	                .WithStatementSubstitutionParameter(new SupportPortableDeploySubstitutionParams(1, 3).SetStatementParameters)
	    ...
	    private static void AssertEvents(SupportListener listener, string symbol, long volume, double sum, bool unique) {
