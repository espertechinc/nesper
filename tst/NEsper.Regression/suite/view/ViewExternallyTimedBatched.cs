	...
	public class ViewExternallyTimedBatched {
	    ...
	    public class ViewExternallyTimedBatchSceneOne : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream theString as c0 from SupportBean#ext_timed_batch(longPrimitive, 10 sec)";
	            ...
	            env.AssertPropsPerRowIteratorAnyOrder("s0", fields, new object[][]{new object[] {"E3"}, new object[] {"E4"}});
	            SendSupportBeanWLong(env, "E5", 21000);
	            env.AssertPropsPerRowIRPair("s0", fields,
	                new object[][]{new object[] {"E3"}, new object[] {"E4"}}, new object[][]{new object[] {"E1"}, new object[] {"E2"}});
	            ...
	            env.AssertPropsPerRowIRPair("s0", fields,
	                new object[][]{new object[] {"E5"}}, new object[][]{new object[] {"E3"}, new object[] {"E4"}});
	            SendSupportBeanWLong(env, "E7", 41000);
	            env.AssertPropsPerRowIRPair("s0", fields,
	                new object[][]{new object[] {"E6"}}, new object[][]{new object[] {"E5"}});
	    ...
	    private class ViewExternallyTimedBatchedNoReference : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream * from SupportEventIdWithTimestamp#ext_timed_batch(mytimestamp, 1 minute)";
	            env.CompileDeployAddListenerMileZero(epl, "s0");
	    ...
	    private class ViewExternallyTimedBatchedWithRefTime : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            var epl = "@name('s0') select irstream * from SupportEventIdWithTimestamp#ext_timed_batch(mytimestamp, 1 minute, 5000)";
	    ...
	    private static void TryAssertionWithRefTime(RegressionEnvironment env, string epl, AtomicLong milestone) {
	        var fields = "id".SplitCsv();
	    ...
	    private class ViewExternallyTimedBatchMonthScoped : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNew("s0", "theString".SplitCsv(), new object[][]{new object[] {"E1"}, new object[] {"E2"}});
