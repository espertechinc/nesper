...
namespace com.espertech.esper.regressionlib.suite.rowrecog
{
	public class RowRecogInterval {
	    ...
	    private class RowRecogIntervalSimple : RegressionExecution {
	        ...
	        private void TryAssertionInterval(RegressionEnvironment env, AtomicLong milestone) {
	            ...
	            SendTimer(23000, env);
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A1", null, null, null}, new object[] {"A2", "B1", null, "B1"}});
	            ...
	            SendTimer(35000, env);
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A1", null, null, null}, new object[] {"A2", "B1", null, "B1"}, new object[] {"A3", "B2", "B3", "B4"}});
	    ...
	    private class RowRecogPartitioned : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{
	                new object[] {"A1", "B2", "B3", "B3"}, new object[] {"A2", null, null, null}, new object[] {"A3", "B1", null, "B1"}, new object[] {"A4", "B4", null, "B4"}});
	            ...
	            SendTimer(11000, env);
	            env.AssertPropsPerRowLastNew("s0", fields, new object[][]{new object[] {"A1", "B2", "B3", "B3"}, new object[] {"A2", null, null, null}});
	    ...
	    private class RowRecogMultiCompleted : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            SendTimer(10999, env);
	            env.AssertListenerNotInvoked("s0");
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A1", null, null, null}, new object[] {"A2", null, null, null}});
	            ...
	            env.AssertPropsPerRowIterator("s0", fields, new object[][]{new object[] {"A1", null, null, null}, new object[] {"A2", null, null, null}, new object[] {"A3", null, null, null}, new object[] {"A4", "B1", "B2", "B4"}});
	    ...
	    private class RowRecogMonthScoped : RegressionExecution {
	        public void Run(RegressionEnvironment env) {
	            ...
	            env.AssertPropsPerRowLastNew("s0", "a,b0,b1".SplitCsv(),
