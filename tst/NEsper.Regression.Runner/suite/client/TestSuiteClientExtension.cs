...
namespace com.espertech.esper.regressionrun.suite.client
{
    ...
    public class TestSuiteClientExtension : AbstractTestBase
    {
        ...
        public class TestClientExtendUDFInlinedClass : AbstractTestBase
        {
            ...
            [Test, RunInApplicationDomain]
            public void WithInlinedWOptions() => RegressionRunner.Run(_session, ClientExtendUDFInlinedClass.WithInlinedWOptions());

            [Test, RunInApplicationDomain]
            public void WithOverloaded() => RegressionRunner.Run(_session, ClientExtendUDFInlinedClass.WithOverloaded());

            [Test, RunInApplicationDomain]
            public void WithCreateInlinedSameModule() => RegressionRunner.Run(_session, ClientExtendUDFInlinedClass.WithCreateInlinedSameModule());

            [Test, RunInApplicationDomain]
            public void WithInlinedFAF() => RegressionRunner.Run(_session, ClientExtendUDFInlinedClass.WithInlinedFAF());

            [Test, RunInApplicationDomain]
            public void WithInlinedInvalid() => RegressionRunner.Run(_session, ClientExtendUDFInlinedClass.WithInlinedInvalid());

            [Test, RunInApplicationDomain]
            public void WithInlinedLocalClass() => RegressionRunner.Run(_session, ClientExtendUDFInlinedClass.WithInlinedLocalClass());
        }
        ...
        public class TestClientExtendAggregationInlinedClass : AbstractTestBase
        {
            ...
            [Test, RunInApplicationDomain]
            public void WithMultiModuleUses() => RegressionRunner.Run(_session, ClientExtendAggregationInlinedClass.WithMultiModuleUses());

            [Test, RunInApplicationDomain]
            public void WithInvalid() => RegressionRunner.Run(_session, ClientExtendAggregationInlinedClass.WithInvalid());

            [Test, RunInApplicationDomain]
            public void WithSameModule() => RegressionRunner.Run(_session, ClientExtendAggregationInlinedClass.WithSameModule());

            [Test, RunInApplicationDomain]
            public void WithFAF() => RegressionRunner.Run(_session, ClientExtendAggregationInlinedClass.WithFAF());

            [Test, RunInApplicationDomain]
            public void WithLocalClass() => RegressionRunner.Run(_session, ClientExtendAggregationInlinedClass.WithLocalClass());
        }
        ...
        public class TestClientExtendAggregationMultiFunction : AbstractTestBase
        {
            ...
            [Test, RunInApplicationDomain]
            public void WithWithTable() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithWithTable());

            [Test, RunInApplicationDomain]
            public void WithSameProviderGroupedReturnSingleEvent() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithSameProviderGroupedReturnSingleEvent());

            [Test, RunInApplicationDomain]
            public void WithCollEvent() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithCollEvent());

            [Test, RunInApplicationDomain]
            public void WithSingleEvent() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithSingleEvent());

            [Test, RunInApplicationDomain]
            public void WithScalarColl() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithScalarColl());

            [Test, RunInApplicationDomain]
            public void WithScalarArray() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithScalarArray());

            [Test, RunInApplicationDomain]
            public void WithScalarOnly() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithScalarOnly());

            [Test, RunInApplicationDomain]
            public void WithSimpleState() => RegressionRunner.Run(_session, ClientExtendAggregationMultiFunction.WithSimpleState());
        }
    }
} // end of namespace