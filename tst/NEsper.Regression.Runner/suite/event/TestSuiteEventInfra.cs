...
namespace com.espertech.esper.regressionrun.suite.@event
{
    ...
    public class TestSuiteEventInfra : AbstractTestBase
    {
        ...
        [Test]
        public void TestEventInfraPropertyUnderlyingSimple([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyUnderlyingSimple(eventRepresentationChoice));
        }

        [Test]
        public void TestEventInfraPropertyMappedIndexed([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyMappedIndexed(eventRepresentationChoice));
        }

        [Test]
        public void TestEventInfraPropertyDynamicSimple([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyDynamicSimple(eventRepresentationChoice));
        }

        [Test]
        public void TestEventInfraPropertyNestedSimple([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyNestedSimple(eventRepresentationChoice));
        }

        [Test]
        public void TestEventInfraPropertyDynamicNonSimple([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyDynamicNonSimple(eventRepresentationChoice));
        }

        [Test]
        public void TestEventInfraPropertyNestedIndexed([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyNestedIndexed(eventRepresentationChoice));
        }
        ...
        [Test]
        public void TestEventInfraPropertyDynamicNestedRootedSimple([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyDynamicNestedRootedSimple(eventRepresentationChoice));
        }
        ...
        [Test]
        public void TestEventInfraPropertyMappedRuntimeKey([Values] EventRepresentationChoice eventRepresentationChoice)
        {
            RegressionRunner.Run(_session, new EventInfraPropertyMappedRuntimeKey(eventRepresentationChoice));
        }
    }
} // end of namespace