...
namespace com.espertech.esper.client.soda
{
    ...
    public class CreateSchemaClause 
    {
        ...
        public CreateSchemaClause(String schemaName, ICollection<String> types, CreateSchemaClauseTypeDef typeDefinition)
        {
        ...
        public CreateSchemaClause(String schemaName, IList<SchemaColumnDesc> columns, ICollection<String> inherits)
        {
            SchemaName = schemaName;
            Columns = columns;
            Inherits = inherits;
