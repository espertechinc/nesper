...
{
    public class FilterParamIndexEqualsInt : FilterParamIndexEqualsTyped<int>
    {
        public FilterParamIndexEqualsInt(
        ...
        protected override int Unbox(object value) => (int) value;
            ...
            ExprEvaluatorContext ctx)
        {
            ...
            using (ConstantsMapRwLock.ReadLock.AcquireScope()) {
                TypedMap.TryGetValue((int) attributeValue, out evaluator);
            }
