...
{
    public class FilterParamIndexEqualsLong : FilterParamIndexEqualsTyped<long>
    {
        public FilterParamIndexEqualsLong(
        ...
        protected override long Unbox(object value) => (long) value;
            ...
            ExprEvaluatorContext ctx)
        {
            ...
            using (ConstantsMapRwLock.ReadLock.AcquireScope()) {
                TypedMap.TryGetValue((long) attributeValue, out evaluator);
            }
