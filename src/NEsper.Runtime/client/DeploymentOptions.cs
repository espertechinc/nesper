...
namespace com.espertech.esper.runtime.client
{
    ...
    public class DeploymentOptions
    {
        ...
        /// <summary>
        ///     Returns the callback overriding the statement name that identifies the statement within
        ///     the deployment and that
        ...
        ///     and that can be obtained using <see cref="EPStatement.Name" />
        /// </summary>
