...
namespace NEsper.Avro.Extensions
{
    public static class SchemaExtensions
    {
        ...
        /// <summary>
        /// Converts the schema to a fixed schema or throws an exception.
        /// </summary>
        /// <param name="schema">The schema.</param>
        /// <returns></returns>
        /// <exception cref="System.ArgumentException">schema of incorrect type;schema</exception>
        public static FixedSchema AsFixedSchema(this Schema schema)
        {
            return AsSchema<FixedSchema>(schema);
        }
