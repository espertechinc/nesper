...
namespace com.espertech.esper.compat.datetime
{
    public static class DateTimeFieldMath
    {
        ...
        /// <returns></returns>
        public static int GetActualMinimum(this DateTime dateTime, DateTimeFieldEnum field)
        {
            switch (field)
            {
        ...
        /// <param name="field">The field.</param>
        /// <returns></returns>
        public static int GetActualMaximum(this DateTimeOffset dateTime, DateTimeFieldEnum field)
        {
            switch (field)
            {
                case DateTimeFieldEnum.MILLISEC:
        ...
        /// <returns></returns>
        public static DateTime SetFieldValue(this DateTime dateTime, DateTimeFieldEnum field, int value)
        {
            switch (field)
            {
                case DateTimeFieldEnum.MILLISEC:
        ...
        /// <param name="field">The field.</param>
        /// <returns></returns>
        public static int GetFieldValue(this DateTime dateTime, DateTimeFieldEnum field)
        {
            switch (field)
            {
                case DateTimeFieldEnum.MILLISEC:
        ...
        /// <returns></returns>
        public static DateTime AddUsingField(this DateTime dateTime, DateTimeFieldEnum field, int amount)
        {
            switch (field)
            {
                case DateTimeFieldEnum.MILLISEC:
