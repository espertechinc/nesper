...
namespace com.espertech.esper.common.@internal.view.core
{
    ...
    ///     <para />
    ///     To feed views that are registered with it, a view should only call the update method on its child views when its
    ///     own
    ///     data has changed. If it receives an update which results in no change to its data, it should not update any
    ///     children
    ///     views.
    /// </summary>
