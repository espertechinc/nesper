...
namespace com.espertech.esper.common.@internal.statemgmtsettings
{
    ...
    {
        StateMgmtSetting Unindexed(
            FabricCharge fabricCharge,
            QueryPlanAttributionKey attributionKey,
            EventType eventType,
            StatementRawInfo raw);

        StateMgmtSetting IndexHash(
            FabricCharge fabricCharge,
            QueryPlanAttributionKey attributionKey,
            string indexName,
            EventType eventType,
        ...
        StateMgmtSetting IndexInSingle(
            FabricCharge fabricCharge,
            QueryPlanAttributionKey attributionKey,
            EventType eventType,
