...
{
    public class ProxyJsonEventBeanManufacturer : ProxyEventBeanManufacturer
    {
        public EventBeanTypedEventFactory EventFactory { get; set; }
        public EventType EventType { get; set; }

        public ProxyJsonEventBeanManufacturer(
            EventType eventType,
        ...
        public override EventBean Make(object[] properties)
        {
            ...
            return EventFactory.AdapterForTypedJson(und, EventType);
        }
    }
}