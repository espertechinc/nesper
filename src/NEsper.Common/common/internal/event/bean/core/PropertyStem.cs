...
namespace com.espertech.esper.common.@internal.@event.bean.core
{
    ...
    public class PropertyStem
    {
        ...
        {
            return
                $"{nameof(PropertyName)}: {PropertyName}, {nameof(PropertyType)}: {PropertyType}, {nameof(ReadMethod)}: {ReadMethod}, {nameof(IsSimpleReadMethod)}: {IsSimpleReadMethod}, {nameof(IsIndexedReadMethod)}: {IsIndexedReadMethod}, {nameof(IsMappedReadMethod)}: {IsMappedReadMethod}, {nameof(AccessorField)}: {AccessorField}, {nameof(AccessorProp)}: {AccessorProp}, {nameof(ReturnType)}: {ReturnType}, {nameof(DeclaringType)}: {DeclaringType}, {nameof(ReturnTypeGeneric)}: {ReturnTypeGeneric}";
        }
