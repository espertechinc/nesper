...
namespace com.espertech.esper.common.@internal.@event.json.core
{
    public class EventTypeNestableGetterFactoryJson : EventTypeNestableGetterFactory
    {
            ...
            BeanEventTypeFactory beanEventTypeFactory)
        {
            ...
            if (type == null && _detail.IsDynamic) { // we do not know this property
                ...
                if (prop is DynamicIndexedProperty dynamicIndexedProperty) {
                    return new JsonGetterDynamicIndexedSchema(
                        dynamicIndexedProperty.PropertyNameAtomic,
                        dynamicIndexedProperty.Index);
                }
            ...
            if (prop is DynamicSimpleProperty) {
                ...
                if (type is Type) {
                    return GetGetterProperty(prop.PropertyNameAtomic, null, eventBeanTypedEventFactory, true);
                }
            ...
            if (prop is DynamicIndexedProperty indexed) {
                ...
                if (type is TypeBeanOrUnderlying[]) {
                    return GetGetterIndexedUnderlyingArray(
                        prop.PropertyNameAtomic,
                        indexed.Index,
                        eventBeanTypedEventFactory,
                        null,
            ...
            bool canFragment)
        {
            ...
            if (field.OptionalField != null) {
                if (field.OptionalField.FieldType.IsArray) {
                    return new JsonGetterSimpleProvidedWFragmentArray(
                        field.OptionalField,
                        nativeFragmentType,
                        eventBeanTypedEventFactory);
                }

                return new JsonGetterSimpleProvidedWFragmentSimple(
                    field.OptionalField,
                    nativeFragmentType,
                    eventBeanTypedEventFactory);
            }

            return new JsonGetterSimpleSchemaWFragment(
                field,
                _detail.UnderlyingClassName,
                null,
                eventBeanTypedEventFactory);
        }
            ...
            EventBeanTypedEventFactory eventBeanTypedEventFactory)
        {
            ...
            return new JsonGetterSimpleSchemaWFragmentArray(
                field,
                _detail.UnderlyingClassName,
                eventType,
                eventBeanTypedEventFactory);
            ...
            BeanEventTypeFactory beanEventTypeFactory)
        {
            ...
            if (field.OptionalField != null) {
                return new JsonGetterIndexedProvided(
                    index,
                    _detail.UnderlyingClassName,
                    innerType,
                    eventBeanTypedEventFactory,
            ...
            return new JsonGetterIndexedSchema(
                index,
                _detail.UnderlyingClassName,
                innerType,
                eventBeanTypedEventFactory,
            ...
            BeanEventTypeFactory beanEventTypeFactory)
        {
            ...
            if (field.OptionalField != null) {
                return new JsonGetterIndexedProvidedBaseNative(
                    eventBeanTypedEventFactory,
                    beanEventTypeFactory,
                    componentType,
                    field.OptionalField,
            ...
            EventBeanTypedEventFactory eventBeanTypedEventFactory)
        {
            ...
            if (field.OptionalField != null) {
                return new JsonGetterNestedArrayIndexedProvided(
                    index,
                    (JsonEventPropertyGetter)getter,
                    _detail.UnderlyingClassName,
                    field.OptionalField);
            }

            return new JsonGetterNestedArrayIndexedSchema(
                index,
                (JsonEventPropertyGetter)getter,
                _detail.UnderlyingClassName,
                field);
        ...
        public EventPropertyGetterSPI GetGetterNestedPropertyProvidedGetterDynamic(
            ...
            EventBeanTypedEventFactory eventBeanTypedEventFactory)
        {
            return new JsonGetterDynamicNestedSchema(
                propertyName,
                (JsonEventPropertyGetter)nestedGetter,
                _detail.UnderlyingClassName);
        }
            ...
            EventBeanTypedEventFactory eventBeanTypedEventFactory)
        {
            ...
            if (field.OptionalField != null) {
                return new JsonGetterNestedProvided(
