...
namespace com.espertech.esper.common.@internal.@event.json.getter.provided
{
        ...
        JsonEventPropertyGetter
    {
        ...
        public JsonGetterNestedPONOPropProvided(
            ...
            Type returnType,
            FieldInfo field,
            BeanEventPropertyGetter nestedGetter) : base(eventBeanTypedEventFactory, beanEventTypeFactory, returnType)
        {
            _field = field;
            ...
            CodegenClassScope codegenClassScope)
        {
            return codegenMethodScope.MakeChild(typeof(object), GetType(), codegenClassScope)
                ...
                .MethodReturn(_nestedGetter.UnderlyingGetCodegen(CastRef(_nestedGetter.TargetType, "value"), codegenMethodScope, codegenClassScope));
        }
            ...
            CodegenClassScope codegenClassScope)
        {
            return codegenMethodScope.MakeChild(typeof(bool), GetType(), codegenClassScope)
                ...
                .MethodReturn(_nestedGetter.UnderlyingExistsCodegen(CastRef(_nestedGetter.TargetType, "value"), codegenMethodScope, codegenClassScope));
        }
    }
} // end of namespace