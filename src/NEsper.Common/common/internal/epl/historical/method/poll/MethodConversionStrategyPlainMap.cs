...
{
    public class MethodConversionStrategyPlainMap : MethodConversionStrategyBase
    {
            ...
            ExprEvaluatorContext exprEvaluatorContext)
        {
            return Collections.SingletonList<EventBean>(
                exprEvaluatorContext.EventBeanTypedEventFactory.AdapterForTypedMap(
                    invocationResult.UnwrapStringDictionary(),
                    eventType));
        }
    }
} // end of namespace