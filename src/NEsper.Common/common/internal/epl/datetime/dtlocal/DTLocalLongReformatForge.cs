...
{
    public class DTLocalLongReformatForge : DTLocalReformatForgeBase
    {
        ...
        public override DTLocalEvaluator DTEvaluator => new DTLocalLongReformatEval(reformatForge.Op);
