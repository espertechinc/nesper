...
namespace com.espertech.esper.common.@internal.epl.expression.funcs
{
    ...
    {
        [NonSerialized] private ExprTypeofNodeForge _forge;
        ...
        public ExprFilterSpecLookupableForge FilterLookupable {
            get {
                ...
                var serde = _exprValidationContext.SerdeResolver.SerdeForFilter(typeof(string), _exprValidationContext.StatementRawInfo);
