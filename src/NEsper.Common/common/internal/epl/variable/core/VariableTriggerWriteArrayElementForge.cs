...
namespace com.espertech.esper.common.@internal.epl.variable.core
{
    public class VariableTriggerWriteArrayElementForge : VariableTriggerWriteForge
    {
        ...
        {
            var method = parent.MakeChild(typeof(VariableTriggerWriteArrayElement), GetType(), classScope);
            method.Block
                .DeclareVar<VariableTriggerWriteArrayElement>(
                    "desc",
                    NewInstance(typeof(VariableTriggerWriteArrayElement)))
                ...
                .SetProperty(
                    ...
                    widener == null
                        ? ConstantNull()
                        : TypeWidenerFactory.CodegenWidener(widener, method, GetType(), classScope))
