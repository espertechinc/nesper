...
namespace com.espertech.esper.common.@internal.epl.join.exec.sorted
{
        ...
        SortedAccessStrategy
    {
        ...
        public ISet<EventBean> LookupCollectKeys(
            ...
            List<object> keys)
        {
            object start = EvaluateLookupStart(theEvent, context);
            keys.Add(start);
            object end = EvaluateLookupEnd(theEvent, context);
            keys.Add(end);
        ...
        public ICollection<EventBean> LookupCollectKeys(
            ...
            List<object> keys)
        {
            object start = EvaluatePerStreamStart(eventsPerStream, context);
            keys.Add(start);
            object end = EvaluatePerStreamEnd(eventsPerStream, context);
            keys.Add(end);
