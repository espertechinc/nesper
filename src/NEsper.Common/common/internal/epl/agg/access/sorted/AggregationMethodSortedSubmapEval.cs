...
namespace com.espertech.esper.common.@internal.epl.agg.access.sorted
{
    public class AggregationMethodSortedSubmapEval : AggregationMultiFunctionAggregationMethod
    {
            ...
            ExprEvaluatorContext exprEvaluatorContext)
        {
            ...
            var fromInclusive = _fromInclusiveEval.Evaluate(eventsPerStream, isNewData, exprEvaluatorContext)
                .AsBoxedBoolean();
            ...
            var toInclusive = _toInclusiveEval.Evaluate(eventsPerStream, isNewData, exprEvaluatorContext)
                .AsBoxedBoolean();
            if (toInclusive == null) {
                return null;
            }
            ...
            foreach (var entry in submap) {
                mapOfArrays.Put(
                    entry.Key,
                    AggregatorAccessSortedImpl.CheckedPayloadGetUnderlyingArray(entry.Value, _underlyingClass));
            }
