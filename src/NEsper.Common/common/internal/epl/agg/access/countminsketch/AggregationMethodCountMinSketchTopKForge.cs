...
namespace com.espertech.esper.common.@internal.epl.agg.access.countminsketch
{
	public class AggregationMethodCountMinSketchTopKForge : AggregationMethodForge
	{
		...
		{
			CodegenMethod method = parent.MakeChild(typeof(AgregationMethodCountMinSketchTopK), GetType(), classScope);
			method.Block
				.DeclareVarNewInstance<AgregationMethodCountMinSketchTopK>("strat")
