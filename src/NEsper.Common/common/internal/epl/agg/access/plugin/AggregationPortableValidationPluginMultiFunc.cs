...
namespace com.espertech.esper.common.@internal.epl.agg.access.plugin
{
    public class AggregationPortableValidationPluginMultiFunc : AggregationPortableValidation
    {
            ...
            CodegenClassScope classScope)
        {
            ...
            method.Block
                .DeclareVarNewInstance<AggregationPortableValidationPluginMultiFunc>("portable")
        ...
        ExprNode[] @params)
    {
        ...
        // set of reader
        var type = Handler.ReturnType;
        var returnType = type.GetNormalizedClass();
        ...
        var eventTypeCollection = type.OptionalIsEventTypeColl();
        var eventTypeSingle = type.OptionalIsEventTypeSingle();
        var componentTypeCollection = type switch {
            EPChainableTypeClass typeClass => typeClass.Clazz.GetIndexType(),
            _ => null
        };
