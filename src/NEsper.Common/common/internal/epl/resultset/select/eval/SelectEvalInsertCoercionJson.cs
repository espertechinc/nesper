...
namespace com.espertech.esper.common.@internal.epl.resultset.select.eval
{
	public class SelectEvalInsertCoercionJson : SelectExprProcessorForge
	{
		...
		{
			CodegenMethod methodNode = codegenMethodScope.MakeChild(typeof(EventBean), GetType(), codegenClassScope);
			...
			methodNode.Block
				...
				.DeclareVar(target.Detail.UnderlyingClassName, "und", NewInstanceNamed(target.Detail.UnderlyingClassName));
