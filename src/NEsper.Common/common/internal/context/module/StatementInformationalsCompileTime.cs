    ...
    public class StatementInformationalsCompileTime
    {
            ...
            CodegenClassScope classScope)
        {
            ...
            builder
                ...
                .ConstantDefaultChecked("Preemptive", _preemptive)
                .ConstantDefaultChecked("HasVariables", _hasVariables)
                .ConstantDefaultChecked("WritesToTables", _writesToTables)
                ...
                .ConstantDefaultChecked("ForClauseDelivery", _forClauseDelivery)
