...
{
    public class StmtClassForgeableAIFactoryProviderCreateDataflow : StmtClassForgeableAIFactoryProviderBase
    {
        private readonly StatementAgentInstanceFactoryCreateDataflowForge forge;

        public StmtClassForgeableAIFactoryProviderCreateDataflow(
            string className,
