...
<!--
	...
	FROM HIBERNATE
	 - Replaced hibernate title page image with a blank image
	 - Replace hibernate reference in page numbers with Esper 
        ...
        <xsl:variable name="Version">
            <xsl:choose>
                <xsl:when test="//releaseinfo">
                    <xsl:text>&#169; 2011 EsperTech Inc. - Esper </xsl:text>
